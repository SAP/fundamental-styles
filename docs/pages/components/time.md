...
<div class="fd-time">
  <div class="fd-time__item">
      <div class="fd-time__control">
          <button class="fd-button fd-button--light sap-icon--navigation-up-arrow"
      ...
      <div class="fd-time__control">
          <button class="fd-button fd-button--light sap-icon--navigation-down-arrow"
...
<div class="fd-time">
  <div class="fd-time__item">
      ...
      <div class="fd-time__control">
          <button class="fd-button fd-button--light sap-icon--navigation-down-arrow is-disabled"
          aria-label="Decrease hours" aria-controls="Rjap5115"></button>
      </div>
  </div>
  <div class="fd-time__item">
      <div class="fd-time__control">
          <button class="fd-button fd-button--light sap-icon--navigation-up-arrow is-disabled"
