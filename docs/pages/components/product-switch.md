...
{: .docs-intro}
The granularity of the Product Switch is based on the LoB and the product slicing. It provides a role based access to all products or LoBs.
The Product Switch is designed to be as simple as possible. It shows only one level of navigation.
When navigating to one of the elements the describtive product name/ LoB name that is shown in the Product Switch is reflected in the shell bar.
