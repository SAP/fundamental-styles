	...
	<div class="fd-popover">
		<div class="fd-popover__control">
			<div class="fd-input-group fd-input-group--after">
				...
				<button class="fd-popover__control fd-button--light sap-icon--calendar fd-input-group__button" aria-controls="Itcgq828" aria-expanded="false" aria-haspopup="true" aria-hidden="true"></button>
				</span>
			</div>
		</div>
	...
	<div class="fd-popover">
		<div class="fd-popover__control">
			<div class="fd-input-group fd-input-group--after fd-input-group--compact">
				...
				<span class="fd-input-group__addon fd-input-group__addon--after fd-input-group__addon--button">
				<button class="fd-popover__control fd-button--light fd-button--compact sap-icon--calendar fd-input-group__button" aria-controls="Itcgq82" aria-expanded="false" aria-haspopup="true" aria-hidden="true"></button>
				</span>
			</div>
		</div>
