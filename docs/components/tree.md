...
selector: fd-tree
cssFile: tree.css
sourcePath: packages/styles/stories/Components/tree/tree.stories.js
tags: []
dependencies: ["button","checkbox","icon","radio","tree"]
relatedComponents: ["button","checkbox","icon","radio","tree"]
stability: stable
generatedAt: 2026-06-08T17:49:01.597Z
---

# Components/Tree

Tree allows the user to display and work with a hierarchical set of items. Trees are mostly used in the master list for a master-detail scenario using the **Flexible Column Layout** and in **Popovers** or **Dialogs**. In certain use cases, they can also be used in the **Dynamic Page Layout**.
...
<link href="node_modules/fundamental-styles/dist/tree.css" rel="stylesheet">
...
- `fd-tree__button`
- `fd-tree__content`
- `fd-tree__content--wrap`
- `fd-tree__expander`
- `fd-tree__icon`
- `fd-tree__icon--navigation`
- `fd-tree__item`
- `fd-tree__item-container`
- `fd-tree__item-container--active`
- `fd-tree__text`
...
- `--fdList_Button_Spacing`
- `--fdTree_Button_Spacing`
- `--fdTree_Expander_Icon_Font_Size`
- `--fdTree_Expander_Size`
- `--fdTree_Item_Font_Size`
- `--fdTree_Item_Height`
- `--fdTree_Item_Wrap_Text_Line_Height`
- `--navigation`
- `--sapButton_IconColor`
...
This documentation was automatically generated from: `packages/styles/stories/Components/tree/tree.stories.js`
