...
selector: fd-popover
cssFile: popover.css
sourcePath: packages/styles/stories/Components/notification/notification.stories.js
tags: []
...
stability: stable
generatedAt: 2026-06-01T19:23:59.963Z
---
...
Notification items display a container with:
<ul>
...
You can display a group of notifications in a list format, and the user can sort them from the header. A Message Strip can be places after the group header. To load more notifications, the list can have a Growing Item placed at the bottom of the group.
...
Notifications can be displayed as banners in the top right corner. Apply the modifier class \
...
This documentation was automatically generated from: `packages/styles/stories/Components/notification/notification.stories.js`
