...
stability: stable
generatedAt: 2026-06-01T19:23:59.527Z
---
...
<link href="node_modules/fundamental-styles/dist/illustrated-message.css" rel="stylesheet">
...
| Class | Description |
|-------|-------------|
| `fd-card--analytical` | The analytical card is used for data visualization |
| `fd-card--interactive` | Non-interactive cards have <code>role="region"</code> |
| `fd-card--object` | The object card can display a single object or a group of objects |
| `fd-card--table` | Alternatively to an Avatar a Message Icon can be displayed within the Main Header |
