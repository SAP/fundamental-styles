---
component: fd-calendar
title: Components/Calendar
category: Components
selector: fd-calendar
cssFile: calendar.css
sourcePath: packages/styles/stories/Components/calendar/calendar.stories.js
tags: []
...
stability: stable
generatedAt: 2026-05-28T16:47:20.914Z
---
...
<link href="node_modules/fundamental-styles/dist/calendar.css" rel="stylesheet">
...
| Class | Description |
|-------|-------------|
| `fd-calendar--mobile` | Style variant |
...
- `fd-calendar__my-item`
- `fd-calendar__my-item-button`
...
- `--arrow-right`
- `--auto-column`
- `--fdCalendarContainerFlexDirection`
- `--fdCalendarContainerGap`
- `--fdCalendar_Action_Padding`
- `--fdCalendar_Action_Width`
- `--fdCalendar_Active_Item_Border`
- `--fdCalendar_Active_Item_Font_Weight`
- `--fdCalendar_Background`
- `--fdCalendar_Border_Radius`
- `--fdCalendar_Button_Horizontal_Space`
- `--fdCalendar_Item_Active_Background_Hover`
...
The Calendar component can display a customizable legend to help users interpret the meaning of various colors and styles used within the calendar.<br>
The legend includes:
...
This documentation was automatically generated from: `packages/styles/stories/Components/calendar/calendar.stories.js`
