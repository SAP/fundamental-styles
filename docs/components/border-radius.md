...
relatedComponents: []
stability: stable
generatedAt: 2026-06-01T19:24:00.280Z
---

# Border Radius

Provides CSS classes and SCSS mixins for controlling the corner rounding of elements. Classes apply predefined theme-based border-radius values, while the sap-border-radius mixin lets you define custom values for one or multiple corners.
...
This documentation was automatically generated from: `packages/common-css/stories/border-radius/border-radius.stories.js`
