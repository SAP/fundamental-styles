---
component: fd-micro-process-flow
title: Components/Micro Process Flow
category: Components
selector: fd-micro-process-flow
cssFile: micro-process-flow.css
sourcePath: packages/styles/stories/Components/micro-process-flow/micro-process-flow.stories.js
tags: []
...
stability: stable
generatedAt: 2026-06-08T17:49:02.193Z
---
...
<link href="node_modules/fundamental-styles/dist/micro-process-flow.css" rel="stylesheet">
...
- `fd-micro-process-flow__connector--intermediate`
- `fd-micro-process-flow__content`
- `fd-micro-process-flow__content-wrapper`
- `fd-micro-process-flow__focusable-item`
- `fd-micro-process-flow__icon`
- `fd-micro-process-flow__icon-container`
- `fd-micro-process-flow__intermediary-item`
- `fd-micro-process-flow__item`
- `fd-micro-process-flow__item--critical`
- `fd-micro-process-flow__item--information`
- `fd-micro-process-flow__item--negative`
- `fd-micro-process-flow__item--positive`
...
- `--fdMicro_Process_Flow_Compact_Connector_Width`
- `--fdMicro_Process_Flow_Compact_Item_Min_Width`
- `--fdMicro_Process_Flow_Compact_Item_Width`
- `--fdMicro_Process_Flow_Compact_Max_Container_Width`
- `--fdMicro_Process_Flow_Connector_Width`
- `--fdMicro_Process_Flow_Icon_Color`
- `--fdMicro_Process_Flow_Icon_Font_Size`
- `--fdMicro_Process_Flow_Item_Active_Background`
- `--fdMicro_Process_Flow_Item_Active_Border_Color`
- `--fdMicro_Process_Flow_Item_Background`
- `--fdMicro_Process_Flow_Item_Border_Color`
- `--fdMicro_Process_Flow_Item_Hover_Background`
- `--fdMicro_Process_Flow_Item_Hover_Border_Color`
- `--fdMicro_Process_Flow_Item_Min_Width`

*...and 5 more*

## Examples

### Micro process flow with dependent steps (Default)
...
### Micro process flow with custom steps
        ...
        <div class="fd-micro-process-flow__wrapper">
                ...
                <div class="fd-micro-process-flow__content">
                    <div class="fd-micro-process-flow__content-wrapper">
                        <div class="fd-status-indicator fd-status-indicator--positive coreographed fd-status-indicator--md fd-micro-process-flow__focusable-item" aria-roledescription="Status Indicator" role="progressbar" aria-valuetext="70%" tabindex=0 aria-label="Status Indicator example for order dispatching" focusable="true" title="Fill object to form single filling pattern">
                            <svg id="__shape0__box32-24-cart" class="fd-status-indicator__svg" version="1.1" xlmns="http://www.w3.org/2000/svg" viewBox="0 0 26 25" preserveAspectRatio="xMidYMid meet" x="0" y="0" width="100%" height="100%">
                ...
                <div class="fd-micro-process-flow__content">
                    <div class="fd-micro-process-flow__content-wrapper">
                        <div class="fd-status-indicator fd-status-indicator--critical coreographed fd-status-indicator--md fd-micro-process-flow__focusable-item" aria-roledescription="Status Indicator" role="progressbar" aria-valuetext="70%" tabindex=0 aria-label="Status Indicator example for order dispatching" focusable="true" title="Fill object to form single filling pattern">
                            <svg id="__shape0__box29-24-factory" version="1.1" class="fd-status-indicator__svg" xlmns="http://www.w3.org/2000/svg" viewBox="0 0 26 25" preserveAspectRatio="xMidYMid meet" x="0" y="0" width="100%" height="100%">
            ...
            <div class="fd-micro-process-flow__item fd-micro-process-flow__item--positive">
                <div class="fd-micro-process-flow__content">
                    <div class="fd-micro-process-flow__content-wrapper">
                        <div class="fd-status-indicator fd-status-indicator--critical coreographed fd-status-indicator--md fd-micro-process-flow__focusable-item" aria-roledescription="Status Indicator" role="progressbar" aria-valuetext="70%" tabindex=0 aria-label="Status Indicator example for order dispatching" focusable="true" title="Fill object to form single filling pattern">
                            <svg id="__shape0__box30-24-truck" version="1.1" class="fd-status-indicator__svg" xlmns="http://www.w3.org/2000/svg" viewBox="0 0 45 25" preserveAspectRatio="xMidYMid meet" x="0" y="0" width="100%" height="100%">
                ...
                <div class="fd-micro-process-flow__content">
                    <div class="fd-micro-process-flow__content-wrapper">
                        <div class="fd-status-indicator coreographed fd-status-indicator--md fd-micro-process-flow__focusable-item" aria-roledescription="Status Indicator" role="progressbar" aria-valuetext="70%" tabindex=0 aria-label="Status Indicator example for order dispatching" focusable="true" title="Fill object to form single filling pattern">
                            <svg id="__shape0__box31-24-plane" version="1.1" class="fd-status-indicator__svg" xlmns="http://www.w3.org/2000/svg" viewBox="0 0 26 25" preserveAspectRatio="xMidYMid meet" x="0" y="0" width="100%" height="100%">
...
### Micro process flow with popover

Information displayed in micro flow process items can be extended by adding popovers with additional context.
...
### Micro process flow with overflow
...
### Micro process flow with elements inserted between nodes
            ...
            <div class="fd-micro-process-flow__item">
                <div class="fd-micro-process-flow__content">
                    ...
                    <div class="fd-micro-process-flow__connector">
                        <i class="sap-icon--color-critical sap-icon--syringe fd-micro-process-flow__intermediary-item" role="presentation"></i>
                    </div>
                </div>
            </div>
            <div class="fd-micro-process-flow__item fd-micro-process-flow__item--positive">
...
This documentation was automatically generated from: `packages/styles/stories/Components/micro-process-flow/micro-process-flow.stories.js`
