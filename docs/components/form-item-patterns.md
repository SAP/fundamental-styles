...
The AI Text highlight pattern is always used on a block of text shown within components like Text Area, Rich Text Editor etc.
...
This documentation was automatically generated from: `packages/styles/stories/AI/Patterns/ai-text-highlight/ai-text-highlight.stories.js`
