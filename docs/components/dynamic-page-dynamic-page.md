...
cssFile: dynamic-page.css
sourcePath: packages/styles/stories/Layouts/dynamic-page/dynamic-page.stories.js
tags: []
...
stability: stable
generatedAt: 2026-06-01T19:24:00.321Z
---

# Layouts/Dynamic Page

The dynamic page is the foundation for all pages in SAP. It is a generic layout designed to support various use cases; therefore, the content of both the header and page can vary.
...
<link href="node_modules/fundamental-styles/dist/dynamic-page.css" rel="stylesheet">
...
<link href="node_modules/fundamental-styles/dist/dynamic-page.css" rel="stylesheet">
<link href="node_modules/fundamental-styles/dist/facet.css" rel="stylesheet">
...
<link href="node_modules/fundamental-styles/dist/paddings.css" rel="stylesheet">
...
- `fd-dynamic-page__collapse-button`
...
- `fd-dynamic-page__header-button`
- `fd-dynamic-page__main-container`
- `fd-dynamic-page__pin-button`
- `fd-dynamic-page__subtitle`
- `fd-dynamic-page__summarized-title`
- `fd-dynamic-page__summarized-title--collapsed`
- `fd-dynamic-page__summarized-title-area`
- `fd-dynamic-page__summarized-title-area--no-shadow`
- `fd-dynamic-page__tabs`
- `fd-dynamic-page__tabs--add-shadow`
- `fd-dynamic-page__tabs--overflow`
...
- `fd-dynamic-page__toolbar`
- `fd-dynamic-page__toolbar--actions`
- `fd-dynamic-page__toolbar--content`
...
Displays the dynamic page with a collapsed header on desktop screens.
...
The header can be configured without a pin button, allowing users to only expand or collapse the header area.
...
This documentation was automatically generated from: `packages/styles/stories/Layouts/dynamic-page/dynamic-page.stories.js`
