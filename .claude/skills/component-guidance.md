...
This skill provides SAP Fiori Design Guidelines for fundamental-styles components, helping you understand when to use each component, when to avoid them, and best practices.
