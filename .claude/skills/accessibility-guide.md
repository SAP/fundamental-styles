...
<div role="progressbar"
     ...
     aria-valuemin="0"
     aria-valuemax="100"
     aria-label="Upload progress">60%</div>
```
...
<div role="option" 
     aria-selected="false">Option 1</div>
```
...
<div role="combobox"
     ...
     aria-owns="listbox-1">
  <input type="text" />
  <ul role="listbox" id="listbox-1" hidden>...</ul>
</div>
```
...
<div role="tablist" aria-label="Product categories">
  <button role="tab" 
          ...
          aria-controls="panel-1"
          id="tab-1"
          tabindex="0">Electronics</button>
  <button role="tab" 
          aria-selected="false" 
          aria-controls="panel-2"
          id="tab-2"
          tabindex="-1">Clothing</button>
</div>
...
```html
<div role="menu">
  <button>New</button>  <!-- Missing role="menuitem" -->
</div>
```
...
<div 
  ...
  <div class="fd-dialog__content">
    <header class="fd-dialog__header">
      <h2 id="dialog-title" class="fd-title fd-title--h5">
        Confirm Action
      </h2>
      <button 
...
```html
<div 
  class="fd-message-strip fd-message-strip--error" 
  role="alert">
  <p class="fd-message-strip__text">
    There was an error processing your request.
  </p>
  <button 
    class="fd-button fd-button--transparent fd-message-strip__close"
...
<nav aria-label="Breadcrumb">
  <ol class="fd-breadcrumb">
    ...
    <li class="fd-breadcrumb__item">
      <span class="fd-breadcrumb__link" aria-current="page">
        Product Details
      </span>
    </li>
  </ol>
...
<div role="radiogroup">
  <div role="radio" tabindex="0">Option 1</div>  <!-- Selected -->
  <div role="radio" tabindex="-1">Option 2</div> <!-- Not selected -->
</div>
```
...
<div role="button">Click me</div>  <!-- Not keyboard accessible -->
