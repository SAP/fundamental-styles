...
export const Spot = () => `<div style="width: 100%; display: flex; justify-content: center">
    <figure class="fd-illustrated-message fd-illustrated-message--spot">
        ...
        <figcaption class="fd-illustrated-message__figcaption">
            <h4 class="fd-illustrated-message__title">Headline text goes here</h4>
            <p class="fd-illustrated-message__text">Description provides user with clarity and possible next steps.</p>
        </figcaption>
...
export const SceneTruncate = () => `<div style="width: 100%; display: flex; justify-content: center">
    <div class="fd-illustrated-message-container">
        <figure class="fd-illustrated-message">
            <svg class="fd-illustrated-message__illustration" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="320" height="240" viewBox="0 0 320 240" id="sapIllus-Scene-NoMail">
                <path class="sapIllus_BackgroundColor" style="fill:var(--sapIllus_BackgroundColor)" d="M160.9349,25c-63.5127,0-117,45.65-117,111.0215,0,57.985,53.4873,102.9785,117,102.9785s115-45.0093,115-102.9944C275.9349,72.6147,224.4477,25,160.9349,25Z"/>
            ...
            <figcaption class="fd-illustrated-message__figcaption">
                <h2 class="fd-illustrated-message__title fd-illustrated-message__title--truncate">Headline text goes here Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</h2>
                <p class="fd-illustrated-message__text fd-illustrated-message__text--truncate">Description provides user with clarity and possible next steps. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
            </figcaption>
...
SceneTruncate.storyName = 'Text truncation';
SceneTruncate.parameters = {
    docs: {
        iframeHeight: 330,
        description: {
            story: `Long title and text can be truncated with modifier classes \`.fd-illustrated-message__title--truncate\` and \`.fd-illustrated-message__text--truncate\`. <br>
            <b>Note: </b>the title and the text have max-height that is different for each Illustrated Message type. The max-height of the element determines the truncation rule (number of lines before the text truncates).
        `
        }
    },
    styles: [
...
export const SceneAutoText = () => `<div style="width: 100%; display: flex; justify-content: center">
    <div class="fd-illustrated-message-container">
        <figure class="fd-illustrated-message">
            <svg class="fd-illustrated-message__illustration" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="320" height="240" viewBox="0 0 320 240" id="sapIllus-Scene-NoMail">
                <path class="sapIllus_BackgroundColor" style="fill:var(--sapIllus_BackgroundColor)" d="M160.9349,25c-63.5127,0-117,45.65-117,111.0215,0,57.985,53.4873,102.9785,117,102.9785s115-45.0093,115-102.9944C275.9349,72.6147,224.4477,25,160.9349,25Z"/>
            ...
            <figcaption class="fd-illustrated-message__figcaption">
                <h2 class="fd-illustrated-message__title fd-illustrated-message__title--auto-height">Headline text goes here Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h2>
                <p class="fd-illustrated-message__text fd-illustrated-message__text--auto-height">Description provides user with clarity and possible next steps. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
            </figcaption>
...
SceneAutoText.storyName = 'Title and Text with auto height';
SceneAutoText.parameters = {
    docs: {
        iframeHeight: 330,
        description: {
            story: `For title and text that grow to fit the content use the modifier classes \`.fd-illustrated-message__title--auto-height\` and \`.fd-illustrated-message__text--auto-height\`. In this case the max-height of the title and text elements is set to \`initial\`.
        `
        }
    },
    styles: [
