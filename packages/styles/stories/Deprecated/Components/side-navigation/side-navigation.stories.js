...
DynamicWidth.storyName = 'Dynamic Width';
...
export const CosyNarrow = () => `<nav class="fd-side-nav fd-side-nav--narrow">
...
CosyNarrowPopover.storyName = 'Cosy Narrow Popover';
...
export const CompactNarrow = () => `<nav class="fd-side-nav fd-side-nav--compact fd-side-nav--narrow">
    <div class="fd-side-nav__main-navigation">
...
CompactNarrow.storyName = 'Compact Narrow';
...
CompactNarrowPopover.storyName = 'Compact Narrow Popover';

CompactNarrowPopover.parameters = {
    docs: {
        iframeHeight: 1000,
        description: {
            story: `
