/* empty css             *//* empty css                *//* empty css             */const v=`<div style="width: 400px; margin: auto;">
...
`;const h={title:"Components/Progress Indicator",parameters:{description:`The progress indicator visualizes the current advancement of a process or a degree of accomplishment. The inside of the progress indicator is filled with color to indicate the state of progress. The advancement depends on the specific process. The progress is shown either using absolute numbers or the current percentage of completion together with a progress bar.
...
Negative | \`fd-progress-indicator--negative\`
        `,components:["progress-indicator","menu","popover","icon"],tags:["f3","a11y","theme","development"]}},s=()=>f;s.parameters={docs:{story:{iframeHeight:600},description:{story:`
...
You also have the option of showing any application-specific text instead of a percentage.
        `}}};const a=()=>g;a.storyName="States";a.parameters={docs:{story:{iframeHeight:600},description:{story:"The progress indicator can visualize different value states that are represented by various theme-dependent semantic colors. The states are: normal, success, warning, error, and information."}}};const r=()=>v;r.storyName="Truncation Behaviour";r.parameters={docs:{story:{iframeHeight:600},description:{story:"If the length of the text exceeds the available space in the progress indicator, the text truncates. In this case, clicking the progress indicator displays an information popover with the full text."}}};var i,e,n;s.parameters={...s.parameters,docs:{...(i=s.parameters)==null?void 0:i.docs,source:{originalSource:"() => layoutExampleHtml",...(n=(e=s.parameters)==null?void 0:e.docs)==null?void 0:n.source}}};var o,t,d;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:"() => valueStatesExampleHtml",...(d=(t=a.parameters)==null?void 0:t.docs)==null?void 0:d.source}}};var l,c,p;r.parameters={...r.parameters,docs:{...(l=r.parameters)==null?void 0:l.docs,source:{originalSource:"() => truncationExampleHtml",...(p=(c=r.parameters)==null?void 0:c.docs)==null?void 0:p.source}}};const b=["Layout","ValueStates","Truncation"];export{s as Layout,r as Truncation,a as ValueStates,b as __namedExportsOrder,h as default};
//# sourceMappingURL=progress-indicator.stories-3712eb99.js.map
