var M=Object.defineProperty,U=Object.defineProperties;var T=Object.getOwnPropertyDescriptors;var m=Object.getOwnPropertySymbols;var H=Object.prototype.hasOwnProperty,P=Object.prototype.propertyIsEnumerable;var c=(a,i,s)=>i in a?M(a,i,{enumerable:!0,configurable:!0,writable:!0,value:s}):a[i]=s,e=(a,i)=>{for(var s in i||(i={}))H.call(i,s)&&c(a,s,i[s]);if(m)for(var s of m(i))P.call(i,s)&&c(a,s,i[s]);return a},t=(a,i)=>U(a,T(i));/* empty css             *//* empty css             */const S=`<div class="example-container">
...
`,I=`<p class="fd-text">
    ...
    eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
    deserunt mollit anim id est laborum.</p>
`,F={title:"Components/Text",parameters:{description:`The text component displays text inside a form, table, or any other content area.
        It is generally used throughout the entire application and is responsive to all screen sizes.`,tags:["f3","a11y","theme"]}},n=()=>I;n.storyName="Default";n.parameters={docs:{description:{story:`The default text component can display lines of text that wrap to the next line
        once they reach the end of the content container width.`}}};const r=()=>_;r.parameters={docs:{description:{story:"The text component has a property that allows browsers to render specified indents and\n        whitespace. To display indents and/or whitespace, add a\n        `fd-text--pre-wrap` modifier class to the main element."}}};const u=()=>D;u.storyName="Max lines";u.parameters={docs:{description:{story:'The text component can be displayed with a maximum number of lines.\nWhen the maximum is reached, the text truncates and displays an ellipsis. To display text with a maximum line count,\nadd the `fd-text--max-lines` modifier class and an inline style rule with the number of\nlines to the main element. For example, add `style="-webkit-line-clamp: 3;"` to display\nthree lines of text.\n\n**Note**: The property `-webkit-line-clamp` doesn\'t work in IE11 and should be changed\nto `height`. For example, `style="height: 200px;"`.\n'}}};const l=()=>N;l.parameters={docs:{description:{story:`Along with max lines, text component can display "More" and "Less" links that can show
more or less of the text.`}}};const o=()=>S;o.parameters={docs:{description:{story:`The text component can display words that are broken at appropriate hyphenation
...
In HTML, add the \`&shy;\` Unicode to insert a soft hyphen.`}}};var d,p,h;n.parameters=t(e({},n.parameters),{docs:t(e({},(d=n.parameters)==null?void 0:d.docs),{source:e({originalSource:"() => defaultExampleExampleHtml"},(h=(p=n.parameters)==null?void 0:p.docs)==null?void 0:h.source)})});var f,g,b;r.parameters=t(e({},r.parameters),{docs:t(e({},(f=r.parameters)==null?void 0:f.docs),{source:e({originalSource:"() => whitespaceExampleHtml"},(b=(g=r.parameters)==null?void 0:g.docs)==null?void 0:b.source)})});var x,v,q;u.parameters=t(e({},u.parameters),{docs:t(e({},(x=u.parameters)==null?void 0:x.docs),{source:e({originalSource:"() => maxLinesExampleHtml"},(q=(v=u.parameters)==null?void 0:v.docs)==null?void 0:q.source)})});var y,E,w;l.parameters=t(e({},l.parameters),{docs:t(e({},(y=l.parameters)==null?void 0:y.docs),{source:e({originalSource:"() => expandExampleHtml"},(w=(E=l.parameters)==null?void 0:E.docs)==null?void 0:w.source)})});var L,k,A;o.parameters=t(e({},o.parameters),{docs:t(e({},(L=o.parameters)==null?void 0:L.docs),{source:e({originalSource:"() => hyphenationExampleHtml"},(A=(k=o.parameters)==null?void 0:k.docs)==null?void 0:A.source)})});const z=["DefaultExample","Whitespace","MaxLines","Expand","Hyphenation"];export{n as DefaultExample,l as Expand,o as Hyphenation,u as MaxLines,r as Whitespace,z as __namedExportsOrder,F as default};
