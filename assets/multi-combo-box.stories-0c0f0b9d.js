/* empty css                   *//* empty css                *//* empty css              *//* empty css              *//* empty css                  *//* empty css                    *//* empty css                 *//* empty css             *//* empty css               *//* empty css             *//* empty css               *//* empty css            *//* empty css              *//* empty css                    *//* empty css             */const G=` <div style="height: 350px;">
...
`,K=`<div class="fd-dialog fd-dialog-docs-static fd-select-docs-max-height fd-dialog--active" id="select-dialog-example">
...
`,et={title:"Patterns/Multi ComboBox",parameters:{description:`
...
`,tags:["f3","a11y","theme"],components:["form-label","popover","radio","title","token","input-group","checkbox","list","button","icon","tokenizer","dialog","bar","input","layout-grid","link"]}},t=()=>I;t.parameters={docs:{description:{story:`
...
`}}};const e=()=>L;e.parameters={docs:{description:{story:"In cases where the list items need to be categorized into groups, it is possible to add headers for each category as seen below."}}};const n=()=>C;n.parameters={docs:{description:{story:"\nThe default length size of the popover body is often different from the text length.\nThe body length can be adjusted to match the text length by adding the `fd-popover__body--dropdown-fill` class to the `fd-popover__body`.\n\nThis class has been added to all the `Multi ComboBox` examples above.\nIn the example you can see how the `Multi ComboBox` component looks without the `fd-popover__body--dropdown-fill` modifier.\n"}}};const a=()=>T;a.parameters={docs:{description:{story:'\nTo make the `Multi ComboBox` component read-only, the readonly attribute needs to be added to the `fd-nput-group` element.\nThis can also be done by using the `.is-readonly` class or `aria-readonly="true"` attribute.\n\nTo disable a `Multi ComboBox` component, the disabled attribute needs to be added to the `fd-popover__control` and the `fd-input__control` elements.\nThe disabled state can also be achieved by adding the `.is-disabled` class or the `aria-disabled="true"` attribute.\n'}}};const s=()=>E;s.parameters={docs:{description:{story:"\nFor a complete list of states supported by the `Multi ComboBox` component, please see the documentation for the form or select components.\n\nThe semantic mode can be used to modify the combobox component by adding one of\n`is-error` | `is-success` | `is-warning` | `is-information` classes into `fd-input-group` element.\nTo add text in the `body` of the component, simply include your text in the `fd-list__message` under the `ul` element."}}};const i=()=>K;i.parameters={docs:{description:{story:"\nFor mobile devices, or tablets, Multi ComboBox component should be displayed in fullscreen mode.\nSo instead of using popover and dropdown, it should be wrapped in `dialog` and `bar` components."}}};const l=()=>X;l.parameters={docs:{description:{story:`
The user can filter selectable options by typing in the input. A button with the text "Show All" should be displayed, that when clicked, will clear the text in the input and show all options in the list.`}}};const o=()=>G;o.parameters={docs:{description:{story:`
The user can filter selectable having 2 options by typing in the input. A button with the text "Show All" should be displayed, that when clicked, will clear the text in the input and show all options in the list.`}}};var d,r,c;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:"() => asFormItemExampleHtml",...(c=(r=t.parameters)==null?void 0:r.docs)==null?void 0:c.source}}};var p,b,f;e.parameters={...e.parameters,docs:{...(p=e.parameters)==null?void 0:p.docs,source:{originalSource:"() => groupingExampleHtml",...(f=(b=e.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};var _,u,m;n.parameters={...n.parameters,docs:{...(_=n.parameters)==null?void 0:_.docs,source:{originalSource:"() => matchPopoverBodySizeExampleHtml",...(m=(u=n.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};var x,v,h;a.parameters={...a.parameters,docs:{...(x=a.parameters)==null?void 0:x.docs,source:{originalSource:"() => readOnlyAndDisabledExampleHtml",...(h=(v=a.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var k,g,y;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:"() => semanticExampleHtml",...(y=(g=s.parameters)==null?void 0:g.docs)==null?void 0:y.source}}};var z,A,w;i.parameters={...i.parameters,docs:{...(z=i.parameters)==null?void 0:z.docs,source:{originalSource:"() => mobileModeExampleHtml",...(w=(A=i.parameters)==null?void 0:A.docs)==null?void 0:w.source}}};var F,B,O;l.parameters={...l.parameters,docs:{...(F=l.parameters)==null?void 0:F.docs,source:{originalSource:"() => filteringExampleHtml",...(O=(B=l.parameters)==null?void 0:B.docs)==null?void 0:O.source}}};var H,M,S;o.parameters={...o.parameters,docs:{...(H=o.parameters)==null?void 0:H.docs,source:{originalSource:"() => twoColumnComboBoxExampleHtml",...(S=(M=o.parameters)==null?void 0:M.docs)==null?void 0:S.source}}};const nt=["AsFormItem","Grouping","MatchPopoverBodySize","ReadOnlyAndDisabled","Semantic","MobileMode","Filtering","TwoColumnComboBox"];export{t as AsFormItem,l as Filtering,e as Grouping,n as MatchPopoverBodySize,i as MobileMode,a as ReadOnlyAndDisabled,s as Semantic,o as TwoColumnComboBox,nt as __namedExportsOrder,et as default};
//# sourceMappingURL=multi-combo-box.stories-0c0f0b9d.js.map
