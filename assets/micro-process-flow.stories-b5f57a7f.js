/* empty css             *//* empty css             *//* empty css                *//* empty css                         */const C=`<div class="fd-micro-process-flow">
...
`,z=`<div class="fd-micro-process-flow">
    <div class="fd-micro-process-flow__overflow-container">
        <div class="fd-micro-process-flow__wrapper">
...
`,S=`<div class="fd-micro-process-flow">
    <div class="fd-micro-process-flow__overflow-container">
        <div class="fd-micro-process-flow__wrapper">
            <div class="fd-micro-process-flow__item">
                <div class="fd-micro-process-flow__content">
...
`,A=`<div class="fd-micro-process-flow">
    <div class="fd-micro-process-flow__overflow-container">
        <div class="fd-micro-process-flow__wrapper">
            <div class="fd-micro-process-flow__item">
                <div class="fd-micro-process-flow__content">
...
`,L=`<div class="fd-micro-process-flow fd-micro-process-flow--independent-steps">
    <div class="fd-micro-process-flow__overflow-container">
        <div class="fd-micro-process-flow__wrapper">
            <div class="fd-micro-process-flow__item">
                <div class="fd-micro-process-flow__content">
...
`,V=`<div class="fd-micro-process-flow">
    <div class="fd-micro-process-flow__overflow-container">
        <div class="fd-micro-process-flow__wrapper">
            <div class="fd-micro-process-flow__item">
                <div class="fd-micro-process-flow__content">
...
`;const R={title:"Components/Micro Process Flow",parameters:{description:`The micro process flow control enables you to visualize the state of individual items in a linear workflow. You can embed it into a list or a table.
...
- **With independent steps**:  the steps are not connected and can be processed in any order. This type can be used when the user doesn’t need to perform the steps in a linear sequence.
        ...
        `,tags:["f3","a11y","theme"]}},o=()=>V;o.storyName="Micro process flow with dependent steps (Default)";o.parameters={docs:{story:{iframeHeight:210},description:{story:`
        `}}};const s=()=>L;s.storyName="Micro process flow with independent steps";s.parameters={docs:{story:{iframeHeight:210},description:{story:"Add the `.fd-micro-process-flow--independent-steps` modifier class to `.fd-micro-process-flow` class to remove the connector line.\n        "}}};const i=()=>A;i.storyName="Micro process flow with custom steps";i.parameters={docs:{story:{iframeHeight:210},description:{story:`
        `}}};const e=()=>O;e.storyName="Micro process flow with popover";e.parameters={docs:{description:{story:`Information displayed in micro flow process items can be extended by adding popovers with additional context.
        `}}};const c=()=>S;c.storyName="Micro process flow with overflow";c.parameters={docs:{story:{iframeHeight:210},description:{story:`
        `}}};const n=()=>z;n.storyName="Micro process flow with elements inserted between nodes";n.parameters={docs:{story:{iframeHeight:210},description:{story:`
        `}}};const r=()=>C;r.storyName="Micro process flow with custom node width";r.parameters={docs:{story:{iframeHeight:210},description:{story:'By default, the width of the item container is calculated based on the actual item width and the connector line. To change the width add inline style to the element with `.fd-micro-process-flow__item` class and provide value for the width.\n\nFor example:\n`<div class="fd-micro-process-flow__item" style="width: 6rem;">`\n        '}}};var t,a,l;o.parameters={...o.parameters,docs:{...(t=o.parameters)==null?void 0:t.docs,source:{originalSource:"() => defaultMicroProcessFlowExampleHtml",...(l=(a=o.parameters)==null?void 0:a.docs)==null?void 0:l.source}}};var d,p,f;s.parameters={...s.parameters,docs:{...(d=s.parameters)==null?void 0:d.docs,source:{originalSource:"() => microProcessFlowIndependentStepsExampleHtml",...(f=(p=s.parameters)==null?void 0:p.docs)==null?void 0:f.source}}};var _,m,v;i.parameters={...i.parameters,docs:{...(_=i.parameters)==null?void 0:_.docs,source:{originalSource:"() => microProcessFlowCustomExampleHtml",...(v=(m=i.parameters)==null?void 0:m.docs)==null?void 0:v.source}}};var w,h,u;e.parameters={...e.parameters,docs:{...(w=e.parameters)==null?void 0:w.docs,source:{originalSource:"() => microProcessFlowWithPopoverExampleHtml",...(u=(h=e.parameters)==null?void 0:h.docs)==null?void 0:u.source}}};var b,g,x;c.parameters={...c.parameters,docs:{...(b=c.parameters)==null?void 0:b.docs,source:{originalSource:"() => overflowMicroProcessFlowExampleHtml",...(x=(g=c.parameters)==null?void 0:g.docs)==null?void 0:x.source}}};var k,y,M;n.parameters={...n.parameters,docs:{...(k=n.parameters)==null?void 0:k.docs,source:{originalSource:"() => microProcessFlowWithObjectsExampleHtml",...(M=(y=n.parameters)==null?void 0:y.docs)==null?void 0:M.source}}};var P,F,H;r.parameters={...r.parameters,docs:{...(P=r.parameters)==null?void 0:P.docs,source:{originalSource:"() => microProcessFlowCustomWidthExampleHtml",...(H=(F=r.parameters)==null?void 0:F.docs)==null?void 0:H.source}}};const G=["DefaultMicroProcessFlow","MicroProcessFlowIndependentSteps","MicroProcessFlowCustom","MicroProcessFlowWithPopover","OverflowMicroProcessFlow","MicroProcessFlowWithObjects","MicroProcessFlowCustomWidth"];export{o as DefaultMicroProcessFlow,i as MicroProcessFlowCustom,r as MicroProcessFlowCustomWidth,s as MicroProcessFlowIndependentSteps,n as MicroProcessFlowWithObjects,e as MicroProcessFlowWithPopover,c as OverflowMicroProcessFlow,G as __namedExportsOrder,R as default};
//# sourceMappingURL=micro-process-flow.stories-b5f57a7f.js.map
