var F=Object.defineProperty,W=Object.defineProperties;var O=Object.getOwnPropertyDescriptors;var r=Object.getOwnPropertySymbols;var V=Object.prototype.hasOwnProperty,E=Object.prototype.propertyIsEnumerable;var b=(n,i,e)=>i in n?F(n,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[i]=e,t=(n,i)=>{for(var e in i||(i={}))V.call(i,e)&&b(n,e,i[e]);if(r)for(var e of r(i))E.call(i,e)&&b(n,e,i[e]);return n},s=(n,i)=>W(n,O(i));/* empty css             *//* empty css             *//* empty css                          *//* empty css               *//* empty css                      *//* empty css                      *//* empty css                      */const B=`
...
`;const U={title:"Components/Object List",parameters:{description:`
...
`,tags:["f3","a11y","theme","development"]}},a=()=>L;a.parameters={docs:{description:{story:"The standard object list item displays a title, introductory text, an avatar and object display components. It is recommended to display avatar in size S, therefore add the `fd-avatar--s` modifier class to the `fd-avatar` element."}}};const d=()=>T;d.parameters={docs:{description:{story:"An object list can display links that the users can navigate to. To display a navigation object list, add the `fd-list--navigation-object` modifier class together with `fd-list--navigation` and the `fd-list__item--link` modifier class to the list elements that contain a link. All items should be navigable."}}};const c=()=>N;c.parameters={docs:{description:{story:"Object list items can be selectable by adding the `fd-list--selection` and `fd-list--selection-row` modifier classes to the main element."}}};const l=()=>I;l.parameters={docs:{description:{story:"This object list is both selectable and navigable. To display selectable object list items with navigation, add the `fd-list--selection`, `fd-list--navigation` and `fd-list--navigation-object` modifier classes to the list and the `fd-list__item--link` modifier class to the list elements that contain links. All items should be navigable."}}};const o=()=>B;o.parameters={docs:{description:{story:"Object list items can be displayed without borders. To display a borderless list, add the `fd-list--no-border` modifier class to the list element."}}};var _,f,v;a.parameters=s(t({},a.parameters),{docs:s(t({},(_=a.parameters)==null?void 0:_.docs),{source:t({originalSource:"() => standartExampleHtml"},(v=(f=a.parameters)==null?void 0:f.docs)==null?void 0:v.source)})});var j,p,u;d.parameters=s(t({},d.parameters),{docs:s(t({},(j=d.parameters)==null?void 0:j.docs),{source:t({originalSource:"() => navigationExampleHtml"},(u=(p=d.parameters)==null?void 0:p.docs)==null?void 0:u.source)})});var m,h,g;c.parameters=s(t({},c.parameters),{docs:s(t({},(m=c.parameters)==null?void 0:m.docs),{source:t({originalSource:"() => selectionExampleHtml"},(g=(h=c.parameters)==null?void 0:h.docs)==null?void 0:g.source)})});var w,x,y;l.parameters=s(t({},l.parameters),{docs:s(t({},(w=l.parameters)==null?void 0:w.docs),{source:t({originalSource:"() => selectionWithNavigationExampleHtml"},(y=(x=l.parameters)==null?void 0:x.docs)==null?void 0:y.source)})});var k,S,A;o.parameters=s(t({},o.parameters),{docs:s(t({},(k=o.parameters)==null?void 0:k.docs),{source:t({originalSource:"() => borderlessExampleHtml"},(A=(S=o.parameters)==null?void 0:S.docs)==null?void 0:A.source)})});const q=["Standard","Navigation","Selection","SelectionWithNavigation","Borderless"];export{o as Borderless,d as Navigation,c as Selection,l as SelectionWithNavigation,a as Standard,q as __namedExportsOrder,U as default};
