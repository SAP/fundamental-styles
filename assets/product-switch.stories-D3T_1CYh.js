/* empty css                       *//* empty css                *//* empty css               *//* empty css             *//* empty css                 *//* empty css               */const e=`<div style="width: 353px">
...
`,d=`<div class="fd-product-switch__body fd-product-switch__body--col-3">
    <ul class="fd-product-switch__list" role="menu">
...
`,r=`<div class="fd-product-switch__body">
    <ul class="fd-product-switch__list" role="menu">
...
`;a.parameters={docs:{description:{story:`The product switch button is typically displayed within a **Shellbar** on the far-right side.
...
<br> Both **title** and **subtitle** are recommended to wrap at maximum of 2 lines of text although text is never truncated. If the title or subtitle exceeds 2 lines of text, the item height will grow to accommodate the text.
        `}}};const i=()=>r;i.parameters={docs:{description:{story:"Product switch is displayed with a maximum of 4 columns on large desktop screens. When the popover contains too many items, it will grow until the maximum is reached. Once the maximum is reached, the popover can be scrolled vertically."}}};const t=()=>d;t.parameters={docs:{description:{story:"If there are 6 (or less) items to display, it is recommended to use the 3-column layout (medium). To display a medium-sized product switch, add the `fd-product-switchbody--col-3` modifier class to the main element.\n        "}}};const s=()=>e;s.parameters={docs:{description:{story:"For smaller screens (mobile), the product switch is displayed in list format. To achieve this style, add the `fd-product-switch__body--mobile` modifier class to the main element.\n        "}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`() => \`\${localStyles}
<div class="fd-shellbar">
    <div class="fd-shellbar__group fd-shellbar__group--full-width fd-shellbar__group--actions">
        <div class="fd-shellbar__action">
            <div class="fd-product-switch">
...
<div style="min-height: 530px"></div>
\``,...a.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => largeExampleHtml",...i.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => mediumExampleHtml",...t.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => smallExampleHtml",...s.parameters?.docs?.source}}};const _=["Shellbar","Large","Medium","Small"];export{i as Large,t as Medium,a as Shellbar,s as Small,_ as __namedExportsOrder,v as default};
