/* empty css                *//* empty css              */const l=`<div class="docs-column-flex docs-layout-margins-paddings--padded">
...
`,c=`<div class="docs-column-flex docs-column-flex--align-start">
...
`,p=`<div class="docs-column-flex docs-column-flex--align-start">
        <div class="docs-layout-margins-paddings--secondary-bg">
...
`,u=`<div class="docs-column-flex docs-column-flex--align-start">
        <div class="docs-layout-margins-paddings--secondary-bg">
...
`,y=`<div class="docs-column-flex docs-column-flex--align-start">
        <div class="docs-layout-margins-paddings--secondary-bg">
...
`,M={title:"Layouts/Margins",parameters:{description:`The CSS margin properties are used to create space around elements, outside of any defined borders.
        With CSS, you have full control over the margins. There are properties for setting the margin for each side of an element.
        We now provide a number of predefined margin clases which add predefined margin values.`,tags:[]}},d=()=>h;d.storyName="All-Round Margin";d.parameters={docs:{description:{story:"All-round margin appears on all sides of the container they are applied to. Use `fd-margin` class with any of the following modifiers:\n\n| Element | Modifier class | Margin applied |\n| ----------------: | :------------ | :------------ |\n| Tiny | `fd-margin--tiny` | 0.5rem |\n| Small | `fd-margin--sm` | 1rem |\n| Medium | `fd-margin--md` | 2rem |\n| Large | `fd-margin--lg` | 3rem |\n"}}};const n=()=>b;n.storyName="Single-Sided Margin Top";n.parameters={docs:{description:{story:`Single sided margins appear on only one of the sides of the element:
...
`}}};const i=()=>f;i.storyName="Single-Sided Margin End";const o=()=>v;o.storyName="Single-Sided Margin Bottom";const e=()=>y;e.storyName="Single-Sided Margin Begin";const a=()=>u;a.storyName="Double-Sided Margin Top-Bottom";a.parameters={docs:{description:{story:`Double sided margins appear on two opposite sides of the element.

- top-bottom - displayed on top and bottom of the element
- begin-end - displayed on left and right side of the element

Use \`fd-margin-top-bottom\` or \`fd-margin-begin-end\` class with any of the size modifiers as mentioned above.`}}};const r=()=>p;r.storyName="Double-Sided Margin Begin-End";const g=()=>m;g.parameters={docs:{description:{story:'No margin classes remove existing container margins. Use `fd-margin--none` or  `fd-margin-top--none` or `fd-margin-end--none` or `fd-margin-bottom--none` or `fd-margin-begin--none` modifier classes to remove existing margin. Place the no margin classes last to make sure they will be applied. In the case of `fd-margin-begin--none` and `fd-margin-end--none`, `!important` is not applied since we want the user-specified margins(if any) to be reapplied in the RTL mode. Please note that for RTL to work correctly, you must add `[dir="rtl"]` style on the class where these modifiers will be applied.'}}};const t=()=>c;t.parameters={docs:{description:{story:"The responsive margins class adds a margin around an element based on the width of the container the element is in. Use `fd-margin-responsive`\n        class with any of the following modifiers:\n\n| Element | Modifier class |\n| ----------------: | :------------ |\n| Small | `fd-margin-responsive--sm` |\n| Medium | `fd-margin-responsive--md` |\n| Large | `fd-margin-responsive--lg` |\n| Extra-large | `fd-margin-responsive--xl` |\n"}}};const s=()=>l;s.storyName="Double-Sided Negative Margin Begin-End";s.parameters={docs:{description:{story:"The negative margin class adds a double sided negative margin to an element. This is useful when aligning elements with built-in paddings.\n  Use `fd-margin-negative-begin-end` class with any of the size modifiers as mentioned above."}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => allRoundMarginExampleHtml",...d.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => singleSidedMarginTopExampleHtml",...n.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => singleSidedMarginEndExampleHtml",...i.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => singleSidedMarginBottomExampleHtml",...o.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => singleSidedMarginBeginExampleHtml",...e.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => doubleSidedMarginTopBottomExampleHtml",...a.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => doubleSidedMarginBeginEndExampleHtml",...r.parameters?.docs?.source}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:"() => noMarginExampleHtml",...g.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => responsiveMarginExampleHtml",...t.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => doubleSidedNegativeMarginBeginEndExampleHtml",...s.parameters?.docs?.source}}};const x=["AllRoundMargin","SingleSidedMarginTop","SingleSidedMarginEnd","SingleSidedMarginBottom","SingleSidedMarginBegin","DoubleSidedMarginTopBottom","DoubleSidedMarginBeginEnd","NoMargin","ResponsiveMargin","DoubleSidedNegativeMarginBeginEnd"];export{d as AllRoundMargin,r as DoubleSidedMarginBeginEnd,a as DoubleSidedMarginTopBottom,s as DoubleSidedNegativeMarginBeginEnd,g as NoMargin,t as ResponsiveMargin,e as SingleSidedMarginBegin,o as SingleSidedMarginBottom,i as SingleSidedMarginEnd,n as SingleSidedMarginTop,x as __namedExportsOrder,M as default};
