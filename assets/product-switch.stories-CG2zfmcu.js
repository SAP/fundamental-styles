/* empty css                       *//* empty css                *//* empty css               *//* empty css             *//* empty css                 *//* empty css               */const d=`<div style="width: 353px">
    <div class="fd-product-switch__body fd-product-switch__body--mobile">
        <ul class="fd-product-switch__list" role="menu">
            ...
            <li class="fd-product-switch__item" tabindex="0" role="menuitem" aria-label="Guided Buying" aria-posinset="4" aria-setsize="14">
                <span
                    class="fd-avatar fd-avatar--sm fd-avatar--thumbnail"
                    style="background-image: url('/assets/images/landscape/demo-avatar.png')"
                    role="img"
...
`,r=`<div class="fd-product-switch__body fd-product-switch__body--col-3">
    <ul class="fd-product-switch__list" role="menu">
...
`,n=`<div class="fd-product-switch__body">
    <ul class="fd-product-switch__list" role="menu">
...
`,l=`<div class="fd-product-switch__body fd-product-switch__body--col-2">
    <ul class="fd-product-switch__list" role="menu">
...
`;i.parameters={docs:{description:{story:`The product switch button is typically displayed within a **Shellbar** on the far-right side.
...
<br> Both **title** and **subtitle** are recommended to wrap at maximum of 2 lines of text although text is never truncated. If the title or subtitle exceeds 2 lines of text, the item height will grow to accommodate the text.
        `}}};const t=()=>n;t.parameters={docs:{description:{story:"Product switch is displayed with a maximum of 4 columns on large desktop screens. The body grows to accommodate up to 4 rows of items (max-height: 33rem / 528px). Once that limit is reached, additional items are accessible via vertical scroll."}}};const s=()=>r;s.parameters={docs:{description:{story:"If there are 6 (or less) items to display, it is recommended to use the 3-column layout (medium). To display a medium-sized product switch, add the `fd-product-switchbody--col-3` modifier class to the main element.\n        "}}};const a=()=>l;a.storyName="Two Column";a.parameters={docs:{description:{story:"When fewer than 3 items are provided, use the 2-column layout to hug the content width. Add the `fd-product-switch__body--col-2` modifier class to the body element."}}};const e=()=>d;e.parameters={docs:{description:{story:"For smaller screens (mobile), the product switch is displayed in list format. To achieve this style, add the `fd-product-switch__body--mobile` modifier class to the main element.\n        "}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`() => \`\${localStyles}
<div class="fd-shellbar">
    <div class="fd-shellbar__group fd-shellbar__group--full-width fd-shellbar__group--actions">
        <div class="fd-shellbar__action">
            <div class="fd-product-switch">
...
<div style="min-height: 530px"></div>
\``,...i.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => largeExampleHtml",...t.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => mediumExampleHtml",...s.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => twoColumnExampleHtml",...a.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => smallExampleHtml",...e.parameters?.docs?.source}}};const h=["Shellbar","Large","Medium","TwoColumn","Small"];export{t as Large,s as Medium,i as Shellbar,e as Small,a as TwoColumn,h as __namedExportsOrder,f as default};
