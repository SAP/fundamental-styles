/* empty css                    */const U=`<div class='fd-container'>
    <div class='fd-row'>
...
`,C=`<div class='fd-container fd-container--no-horizontal-gap fd-container--no-vertical-gap'>
  <div class='fd-row'>
...
`,D=`<div class='fd-container fd-container--no-vertical-gap'>
    <div class='fd-row'>
        <div class='fd-col fd-col--8'>
            <div class='docs-layout-grid-bg docs-layout-grid-bg--color-1'>
                8 col no gap
...
`,I=`<div class='fd-container fd-container--no-horizontal-gap'>
    <div class='fd-row'>
        <div class='fd-col fd-col--8'>
            <div class='docs-layout-grid-bg docs-layout-grid-bg--color-1'>
                8 col no gap
...
`,B={title:"Layouts/Layout Grid",parameters:{description:"The layout grid is made to separate data into both columns and rows. If there is not enough space on the current line of the same row, the item will go to the next line.\nTo use the grid, the user must use all of the `fd-container`, `fd-row`, and `fd-col` classes.\n\n- Use the `fd-container` class to wrap the whole grid.\n- Use the `fd-container--no-vertical-gap` modifier to remove the gutter spacing between rows.\n- Use the `fd-container--no-horizontal-gap` modifier to remove the gutter spacing between columns.\n- Use the `fd-container--no-gap` modifier to remove the gutter spacing between columns and rows.\n- Use the `fd-row` to separate rows.\n- Use the `fd-col` to separate a column of certain width. The default value will create a column the full width, being 12 columns of the parent at size small and above unless specified another size.\n- Use the `fd-col--x` modifier class to make the column spread x-rows/12 (e.g. `fd-col--4` which will take 4 columns out of 12).\n\n<h2>Breakpoints</h2>\n\n- Default until next specified breakpoint<br>\n`fd-col--x` will be used until the next specified minimum breakpoint, column takes x/12 space of the row.\n- Medium 600px<br>\n`fd-col-md--x` will be used from 600px to the next specified minimum breakpoint, column takes x/12 space of the row.\n- Large 1024px<br>\n`fd-col-lg--x` will be used from 1024px to the next specified minimum breakpoint, column takes x/12 space of the row.\n- Extra-large 1440px<br>\n`fd-col-xl--x` will be used from 1440px and larger, column takes x/12 space of the row."}},o=()=>_;o.parameters={docs:{story:{iframeHeight:1150},description:{story:"To define the size of that column use the `fd-col--x` modifier, where `x` can go from 1-12"}}};const d=()=>O;d.parameters={docs:{story:{iframeHeight:320},description:{story:"You can define different column sizes for each inflection point. In this example for extra large the cells are taking 4 columns out of 12 `fd-col-xl--4`; 4 columns out of 12 in large `fd-col-lg--4`; 6 columns out of 12 in medium `fd-col-md--6`, and 12 out of 12 in small `fd-col--12`"}}};const l=()=>L;l.parameters={docs:{story:{iframeHeight:150},description:{story:"Add an extra `fd-row` class in between inner rows when using nesting. It will add a gutter in between rows."}}};const s=()=>V;s.parameters={docs:{story:{iframeHeight:450},description:{story:"To add an offset to the left of the column for all sizes use the `--offset-x` modifier. X will be the size of your choice. If the column after the offset col no longer fits in parent container it will switch to the next line. To add an offset to the left of the column for certain sizes and above use the `--offset-x--size` modifier, where size is either s,m,l,xl. To make the offset after and not before use the `--offset-after-x--size` modifier."}}};const c=()=>I;c.parameters={docs:{story:{iframeHeight:300},description:{story:"To remove gutters between columns apply the `fd-container--no-horizontal-gap` modifier to the container."}}};const n=()=>D;n.parameters={docs:{story:{iframeHeight:300},description:{story:"To remove gutters between rows apply the `fd-container--no-vertical-gap` modifier to the container."}}};const i=()=>C;i.parameters={docs:{story:{iframeHeight:300},description:{story:"To remove gutters between rows and columns apply both the `fd-container--no-vertical-gap` and `fd-container--no-horizontal-gap` modifiers to the container."}}};const a=()=>U;a.parameters={docs:{story:{iframeHeight:300},description:{story:"To make the column auto adjust and occupy the remaining space of the row use the `--full` modifier. There is a minimum width of 1/12 columns"}}};var e,r,t;o.parameters={...o.parameters,docs:{...(e=o.parameters)==null?void 0:e.docs,source:{originalSource:"() => differentSizeColumnsExampleHtml",...(t=(r=o.parameters)==null?void 0:r.docs)==null?void 0:t.source}}};var f,v,g;d.parameters={...d.parameters,docs:{...(f=d.parameters)==null?void 0:f.docs,source:{originalSource:"() => responsivenessExampleHtml",...(g=(v=d.parameters)==null?void 0:v.docs)==null?void 0:g.source}}};var u,m,p;l.parameters={...l.parameters,docs:{...(u=l.parameters)==null?void 0:u.docs,source:{originalSource:"() => nestingExampleHtml",...(p=(m=l.parameters)==null?void 0:m.docs)==null?void 0:p.source}}};var b,y,h;s.parameters={...s.parameters,docs:{...(b=s.parameters)==null?void 0:b.docs,source:{originalSource:"() => offsetExampleHtml",...(h=(y=s.parameters)==null?void 0:y.docs)==null?void 0:h.source}}};var w,x,H;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:"() => noHorizontalGapExampleHtml",...(H=(x=c.parameters)==null?void 0:x.docs)==null?void 0:H.source}}};var z,E,k;n.parameters={...n.parameters,docs:{...(z=n.parameters)==null?void 0:z.docs,source:{originalSource:"() => noVerticalGapExampleHtml",...(k=(E=n.parameters)==null?void 0:E.docs)==null?void 0:k.source}}};var G,S,T;i.parameters={...i.parameters,docs:{...(G=i.parameters)==null?void 0:G.docs,source:{originalSource:"() => noGapExampleHtml",...(T=(S=i.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};var A,N,j;a.parameters={...a.parameters,docs:{...(A=a.parameters)==null?void 0:A.docs,source:{originalSource:"() => autoAdjustingExampleHtml",...(j=(N=a.parameters)==null?void 0:N.docs)==null?void 0:j.source}}};const M=["DifferentSizeColumns","Responsiveness","Nesting","Offset","NoHorizontalGap","NoVerticalGap","NoGap","AutoAdjusting"];export{a as AutoAdjusting,o as DifferentSizeColumns,l as Nesting,i as NoGap,c as NoHorizontalGap,n as NoVerticalGap,s as Offset,d as Responsiveness,M as __namedExportsOrder,B as default};
//# sourceMappingURL=layout-grid.stories-9443e044.js.map
