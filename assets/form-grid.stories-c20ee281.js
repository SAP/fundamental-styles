var xl=Object.defineProperty,hl=Object.defineProperties;var gl=Object.getOwnPropertyDescriptors;var C=Object.getOwnPropertySymbols;var wl=Object.prototype.hasOwnProperty,Cl=Object.prototype.propertyIsEnumerable;var _=(i,a,o)=>a in i?xl(i,a,{enumerable:!0,configurable:!0,writable:!0,value:o}):i[a]=o,l=(i,a)=>{for(var o in a||(a={}))wl.call(a,o)&&_(i,o,a[o]);if(C)for(var o of C(a))Cl.call(a,o)&&_(i,o,a[o]);return i},d=(i,a)=>hl(i,gl(a));/* empty css                   *//* empty css                         *//* empty css                    *//* empty css              *//* empty css                *//* empty css               *//* empty css             *//* empty css               */const Al={title:"Components/Forms/Form Grid",parameters:{description:`
...
`,s=()=>`<div class="fd-container fd-form-layout-grid-container fd-form-layout-grid-container--vertical fd-form-group" style="max-width:600px;">
...
`+e;s.storyName="Small";s.parameters={docs:{description:{story:`
...
`}}};const t=()=>`<div class="fd-container fd-form-layout-grid-container fd-form-group" style="max-width:1024px;">
  <div class="fd-row fd-form-item">
...
`+e;t.storyName="Default [M]";t.parameters={docs:{description:{story:`
...
`}}};const n=()=>`<div class="fd-container fd-form-layout-grid-container fd-form-group" style="max-width:1024px;">
  <div class="fd-row fd-form-item">
...
`+e;n.storyName="Split screen [M]";n.parameters={docs:{description:{story:`
...
`}}};const c=()=>`<div class="fd-container fd-form-layout-grid-container fd-form-group" style="max-width:1024px;">
  <div class="fd-row fd-form-item">
...
`+e;c.storyName="Full screen [M]";c.parameters={docs:{description:{story:`
...
`}}};const f=()=>`<div class="fd-container fd-form-layout-grid-container fd-form-group" style="max-width:1024px;">
  <div class="fd-row fd-form-item">
    <div class="fd-col fd-col-md--4">
...
`+e;f.storyName="Long label [M]";f.parameters={docs:{description:{story:`
...
`}}};const r=()=>`<div class="fd-container fd-form-layout-grid-container fd-form-group" style="max-width:1440px;">
  <div class="fd-row fd-form-item">
...
`+e;r.storyName="Default [L]";r.parameters={docs:{description:{story:`
...
`}}};const v=()=>`<div class="fd-container fd-form-layout-grid-container fd-form-group" style="max-width:1440px;">
  <div class="fd-row fd-form-item">
...
`+e;v.storyName="Single form [L]";v.parameters={docs:{description:{story:`
...
Empty grid columns | 4 | There are four empty spaces on the right of the field.
        `}}};const p=()=>`<div class="fd-container fd-form-layout-grid-container fd-form-layout-grid-container--lg-vertical fd-form-layout-grid-container--xl-vertical" style="max-width:1440px;">
  <div class="fd-row">
...
`+e;p.storyName="Multiple form [L]";p.parameters={docs:{description:{story:`
...
**Note:** As explained in the main description, large goes down to 1025 px. Therefore, long labels that are put next to fields might not fit on smaller large-sized screens (especially in split-view apps). For this reason, labels are put above fields.
        ...
        `}}};const m=()=>`<div class="fd-container fd-form-layout-grid-container fd-form-group">
  <div class="fd-row fd-form-item">
...
`+e;m.storyName="Default [XL]";m.parameters={docs:{description:{story:`
...
`}}};const u=()=>`<div class="fd-container fd-form-layout-grid-container fd-form-group">
  <div class="fd-row fd-form-item">
...
`+e;u.storyName="Single form [XL]";u.parameters={docs:{description:{story:`
If the form contains a single form group, you can use a single-column layout.
...
`}}};const b=()=>`<div class="fd-container fd-form-layout-grid-container">
  <div class="fd-row">
...
`+e;b.storyName="Double form [XL]";b.parameters={docs:{description:{story:`
If the form contains multiple form groups, you can use a two-column layout.
...
`}}};const y=()=>`<div class="fd-container fd-form-layout-grid-container fd-form-layout-grid-container--xl-vertical">
  <div class="fd-row">
...
`+e;y.storyName="Multiple form [XL]";y.parameters={docs:{description:{story:`
####Label-field ratio
...
`+e;x.storyName="Recommended layouts";x.parameters={docs:{description:{story:`
...
`+e;h.storyName="Layout variations";h.parameters={docs:{description:{story:`
...
`+e;w.parameters={docs:{description:{story:`
The layout that is not recommended for a form group are XL3-L2-M2-S1
`}}};const g=()=>`<h2>Vertical layout at every breakpoint</h2>
...
`+e;g.storyName="Vertical layout";g.parameters={docs:{description:{story:`
...
\`.fd-form-layout-grid-container--xl-vertical\` | **XL**
        `}}};var N,S,E;s.parameters=d(l({},s.parameters),{docs:d(l({},(N=s.parameters)==null?void 0:N.docs),{source:l({originalSource:`() => \`<div class="fd-container fd-form-layout-grid-container fd-form-layout-grid-container--vertical fd-form-group" style="max-width:600px;">
    <div class="fd-row fd-form-item">
        <div class="fd-col">
                <label class="fd-form-label" for="input-1-name">Name:</label>
        </div>
...
\` + docsStyles`},(E=(S=s.parameters)==null?void 0:S.docs)==null?void 0:E.source)})});var L,P,z;t.parameters=d(l({},t.parameters),{docs:d(l({},(L=t.parameters)==null?void 0:L.docs),{source:l({originalSource:`() => \`<div class="fd-container fd-form-layout-grid-container fd-form-group" style="max-width:1024px;">
  <div class="fd-row fd-form-item">
    <div class="fd-col fd-col-md--2">
      <label class="fd-form-label" for="input-2-name">Name:</label>
    </div>
...
\` + docsStyles`},(z=(P=t.parameters)==null?void 0:P.docs)==null?void 0:z.source)})});var F,M,A;n.parameters=d(l({},n.parameters),{docs:d(l({},(F=n.parameters)==null?void 0:F.docs),{source:l({originalSource:`() => \`<div class="fd-container fd-form-layout-grid-container fd-form-group" style="max-width:1024px;">
  <div class="fd-row fd-form-item">
    <div class="fd-col fd-col-md--4">
      <label class="fd-form-label" for="input-3-name">Name:</label>
    </div>
...
\` + docsStyles`},(A=(M=n.parameters)==null?void 0:M.docs)==null?void 0:A.source)})});var I,Z,q;c.parameters=d(l({},c.parameters),{docs:d(l({},(I=c.parameters)==null?void 0:I.docs),{source:l({originalSource:`() => \`<div class="fd-container fd-form-layout-grid-container fd-form-group" style="max-width:1024px;">
  <div class="fd-row fd-form-item">
    <div class="fd-col fd-col-md--3">
      <label class="fd-form-label" for="input-4-name">Name:</label>
    </div>
...
\` + docsStyles`},(q=(Z=c.parameters)==null?void 0:Z.docs)==null?void 0:q.source)})});var D,X,T;f.parameters=d(l({},f.parameters),{docs:d(l({},(D=f.parameters)==null?void 0:D.docs),{source:l({originalSource:`() => \`<div class="fd-container fd-form-layout-grid-container fd-form-group" style="max-width:1024px;">
  <div class="fd-row fd-form-item">
    <div class="fd-col fd-col-md--4">
      <label class="fd-form-label" for="input-5-name">Name:</label>
    </div>
...
\` + docsStyles`},(T=(X=f.parameters)==null?void 0:X.docs)==null?void 0:T.source)})});var U,G,k;r.parameters=d(l({},r.parameters),{docs:d(l({},(U=r.parameters)==null?void 0:U.docs),{source:l({originalSource:`() => \`<div class="fd-container fd-form-layout-grid-container fd-form-group" style="max-width:1440px;">
  <div class="fd-row fd-form-item">
    <div class="fd-col fd-col-md--2 fd-col-lg--4">
      <label class="fd-form-label" for="input-6-name">Name:</label>
    </div>
...
\` + docsStyles`},(k=(G=r.parameters)==null?void 0:G.docs)==null?void 0:k.source)})});var O,V,R;v.parameters=d(l({},v.parameters),{docs:d(l({},(O=v.parameters)==null?void 0:O.docs),{source:l({originalSource:`() => \`<div class="fd-container fd-form-layout-grid-container fd-form-group" style="max-width:1440px;">
  <div class="fd-row fd-form-item">
    <div class="fd-col fd-col-md--2 fd-col-lg--3">
      <label class="fd-form-label" for="input-7-name">Name:</label>
    </div>
...
\` + docsStyles`},(R=(V=v.parameters)==null?void 0:V.docs)==null?void 0:R.source)})});var W,B,Y;p.parameters=d(l({},p.parameters),{docs:d(l({},(W=p.parameters)==null?void 0:W.docs),{source:l({originalSource:`() => \`<div class="fd-container fd-form-layout-grid-container fd-form-layout-grid-container--lg-vertical fd-form-layout-grid-container--xl-vertical" style="max-width:1440px;">
  <div class="fd-row">
    <div class="fd-col fd-col-lg--6 fd-col--wrap fd-form-group">
      <div class="fd-row fd-form-item">
        <div class="fd-col fd-col-md--2 fd-col-lg--12">
...
\` + docsStyles`},(Y=(B=p.parameters)==null?void 0:B.docs)==null?void 0:Y.source)})});var j,H,J;m.parameters=d(l({},m.parameters),{docs:d(l({},(j=m.parameters)==null?void 0:j.docs),{source:l({originalSource:`() => \`<div class="fd-container fd-form-layout-grid-container fd-form-group">
  <div class="fd-row fd-form-item">
    <div class="fd-col fd-col-md--2 fd-col-lg--4 fd-col-xl--4">
      <label class="fd-form-label" for="input-9-name">Name:</label>
    </div>
...
\` + docsStyles`},(J=(H=m.parameters)==null?void 0:H.docs)==null?void 0:J.source)})});var K,Q,$;u.parameters=d(l({},u.parameters),{docs:d(l({},(K=u.parameters)==null?void 0:K.docs),{source:l({originalSource:`() => \`<div class="fd-container fd-form-layout-grid-container fd-form-group">
  <div class="fd-row fd-form-item">
    <div class="fd-col fd-col-md--2 fd-col-lg--4 fd-col-xl--3">
      <label class="fd-form-label" for="input-10-name">Name:</label>
    </div>
...
\` + docsStyles`},($=(Q=u.parameters)==null?void 0:Q.docs)==null?void 0:$.source)})});var ll,dl,el;b.parameters=d(l({},b.parameters),{docs:d(l({},(ll=b.parameters)==null?void 0:ll.docs),{source:l({originalSource:`() => \`<div class="fd-container fd-form-layout-grid-container">
  <div class="fd-row">
    <div class="fd-col fd-col-xl--6 fd-col--wrap fd-form-group">
      <div class="fd-row fd-form-item">
        <div class="fd-col fd-col-md--2 fd-col-lg--4 fd-col-xl--4">
...
\` + docsStyles`},(el=(dl=b.parameters)==null?void 0:dl.docs)==null?void 0:el.source)})});var al,ol,il;y.parameters=d(l({},y.parameters),{docs:d(l({},(al=y.parameters)==null?void 0:al.docs),{source:l({originalSource:`() => \`<div class="fd-container fd-form-layout-grid-container fd-form-layout-grid-container--xl-vertical">
  <div class="fd-row">
    <div class="fd-col fd-col-xl--4 fd-col--wrap fd-form-group">
      <div class="fd-row fd-form-item">
        <div class="fd-col fd-col-md--2 fd-col-lg--4 fd-col-xl--12">
...
\` + docsStyles`},(il=(ol=y.parameters)==null?void 0:ol.docs)==null?void 0:il.source)})});var sl,tl,nl;x.parameters=d(l({},x.parameters),{docs:d(l({},(sl=x.parameters)==null?void 0:sl.docs),{source:l({originalSource:`() => \`<h2>Layout 1</h2>
<div class="fd-container fd-form-layout-grid-container fd-form-group">
  <div class="fd-row">
    <div class="fd-col fd-col-md--6 fd-col-lg--6 fd-col-xl--6 fd-col--wrap fd-form-item">
      <div class="fd-row">
...
\` + docsStyles`},(nl=(tl=x.parameters)==null?void 0:tl.docs)==null?void 0:nl.source)})});var cl,fl,rl;h.parameters=d(l({},h.parameters),{docs:d(l({},(cl=h.parameters)==null?void 0:cl.docs),{source:l({originalSource:`() => \`<h2>Layout 4</h2>
<div class="fd-container fd-form-layout-grid-container fd-form-group">
  <div class="fd-row">
    <div class="fd-col fd-col-xl--4 fd-col--wrap fd-form-item">
      <div class="fd-row">
...
\` + docsStyles`},(rl=(fl=h.parameters)==null?void 0:fl.docs)==null?void 0:rl.source)})});var vl,pl,ml;w.parameters=d(l({},w.parameters),{docs:d(l({},(vl=w.parameters)==null?void 0:vl.docs),{source:l({originalSource:`() => \`<h1>XL3-L2-M2-S1</h1>
<div class="fd-container fd-form-layout-grid-container fd-form-group">
  <div class="fd-row">
    <div class="fd-col fd-col-lg--6 fd-col-xl--4 fd-col--wrap fd-form-item">
      <div class="fd-row">
...
\` + docsStyles`},(ml=(pl=w.parameters)==null?void 0:pl.docs)==null?void 0:ml.source)})});var ul,bl,yl;g.parameters=d(l({},g.parameters),{docs:d(l({},(ul=g.parameters)==null?void 0:ul.docs),{source:l({originalSource:`() => \`<h2>Vertical layout at every breakpoint</h2>
<div class="fd-container fd-form-layout-grid-container fd-form-layout-grid-container--vertical fd-form-group">
  <div class="fd-row">
    <div class="fd-col fd-col--wrap fd-form-item">
      <div class="fd-row">
...
\` + docsStyles`},(yl=(bl=g.parameters)==null?void 0:bl.docs)==null?void 0:yl.source)})});const Il=["SSize","MSizeDefault","MSizeSplitScreen","MSizeFullScreenApp","MSizeFullScreenAppLongLabel","LSizeDefault","LSizeSingleFormGroup","LSizeMultipleFormGroup","XlDefault","XlSingleFormGroup","XlDoubleFormGroup","XlMultipleFormGroup","ColumnRecommended","ColumnPossible","ColumnNotRecommended","Vertical"];export{w as ColumnNotRecommended,h as ColumnPossible,x as ColumnRecommended,r as LSizeDefault,p as LSizeMultipleFormGroup,v as LSizeSingleFormGroup,t as MSizeDefault,c as MSizeFullScreenApp,f as MSizeFullScreenAppLongLabel,n as MSizeSplitScreen,s as SSize,g as Vertical,m as XlDefault,b as XlDoubleFormGroup,y as XlMultipleFormGroup,u as XlSingleFormGroup,Il as __namedExportsOrder,Al as default};
