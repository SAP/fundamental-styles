...
<div class="border-example-card">
    ...
    <pre><div class="sap-position-relative sap-position-top-0 sap-position-bottom-0">.sap-position-relative.sap-position-top-0.sap-position-bottom-0</div></pre>
</div>

<div class="border-example-card">
    <h4>Static Position</h4>
    <pre>.sap-position-static</pre>
</div>

<div class="border-example-card">
    <h4>Inherit Position</h4>
    <pre>.sap-position-inherit</pre>
</div>

<div class="border-example-card">
    <h4>Absolute Position</h4>
    <pre>.sap-position-absolute</pre>
</div>
`,t=`<style>
...
`,s={title:"Position",parameters:{description:i}},o=`
<style>
...
`,e=()=>`${o}${r}`;e.parameters={docs:{description:{story:`
        `}}};const n=()=>`${o}${t}`;n.parameters={docs:{description:{story:`
        `}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => `${localStyles}${positionClassesExampleHtml}`",...e.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => `${localStyles}${positionMixinsExampleHtml}`",...n.parameters?.docs?.source}}};const a=["PositionClasses","PositionMixins"];export{e as PositionClasses,n as PositionMixins,a as __namedExportsOrder,s as default};
