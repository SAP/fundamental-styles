/* empty css               *//* empty css               *//* empty css             *//* empty css                *//* empty css               *//* empty css                   *//* empty css                  */const p=`<div style="height: 40rem; display: flex; justify-content: flex-end;">
    <div class="is-cozy">
...
</div>`,v=`<div style="height: 40rem; display: flex; justify-content: flex-end;">
    <div class="is-cozy">
        <div class="fd-popover fd-popover--right fd-user-menu fd-user-menu--tool-header">
            <div class="fd-popover__control">
                <span
...
</div>`,f=`<div style="height: 40rem; display: flex; justify-content: flex-end;">
    <div class="is-cozy">
        <div class="fd-popover fd-popover--right fd-user-menu fd-user-menu--tool-header">
            <div class="fd-popover__control">
                <span
...
</div>`,y={title:"BTP/User Menu",parameters:{description:`The User Menu offers a range of options that are specific to the user and is accessible on all BTP tool screens. Users can access it by clicking on the avatar on the end side of the Tool Header. Apart from always available options, the User Menu can also contain tool-specific actions.
...
`,tags:["btp"]}},a=()=>p;a.storyName="Desktop";a.parameters={docs:{story:{},description:{story:""}}};const n=()=>v;n.storyName="Tablet";n.parameters={docs:{story:{},description:{story:"The interaction behavior for desktop and tablet is identical. The only difference is in the sizes of the components used. "}}};const i=()=>f;i.storyName="Phone";i.parameters={docs:{story:{},description:{story:"For mobile phones, in addition to tablet deltas, the cascading of menus happens in place. In the sub-menus, a title with a back button appears. "}}};var e,t,s;a.parameters={...a.parameters,docs:{...(e=a.parameters)==null?void 0:e.docs,source:{originalSource:"() => userMenuExampleHtml",...(s=(t=a.parameters)==null?void 0:t.docs)==null?void 0:s.source}}};var o,r,l;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:"() => userMenuTabletExampleHtml",...(l=(r=n.parameters)==null?void 0:r.docs)==null?void 0:l.source}}};var d,c,_;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:"() => userMenuPhoneExampleHtml",...(_=(c=i.parameters)==null?void 0:c.docs)==null?void 0:_.source}}};const T=["UserMenuExample","UserMenuTabletExample","UserMenuPhoneExample"];export{a as UserMenuExample,i as UserMenuPhoneExample,n as UserMenuTabletExample,T as __namedExportsOrder,y as default};
//# sourceMappingURL=user-menu.stories-15e1c027.js.map
