var na=Object.defineProperty,sa=Object.defineProperties;var ia=Object.getOwnPropertyDescriptors;var g=Object.getOwnPropertySymbols;var oa=Object.prototype.hasOwnProperty,da=Object.prototype.propertyIsEnumerable;var W=(t,e,l)=>e in t?na(t,e,{enumerable:!0,configurable:!0,writable:!0,value:l}):t[e]=l,a=(t,e)=>{for(var l in e||(e={}))oa.call(e,l)&&W(t,l,e[l]);if(g)for(var l of g(e))da.call(e,l)&&W(t,l,e[l]);return t},r=(t,e)=>sa(t,ia(e));/* empty css               *//* empty css             */const ca=`
...
`,xa=`<span class="fd-avatar fd-avatar--xs" role="img" aria-label="Avatar">
...
`,za={title:"Components/Avatar",parameters:{description:`The avatar control is used for presenting various images, including user profiles, user initials, placeholder images, icons, or business-related images like product pictures.<br>
...
`,n=()=>ga;n.storyName="Image, Person";n.parameters={docs:{description:{story:"An avatar is a visual representation of an user or a product in the digital space. For representing a person, the circular shape is used. For representing a product or object, the square shape is used. <br/>\nThis type of Avatar requires the `fd-avatar--thumbnail` modifier class.\nThere are two options to set the background: Cover (default) and Contain.\n\n- <b>Cover:</b> The size of the image is scaled up to completely cover the control area. As a result, parts of the image may be outside the shape.\n- <b>Contain:</b> The image is scaled down to fit into the control area. The entire image is displayed, but might not fully fill the shape. In this case, the control displays a default background color. The image itself is always centered inside the shape.\n\nChanging the default `background-size: cover` to `background-size: contain` CSS property can be achieved by adding `fd-avatar--background-contain` modifier class."}}};const o=()=>_a;o.parameters={docs:{description:{story:'The initials avatar can display up to <b style="color: red;">three</b> alphabetical characters representing the first and last name(s) of a person, for example: MvV for Marjolein van Veen. The order in which the first and last name(s) are displayed depends on the language-specific settings. If more than 3 initials are required to display longer names, then a gender-neutral person icon should be displayed instead. If the three letters does not fit in the shape (e.g. WWW), then the genderneutral person icon is used as a fallback.'}}};const d=()=>xa;d.parameters={docs:{description:{story:"Placeholders are used when there is no other image available. Avatar and standardized images require placeholders. The default placeholder for an avatar is a gender-neutral person icon inside a circle. The default placeholder for a business image is a neutral product icon inside a square."}}};const c=()=>Wa;c.parameters={docs:{description:{story:" The circular shape is used mainly to represent a person. For this type of Avatar use the `fd-avatar--circle` modifier class with the `fd-avatar` base class. Business images display a product, company, object, logo, or other business-related content. Always use a square (default) for business images."}}};const p=()=>ma;p.parameters={docs:{description:{story:"A transparent style can be displayed by adding the `fd-avatar--transparent` modifier class to the `fd-avatar` base class. This can be useful for displaying descriptive illustrations and decorative pictures, for example."}}};const v=()=>ua;v.parameters={docs:{description:{story:"An avatar with a placeholder background can be displayed by adding the `fd-avatar--placeholder` modifier class."}}};const f=()=>ha;f.parameters={docs:{description:{story:"An avatar with a tile icon background can be displayed by adding the `fd-avatar--tile` modifier class."}}};const s=()=>ba;s.storyName="Color variations";s.parameters={docs:{description:{story:"The Avatar can have different background colors depending on the scenario. To change the accent background color, add the `fd-avatar--accent-color-*` class with the number indicating the desired color. The color options include numbers ranging from 1 to 10, for example: `fd-avatar--accent-color-10`."}}};const i=()=>fa;i.storyName="Color variations in Shell header context";i.parameters={docs:{description:{story:"When used in Shell header context, an additional modifier class `fd-avatar--shell` should be added to the `fd-avatar` base class and the modifier class specifying the accent color `fd-avatar--accent-color-*`."}}};const b=()=>va;b.parameters={docs:{description:{story:`If an avatar is clickable, you can show an optional badge and icon. 
            The badge indicates that the avatar is interactive and the icon indicates the action triggered by clicking the avatar. This feature gives users visual affordance of the available action, and is particularly useful for images.`}}};const h=()=>pa;h.parameters={docs:{description:{story:"Value States can be added to the Avatar badge. <br>For <b>positive</b> value state use the `.fd-avatar__zoom-icon--positive` modifier class with the `fd-avatar__zoom-icon` base class. <br>For <b>caution</b> value state apply the `.fd-avatar__zoom-icon--caution` modifier class. <br>The <b>negative</b> value state can be achieved with `.fd-avatar__zoom-icon--negative` modifier class. <br><b>Information</b> value state would require adding `.fd-avatar__zoom-icon--information` to the `fd-avatar__zoom-icon` base class."}}};const u=()=>ca;u.parameters={docs:{description:{story:"You can add a very subtle border to the avatar with the `fd-avatar--border` modifier class."}}};const m=()=>`${ya}
<h3>Regular State</h3>
<span class="fd-avatar fd-avatar--xs fd-avatar--circle fd-avatar--accent-color-1" tabindex="0" role="button" aria-label="Avatar">
    <i class="fd-avatar__icon sap-icon--person-placeholder" role="presentation" aria-hidden="true" aria-label="Image placeholder"></i>
</span>
...
`;m.parameters={docs:{description:{story:""}}};var _,x,y;n.parameters=r(a({},n.parameters),{docs:r(a({},(_=n.parameters)==null?void 0:_.docs),{source:a({originalSource:"() => backgroundImageExampleHtml"},(y=(x=n.parameters)==null?void 0:x.docs)==null?void 0:y.source)})});var A,I,k;o.parameters=r(a({},o.parameters),{docs:r(a({},(A=o.parameters)==null?void 0:A.docs),{source:a({originalSource:"() => initialsExampleHtml"},(k=(I=o.parameters)==null?void 0:I.docs)==null?void 0:k.source)})});var z,S,E;d.parameters=r(a({},d.parameters),{docs:r(a({},(z=d.parameters)==null?void 0:z.docs),{source:a({originalSource:"() => iconExampleHtml"},(E=(S=d.parameters)==null?void 0:S.docs)==null?void 0:E.source)})});var H,T,C;c.parameters=r(a({},c.parameters),{docs:r(a({},(H=c.parameters)==null?void 0:H.docs),{source:a({originalSource:"() => circleExampleHtml"},(C=(T=c.parameters)==null?void 0:T.docs)==null?void 0:C.source)})});var w,D,L;p.parameters=r(a({},p.parameters),{docs:r(a({},(w=p.parameters)==null?void 0:w.docs),{source:a({originalSource:"() => transparentExampleHtml"},(L=(D=p.parameters)==null?void 0:D.docs)==null?void 0:L.source)})});var J,M,B;v.parameters=r(a({},v.parameters),{docs:r(a({},(J=v.parameters)==null?void 0:J.docs),{source:a({originalSource:"() => placeholderBackgroundExampleHtml"},(B=(M=v.parameters)==null?void 0:M.docs)==null?void 0:B.source)})});var F,P,U;f.parameters=r(a({},f.parameters),{docs:r(a({},(F=f.parameters)==null?void 0:F.docs),{source:a({originalSource:"() => tileIconBackgroundExampleHtml"},(U=(P=f.parameters)==null?void 0:P.docs)==null?void 0:U.source)})});var q,j,V;s.parameters=r(a({},s.parameters),{docs:r(a({},(q=s.parameters)==null?void 0:q.docs),{source:a({originalSource:"() => accentColorsExampleHtml"},(V=(j=s.parameters)==null?void 0:j.docs)==null?void 0:V.source)})});var Y,N,R;i.parameters=r(a({},i.parameters),{docs:r(a({},(Y=i.parameters)==null?void 0:Y.docs),{source:a({originalSource:"() => accentColorsShellHeaderContextExampleHtml"},(R=(N=i.parameters)==null?void 0:N.docs)==null?void 0:R.source)})});var X,Z,$;b.parameters=r(a({},b.parameters),{docs:r(a({},(X=b.parameters)==null?void 0:X.docs),{source:a({originalSource:"() => zoomIconExampleHtml"},($=(Z=b.parameters)==null?void 0:Z.docs)==null?void 0:$.source)})});var G,O,K;h.parameters=r(a({},h.parameters),{docs:r(a({},(G=h.parameters)==null?void 0:G.docs),{source:a({originalSource:"() => valueStatesExampleHtml"},(K=(O=h.parameters)==null?void 0:O.docs)==null?void 0:K.source)})});var Q,aa,ra;u.parameters=r(a({},u.parameters),{docs:r(a({},(Q=u.parameters)==null?void 0:Q.docs),{source:a({originalSource:"() => bordersExampleHtml"},(ra=(aa=u.parameters)==null?void 0:aa.docs)==null?void 0:ra.source)})});var ea,la,ta;m.parameters=r(a({},m.parameters),{docs:r(a({},(ea=m.parameters)==null?void 0:ea.docs),{source:a({originalSource:`() => \`\${localStyles}
<h3>Regular State</h3>
<span class="fd-avatar fd-avatar--xs fd-avatar--circle fd-avatar--accent-color-1" tabindex="0" role="button" aria-label="Avatar">
    <i class="fd-avatar__icon sap-icon--person-placeholder" role="presentation" aria-hidden="true" aria-label="Image placeholder"></i>
</span>
...
\``},(ta=(la=m.parameters)==null?void 0:la.docs)==null?void 0:ta.source)})});const Sa=["BackgroundImage","Initials","Icon","Circle","Transparent","PlaceholderBackground","TileIconBackground","AccentColors","AccentColorsShellHeaderContext","ZoomIcon","ValueStates","Borders","Interactive"];export{s as AccentColors,i as AccentColorsShellHeaderContext,n as BackgroundImage,u as Borders,c as Circle,d as Icon,o as Initials,m as Interactive,v as PlaceholderBackground,f as TileIconBackground,p as Transparent,h as ValueStates,b as ZoomIcon,Sa as __namedExportsOrder,za as default};
