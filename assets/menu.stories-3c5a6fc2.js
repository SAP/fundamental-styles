var Q=Object.defineProperty,Z=Object.defineProperties;var $=Object.getOwnPropertyDescriptors;var h=Object.getOwnPropertySymbols;var ee=Object.prototype.hasOwnProperty,ne=Object.prototype.propertyIsEnumerable;var b=(t,s,a)=>s in t?Q(t,s,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[s]=a,e=(t,s)=>{for(var a in s||(s={}))ee.call(s,a)&&b(t,a,s[a]);if(h)for(var a of h(s))ne.call(s,a)&&b(t,a,s[a]);return t},n=(t,s)=>Z(t,$(s));/* empty css            *//* empty css               *//* empty css               *//* empty css             *//* empty css             *//* empty css              *//* empty css              */const se=`<nav class="fd-menu">
...
`,ae=`<nav class="fd-menu fd-menu--icons">
    <ul class="fd-menu__list" role="menu">
        <li class="fd-menu__item" role="presentation">
...
`,te=`<div style="width: 33%; display: inline-block">
...
`,ie=`<div style="width: 20rem; margin: 0 10rem; display: inline-block" class="fd-dialog fd-dialog-docs-static fd-select-docs-max-height fd-dialog--active" id="select-dialog-example">
    <section
...
`,oe=`<nav aria-label="navigation menu" class="fd-menu fd-menu--overflow" style="max-height: 150px">
    <ul class="fd-menu__list" role="menu">
        <li class="fd-menu__item" role="presentation">
            <a class="fd-menu__link" href="#" role="menuitem">
                <span class="fd-menu__title">Option 1</span>
...
`,re=`<nav aria-label="navigation menu" class="fd-menu">
    <ul class="fd-menu__list" role="menu">
        <li class="fd-menu__item" role="presentation">
            <a class="fd-menu__link" href="#" role="menuitem">
                <span class="fd-menu__title">Option 1</span>
...
`,me=`<div style="display: flex; gap: 3rem; flex-wrap:wrap;">
    <nav class="fd-menu fd-menu--icons">
        <ul class="fd-menu__list" role="menu">
            <li class="fd-menu__item has-separator" role="presentation">
                <a class="fd-menu__link" href="#" role="menuitem">
...
</div>`,de=`<div style="display: flex; gap: 3rem; flex-wrap:wrap;">
    <nav class="fd-menu fd-menu--icons">
        <ul class="fd-menu__list" role="menu">
            <li class="fd-menu__item has-separator" role="presentation">
                <a class="fd-menu__link" href="#" role="menuitem">
...
</div>`,ue=`<div style="display: flex; gap: 3rem; flex-wrap:wrap;">
    <nav class="fd-menu fd-menu--icons">
        <ul class="fd-menu__list" role="menu">
            <li class="fd-menu__item" role="presentation">
...
</div>`,ce=`<div style="display: flex; gap: 3rem; flex-wrap:wrap;">
    <nav class="fd-menu fd-menu--icons">
        <ul class="fd-menu__list" role="menu">
            <li class="fd-menu__item" role="presentation">
...
</div>`,ye={title:"Components/Menu",parameters:{tags:["f3","a11y","theme","development"],description:`
...
`}},p=()=>re;p.parameters={docs:{description:{story:"The basic structure of a menu. Place the menu item title in a `<span>` tag using class `fd-menu__title` and wrap it in the `fd-menu__link` and `fd-menu__item` classes as shown.\n               <br><b>Note:</b>Use compact menus for the Desktop and use cozy for the Tablet mode."}}};const l=()=>oe;l.storyName="Vertical overflow";l.parameters={docs:{description:{story:'The `fd-menu--overflow` modifier class will clip the content and add a vertical scroll to the element. You need to manually set the max-height of the element on the `fd-menu` level. For example: `style="max-height: 120px;"`. <br><b>Important: </b>this modifier class cannot be used in cases where the menu has a submenu.'}}};const _=()=>ie;_.parameters={docs:{description:{story:"The basic structure of a menu in mobile where it opens as a dialog. Use class `fd-menu--mobile` on menu container level. Example shows the parent menu's item in active state to simulate a pressed/touched event. Submenu appears in its own fullscreen dialog in mobile devices. The device's back button takes one back to the parent menu fullscreen dialog."}}};const i=()=>le;i.storyName="List with separated items";i.parameters={docs:{description:{story:"Separators can be added between Menu Items by adding the `has-separator` class to the element with class `fd-menu__item`. The separator will appear under this item."}}};const o=()=>te;o.storyName="List different states";o.parameters={docs:{description:{story:"\nSimulate different states to show state behaviour between the items.\n\n- For simulating hover state, use class `is-hover` on the menu item.\n- For simulating active state, use class `is-active` on the menu item.\n- For simulating selected state, use class `is-selected` on the menu item.\n- For simulating selected-hover state, use classes `is-selected is-hover` on the menu item.\n- For simulating disabled state, use class `is-disabled` on the menu item.\n\nTo remove default box shadow from menu containers use `fd-menu__list--no-shadow` or `fd-menu__sublist--no-shadow`."}}};const r=()=>ae;r.storyName="List with Icon";r.parameters={docs:{description:{story:"\nTo create an addon before or after `fd-menu__title` element, use elements with folowing classes inside `fd-menu__link`:\n- `fd-menu__addon-before`   - styles addon befotre `fd-menu__title`\n- `fd-menu__addon-after`    - styles addon after `fd-menu__title`\n- `fd-menu__shortcut`       - styles shortcut placed after `fd-menu__title`\nAccording to Fiori3 design shortcuts should be on desktop devices."}}};const f=()=>se;f.parameters={docs:{description:{story:"\nMenu with an additional submenu that can be used for items that can be further grouped under a level but not necessarily visible to user always.\n\nFor a submenu, do the following:\n- Specify `fd-menu__link` class normally like other items. Use `has-child` class to apply styles for parent containing the submenu.\n- Create an addon indicating submenu level using `fd-menu__addon-after--submenu` class and an icon.\n- After the end of the `fd-menu__link` container, use `fd-menu__sublist` class in its own `<ul>`\n- Follow the same template for submenu as you would for a normal menu. The same `fd-menu__item` and `fd-menu__link` works for the subitems too.\n"}}};const m=()=>me;m.storyName="Extended Menu List Items (Segmented Button)";m.parameters={docs:{description:{story:`Each view of the segmented button gets its own menu item. The selected Button in the Segmented Button gets the Active Dot in front of the Menu List Item and is always separated with a separator.
      The ‘segmented button menu items’ cannot have an icon in front. Instead, the place is reserved for the Active Dot.
`}}};const d=()=>de;d.storyName="Extended Menu List Items (Toggle Button)";d.parameters={docs:{description:{story:`The toggle button gets “transformed” into a menu item which can be toggled and untoggled. If the toggle button is toggled, then a checkmark appears in front of the text (on position of an icon).
...
`}}};const u=()=>ue;u.storyName="Extended Menu List Items (Input)";u.parameters={docs:{description:{story:`An Input field can be placed in a menu item.
...
`}}};const c=()=>ce;c.storyName="Extended Menu List Items (Buttons as Menu Items)";c.parameters={docs:{description:{story:`The buttons are “transformed” into menu items. It is optional to add an icon and those could be replaced by product teams.
`}}};var v,g,k;p.parameters=n(e({},p.parameters),{docs:n(e({},(v=p.parameters)==null?void 0:v.docs),{source:e({originalSource:"() => defaultExampleHtml"},(k=(g=p.parameters)==null?void 0:g.docs)==null?void 0:k.source)})});var y,w,x;l.parameters=n(e({},l.parameters),{docs:n(e({},(y=l.parameters)==null?void 0:y.docs),{source:e({originalSource:"() => overflowExampleHtml"},(x=(w=l.parameters)==null?void 0:w.docs)==null?void 0:x.source)})});var S,O,E;_.parameters=n(e({},_.parameters),{docs:n(e({},(S=_.parameters)==null?void 0:S.docs),{source:e({originalSource:"() => mobileModeExampleHtml"},(E=(O=_.parameters)==null?void 0:O.docs)==null?void 0:E.source)})});var H,I,M;i.parameters=n(e({},i.parameters),{docs:n(e({},(H=i.parameters)==null?void 0:H.docs),{source:e({originalSource:"() => seperatedItemsExampleHtml"},(M=(I=i.parameters)==null?void 0:I.docs)==null?void 0:M.source)})});var A,T,B;o.parameters=n(e({},o.parameters),{docs:n(e({},(A=o.parameters)==null?void 0:A.docs),{source:e({originalSource:"() => differentStatesExampleHtml"},(B=(T=o.parameters)==null?void 0:T.docs)==null?void 0:B.source)})});var C,F,D;r.parameters=n(e({},r.parameters),{docs:n(e({},(C=r.parameters)==null?void 0:C.docs),{source:e({originalSource:"() => menuIconExampleHtml"},(D=(F=r.parameters)==null?void 0:F.docs)==null?void 0:D.source)})});var N,V,L;f.parameters=n(e({},f.parameters),{docs:n(e({},(N=f.parameters)==null?void 0:N.docs),{source:e({originalSource:"() => withSubmenuExampleHtml"},(L=(V=f.parameters)==null?void 0:V.docs)==null?void 0:L.source)})});var P,R,W;m.parameters=n(e({},m.parameters),{docs:n(e({},(P=m.parameters)==null?void 0:P.docs),{source:e({originalSource:"() => segmentedButtonExampleHtml"},(W=(R=m.parameters)==null?void 0:R.docs)==null?void 0:W.source)})});var U,X,j;d.parameters=n(e({},d.parameters),{docs:n(e({},(U=d.parameters)==null?void 0:U.docs),{source:e({originalSource:"() => toggleButtonExampleHtml"},(j=(X=d.parameters)==null?void 0:X.docs)==null?void 0:j.source)})});var z,Y,q;u.parameters=n(e({},u.parameters),{docs:n(e({},(z=u.parameters)==null?void 0:z.docs),{source:e({originalSource:"() => inputExampleHtml"},(q=(Y=u.parameters)==null?void 0:Y.docs)==null?void 0:q.source)})});var G,J,K;c.parameters=n(e({},c.parameters),{docs:n(e({},(G=c.parameters)==null?void 0:G.docs),{source:e({originalSource:"() => buttonsExampleHtml"},(K=(J=c.parameters)==null?void 0:J.docs)==null?void 0:K.source)})});const we=["Default","Overflow","MobileMode","SeperatedItems","DifferentStates","MenuIcon","WithSubmenu","SegmentedButton","ToggleButton","Input","Buttons"];export{c as Buttons,p as Default,o as DifferentStates,u as Input,r as MenuIcon,_ as MobileMode,l as Overflow,m as SegmentedButton,i as SeperatedItems,d as ToggleButton,f as WithSubmenu,we as __namedExportsOrder,ye as default};
