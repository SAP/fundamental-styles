...
`,h=`<table style="width: 100%; border-collapse: collapse; margin-top: 1rem;">
    <tr>
...
`,l={title:"Shadow",parameters:{description:`Helper mixins for shadow:
        <ul>
...
`,e=()=>`${n}${d}`;e.storyName="Shadow Types";e.parameters={docs:{description:{story:h}}};var t,a,s;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:"() => `${localStyles}${shadowExampleHtml}`",...(s=(a=e.parameters)==null?void 0:a.docs)==null?void 0:s.source}}};const o=["ShadowExample"];export{e as ShadowExample,o as __namedExportsOrder,l as default};
