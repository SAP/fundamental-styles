/* empty css              *//* empty css                   *//* empty css                 *//* empty css                   */const _=`<fieldset class="fd-fieldset" id="radio1Truncation">
...
</fieldset>`,h=`<fieldset class="fd-fieldset" id="radio5a">
...
`,v=`<fieldset class="fd-fieldset" id="radio4">
...
`,g=`<fieldset class="fd-fieldset" id="radio1">
    <legend class="fd-fieldset__legend">Radio Buttons</legend>
    <div class="fd-form__group">
        <div class="fd-form-item">
...
</fieldset>`,w={title:"Components/Forms/Radio",parameters:{description:`
...
`,tags:["f3","a11y","theme"]}},a=()=>g;a.parameters={docs:{story:{iframeHeight:250}}};const i=()=>v;i.parameters={docs:{description:{story:`
...
`}}};const e=()=>h;e.parameters={docs:{story:{iframeHeight:550},description:{story:"A radio button can have different states that affect its appearance value states, such as “error” or “warning”, which are indicated using semantic colors"}}};const d=()=>_;d.parameters={docs:{story:{iframeHeight:250},description:{story:"By default, long radio label truncates with ellipsis. For this behaviour no modifier class is needed. For radio label that wraps on a new line to show the entire content, use `.fd-radio__label--wrap` modifier class applied with `.fd-radio__label`. Keep in mind that for this to work <b>max-width</b> should be set on the label. For a <b>top-left aligned</b> label use the `.fd-radio__label--wrap-top-aligned` modifier class."}}};var s,n,o;a.parameters={...a.parameters,docs:{...(s=a.parameters)==null?void 0:s.docs,source:{originalSource:"() => primaryExampleHtml",...(o=(n=a.parameters)==null?void 0:n.docs)==null?void 0:o.source}}};var l,t,r;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:"() => inlineExampleHtml",...(r=(t=i.parameters)==null?void 0:t.docs)==null?void 0:r.source}}};var c,f,p;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:"() => interactionStatesExampleHtml",...(p=(f=e.parameters)==null?void 0:f.docs)==null?void 0:p.source}}};var m,u,b;d.parameters={...d.parameters,docs:{...(m=d.parameters)==null?void 0:m.docs,source:{originalSource:"() => textTruncationExampleHtml",...(b=(u=d.parameters)==null?void 0:u.docs)==null?void 0:b.source}}};const R=["Primary","Inline","InteractionStates","TextTruncation"];export{i as Inline,e as InteractionStates,a as Primary,d as TextTruncation,R as __namedExportsOrder,w as default};
//# sourceMappingURL=radio.stories-6c32276f.js.map
