const t={title:"Shadow",parameters:{description:`Helper mixins for shadow:
        <ul>
...
`;e.storyName="Shadow Types";e.parameters={docs:{story:{iframeHeight:500},description:{story:`<table style="width: 100%; border-collapse: collapse; margin-top: 1rem;">
    <tr>
...
</table>`}}};var a,s,d;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`() => \`\${localStyles}
<h3>Level 0 Shadow</h3>
<div class="demo sap-has-shadow-level-0"></div>
<br>
<h3>Level 1 Shadow</h3>
...
//# sourceMappingURL=shadow.stories-1cbd5a45.js.map
