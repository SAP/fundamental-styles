import{t as n,D as t}from"./iframe-B6QDNtRj.js";import{R as s}from"./IntroductionPageWrapper-4wvyWoIx.js";import"./preload-helper-CR6acF8F.js";const a=`# Fundamental Library Styles
...
Fundamental Library Styles is a lightweight presentation layer that can be used in conjunction with any UI framework, such as Angular, React, Vue, etc. By utilizing the Fundamental Styles library, which includes a collection of stylesheets and HTML tags, developers can create visually consistent and professional-looking SAP applications in any web-based technology of their choice.
...
`,l={title:"Docs / Introduction",component:()=>null,parameters:{docs:{container:t,page:s(a),theme:n},previewTabs:{canvas:{hidden:!0}},viewMode:"docs",visualDisabled:!0,docsOnly:!0}},e={render:()=>"<div></div>",parameters:{title:"Overview",storyshots:{disable:!0},viewMode:"docs",docsOnly:!0}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  render: () => {
    /*
...
}`,...e.parameters?.docs?.source}}};const c=["Overview"];export{e as Overview,c as __namedExportsOrder,l as default};
