...
`,r=`<div class="fd-shellbar fd-shellbar--side-nav" role="banner" aria-label="Shell Bar">
    <div class="fd-shellbar__group fd-shellbar__group--product">
        <button
            aria-label="Main Navigation"
            aria-expanded="false"
...
<ul>
  ...
  <li><b>Spacer:</b> creates space between groups of elements in context area. Visually separates the context area into left and right group.</li>
        ...
        `}}};const i=()=>r;i.storyName="Actions in Overflow Toolbar";i.parameters={docs:{description:{story:`Truncation and overflow logic of Shell Bar are based on priorities, such as when a component with a higher priority takes precedence over an element with a lower priority. <br><br>For all screen sizes the following elements are always displayed:
<ul>
...
<br>
<b>Overflow</b>
The overflow is displayed via a Popover and is used when there is more than one action available; the button should show a toggled state when the Popover is active.`}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => primaryExampleHtml",...n.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => optionalItemsExampleHtml",...a.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => responsivePaddingsExampleHtml",...t.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => overflowToolbarExampleHtml",...s.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => responsivenessExampleHtml",...i.parameters?.docs?.source}}};const S=["Primary","OptionalItems","ResponsivePaddings","OverflowToolbar","Responsiveness"];export{a as OptionalItems,s as OverflowToolbar,n as Primary,t as ResponsivePaddings,i as Responsiveness,S as __namedExportsOrder,k as default};
