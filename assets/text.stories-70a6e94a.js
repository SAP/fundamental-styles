var E=Object.defineProperty,A=Object.defineProperties;var U=Object.getOwnPropertyDescriptors;var o=Object.getOwnPropertySymbols;var L=Object.prototype.hasOwnProperty,S=Object.prototype.propertyIsEnumerable;var m=(s,i,t)=>i in s?E(s,i,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[i]=t,e=(s,i)=>{for(var t in i||(i={}))L.call(i,t)&&m(s,t,i[t]);if(o)for(var t of o(i))S.call(i,t)&&m(s,t,i[t]);return s},a=(s,i)=>A(s,U(i));const M=`<div class="example-container">
...
`,D=`<p class="sap-text">
    ...
    eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
    deserunt mollit anim id est laborum.</p>
`;const N={title:"Text",parameters:{description:`The text component displays text inside a form, table, or any other content area.
...
- <code>"hyphenation"</code>: to display hyphens<br>`}},n=()=>D;n.storyName="Default";n.parameters={docs:{description:{story:`The default text component can display lines of text that wrap to the next line
        once they reach the end of the content container width.`}}};const r=()=>P;r.parameters={docs:{description:{story:"The text component has a property that allows browsers to render specified indents and\n        whitespace. To display indents and/or whitespace, use the\n        `.fd-text-pre-wrap` class or `data-wrap` attribute to `.fd-text` class."}}};const u=()=>T;u.storyName="Max lines";u.parameters={docs:{description:{story:'The text component can be displayed with a maximum number of lines.\nWhen the maximum is reached, the text truncates and displays an ellipsis. To display text with a maximum line count,\nuse the `.fd-text-max-lines` class and an inline style rule with the number of\nlines to the main element. For example, add `style="-webkit-line-clamp: 3;"` to display\nthree lines of text.\n\nYou can also add the `data-lines` attribute to `.fd-text` class and specify the number of lines. \n\n**Note**: The property `-webkit-line-clamp` doesn\'t work in IE11 and should be changed\nto `height`. For example, `style="height: 200px;"`.\n'}}};const l=()=>M;l.parameters={docs:{description:{story:`The text component can display words that are broken at appropriate hyphenation
...
In HTML, add the \`&shy;\` Unicode to insert a soft hyphen.`}}};var c,d,p;n.parameters=a(e({},n.parameters),{docs:a(e({},(c=n.parameters)==null?void 0:c.docs),{source:e({originalSource:"() => defaultExampleExampleHtml"},(p=(d=n.parameters)==null?void 0:d.docs)==null?void 0:p.source)})});var h,b,g;r.parameters=a(e({},r.parameters),{docs:a(e({},(h=r.parameters)==null?void 0:h.docs),{source:e({originalSource:"() => whitespaceExampleHtml"},(g=(b=r.parameters)==null?void 0:b.docs)==null?void 0:g.source)})});var f,q,x;u.parameters=a(e({},u.parameters),{docs:a(e({},(f=u.parameters)==null?void 0:f.docs),{source:e({originalSource:"() => maxLinesExampleHtml"},(x=(q=u.parameters)==null?void 0:q.docs)==null?void 0:x.source)})});var v,y,w;l.parameters=a(e({},l.parameters),{docs:a(e({},(v=l.parameters)==null?void 0:v.docs),{source:e({originalSource:"() => hyphenationExampleHtml"},(w=(y=l.parameters)==null?void 0:y.docs)==null?void 0:w.source)})});const k=["DefaultExample","Whitespace","MaxLines","Hyphenation"];export{n as DefaultExample,l as Hyphenation,u as MaxLines,r as Whitespace,k as __namedExportsOrder,N as default};
