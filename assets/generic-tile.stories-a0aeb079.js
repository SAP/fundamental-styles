var O=Object.defineProperty,J=Object.defineProperties;var X=Object.getOwnPropertyDescriptors;var p=Object.getOwnPropertySymbols;var Q=Object.prototype.hasOwnProperty,Y=Object.prototype.propertyIsEnumerable;var m=(d,t,n)=>t in d?O(d,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):d[t]=n,e=(d,t)=>{for(var n in t||(t={}))Q.call(t,n)&&m(d,n,t[n]);if(p)for(var n of p(t))Y.call(t,n)&&m(d,n,t[n]);return d},i=(d,t)=>J(d,X(t));/* empty css             *//* empty css              *//* empty css               *//* empty css                        *//* empty css             */const Z=`<div class="fddocs-container">
...
</div>`,$=`<h4>Link tile: Floating behaviour</h4>
...
</div>`,ee=`<div class="fddocs-container">
...
</div>`,ie=`<div class="fddocs-container">
...
</div>`,te=`<div class="fddocs-container">
    <div role="button" tabindex="0" class="fd-tile fd-tile--double fd-tile--feed">
        <div class="fd-tile__header">
            <div class="fd-tile__title">Title: Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</div>
            <div class="fd-tile__subtitle">Subtitle</div>
...
</div>`,ne=`<h4>KPI tile with numeric content (size L)</h4>
...
`,de=`<h4>Launch tile with numeric content and launch icon</h4>
<br>
<div class="fddocs-container">
    <div role="button" tabindex="0" class="fd-tile fd-tile--launch">
        <div class="fd-tile__header">
...
</div>`,le=`<div class="fddocs-container">
...
</div>`,ue={title:"Components/Generic Tiles",parameters:{description:`
...
<br>
      `,tags:["f3","a11y","theme"]}},l=()=>ae;l.storyName="Sizes";l.parameters={docs:{description:{story:`
...
- Small tile (2 x 1) - 19 x 9.25rem
        `}}};const s=()=>se;s.storyName="Layout";s.parameters={docs:{description:{story:`
...
L | 4 characters can be displayed within numeric content.
        `}}};const c=()=>ne;c.storyName="KPI tile";c.parameters={docs:{description:{story:`
...
**Note:** The KPI tile supports a limited number of characters, which varies depending on the tile size (see launch tile above for more details).
        `}}};const r=()=>te;r.storyName="Feed tile";r.parameters={docs:{description:{story:"The feed tile displays a news feed with a news headline, the source, and a time stamp. It shows new notifications in 10-second intervals, and tile content is updated every five minutes. If there are no new notifications, the most recent notifications are displayed. The feed tile’s headline uses the full width of the container and does not contain an icon. To display a feed tile, add the `fd-tile--feed` modifier class to the main element.\n        "}}};const v=()=>ie;v.storyName="Badge tile";v.parameters={docs:{description:{story:`The badge tile displays very short and important information at the top right corner of the tile. It's recommended to add a badge to a tile when it has been newly added. Badges are not displayed when in action/edit mode.
        `}}};const _=()=>ee;_.storyName="Slide tile";_.parameters={docs:{description:{story:`
...
When in action mode, default (floating) link tiles display the actions and close button immediately after the text. However, when they are in list format, link tiles display the actions and close button along the right side of the container. To display link tile in action mode, add \`fd-tile__action-container\` after the header element. Gradient masking is also supported in edit mode.
        ...
        `}}};const u=()=>Z;u.storyName="Action mode";u.parameters={docs:{description:{story:"\nWhile a tile is in action mode, a close button is displayed on the top right-hand corner of the tile. The action icon is displayed on the bottom right-hand corner, and is only an indicator. The click/touch area fills the entire tile, excluding the area reserved for the close button. To display generic tile in action mode, add the `fd-tile--action` modifier class to the main element.\n        "}}};var b,h,g;l.parameters=i(e({},l.parameters),{docs:i(e({},(b=l.parameters)==null?void 0:b.docs),{source:e({originalSource:"() => genericTileSizesExampleHtml"},(g=(h=l.parameters)==null?void 0:h.docs)==null?void 0:g.source)})});var x,y,k;s.parameters=i(e({},s.parameters),{docs:i(e({},(x=s.parameters)==null?void 0:x.docs),{source:e({originalSource:"() => genericTileLayoutExampleHtml"},(k=(y=s.parameters)==null?void 0:y.docs)==null?void 0:k.source)})});var T,w,S;a.parameters=i(e({},a.parameters),{docs:i(e({},(T=a.parameters)==null?void 0:T.docs),{source:e({originalSource:"() => genericTileContentColumnsExampleHtml"},(S=(w=a.parameters)==null?void 0:w.docs)==null?void 0:S.source)})});var q,L,I;o.parameters=i(e({},o.parameters),{docs:i(e({},(q=o.parameters)==null?void 0:q.docs),{source:e({originalSource:"() => launchTileExampleHtml"},(I=(L=o.parameters)==null?void 0:L.docs)==null?void 0:I.source)})});var N,P,A;c.parameters=i(e({},c.parameters),{docs:i(e({},(N=c.parameters)==null?void 0:N.docs),{source:e({originalSource:"() => kpiTileExampleHtml"},(A=(P=c.parameters)==null?void 0:P.docs)==null?void 0:A.source)})});var F,M,E;r.parameters=i(e({},r.parameters),{docs:i(e({},(F=r.parameters)==null?void 0:F.docs),{source:e({originalSource:"() => feedTileExampleHtml"},(E=(M=r.parameters)==null?void 0:M.docs)==null?void 0:E.source)})});var z,H,B;v.parameters=i(e({},v.parameters),{docs:i(e({},(z=v.parameters)==null?void 0:z.docs),{source:e({originalSource:"() => badgeTileExampleHtml"},(B=(H=v.parameters)==null?void 0:H.docs)==null?void 0:B.source)})});var C,G,D;_.parameters=i(e({},_.parameters),{docs:i(e({},(C=_.parameters)==null?void 0:C.docs),{source:e({originalSource:"() => slideTileExampleHtml"},(D=(G=_.parameters)==null?void 0:G.docs)==null?void 0:D.source)})});var K,R,W;f.parameters=i(e({},f.parameters),{docs:i(e({},(K=f.parameters)==null?void 0:K.docs),{source:e({originalSource:"() => linkTileExampleHtml"},(W=(R=f.parameters)==null?void 0:R.docs)==null?void 0:W.source)})});var U,j,V;u.parameters=i(e({},u.parameters),{docs:i(e({},(U=u.parameters)==null?void 0:U.docs),{source:e({originalSource:"() => tileInActionModeExampleHtml"},(V=(j=u.parameters)==null?void 0:j.docs)==null?void 0:V.source)})});const pe=["GenericTileSizes","GenericTileLayout","GenericTileContentColumns","LaunchTile","KpiTile","FeedTile","BadgeTile","SlideTile","LinkTile","TileInActionMode"];export{v as BadgeTile,r as FeedTile,a as GenericTileContentColumns,s as GenericTileLayout,l as GenericTileSizes,c as KpiTile,o as LaunchTile,f as LinkTile,_ as SlideTile,u as TileInActionMode,pe as __namedExportsOrder,ue as default};
