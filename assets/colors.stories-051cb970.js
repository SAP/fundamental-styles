var v=Object.defineProperty,m=Object.defineProperties;var b=Object.getOwnPropertyDescriptors;var s=Object.getOwnPropertySymbols;var T=Object.prototype.hasOwnProperty,k=Object.prototype.propertyIsEnumerable;var d=(e,o,r)=>o in e?v(e,o,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[o]=r,a=(e,o)=>{for(var r in o||(o={}))T.call(o,r)&&d(e,r,o[r]);if(s)for(var r of s(o))k.call(o,r)&&d(e,r,o[r]);return e},n=(e,o)=>m(e,b(o));/* empty css                   */const B=`<h3>brandColor (--sapBrandColor)</h3>
...
`,x=`<h3>brandColor (--sapBrandColor)</h3>
...
`,S={title:"Colors",parameters:{description:""}},C=`
<style>
    div.demo {
        display: flex;
        height: 4rem;
...
${C}
${B}
`;c.parameters={docs:{description:{story:`To set the text color of an element use the class <code>.sap-color-<i style="color: red;">colorName</i></code>, where <i style="color: red;">colorName</i> is the base of the css variable from the SAP-theming package that represent the desired color. <br><br>
            <b>SCSS Mixin:</b> 
            <code>@include  sap-color(colorName)</code>
            `}}};const l=()=>`
${C}
${x}
`;l.parameters={docs:{description:{story:`To set the background color of an element use the class <code>.sap-bg-color-<i style="color: red;">colorName</i></code>, where <i style="color: red;">colorName</i> is the base of the css variable from the SAP-theming package that represent the desired color. <br><br>
            <b>SCSS Mixin:</b> 
            <code>@include  sap-bg-color(colorName)</code>
            `}}};var t,i,p;c.parameters=n(a({},c.parameters),{docs:n(a({},(t=c.parameters)==null?void 0:t.docs),{source:a({originalSource:"() => `\n${localStyles}\n${textColorExampleHtml}\n`"},(p=(i=c.parameters)==null?void 0:i.docs)==null?void 0:p.source)})});var g,h,u;l.parameters=n(a({},l.parameters),{docs:n(a({},(g=l.parameters)==null?void 0:g.docs),{source:a({originalSource:"() => `\n${localStyles}\n${backgroundColorExampleHtml}\n`"},(u=(h=l.parameters)==null?void 0:h.docs)==null?void 0:u.source)})});const y=["TextColor","BackgroundColor"];export{l as BackgroundColor,c as TextColor,y as __namedExportsOrder,S as default};
