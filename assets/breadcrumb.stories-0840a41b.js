...
`,i=`<nav aria-label="Breadcrumb Trail">
    <ol class="fd-breadcrumb">
...
`,tags:["f3","a11y","theme"]}},a=()=>i;a.parameters={docs:{description:{story:"The standard breadcrumb component displays several pages in text format separated by dividers, indicating a navigation path. Each page can be specifically selected to navigate to its corresponding page. It can be displayed by using the `fd-breadcrumb` class."}}};const n=()=>r;n.parameters={docs:{description:{story:"Separator between the links can be configured with modifier classes added to the main `fd-breadcrumb` class. For example: `fd-breadcrumb--backslash` or `fd-breadcrumb--double-greater-than`.\n\n| **Separator style**      | **Modifier class**                 |\n| :------------------ | :-------------------------------------- |\n| Slash               | default (no modiier class)              |\n| Backslash           | `fd-breadcrumb--backslash`            |\n| Double slash        | `fd-breadcrumb--double-slash`         |\n| Double backslash	  | `fd-breadcrumb--double-backslash`     |\n| Greater than        | `fd-breadcrumb--greater-than`         |\n| Double greater than	| `fd-breadcrumb--double-greater-than`  |"}}};const e=()=>t;e.parameters={docs:{description:{story:'The Breadcrumbs component offers two visual styles for the last item: as a "current page" (non-interactive and without a separator) or as a regular link with a following separator.'}}};const s=()=>l;s.parameters={docs:{story:{},description:{story:"The overflow breadcrumb component displays a dropdown menu, followed by several pages in the navigation path. <br>Like the standard breadcrumb, each page can be selected to navigate to its corresponding page. This type is responsive and will collapse into a dropdown menu if there is insufficient horizontal space on the screen. <br>To display the overflow breadcrumb, include the `fd-popover` component in the first breadcrumb item within the element."}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => standardExampleHtml",...a.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => stylesExampleHtml",...n.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => currentItemExampleHtml",...e.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => overflowExampleHtml",...s.parameters?.docs?.source}}};const _=["Standard","Styles","CurrentItem","Overflow"];export{e as CurrentItem,s as Overflow,a as Standard,n as Styles,_ as __namedExportsOrder,p as default};
