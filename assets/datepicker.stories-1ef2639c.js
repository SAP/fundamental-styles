...
`,g=`<div class="fd-dialog-docs-static fd-calendar-mobile-docs-static--landscape fd-dialog fd-dialog--active">
<div class="fd-dialog__content fd-dialog__content--s fd-dialog__content--mobile">
  <div class="fd-dialog__body fd-dialog__body--no-vertical-padding">
...
`,h=`<div class="fd-docs-date-picker" style="height:500px">
...
`,x=`<div class="fd-docs-date-picker" style="height:450px">
<div class="fd-popover">
  <div class="fd-popover__control is-expanded">
...
`,H={title:"Patterns/Date Picker",parameters:{description:`The date picker provides responsive behavior that allows for simple operation on all devices. It is smaller in compact mode and provides a touch-friendly size in cozy mode.
...
-    The user needs to navigate directly from one month or year to another.
      `,tags:["f3","a11y","theme"]}},e=()=>x;e.parameters={docs:{story:{iframeHeight:500},description:{story:`
...
`}}};const d=()=>h;d.parameters={docs:{story:{iframeHeight:450},description:{story:`
...
`}}};const a=()=>g;a.storyName="Mobile landscape mode with today navigation";a.parameters={docs:{story:{iframeHeight:400},description:{story:"The additional `Today` button displayed in the navigation part of the calendar, sets the focus to the current date. The landscape sizing and roation of thw the date picker is done by adding the `fd-calendar--mobile-landscape` class."}}};const n=()=>u;n.storyName="Mobile portrait mode with today navigation";n.parameters={docs:{story:{iframeHeight:500},description:{story:"Similar to the mobile landscape example, mobile portrait mode has a `Today` button. To make date picker visible in portrait mode, add the`fd-calendar--mobile-portrait` class."}}};var t,l,s;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:"() => todaySelectionButtonExampleHtml",...(s=(l=e.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};var r,c,_;d.parameters={...d.parameters,docs:{...(r=d.parameters)==null?void 0:r.docs,source:{originalSource:"() => todayNavigationButtonExampleHtml",...(_=(c=d.parameters)==null?void 0:c.docs)==null?void 0:_.source}}};var i,o,f;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:"() => mobileLandscapeExampleHtml",...(f=(o=a.parameters)==null?void 0:o.docs)==null?void 0:f.source}}};var p,m,b;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:"() => mobilePortraitExampleHtml",...(b=(m=n.parameters)==null?void 0:m.docs)==null?void 0:b.source}}};const M=["TodaySelectionButton","TodayNavigationButton","MobileLandscape","MobilePortrait"];export{a as MobileLandscape,n as MobilePortrait,d as TodayNavigationButton,e as TodaySelectionButton,M as __namedExportsOrder,H as default};
//# sourceMappingURL=datepicker.stories-1ef2639c.js.map
