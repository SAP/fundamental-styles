var _=Object.defineProperty,f=Object.defineProperties;var p=Object.getOwnPropertyDescriptors;var l=Object.getOwnPropertySymbols;var v=Object.prototype.hasOwnProperty,b=Object.prototype.propertyIsEnumerable;var d=(i,a,t)=>a in i?_(i,a,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[a]=t,s=(i,a)=>{for(var t in a||(a={}))v.call(a,t)&&d(i,t,a[t]);if(l)for(var t of l(a))b.call(a,t)&&d(i,t,a[t]);return i},e=(i,a)=>f(i,p(a));/* empty css               *//* empty css             *//* empty css                      *//* empty css                        *//* empty css              *//* empty css                 *//* empty css             *//* empty css             */const m=`<div class="fd-fixed-card-layout__card-layout fd-fixed-card-layout__card-layout--columns-3" style="height: 1102px;" [attr.dir]="dir">
    ...
    </div>`;const T={title:"Layouts/Fixed Card Layout",parameters:{description:`The fixed card layout is a layout for the overview page. The cards have a fixed width, and the height is determined by the card type and the embedded control.
        `,tags:["f3","a11y","theme","development"],components:["fixed-card-layout","avatar","card","object-status","numeric-content","table","checkbox","list","icon"]}},n=()=>m;n.storyName="Fixed card layout with 3 columns";n.parameters={docs:{description:{story:"Cards arrangement in a 3 column layout.\n* Use `fd-fixed-card-layout__card-layout` class for the wrapper element, specify amount of columns with `fd-fixed-card-layout__card-layout--columns-N` class, where `1 < N < 11`.\nLayout is single column by default. Also, set `height` or `max-height` for the wrapper element.\n* Apply `fd-fixed-card-layout__card` class to the every card element."}}};var c,r,o;n.parameters=e(s({},n.parameters),{docs:e(s({},(c=n.parameters)==null?void 0:c.docs),{source:s({originalSource:"() => fixedCardLayoutExampleHtml"},(o=(r=n.parameters)==null?void 0:r.docs)==null?void 0:o.source)})});const E=["FixedCardLayout"];export{n as FixedCardLayout,E as __namedExportsOrder,T as default};
