/* empty css               *//* empty css                      *//* empty css             *//* empty css             */const B=`<div class="fd-message-strip fd-message-strip--dismissible fd-message-strip--indication-color-1" role="note" aria-live="assertive" id="message-strip-17" aria-labelledby="message-strip-17">
...
`,G=`<div class="fd-message-strip fd-message-strip--dismissible" role="note" aria-live="assertive" id="message-strip-15" aria-labelledby="message-strip-15">
  <div class="fd-message-strip__icon-container" aria-hidden="true">
    <span class="sap-icon sap-icon--master-task-triangle-2" focusable="false" role="presentation" aria-hidden="true"></span>
  </div>
  <p class="fd-message-strip__text">
...
`,P=`<div class="fd-message-strip fd-message-strip--error fd-message-strip--dismissible fd-message-strip--link" role="note" aria-live="assertive" id="message-strip-14" aria-labelledby="message-strip-14">
  <div class="fd-message-strip__icon-container" aria-hidden="true">
...
`,R=`<div class="fd-message-strip fd-message-strip--information fd-message-strip--no-icon"
...
`,O=`<div class="fd-message-strip fd-message-strip--information fd-message-strip--no-icon fd-message-strip--dismissible"
...
`,z=`<div class="fd-message-strip fd-message-strip--error fd-message-strip--dismissible" role="note" aria-live="assertive" id="message-strip-5" aria-labelledby="message-strip-5">
  <div class="fd-message-strip__icon-container" aria-hidden="true">
    <span class="sap-icon sap-icon--message-error" focusable="false" role="presentation" aria-hidden="true"></span>
  </div>
  <p class="fd-message-strip__text">
...
`,F=`<div class="fd-message-strip fd-message-strip--warning fd-message-strip--dismissible" role="note" aria-live="assertive" id="message-strip-4" aria-labelledby="message-strip-4">
  <div class="fd-message-strip__icon-container" aria-hidden="true">
...
`,J=`<div class="fd-message-strip fd-message-strip--success fd-message-strip--dismissible" role="note" aria-live="assertive" id="message-strip-3" aria-labelledby="message-strip-3">
  <div class="fd-message-strip__icon-container" aria-hidden="true">
...
`,K=`<div class="fd-message-strip fd-message-strip--information fd-message-strip--dismissible" role="note" aria-live="assertive" id="message-strip-2" aria-labelledby="message-strip-2">
  <div class="fd-message-strip__icon-container" aria-hidden="true">
...
`,Q=`<div class="fd-message-strip fd-message-strip--no-icon" role="note" aria-live="assertive" id="message-strip-1" aria-labelledby="message-strip-1">
  <p class="fd-message-strip__text">
    Vivamus sagittis diam in vehicula lobortis sapien arcu mattis erat vel aliquet sem urna et.
  </p>
</div>
`,es={title:"Components/Message Strip",parameters:{description:`Message Strip is a component that enables the embedding of application-related messages in the application. They are useed to draw the user’s attention to information that is important in the context of the page content. This could be a warning or a change of state, that would be easy to miss it.
...
- <b>Close button (optional) </b>- each message can have a Close button so it can be removed from the UI, if needed. Add the \`.fd-message-strip--dismissible\` modifier class for a dismissible message strip.
        ...
        `,tags:["f3","theme"]}},s=64,e=()=>Q;e.storyName="Default";e.parameters={docs:{story:{iframeHeight:s},description:{story:"The default message strip can be used for general messages that don’t fit into any of the semantic type use cases."}}};const o=()=>K;o.parameters={docs:{story:{iframeHeight:s},description:{story:"To display an information message strip, add the `fd-message-strip--information` modifier class to the main element."}}};const l=()=>J;l.parameters={docs:{story:{iframeHeight:s},description:{story:"To display a success message strip, add the `fd-message-strip--success` modifier class to the main element."}}};const d=()=>F;d.parameters={docs:{story:{iframeHeight:s},description:{story:"To display a warning message strip, add the `fd-message-strip--warning` modifier class to the main element."}}};const p=()=>z;p.parameters={docs:{story:{iframeHeight:s},description:{story:"To display the error message strip, add the `fd-message-strip--error` modifier class to the main element.\n"}}};const a=()=>O;a.storyName="No icon";a.parameters={docs:{story:{iframeHeight:s*4},description:{story:"To display message strip without an icon, add the `fd-message-strip--no-icon` modifier class to the main element. Add the `fd-message-strip--dismissible` modifier class if the element is dismissible."}}};const i=()=>R;i.storyName="No icon and no dismiss button";i.parameters={docs:{story:{iframeHeight:s*4},description:{story:"To display message strip without an icon, add the `fd-message-strip--no-icon` modifier class to the main element."}}};const t=()=>P;t.storyName="Text with link";t.parameters={docs:{story:{iframeHeight:s},description:{story:"The Link inside Message Strip has additional styling. Add the `fd-message-strip--link` modifier class if the message contains a link element."}}};const n=()=>G;n.storyName="Custom icon";n.parameters={docs:{story:{iframeHeight:s},description:{story:'The message strip can be customized by changing the status icon. Check <a href="https://sap.github.io/fundamental-styles/?path=/docs/components-icons-sap-icons--sizes" target="_blank" rel="noopener noreferrer" title="click to open Avatar component. Opens in a new window.">Icons</a> control for more icon types.'}}};const r=()=>B;r.storyName="Custom Message Strip";r.parameters={docs:{story:{iframeHeight:s},description:{story:"If the application needs a custom Message Strip, other than the semantic variations, then the colours from Inverted Object Status/Tag control should be used. Use the modifier classes `.fd-message-strip--indication-color-*`, where `*` is a number from 1 to 10 for the first set, and 1b to 10b for the second set. "}}};var c,m,g;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:"() => defaultStripExampleHtml",...(g=(m=e.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};var f,u,b;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:"() => informationExampleHtml",...(b=(u=o.parameters)==null?void 0:u.docs)==null?void 0:b.source}}};var v,h,_;l.parameters={...l.parameters,docs:{...(v=l.parameters)==null?void 0:v.docs,source:{originalSource:"() => successExampleHtml",...(_=(h=l.parameters)==null?void 0:h.docs)==null?void 0:_.source}}};var y,x,S;d.parameters={...d.parameters,docs:{...(y=d.parameters)==null?void 0:y.docs,source:{originalSource:"() => warningExampleHtml",...(S=(x=d.parameters)==null?void 0:x.docs)==null?void 0:S.source}}};var w,C,k;p.parameters={...p.parameters,docs:{...(w=p.parameters)==null?void 0:w.docs,source:{originalSource:"() => errorExampleHtml",...(k=(C=p.parameters)==null?void 0:C.docs)==null?void 0:k.source}}};var H,M,E;a.parameters={...a.parameters,docs:{...(H=a.parameters)==null?void 0:H.docs,source:{originalSource:"() => noIconsExampleHtml",...(E=(M=a.parameters)==null?void 0:M.docs)==null?void 0:E.source}}};var I,T,q;i.parameters={...i.parameters,docs:{...(I=i.parameters)==null?void 0:I.docs,source:{originalSource:"() => noIconsNotDismissibleExampleHtml",...(q=(T=i.parameters)==null?void 0:T.docs)==null?void 0:q.source}}};var N,V,W;t.parameters={...t.parameters,docs:{...(N=t.parameters)==null?void 0:N.docs,source:{originalSource:"() => messageStripWithLinkExampleHtml",...(W=(V=t.parameters)==null?void 0:V.docs)==null?void 0:W.source}}};var D,A,L;n.parameters={...n.parameters,docs:{...(D=n.parameters)==null?void 0:D.docs,source:{originalSource:"() => messageStripWithCustomIconExampleHtml",...(L=(A=n.parameters)==null?void 0:A.docs)==null?void 0:L.source}}};var Y,U,j;r.parameters={...r.parameters,docs:{...(Y=r.parameters)==null?void 0:Y.docs,source:{originalSource:"() => messageStripWithAccentColorsExampleHtml",...(j=(U=r.parameters)==null?void 0:U.docs)==null?void 0:j.source}}};const as=["DefaultStrip","Information","Success","Warning","Error","NoIcons","NoIconsNotDismissible","MessageStripWithLink","MessageStripWithCustomIcon","MessageStripWithAccentColors"];export{e as DefaultStrip,p as Error,o as Information,r as MessageStripWithAccentColors,n as MessageStripWithCustomIcon,t as MessageStripWithLink,a as NoIcons,i as NoIconsNotDismissible,l as Success,d as Warning,as as __namedExportsOrder,es as default};
//# sourceMappingURL=message-strip.stories-f9d683c2.js.map
