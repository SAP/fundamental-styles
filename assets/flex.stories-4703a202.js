...
`;i.storyName="Flex Container";i.parameters={docs:{story:{iframeHeight:150},description:{story:`To turn a parent element into a flex container apply the <code>.sap-flex</code> class to this element. <br>
            <b>SCSS Mixin:</b> 
...
`;d.storyName="Flex Align Content (Flex Container)";d.parameters={docs:{story:{iframeHeight:150},description:{story:`
<table>
    <thead>
    <tr>
...
`;t.storyName="Flex Align Items (Flex Container)";t.parameters={docs:{story:{iframeHeight:150},description:{story:`
<table>
    <thead>
    <tr>
        <th>Modifier Class</th>
...
where <code>type</code> can be one of the following: <code>flex-start | start | self-start | flex-end | end | self-end | center | baseline | stretch </code>`}}};const s=()=>`${e}
<div class="sap-docs-container">
    <h4>row center</h4>
...
`;s.storyName="Flex Center (Flex Container)";s.parameters={docs:{story:{iframeHeight:150},description:{story:`

<b>SCSS Mixin:</b> 
<code>@include sap-flex-center(direction)</code>;<br>
where <code>direction</code> can be one of the following: <code>row (default) | row-reverse | column | column-reverse</code>`}}};const n=()=>`${e}
<div class="sap-docs-container">
    <h4>Row</h4>
...
`;n.storyName="Flex Direction (Flex Container)";n.parameters={docs:{story:{iframeHeight:150},description:{story:`To specify the direction of the items placed in the flex container use one of the following modifier classes: <br><br>
            <table>
                <thead>
                <tr>
                    <th>Modifier Class</th>
...
`;v.storyName="Flex Gap (Flex Container)";v.parameters={docs:{story:{iframeHeight:150},description:{story:`
<table>
    <thead>
    <tr>
        <th>Modifier Class</th>
...
`;a.storyName="Flex Justify Content (Flex Container)";a.parameters={docs:{story:{iframeHeight:150},description:{story:`
<table>
    <thead>
    <tr>
        <th>Modifier Class</th>
...
`;l.storyName="Flex Wrap (Flex Container)";l.parameters={docs:{story:{iframeHeight:150},description:{story:`
<table>
    <thead>
    <tr>
        <th>Modifier Class</th>
...
where <code>type</code> can be one of the following: <code>nowrap(default) | wrap | wrap-reverse</code>`}}};const r=()=>`${e}
<div class="sap-docs-container">
...
`;r.storyName="Flex Order (Flex Items)";r.parameters={docs:{story:{iframeHeight:150},description:{story:`
...
where <code>value</code> is an integer.`}}};const c=()=>`${e}
<div class="sap-docs-container">
    <section class="sap-flex" style="max-width:30rem;">
        <div>1</div>
...
`;c.storyName="Flex Shrink (Flex Items)";c.parameters={docs:{story:{iframeHeight:150},description:{story:`
...
`;o.storyName="Flex Grow (Flex Items)";o.parameters={docs:{story:{iframeHeight:150},description:{story:`
...
`;p.storyName="Flex Align Self (Flex Items)";p.parameters={docs:{story:{iframeHeight:150},description:{story:`
...
\``,...(h=(f=i.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};var m,g,b;d.parameters={...d.parameters,docs:{...(m=d.parameters)==null?void 0:m.docs,source:{originalSource:`() => \`\${localStyles}
<div class="sap-docs-container">
    <h4 style="text-align: center">flex-start</h4>
    <section class="sap-flex sap-flex--align-content-flex-start" style="max-width:30rem;">
        <div></div>
...
\``,...(b=(g=d.parameters)==null?void 0:g.docs)==null?void 0:b.source}}};var y,u,w;t.parameters={...t.parameters,docs:{...(y=t.parameters)==null?void 0:y.docs,source:{originalSource:`() => \`\${localStyles}
<div class="sap-docs-container">
    <h4 style="text-align: center">flex-start | start | self-start</h4>
    <section class="sap-flex sap-flex--align-items-flex-start">
        <div></div>
...
\``,...(w=(u=t.parameters)==null?void 0:u.docs)==null?void 0:w.source}}};var S,F,C;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`() => \`\${localStyles}
<div class="sap-docs-container">
    <h4>row center</h4>
    <section class="sap-flex sap-flex--center" style="max-width:30rem;">
        <div></div>
...
\``,...(C=(F=s.parameters)==null?void 0:F.docs)==null?void 0:C.source}}};var j,$,k;n.parameters={...n.parameters,docs:{...(j=n.parameters)==null?void 0:j.docs,source:{originalSource:`() => \`\${localStyles}
<div class="sap-docs-container">
    <h4>Row</h4>
    <section class="sap-flex sap-flex--row">
        <div>1</div>
...
\``,...(k=($=n.parameters)==null?void 0:$.docs)==null?void 0:k.source}}};var M,N,H;v.parameters={...v.parameters,docs:{...(M=v.parameters)==null?void 0:M.docs,source:{originalSource:`() => \`\${localStyles}
<div class="sap-docs-container">
    <h4 style="text-align: center">tiny</h4>
    <section class="sap-flex sap-flex--gap-tiny">
        <div></div>
...
\``,...(H=(N=v.parameters)==null?void 0:N.docs)==null?void 0:H.source}}};var R,A,T;a.parameters={...a.parameters,docs:{...(R=a.parameters)==null?void 0:R.docs,source:{originalSource:`() => \`\${localStyles}
<div class="sap-docs-container">
    <h4 style="text-align: center">flex-start | start</h4>
    <section class="sap-flex sap-flex--justify-flex-start">
        <div></div>
...
\``,...(T=(A=a.parameters)==null?void 0:A.docs)==null?void 0:T.source}}};var D,I,G;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`() => \`\${localStyles}
<div class="sap-docs-container">
    <h4>nowrap</h4>
    <section class="sap-flex sap-flex--nowrap" style="max-width:30rem;">
        <div></div>
...
\``,...(G=(I=l.parameters)==null?void 0:I.docs)==null?void 0:G.source}}};var L,q,E;r.parameters={...r.parameters,docs:{...(L=r.parameters)==null?void 0:L.docs,source:{originalSource:`() => \`\${localStyles}
<div class="sap-docs-container">
    <section class="sap-flex" style="max-width:30rem;">
        <div class="sap-flex-order-3">1</div>
        <div>2</div>
...
\``,...(E=(q=r.parameters)==null?void 0:q.docs)==null?void 0:E.source}}};var O,J,W;c.parameters={...c.parameters,docs:{...(O=c.parameters)==null?void 0:O.docs,source:{originalSource:`() => \`\${localStyles}
<div class="sap-docs-container">
    <section class="sap-flex" style="max-width:30rem;">
        <div>1</div>
        <div class="sap-flex-shrink-2">2</div>
...
\``,...(W=(J=c.parameters)==null?void 0:J.docs)==null?void 0:W.source}}};var _,z,B;o.parameters={...o.parameters,docs:{...(_=o.parameters)==null?void 0:_.docs,source:{originalSource:`() => \`\${localStyles}
<div class="sap-docs-container">
    <section class="sap-flex" style="max-width:30rem;">
        <div>1</div>
        <div class="sap-flex-grow-4">2</div>
...
\``,...(B=(z=o.parameters)==null?void 0:z.docs)==null?void 0:B.source}}};var K,P,Q;p.parameters={...p.parameters,docs:{...(K=p.parameters)==null?void 0:K.docs,source:{originalSource:`() => \`\${localStyles}
<div class="sap-docs-container">
    <h4>flex-end</h4>
    <section class="sap-flex sap-flex--align-items-flex-start" style="max-width:30rem;">
        <div>1</div>
...
\``,...(Q=(P=p.parameters)==null?void 0:P.docs)==null?void 0:Q.source}}};const V=["Flex","FlexAlignContent","FlexAlignItems","FlexCenter","FlexDirection","FlexGap","FlexJustify","FlexWrap","FlexOrder","FlexShrink","FlexGrow","FlexAlignSelf"];export{i as Flex,d as FlexAlignContent,t as FlexAlignItems,p as FlexAlignSelf,s as FlexCenter,n as FlexDirection,v as FlexGap,o as FlexGrow,a as FlexJustify,r as FlexOrder,c as FlexShrink,l as FlexWrap,V as __namedExportsOrder,U as default};
//# sourceMappingURL=flex.stories-4703a202.js.map
