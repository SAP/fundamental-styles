/* empty css               *//* empty css             *//* empty css                  *//* empty css                   *//* empty css              *//* empty css                *//* empty css                     *//* empty css                     *//* empty css                    */const t=`<h4>User prompt with no input</h4>
<div>
...
</div>`,l={title:"Components/Forms/Prompt Input",parameters:{description:`The Prompt Input component allows the user to write custom instructions in natural language, so that AI is guided to generate content tailored to user needs.
<br><b>Note: The component is in an experimental state.</b>
        `,tags:["ai","experimental"]}},n=()=>t;n.storyName="Basic Sample";n.parameters={docs:{description:{story:"The Prompt Input is built on top of [Input Group](https://fundamental-styles.netlify.app/?path=/docs/sap-fiori-components-forms-input-group--docs) and inherits its states (disabled, read-only, information, etc.)."}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => basicExampleHtml",...n.parameters?.docs?.source}}};const c=["Basic"];export{n as Basic,c as __namedExportsOrder,l as default};
