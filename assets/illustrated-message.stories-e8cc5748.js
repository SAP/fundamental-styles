...
`,r=`<div style="width: 100%; display: flex; justify-content: center">
...
`,o=`<div style="width: 100%; display: flex; justify-content: center">
...
`,p={title:"Components/Illustrated Message",parameters:{description:`Illustrated messages for SAP Fiori are a simple yet powerful way to engage users and add personality to the experience.
...
`,l=()=>`<div class="fd-illustrated-message-responsive-container">
...
${i}`;l.storyName="Scene (Large)";l.parameters={docs:{description:{story:`Default type, no modifier class is required. Can be optionally wrap in a responsive container <code>.fd-illustrated-message-responsive-container</code>
        `}},styles:[`:root {
            --sapIllus_BrandColorPrimary: var(--sapContent_Illustrative_Color1);
            --sapIllus_BrandColorSecondary: var(--sapContent_Illustrative_Color2);
            --sapIllus_AccentColor: var(--sapContent_Illustrative_Color3);
            ...
            --sapIllus_PatternShadow: url(#sapIllus_PatternShadow);
            --sapIllus_PatternHighlight: url(#sapIllus_PatternHighlight);
        }`]};const a=()=>o;a.storyName="Dialog (Medium)";a.parameters={docs:{description:{story:"Add `.fd-illustrated-message--dialog` class\n        "}}};const s=()=>r;s.storyName="Spot (Small)";s.parameters={docs:{description:{story:"Add `.fd-illustrated-message--spot` class\n        "}}};const t=()=>e;t.storyName="Dot (Extra Small)";t.parameters={docs:{description:{story:"Add `.fd-illustrated-message--dot` class\n        "}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`() => \`<div class="fd-illustrated-message-responsive-container">
        <figure class="fd-illustrated-message">
          <div class="fd-illustrated-message__container">
            <svg class="fd-illustrated-message__illustration" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="320" height="240" viewBox="0 0 320 240" id="sapIllus-Scene-NoMail">
                <path class="sapIllus_BackgroundColor" style="fill:var(--sapIllus_BackgroundColor)" d="M160.9349,25c-63.5127,0-117,45.65-117,111.0215,0,57.985,53.4873,102.9785,117,102.9785s115-45.0093,115-102.9944C275.9349,72.6147,224.4477,25,160.9349,25Z"/>
...
\${localStyles}\``,...l.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => dialogExampleHtml",...a.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => spotExampleHtml",...s.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => dotExampleHtml",...t.parameters?.docs?.source}}};const d=["Scene","Dialog","Spot","Dot"];export{a as Dialog,t as Dot,l as Scene,s as Spot,d as __namedExportsOrder,p as default};
