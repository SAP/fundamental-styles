/* empty css             *//* empty css             *//* empty css                          *//* empty css               *//* empty css                      *//* empty css                      *//* empty css                      */const g=`
...
`;const T={title:"Components/Object List",parameters:{description:`
...
`,tags:["f3","a11y","theme","development"]}},t=()=>k;t.parameters={docs:{story:{iframeHeight:785},description:{story:"The standard object list item displays a title, introductory text, an avatar and object display components. It is recommended to display avatar in size S, therefore add the `fd-avatar--s` modifier class to the `fd-avatar` element."}}};const i=()=>x;i.parameters={docs:{story:{iframeHeight:355},description:{story:"An object list can display links that the users can navigate to. To display a navigation object list, add the `fd-list--navigation-object` modifier class together with `fd-list--navigation` and the `fd-list__item--link` modifier class to the list elements that contain a link. All items should be navigable."}}};const s=()=>y;s.parameters={docs:{story:{iframeHeight:305},description:{story:"Object list items can be selectable by adding the `fd-list--selection` and `fd-list--selection-row` modifier classes to the main element."}}};const e=()=>w;e.parameters={docs:{story:{iframeHeight:305},description:{story:"This object list is both selectable and navigable. To display selectable object list items with navigation, add the `fd-list--selection`, `fd-list--navigation` and `fd-list--navigation-object` modifier classes to the list and the `fd-list__item--link` modifier class to the list elements that contain links. All items should be navigable."}}};const n=()=>g;n.parameters={docs:{story:{iframeHeight:305},description:{story:"Object list items can be displayed without borders. To display a borderless list, add the `fd-list--no-border` modifier class to the list element."}}};var a,d,c;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:"() => standartExampleHtml",...(c=(d=t.parameters)==null?void 0:d.docs)==null?void 0:c.source}}};var l,o,r;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:"() => navigationExampleHtml",...(r=(o=i.parameters)==null?void 0:o.docs)==null?void 0:r.source}}};var b,_,f;s.parameters={...s.parameters,docs:{...(b=s.parameters)==null?void 0:b.docs,source:{originalSource:"() => selectionExampleHtml",...(f=(_=s.parameters)==null?void 0:_.docs)==null?void 0:f.source}}};var v,j,p;e.parameters={...e.parameters,docs:{...(v=e.parameters)==null?void 0:v.docs,source:{originalSource:"() => selectionWithNavigationExampleHtml",...(p=(j=e.parameters)==null?void 0:j.docs)==null?void 0:p.source}}};var u,m,h;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:"() => borderlessExampleHtml",...(h=(m=n.parameters)==null?void 0:m.docs)==null?void 0:h.source}}};const B=["Standart","Navigation","Selection","SelectionWithNavigation","Borderless"];export{n as Borderless,i as Navigation,s as Selection,e as SelectionWithNavigation,t as Standart,B as __namedExportsOrder,T as default};
//# sourceMappingURL=object-list.stories-63c9f12c.js.map
