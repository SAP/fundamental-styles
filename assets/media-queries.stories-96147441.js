const i=`<table style="width: 100%; border-collapse: collapse; margin-top: 1rem;">
    <tbody>
...
<br><br><br><br>
`,r={title:"Media Queries",parameters:{description:i,docs:{iframeHeight:500}}},e=()=>`<pre>
...
</pre>`;e.storyName=" ";var d,t,n;e.parameters={...e.parameters,docs:{...(d=e.parameters)==null?void 0:d.docs,source:{originalSource:`() => \`<pre>
@include sap-media-min-width(400px) {
    div.example {
        font-size: 0.75 rem;
    }
...
</pre>\``,...(n=(t=e.parameters)==null?void 0:t.docs)==null?void 0:n.source}}};const a=["CustomMediaQueries"];export{e as CustomMediaQueries,a as __namedExportsOrder,r as default};
//# sourceMappingURL=media-queries.stories-96147441.js.map
