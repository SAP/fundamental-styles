...
</div>`;e.storyName="Mixin sap-fiori-focus";e.parameters={docs:{story:{iframeHeight:500},description:{story:"<code>sap-fiori-focus</code> has 2 optional parameters: <code>$offset</code> and <code>$alternative</code>. By default, the <code>$offset</code> is set to -0.1875rem, and <code>$alternative</code> to false. If <code>$alternative</code> is set to true, the outline color is <code>--sapContent_ContrastFocusColor</code>, instead of <code>--sapContent_FocusColor</code>."}}};const r=()=>`<div>
1. with default parameters ($offset: -0.1875rem, $alternative: false)
...
</div>`;i.storyName="Mixin sap-fake-fiori-focus";i.parameters={docs:{story:{iframeHeight:500},description:{story:`Most modern browsers do not support outline radius. An alternative apporach, using <code>sap-fake-fiori-focus</code> mixin, can be applied to solve this problem. 
...
</div>`;s.storyName="Mixin sap-fake-fiori-focus-within";s.parameters={docs:{story:{iframeHeight:500},description:{story:""}}};var t,o,a;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`() => \`<div>
1. with default parameters ($offset: -0.1875rem, $alternative: false)
...
3. with specified focus offset and alternative focus color ($offset: 0.0625rem, $alternative: true)
<pre>@include sap-fiori-focus(0.0625rem, true);</pre>
</div>\``,...(a=(o=e.parameters)==null?void 0:o.docs)==null?void 0:a.source}}};var f,c,n;r.parameters={...r.parameters,docs:{...(f=r.parameters)==null?void 0:f.docs,source:{originalSource:`() => \`<div>
1. with default parameters ($offset: -0.1875rem, $alternative: false)
...
3. with specified focus offset and alternative focus color ($offset: 0.0625rem, $alternative: true)
<pre>@include sap-fiori-focus-within(0.0625rem, true);</pre>
</div>\``,...(n=(c=r.parameters)==null?void 0:c.docs)==null?void 0:n.source}}};var u,d,p;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:`() => \`<div>
1. with default parameters ($offset: 0, $radius: 0, $alternative: false)
...
//# sourceMappingURL=focus.stories-b1f73031.js.map
