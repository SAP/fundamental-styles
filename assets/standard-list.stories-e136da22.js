/* empty css             *//* empty css             *//* empty css                 *//* empty css               *//* empty css                       */const ct=`<ul class="fd-list fd-list__infinite-scroll fddocs-list-height" role="list">
...
`,mt=`<ul class="fd-list fd-list--navigation" role="list">
...
`,_t=`<ul class="fd-list fd-list--selection" role="listbox" aria-labelledby="XezW11">
...
`,pt=`<ul class="fd-list fd-list--no-border" role="list">
  <li role="listitem" tabindex="0" class="fd-list__item">
      <span class="fd-list__title">List item 1</span>
  </li>
  <li role="listitem" tabindex="0" class="fd-list__item">
...
</ul>`,ht=`<ul class="fd-list" role="list">
  <li role="listitem" tabindex="0" class="fd-list__item">
      <span class="fd-list__title">List item 1</span>
...
`,yt=`<ul class="fd-list fd-list--navigation fd-list--navigation-indication" role="list">
...
`,Lt=`<ul class="fd-list fd-list--navigation" role="list">
  <li tabindex="-1" role="listitem" class="fd-list__item fd-list__item--link">
      <a tabindex="0" class="fd-list__link">
        <span class="fd-list__title">List item 1</span>
      </a>
...
`,Nt={title:"Components/List/Standard",parameters:{description:`
...
`,tags:["f3","a11y","theme","development"]}},t=()=>kt;t.storyName="Default";t.parameters={docs:{story:{iframeHeight:445},description:{story:"The default standard list displays list items in the standard size, which is ideal for mobile. To display the standard list in compact mode (for desktop), add the `is-compact` modifier class to the main element.\n        "}}};const o=()=>Ht;o.parameters={docs:{story:{iframeHeight:445},description:{story:"The `fd-list__item--unread` modifier will change the font weight to bold for easier legibility.\n        "}}};const d=()=>St;d.parameters={docs:{story:{iframeHeight:445},description:{story:"\nThe `fd-list__item--interractive` will force list item to handle hover and active states.\nUsage of this modifier is not needed on `Selection`, `Navigation` and `Action` modes.\n        "}}};const r=()=>Lt;r.parameters={docs:{story:{iframeHeight:165},description:{story:"\nStandard list items can contain navigation links. To add navigation, add the `fd-list—navigation` modifier class to the list and the `fd-list__item--link` modifier class to the list elements that contain links. All items should be navigable.\n"}}};const c=()=>vt;c.parameters={docs:{story:{iframeHeight:165},description:{story:`
`}}};const s=()=>yt;s.storyName="Navigation indicators";s.parameters={docs:{story:{iframeHeight:252},description:{story:"\nIf only a subset of the list items is navigable you should indicate them with an arrow icon. To display navigation indicators, add the `fd-list--navigation-indication` modifier class to the unordered list element. Do not show indicators if all items are navigable. In this case, use a standard list with navigation (in the example above).\n"}}};const i=()=>gt;i.storyName="Action";i.parameters={docs:{story:{iframeHeight:600},description:{story:"\nStandard list items can display actions that users can choose from. To display actions, add the `fd-list__item--action` modifier class to the list elements.\n"}}};const e=()=>xt;e.storyName="Secondary data";e.parameters={docs:{story:{iframeHeight:210},description:{story:"To display secondary data in standard list items, add a span element with `fd-list__secondary` class within the list elements. The secondary data can also be a status message by adding the appropriate modifiers. \n\n| **Status** | **Modifier class** |\n| :--------- | :---------- | \n| Neutral | `fd-list__secondary` |\n| Positive | `fd-list__secondary fd-list__secondary--positive` |\n| Critical | `fd-list__secondary fd-list__secondary--critical` |\n| Negative | `fd-list__secondary fd-list__secondary--negative` |\n| Informative | `fd-list__secondary fd-list__secondary--informative` |\n\n        "}}};const m=()=>ht;m.parameters={docs:{story:{iframeHeight:210},description:{story:`The item counter is vertically aligned within the list item, to the right. The maximum number of digits is 5. In case of more digits, the formatting and the transformation is left to the applications. It's recommended to avoid combining item counter to other list variations and status texts.
        `}}};const l=()=>bt;l.storyName="Icon";l.parameters={docs:{story:{iframeHeight:210},description:{story:"To display an icon inside standard list items, add the `fd-list__icon` class along with the icon within the list elements. For example, `fd-list__icon sap-icon—lightbulb`.\n        "}}};const a=()=>ut;a.storyName="Group";a.parameters={docs:{story:{iframeHeight:385},description:{story:"Standard list items can be displayed with headers, separating the items into groups. To add group headers, add the `fd-list__group-header` class to the list elements.\n        "}}};const _=()=>ft;_.parameters={docs:{story:{iframeHeight:240},description:{story:"The standard list can display a footer by adding a span element with an `fd-list__footer` class after the unordered list element.\n        "}}};const p=()=>pt;p.parameters={docs:{story:{iframeHeight:210},description:{story:"To display a borderless standard list, add the `fd-list--no-border` modifier class to the main element.\n        "}}};const f=()=>_t;f.parameters={docs:{story:{iframeHeight:370},description:{story:"Standard list items can display checkboxes that users can select from. To display standard list items with selection, add the `fd-list--selection` modifier class to the main element. To create checkbox form items, add the `fd-list__form-item` class within each list element.\n"}}};const u=()=>mt;u.parameters={docs:{story:{iframeHeight:370},description:{story:`Some list item can be made inactive, to make it non-clickable.
`}}};const n=()=>ct;n.storyName="Infinite scroll";n.parameters={docs:{story:{iframeHeight:380},description:{story:`If height for list is fixed and there are more list otem to show, then we should be able to scroll to next list items.
`}}};var b,h,x;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:"() => standardExampleHtml",...(x=(h=t.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};var g,y,v;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:"() => unreadExampleHtml",...(v=(y=o.parameters)==null?void 0:y.docs)==null?void 0:v.source}}};var L,S,H;d.parameters={...d.parameters,docs:{...(L=d.parameters)==null?void 0:L.docs,source:{originalSource:"() => interactiveExampleHtml",...(H=(S=d.parameters)==null?void 0:S.docs)==null?void 0:H.source}}};var k,I,w;r.parameters={...r.parameters,docs:{...(k=r.parameters)==null?void 0:k.docs,source:{originalSource:"() => navigationExampleHtml",...(w=(I=r.parameters)==null?void 0:I.docs)==null?void 0:w.source}}};var E,A,T;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:"() => buttonsExampleHtml",...(T=(A=c.parameters)==null?void 0:A.docs)==null?void 0:T.source}}};var N,z,U;s.parameters={...s.parameters,docs:{...(N=s.parameters)==null?void 0:N.docs,source:{originalSource:"() => navigationIndicatorExampleHtml",...(U=(z=s.parameters)==null?void 0:z.docs)==null?void 0:U.source}}};var D,q,F;i.parameters={...i.parameters,docs:{...(D=i.parameters)==null?void 0:D.docs,source:{originalSource:"() => actionListExampleHtml",...(F=(q=i.parameters)==null?void 0:q.docs)==null?void 0:F.source}}};var C,B,G;e.parameters={...e.parameters,docs:{...(C=e.parameters)==null?void 0:C.docs,source:{originalSource:"() => secondaryDataExampleHtml",...(G=(B=e.parameters)==null?void 0:B.docs)==null?void 0:G.source}}};var R,Y,P;m.parameters={...m.parameters,docs:{...(R=m.parameters)==null?void 0:R.docs,source:{originalSource:"() => itemCounterExampleHtml",...(P=(Y=m.parameters)==null?void 0:Y.docs)==null?void 0:P.source}}};var W,M,O;l.parameters={...l.parameters,docs:{...(W=l.parameters)==null?void 0:W.docs,source:{originalSource:"() => iconsExampleHtml",...(O=(M=l.parameters)==null?void 0:M.docs)==null?void 0:O.source}}};var X,j,J;a.parameters={...a.parameters,docs:{...(X=a.parameters)==null?void 0:X.docs,source:{originalSource:"() => groupsExampleHtml",...(J=(j=a.parameters)==null?void 0:j.docs)==null?void 0:J.source}}};var K,Q,V;_.parameters={..._.parameters,docs:{...(K=_.parameters)==null?void 0:K.docs,source:{originalSource:"() => footerExampleHtml",...(V=(Q=_.parameters)==null?void 0:Q.docs)==null?void 0:V.source}}};var Z,$,tt;p.parameters={...p.parameters,docs:{...(Z=p.parameters)==null?void 0:Z.docs,source:{originalSource:"() => borderlessExampleHtml",...(tt=($=p.parameters)==null?void 0:$.docs)==null?void 0:tt.source}}};var st,it,et;f.parameters={...f.parameters,docs:{...(st=f.parameters)==null?void 0:st.docs,source:{originalSource:"() => selectionExampleHtml",...(et=(it=f.parameters)==null?void 0:it.docs)==null?void 0:et.source}}};var lt,at,nt;u.parameters={...u.parameters,docs:{...(lt=u.parameters)==null?void 0:lt.docs,source:{originalSource:"() => inactiveExampleHtml",...(nt=(at=u.parameters)==null?void 0:at.docs)==null?void 0:nt.source}}};var ot,dt,rt;n.parameters={...n.parameters,docs:{...(ot=n.parameters)==null?void 0:ot.docs,source:{originalSource:"() => scrollExampleHtml",...(rt=(dt=n.parameters)==null?void 0:dt.docs)==null?void 0:rt.source}}};const zt=["Standard","Unread","Interactive","Navigation","Buttons","NavigationIndicator","ActionList","SecondaryData","ItemCounter","Icons","Groups","Footer","Borderless","Selection","Inactive","Scroll"];export{i as ActionList,p as Borderless,c as Buttons,_ as Footer,a as Groups,l as Icons,u as Inactive,d as Interactive,m as ItemCounter,r as Navigation,s as NavigationIndicator,n as Scroll,e as SecondaryData,f as Selection,t as Standard,o as Unread,zt as __namedExportsOrder,Nt as default};
//# sourceMappingURL=standard-list.stories-e136da22.js.map
