...
- The user needs to carry out a search. In this case, use the search field.
        `,tags:["f3","a11y","theme"]}},e=()=>o;e.storyName="Default";e.parameters={docs:{description:{story:"The standard input component can be displayed by using `fd-input` class"}}};const l=()=>d;l.parameters={docs:{storyDescription:`
...
//# sourceMappingURL=input.stories-6ba06bf4.js.map
