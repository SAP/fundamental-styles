/* empty css             *//* empty css                *//* empty css             */const i=`<div style="width: 400px; margin: auto;">
...
`,l={title:"Components/Progress Indicator",parameters:{description:`The progress indicator visualizes the current advancement of a process or a degree of accomplishment. The inside of the progress indicator is filled with color to indicate the state of progress. The advancement depends on the specific process. The progress is shown either using absolute numbers or the current percentage of completion together with a progress bar.
...
| Negative | \`fd-progress-indicator--negative\` |
        `,components:["progress-indicator","menu","popover","icon"],tags:[]}},s=()=>n;s.parameters={docs:{description:{story:`
