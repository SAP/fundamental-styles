/* empty css             *//* empty css               *//* empty css             */const e=`<div style="display: flex; justify-content: space-around; margin-bottom: 1rem; flex-wrap: wrap;">
...
`,a=`<div style="display: flex; justify-content: space-around; margin-bottom: 1rem; flex-wrap: wrap;">
...
</div>`,t=`<div style="display: flex; justify-content: space-around; margin-bottom: 1rem; flex-wrap: wrap;">
    <div class='fd-time'>
        <div class='fd-time__col'>
            <label class='fd-time__slider-label'>Hrs</label>
            <button class='fd-button fd-button fd-button--transparent' aria-label='Increase hours'>
...
`,m={title:"Components/Time",parameters:{description:`The time component is used to select a time value. It can be used to choose hours, minutes, seconds and/or a given period of the day. This component is rarely used alone and will likely be paired with the **Time Picker** pattern.
<br>
<br>
...
<br>
`,tags:["f3","a11y","theme"]}},i=()=>t;i.storyName="Default";i.parameters={docs:{description:{story:"The default time component is displayed in cozy mode, which is ideal for mobile screens.\n\nOnly one item and wrapper should be active at a time with the `fd-time__wrapper--active` modifier class. The rest of the items must be collapsed with the `fd-timeitem--collapsed` modifier class, displaying only the collapsed slider item (blue) next to the active item.\n\n**Note:** The meridian (AM/PM) wrapper must contain the `fd-time__wrapper--meridian` modifier class.\n        "}}};const s=()=>a;s.storyName="Tablet";s.parameters={docs:{description:{story:"Time can be optimized for tablet screens, which adds padding on each side of the component. To display the time component for tablet, add the `fd-time--tablet` modifier class to the main element.\n        "}}};const n=()=>e;n.storyName="Scrollable";n.parameters={docs:{description:{story:"Time can be scrollable by adding the `fd-time--scrollable` modifier class to the main element. It provides users with the ability to scroll up and down active columns with either a mouse, or on mobile where they can tap and release.\n        "}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => defaultCozyModeExampleHtml",...i.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => tabletModeExampleHtml",...s.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => scrollableModeExampleHtml",...n.parameters?.docs?.source}}};const c=["DefaultCozyMode","TabletMode","ScrollableMode"];export{i as DefaultCozyMode,n as ScrollableMode,s as TabletMode,c as __namedExportsOrder,m as default};
