...
`,tags:["f3","a11y","theme"]}},e=()=>V;e.storyName="Default";e.parameters={docs:{description:{story:"The default dialog component displays a container comprising a header, title, and subheader; followed by a body (content area), loader, footer and action buttons. The container also features a resize handle in the bottom-right corner of the footer, see resizable dialog below for more information."}}};const d=()=>R;d.parameters={docs:{description:{story:`
