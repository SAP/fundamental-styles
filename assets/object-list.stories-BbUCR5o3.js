/* empty css             *//* empty css             *//* empty css                          *//* empty css               *//* empty css                      *//* empty css                      *//* empty css                      */const a=`
...
`,u={title:"Components/Object List",parameters:{description:`
...
`,tags:["f3","a11y","theme","development"]}},t=()=>o;t.parameters={docs:{description:{story:"The standard object list item displays a title, introductory text, an avatar and object display components. It is recommended to display avatar in size S, therefore add the `fd-avatar--s` modifier class to the `fd-avatar` element."}}};const i=()=>l;i.parameters={docs:{description:{story:"An object list can display links that the users can navigate to. To display a navigation object list, add the `fd-list--navigation-object` modifier class together with `fd-list--navigation` and the `fd-list__item--link` modifier class to the list elements that contain a link. All items should be navigable."}}};const s=()=>c;s.parameters={docs:{description:{story:"Object list items can be selectable by adding the `fd-list--selection` and `fd-list--selection-row` modifier classes to the main element."}}};const e=()=>d;e.parameters={docs:{description:{story:"This object list is both selectable and navigable. To display selectable object list items with navigation, add the `fd-list--selection`, `fd-list--navigation` and `fd-list--navigation-object` modifier classes to the list and the `fd-list__item--link` modifier class to the list elements that contain links. All items should be navigable."}}};const n=()=>a;n.parameters={docs:{description:{story:"Object list items can be displayed without borders. To display a borderless list, add the `fd-list--no-border` modifier class to the list element."}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => standartExampleHtml",...t.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => navigationExampleHtml",...i.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => selectionExampleHtml",...s.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => selectionWithNavigationExampleHtml",...e.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => borderlessExampleHtml",...n.parameters?.docs?.source}}};const m=["Standard","Navigation","Selection","SelectionWithNavigation","Borderless"];export{n as Borderless,i as Navigation,s as Selection,e as SelectionWithNavigation,t as Standard,m as __namedExportsOrder,u as default};
