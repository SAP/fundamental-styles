/* empty css              *//* empty css                   *//* empty css                 *//* empty css                   */const n=`<fieldset class="fd-fieldset" id="radio1Truncation">
...
</fieldset>`,s=`<fieldset class="fd-fieldset" id="radio5a">
...
`,o=`<fieldset class="fd-fieldset" id="radio4">
...
`,l=`<fieldset class="fd-fieldset" id="radio1">
    <legend class="fd-fieldset__legend">Radio Buttons</legend>
    <div class="fd-form__group">
        <div class="fd-form-item">
...
</fieldset>`,p={title:"Components/Forms/Radio",parameters:{description:`
...
`,tags:[]}},a=()=>l;a.parameters={docs:{}};const i=()=>o;i.parameters={docs:{description:{story:`
...
`}}};const e=()=>s;e.parameters={docs:{description:{story:"A radio button can have different states that affect its appearance value states, such as “error” or “warning”, which are indicated using semantic colors"}}};const d=()=>n;d.parameters={docs:{description:{story:"By default, long radio label truncates with ellipsis. For this behaviour no modifier class is needed. For radio label that wraps on a new line to show the entire content, use `.fd-radio__label--wrap` modifier class applied with `.fd-radio__label`. Keep in mind that for this to work <b>max-width</b> should be set on the label. For a <b>top-left aligned</b> label use the `.fd-radio__label--wrap-top-aligned` modifier class."}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => primaryExampleHtml",...a.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => inlineExampleHtml",...i.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => interactionStatesExampleHtml",...e.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => textTruncationExampleHtml",...d.parameters?.docs?.source}}};const m=["Primary","Inline","InteractionStates","TextTruncation"];export{i as Inline,e as InteractionStates,a as Primary,d as TextTruncation,m as __namedExportsOrder,p as default};
