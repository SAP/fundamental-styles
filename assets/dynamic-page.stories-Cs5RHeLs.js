...
`,tags:["f3","theme","development"],components:["bar","breadcrumb","tabs","link","toolbar","title","icon","button","popover","facet","form-label","object-status","object-number","rating-indicator","avatar","margins","paddings","text","dynamic-page"]}},s=()=>h;s.parameters={docs:{description:{story:"The dynamic page displays on desktop screens with the L, XL, and XXL sizes. To optimize dynamic page for desktop, add modifier class `fd-dynamic-page--xl`.\n\nIn addition, add the modifier classes `--add-shadow` to the unordered list, and `--overflow` at the parent level for the box-shadow styling.\n"}}};const d=()=>v;d.parameters={docs:{description:{story:"The dynamic page displays on tablet screens with the M size. To optimize dynamic page for tablet, add modifier class `fd-dynamic-page--md`.\n\nIt is recommended that the navigation actions are displayed in a separate row above product actions, and are placed at the same level as the breadcrumb component."}}};const l=()=>g;l.parameters={docs:{description:{story:"The dynamic page displays on mobile screens with the S size. To optimize dynamic page for mobile, add modifier class `fd-dynamic-page--sm`.\n\nTo display the breadcrumb and close button, they must be wrapped in `fd-dynamic-page__breadcrumb-container`. The toolbar overflow actions are functional without being wrapped in an additional container.\nUse `fd-dynamic-page__toolbar--content` for the title content when it is used in an overflow toolbar."}}};const a=()=>_;a.storyName="Collapsed Header (mobile)";a.parameters={docs:{description:{story:"In the example below, the dynamic page is displayed with a collapsed header for mobile screens."}}};const e=()=>f;e.storyName="Summary Line (mobile)";e.parameters={docs:{description:{story:"It is recommended to add a summary line insead of the expand/collapse header feature so users can better focus on the page content. To display a summary line, add `fd-dynamic-page__summarized-title` in the `fd-dynamic-page__summarized-title-area` element."}}};const n=()=>b;n.storyName="Expanded Header";n.parameters={docs:{description:{story:"As demonstrated earlier, the dynamic page header can be either displayed or hidden with the expand/collapse buttons. Users can select the pin button to keep the header displayed (enabling the sticky feature). To collapse the dynamic page, add the `--collapsed` modifier class to the title area and title elements."}}};const r=()=>m;r.parameters={docs:{description:{story:"In the example below, the dynamic page is displayed with a collapsed header for desktop screens."}}};const i=()=>p;i.storyName="Without pin";i.parameters={docs:{description:{story:"The dynamic page can be displayed without a pin button, giving users the option to only expand or collapse the header area."}}};const t=()=>u;t.storyName="With header facets";t.parameters={docs:{description:{story:"To have the image from the image facet appear next to the title, add the class `fd-facet` and apply the modifiers `fd-facet--image` and `fd-facet--image-header-title` to the `fd-dynamic-page__title-container` class. Note that the dynamic page title and subtitle should be placed in the `fd-dynamic-page__title-subtitle-container` class for proper alignment with the image.\n"}}};const o=()=>c;o.storyName="With header facets (mobile)";s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => desktopExampleHtml",...s.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => tabletExampleHtml",...d.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"() => mobileExampleHtml",...l.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => mobileCollapsedExampleHtml",...a.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => summaryLineExampleHtml",...e.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => expandableExampleHtml",...n.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => collapsedHeaderExampleHtml",...r.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => onlyCollapseExampleHtml",...i.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => withFacetsExampleHtml",...t.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => withFacetsMobileExampleHtml",...o.parameters?.docs?.source}}};const F=["Desktop","Tablet","Mobile","MobileCollapsed","SummaryLine","Expandable","CollapsedHeader","OnlyCollapse","WithFacets","WithFacetsMobile"];export{r as CollapsedHeader,s as Desktop,n as Expandable,l as Mobile,a as MobileCollapsed,i as OnlyCollapse,e as SummaryLine,d as Tablet,t as WithFacets,o as WithFacetsMobile,F as __namedExportsOrder,P as default};
