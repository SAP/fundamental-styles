...
`;const u={title:"Components/Variant Management",parameters:{description:`Variants store filter settings which have been defined, for example, within the filter bar.
  ...
  `).join(`
`);a.storyName="Header sizes";a.parameters={docs:{story:{iframeHeight:700},description:{story:`
...
<p><strong>Variant management should by default have the Title control with fd-title--h3 class in dynamic page header
  and fd-title--h4 if used in table header/toolbar above tables.</strong></p>
          `}}};const t=()=>m;t.storyName="Dirty state";t.parameters={docs:{story:{iframeHeight:700},description:{story:`
...
<p>It can be either an asterisk sign, or a human-readable text.</p>
  ...
  \`).join('\\n');
}`,...(s=(i=a.parameters)==null?void 0:i.docs)==null?void 0:s.source}}};var r,o,d;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:"() => dirtyLabelExampleHtml",...(d=(o=t.parameters)==null?void 0:o.docs)==null?void 0:d.source}}};const f=["HeaderSizes","DirtyLabel"];export{t as DirtyLabel,a as HeaderSizes,f as __namedExportsOrder,u as default};
//# sourceMappingURL=variant-management.stories-793f5d5b.js.map
