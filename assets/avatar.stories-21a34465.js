...
`,fa={title:"Components/Avatar",parameters:{description:`The avatar component displays an image, icon or user initials, and is used for user profiles, placeholder images, icons or business-related images i.e. product photos. <br>
...
`,a=()=>da;a.parameters={docs:{story:{iframeHeight:200},description:{story:'The icon avatar can be used to display non-interactive icons. If you want the icon to be interactive, use the **Button** component with an icon inside instead. <br><br>When using the icon avatar for illustrative purposes only, include `role="presentation"` in the element.'}}};const r=()=>oa;r.parameters={docs:{story:{iframeHeight:200},description:{story:"The initials avatar can display up to three alphabetical characters representing the first and last name(s) of a person, for example: MvV for Marjolein van Veen. The order in which the first and last name(s) are displayed depends on the language-specific settings.<br><br> When there is no equivalent text for the avatar, include `aria-label` in the element. This isn’t necessary if the avatar is used for illustrative purposes only. See **Icon** above."}}};const e=()=>sa;e.parameters={docs:{story:{iframeHeight:200},description:{story:"A circle style can be displayed by adding the `fd-avatar--circle` modifier class to the `fd-avatar` base class."}}};const l=()=>ia;l.parameters={docs:{story:{iframeHeight:200},description:{story:"\nA background image can be displayed by adding the `fd-avatar--thumbnail` modifier class.\nThere are two options to set the background: Cover (default) and Contain.\n\n- <b>Cover:</b> The size of the image is scaled up to completely cover the control area. As a result, parts of the image may be outside the shape.\n- <b>Contain:</b> The image is scaled down to fit into the control area. The entire image is displayed, but might not fully fill the shape. In this case, the control displays a default background color. The image itself is always centered inside the shape.\n\nChanging the default `background-size: cover` to `background-size: contain` CSS property can be achieved by adding `fd-avatar--background-contain` modifier class."}}};const t=()=>na;t.parameters={docs:{story:{iframeHeight:200},description:{story:"A transparent style can be displayed by adding the `fd-avatar--transparent` modifier class to the `fd-avatar` base class. This can be useful for displaying descriptive illustrations and decorative pictures, for example."}}};const n=()=>ta;n.parameters={docs:{story:{iframeHeight:200},description:{story:"An avatar with a placeholder background can be displayed by adding the `fd-avatar--placeholder` modifier class."}}};const i=()=>la;i.parameters={docs:{story:{iframeHeight:200},description:{story:"An avatar with a tile icon background can be displayed by adding the `fd-avatar--tile` modifier class."}}};const s=()=>ea;s.parameters={docs:{story:{iframeHeight:200},description:{story:"To change the accent background color, add the `fd-avatar--accent-color-*` class with the number indicating the desired color. The color options include numbers ranging from 1 to 10, for example: `fd-avatar--accent-color-10`."}}};const o=()=>ra;o.parameters={docs:{story:{iframeHeight:200},description:{story:"When used in Shell header context, an additional modifier class `fd-avatar--shell` should be added to the `fd-avatar` base class and the modifier class specifying the accent color `fd-avatar--accent-color-*`."}}};const d=()=>aa;d.parameters={docs:{story:{iframeHeight:200},description:{story:`If an avatar is clickable, you can show an optional badge and icon. 
            The badge indicates that the avatar is interactive and the icon indicates the action triggered by clicking the avatar. This feature gives users visual affordance of the available action, and is particularly useful for images.`}}};const c=()=>Q;c.parameters={docs:{story:{iframeHeight:200},description:{story:"Value States can be added to the Avatar badge. <br>For <b>positive</b> value state use the `.fd-avatar__zoom-icon--positive` modifier class with the `fd-avatar__zoom-icon` base class. <br>For <b>caution</b> value state apply the `.fd-avatar__zoom-icon--caution` modifier class. <br>The <b>negative</b> value state can be achieved with `.fd-avatar__zoom-icon--negative` modifier class. <br><b>Information</b> value state would require adding `.fd-avatar__zoom-icon--information` to the `fd-avatar__zoom-icon` base class."}}};const v=()=>N;v.parameters={docs:{story:{iframeHeight:200},description:{story:"You can add a very subtle border to the avatar with the `fd-avatar--border` modifier class."}}};const p=()=>`${ca}
<h3>Regular State</h3>
<span class="fd-avatar fd-avatar--xs fd-avatar--circle fd-avatar--accent-color-1" tabindex="0" role="button" aria-label="Avatar">
    <i class="fd-avatar__icon sap-icon--money-bills" role="presentation" aria-hidden="true" aria-label="Image placeholder"></i>
</span>
...
`;p.parameters={docs:{story:{iframeHeight:200},description:{story:""}}};var f,b,m;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:"() => iconExampleHtml",...(m=(b=a.parameters)==null?void 0:b.docs)==null?void 0:m.source}}};var h,u,g;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:"() => initialsExampleHtml",...(g=(u=r.parameters)==null?void 0:u.docs)==null?void 0:g.source}}};var W,_,x;e.parameters={...e.parameters,docs:{...(W=e.parameters)==null?void 0:W.docs,source:{originalSource:"() => circleExampleHtml",...(x=(_=e.parameters)==null?void 0:_.docs)==null?void 0:x.source}}};var y,I,A;l.parameters={...l.parameters,docs:{...(y=l.parameters)==null?void 0:y.docs,source:{originalSource:"() => backgroundImageExampleHtml",...(A=(I=l.parameters)==null?void 0:I.docs)==null?void 0:A.source}}};var k,z,S;t.parameters={...t.parameters,docs:{...(k=t.parameters)==null?void 0:k.docs,source:{originalSource:"() => transparentExampleHtml",...(S=(z=t.parameters)==null?void 0:z.docs)==null?void 0:S.source}}};var E,H,w;n.parameters={...n.parameters,docs:{...(E=n.parameters)==null?void 0:E.docs,source:{originalSource:"() => placeholderBackgroundExampleHtml",...(w=(H=n.parameters)==null?void 0:H.docs)==null?void 0:w.source}}};var T,C,D;i.parameters={...i.parameters,docs:{...(T=i.parameters)==null?void 0:T.docs,source:{originalSource:"() => tileIconBackgroundExampleHtml",...(D=(C=i.parameters)==null?void 0:C.docs)==null?void 0:D.source}}};var L,J,M;s.parameters={...s.parameters,docs:{...(L=s.parameters)==null?void 0:L.docs,source:{originalSource:"() => accentColorsExampleHtml",...(M=(J=s.parameters)==null?void 0:J.docs)==null?void 0:M.source}}};var B,F,V;o.parameters={...o.parameters,docs:{...(B=o.parameters)==null?void 0:B.docs,source:{originalSource:"() => accentColorsShellHeaderContextExampleHtml",...(V=(F=o.parameters)==null?void 0:F.docs)==null?void 0:V.source}}};var Y,j,P;d.parameters={...d.parameters,docs:{...(Y=d.parameters)==null?void 0:Y.docs,source:{originalSource:"() => zoomIconExampleHtml",...(P=(j=d.parameters)==null?void 0:j.docs)==null?void 0:P.source}}};var U,q,R;c.parameters={...c.parameters,docs:{...(U=c.parameters)==null?void 0:U.docs,source:{originalSource:"() => valueStatesExampleHtml",...(R=(q=c.parameters)==null?void 0:q.docs)==null?void 0:R.source}}};var X,Z,$;v.parameters={...v.parameters,docs:{...(X=v.parameters)==null?void 0:X.docs,source:{originalSource:"() => bordersExampleHtml",...($=(Z=v.parameters)==null?void 0:Z.docs)==null?void 0:$.source}}};var G,O,K;p.parameters={...p.parameters,docs:{...(G=p.parameters)==null?void 0:G.docs,source:{originalSource:`() => \`\${localStyles}
<h3>Regular State</h3>
<span class="fd-avatar fd-avatar--xs fd-avatar--circle fd-avatar--accent-color-1" tabindex="0" role="button" aria-label="Avatar">
    <i class="fd-avatar__icon sap-icon--money-bills" role="presentation" aria-hidden="true" aria-label="Image placeholder"></i>
</span>
...
//# sourceMappingURL=avatar.stories-21a34465.js.map
