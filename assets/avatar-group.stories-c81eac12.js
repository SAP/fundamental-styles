/* empty css               *//* empty css             *//* empty css               *//* empty css                *//* empty css            *//* empty css                    *//* empty css              *//* empty css                   *//* empty css             *//* empty css                         *//* empty css                   *//* empty css                  *//* empty css                   *//* empty css              */const k=`<div style="min-height: 300px;">
    <div class="fd-avatar-group fd-avatar-group--individual-type fd-avatar-group--s">
        ...
        <div class="fd-popover">
            <div class="fd-popover__control">
                <span 
                    class="fd-avatar fd-avatar--s fd-avatar--circle fd-avatar--border fd-avatar--thumbnail" style="background-image: url('/assets/images/portraits/L_80x80_M1.png')" 
                    role="button" 
                    alt="Christian Bow" 
                    title="Christian Bow"
                    tabindex="0">
        ...
        <div class="fd-popover">
            <div class="fd-popover__control">
                <span 
                    class="fd-avatar fd-avatar--s fd-avatar--circle fd-avatar--border" role="button" 
        ...
        <div class="fd-popover">
            <div class="fd-popover__control">
                <span 
                    class="fd-avatar fd-avatar--s fd-avatar--circle fd-avatar--overflow" tabindex="0" 
                    role="button">+4
                </span>
            </div>
        </div>
    ...
    <div class="fd-avatar-group fd-avatar-group--individual-type fd-avatar-group--s">
        ...
        <div class="fd-popover">
            <div class="fd-popover__control">
                <span 
                    class="fd-avatar fd-avatar--accent-color-5 fd-avatar--s fd-avatar--circle fd-avatar--overflow" tabindex="0" 
                    role="button">+4
                </span>
            </div>
        </div>
    ...
    <div class="fd-avatar-group fd-avatar-group--individual-type fd-avatar-group--s">
        ...
        <div class="fd-popover">
            <div class="fd-popover__control">
                <span 
                    class="fd-avatar fd-avatar--s fd-avatar--overflow" tabindex="0" 
                    role="button">+4
                </span>
            </div>
        </div>
    ...
    <div class="fd-avatar-group fd-avatar-group--individual-type fd-avatar-group--s">
        ...
        <div class="fd-popover">
            <div class="fd-popover__control">
                <span 
                    class="fd-avatar fd-avatar--s fd-avatar--accent-color-8 fd-avatar--overflow" tabindex="0" 
                    role="button">+4
                </span>
            </div>
        </div>
...
`,J=`<div style="min-height: 400px;">
    ...
    <div class="fd-popover">
        <div class="fd-popover__control fd-avatar-group__popover-control"
            ...
            <div class="fd-avatar-group fd-avatar-group--group-type fd-avatar-group--m">
                <span 
                    class="fd-avatar fd-avatar--m fd-avatar--circle fd-avatar--accent-color-1" 
                    role="img" 
                    aria-label="Wendy Wallace" 
                    title="Wendy Wallace">WW
                </span>
                ...
                <span 
                    class="fd-avatar fd-avatar--m fd-avatar--circle fd-avatar--accent-color-2" 
                    role="img" 
                ...
                <span 
                    class="fd-avatar fd-avatar--m fd-avatar--circle fd-avatar--thumbnail" style="background-image: url('/assets/images/portraits/L_80x80_M1.png')" 
                    role="img" 
                    alt="John Doe" 
                    title="John Doe">
                </span>
    ...
    <br><br><div><b>Hover</b></div><br>
    <div class="fd-popover">
        <div class="fd-popover__control fd-avatar-group__popover-control"
            role="button"
            tabindex="0"
            aria-label="Avatar Group">
            <div class="fd-avatar-group fd-avatar-group--group-type fd-avatar-group--m is-hover">
    ...
    <br><br><div><b>Active</b></div><br>
    <div class="fd-popover">
        <div class="fd-popover__control fd-avatar-group__popover-control"
            role="button"
            tabindex="0"
            aria-label="Avatar Group">
            <div class="fd-avatar-group fd-avatar-group--group-type fd-avatar-group--m is-active">
                <span 
                    class="fd-avatar fd-avatar--m fd-avatar--circle fd-avatar--accent-color-1" 
                    role="img" 
                    aria-label="Wendy Wallace" 
    ...
    <br><br><div><b>Disabled</b></div><br>
    <div class="fd-popover">
        <div class="fd-popover__control fd-avatar-group__popover-control"
            role="button"
            tabindex="0"
            aria-label="Avatar Group">
            <div class="fd-avatar-group fd-avatar-group--group-type fd-avatar-group--m is-disabled">
                <span 
                    class="fd-avatar fd-avatar--m fd-avatar--circle fd-avatar--accent-color-1" 
                    role="img" 
                    aria-label="Wendy Wallace" 
    ...
    <br><br><div><b>Focus</b></div><br>
    <div class="fd-popover">
        <div class="fd-popover__control fd-avatar-group__popover-control"
            role="button"
            tabindex="0"
            aria-label="Avatar Group">
            <div class="fd-avatar-group fd-avatar-group--group-type fd-avatar-group--m is-focus">
                <span 
                    class="fd-avatar fd-avatar--m fd-avatar--circle fd-avatar--accent-color-1" 
                    role="img" 
                    aria-label="Wendy Wallace" 
...
`,C=`<div class="is-compact">
    
    <div dir="ltr">
        <div style="min-height: 400px; max-width: 3.25rem;">
        <div class="fd-avatar-group fd-avatar-group--individual-type fd-avatar-group--s fd-avatar-group--vertical">
            <div class="fd-popover">
                <div class="fd-popover__control">
                    <span 
                        class="fd-avatar fd-avatar--s fd-avatar--circle fd-avatar--border" 
                        ...
                        aria-haspopup="true" 
                        aria-expanded="false" 
                        onclick="onPopoverClick('popover_avatar_5z28edb-v');">WW
                    </span>
                </div>
                ...
                <div class="fd-popover__body fd-popover__body--after fd-popover__body--arrow-left" aria-hidden="true" id="popover_avatar_spbw4q-v">
                    <div class="fd-quick-view">
                        ...
                        <div class="fd-quick-view__content">
                            <div class="fd-bar fd-bar--header-with-subheader">
                                <div class="fd-bar__left">
                                    <span class="fd-avatar fd-avatar--s fd-avatar--circle fd-avatar--border" role="img" aria-label="Wendy Wallace" title="Wendy Wallace">WW</span>
                                    <div class="fd-quick-view__subheader-text">
                ...
                <div class="fd-popover__body fd-popover__body--after fd-popover__body--arrow-left" aria-hidden="true" id="popover_avatar_qc1f1jf-v">
                    <div class="fd-quick-view">
                        ...
                        <div class="fd-quick-view__content">
                            <div class="fd-bar fd-bar--header-with-subheader">
                                <div class="fd-bar__left">
                                    <span class="fd-avatar fd-avatar--s fd-avatar--circle fd-avatar--border" role="img" aria-label="Endy Wallace" title="Endy Wallace">EW</span>
                                    <div class="fd-quick-view__subheader-text">
            ...
            <div class="fd-popover">
                <div class="fd-popover__control">
                    <span 
                        class="fd-avatar fd-avatar--accent-color-2  fd-avatar--s fd-avatar--circle fd-avatar--overflow"
                        tabindex="0" 
                        role="button"
                        aria-haspopup="true" 
                        aria-expanded="false" 
                ...
                <div class="fd-popover__body fd-popover__body--after fd-popover__body--arrow-left" aria-hidden="true" id="popover_avatar_more_aoiwjth-v" style="width: 245px;">
    ...
    </div>`,M=`<div style="min-height: 400px;">
    <div class="fd-avatar-group fd-avatar-group--individual-type fd-avatar-group--s">
        <div class="fd-popover">
            <div class="fd-popover__control">
                <span 
                    ...
                    aria-haspopup="true" 
                    aria-expanded="false" 
                    onclick="onPopoverClick('popover_avatar_5z28edb');">WW
                </span>
            </div>
        ...
        <div class="fd-popover">
            <div class="fd-popover__control">
                <span 
                    class="fd-avatar fd-avatar--s fd-avatar--circle fd-avatar--overflow"
                    tabindex="0" 
                    role="button"
                    aria-haspopup="true" 
                    aria-expanded="false" 
...
`;const Y={title:"Components/Avatar Group",parameters:{description:`The avatar group displays a number of avatars, which act as a digital representation of a user. This control is useful for visualizing a team, project team members, or a group of employees, for example. <br />
...
`,docs:{story:{}},tags:["a11y","f3","theme"]}},a=()=>M;a.parameters={docs:{story:{},description:{story:"The avatar individual type consists of avatars and an overflow shape, depending on the use case. Each displayed avatar and the overflow shape have their own, individual click area. <br>For Individual type add the `fd-avatar-group--individual-type` modifier class to the `fd-avatar-group` base class."}}};const n=()=>C;n.parameters={docs:{story:{},description:{story:"For vertical orientation of the Avatar Group add the `fd-avatar-group--vertical` modifier class to the `fd-avatar-group` base class."}}};const r=()=>E;r.parameters={docs:{story:{},description:{story:"The avatar group type is one single click/tap area. This means that the entire control is the click/tap area. <br>For Group type add the `fd-avatar-group--group-type` modifier class to the `fd-avatar-group` base class."}}};const e=()=>D;e.parameters={docs:{story:{},description:{story:"For vertical orientation of the Avatar Group add the `fd-avatar-group--vertical` modifier class to the `fd-avatar-group` base class."}}};const d=()=>J;d.parameters={docs:{story:{},description:{story:""}}};const l=()=>k;l.parameters={docs:{description:{story:'The overflow Avatar inherits the styling of the secondary regular Button control. Applications can also choose to set the background color to a random or specific color from the Avatar. The span element has a `role="button"` and `fd-avatar--overflow` modifier class. '}}};var t,i,s;a.parameters={...a.parameters,docs:{...(t=a.parameters)==null?void 0:t.docs,source:{originalSource:"() => individualTypeExampleHtml",...(s=(i=a.parameters)==null?void 0:i.docs)==null?void 0:s.source}}};var o,v,c;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:"() => individualTypeVerticalExampleHtml",...(c=(v=n.parameters)==null?void 0:v.docs)==null?void 0:c.source}}};var f,p,b;r.parameters={...r.parameters,docs:{...(f=r.parameters)==null?void 0:f.docs,source:{originalSource:"() => groupTypeExampleHtml",...(b=(p=r.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};var m,_,u;e.parameters={...e.parameters,docs:{...(m=e.parameters)==null?void 0:m.docs,source:{originalSource:"() => groupTypeVerticalExampleHtml",...(u=(_=e.parameters)==null?void 0:_.docs)==null?void 0:u.source}}};var h,g,y;d.parameters={...d.parameters,docs:{...(h=d.parameters)==null?void 0:h.docs,source:{originalSource:"() => groupTypeInteractionStatesExampleHtml",...(y=(g=d.parameters)==null?void 0:g.docs)==null?void 0:y.source}}};var W,w,x;l.parameters={...l.parameters,docs:{...(W=l.parameters)==null?void 0:W.docs,source:{originalSource:"() => overflowExampleHtml",...(x=(w=l.parameters)==null?void 0:w.docs)==null?void 0:x.source}}};const O=["IndividualType","IndividualTypeVertical","GroupType","GroupTypeVertical","GroupTypeInteractionStates","Overflow"];export{r as GroupType,d as GroupTypeInteractionStates,e as GroupTypeVertical,a as IndividualType,n as IndividualTypeVertical,l as Overflow,O as __namedExportsOrder,Y as default};
//# sourceMappingURL=avatar-group.stories-c81eac12.js.map
