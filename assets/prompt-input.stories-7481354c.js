...
</div>`,C={title:"Components/Forms/Prompt Input",parameters:{description:`The Prompt Input component allows the user to write custom instructions in natural language, so that AI is guided to generate content tailored to user needs.
<br><b>Note: The component is in an experimental state.</b>
        `,tags:["ai","experimental"]}},a=()=>_;a.storyName="Basic Sample";a.parameters={docs:{description:{story:"The Prompt Input is built on top of [Input Group](https://fundamental-styles.netlify.app/?path=/docs/sap-fiori-components-forms-input-group--docs) and inherits its states (disabled, read-only, information, etc.)."}}};var e,d,u;a.parameters=o(r({},a.parameters),{docs:o(r({},(e=a.parameters)==null?void 0:e.docs),{source:r({originalSource:"() => basicExampleHtml"},(u=(d=a.parameters)==null?void 0:d.docs)==null?void 0:u.source)})});const k=["Basic"];export{a as Basic,k as __namedExportsOrder,C as default};
