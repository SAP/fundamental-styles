...
- You want to make sure that users read the message before they leave the page.
        `,tags:[]}},e=()=>t;e.storyName="Default";e.parameters={docs:{description:{story:`The default message toast displays a simple popup with non-interactive text. The text wraps once it reaches the max-width of 15rem.
