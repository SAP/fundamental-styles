/* empty css             */const d=`The display property of an element specifies its display behaviour. For more information prease refer to the
...
`,i={title:"Display",parameters:{description:d}},t=`
<style>
...
`,e=()=>`${t}${s}`;e.storyName="Display";e.parameters={docs:{description:{story:`
        `}}};const n=()=>`${t}${r}`;n.storyName="Screen-reader-only elements";n.parameters={docs:{description:{story:`The <code>.sap-sr-only</code> class will hide the element visually without hiding it from screen readers. <br><br><b>SCSS Mixin: </b><code>@include sap-sr-only();</code>
