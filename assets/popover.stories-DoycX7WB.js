/* empty css               *//* empty css            *//* empty css               *//* empty css             *//* empty css             *//* empty css                *//* empty css                         *//* empty css                    */const d=`<div style="display: flex; justify-content: center; padding: 100px 0 25px;">
...
`,r=`<div class="fd-popover" style="margin-bottom: 100px">
    <div class="fd-popover__control">
        <button
            class="fd-button"
...
</div>`,l=`<div style="display: flex; justify-content: center; padding: 100px 0 25px;">
    <div class="fd-popover">
        <div class="fd-popover__control">
            <button
                class="fd-button"
...
`,p=`<div class="fd-popover" style="margin-bottom: 300px">
    <div class="fd-popover__control">
        <button
            class="fd-button"
            aria-controls="popoverF1"
...
`,_=`<div class="fd-container" style="margin-bottom: 200px">
    <div class="fd-row">
...
`,c=`<div class="fddocs-container" style="margin-bottom: 400px">
    <div class="fd-popover">
        <div class="fd-popover__control">
            <button
...
`,v=`<div class="fd-container" style="margin-bottom: 400px">
    <div class="fd-row">
        <div class="fd-col--3 fd-col--offset-3">
...
`,tags:[]}},n=()=>c;n.storyName="Body variants";n.parameters={docs:{description:{story:`There are several variants of the popover body that can be displayed depending on the use case.
