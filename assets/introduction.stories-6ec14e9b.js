...
`,p={title:"Docs / Introduction",component:()=>null,parameters:{docs:{container:s,page:t(a),theme:n},previewTabs:{canvas:{hidden:!0}},viewMode:"docs",visualDisabled:!0,docsOnly:!0}},e={render:()=>"<div></div>",parameters:{title:"Overview",storyshots:{disable:!0},viewMode:"docs",docsOnly:!0}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  render: () => {
    /*
...
}`,...e.parameters?.docs?.source}}};const g=["Overview"];export{e as Overview,g as __namedExportsOrder,p as default};
