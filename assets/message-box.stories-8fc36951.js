/* empty css              *//* empty css            *//* empty css               *//* empty css             *//* empty css             */const m=`
...
`,h=`<div class="fd-message-box-docs-static fd-message-box fd-message-box--confirmation fd-message-box--active">
...
`,g=`<div class="fd-message-box-docs-static fd-message-box fd-message-box--active">
    <section class="fd-message-box__content">
        <header class="fd-bar fd-bar--header fd-message-box__header">
            <div class="fd-bar__left">
                <div class="fd-bar__element">
...
`;const y={title:"Components/Message Box",parameters:{description:`
...
- \`.fd-message-box\`: styles the backdrop and displays the message box container with \`position: fixed\`. The message box becomes visible by adding the \`.fd-message-box--active\` modifier class to the container.
    - \`.fd-message-box__content\`: Content container
        ...
        `,tags:["f3","a11y","theme"]}},n=200,e=()=>g;e.storyName="Default";e.parameters={docs:{story:{iframeHeight:n},description:{story:`
The default message box displays a small dialog with a title, message text and action buttons. Use the default if the message does not fit with one of the semantic types.
    `}}};const s=()=>h;s.storyName="Semantic types";s.parameters={docs:{story:{iframeHeight:n*6.5},description:{story:`
...
Information | \`fd-message-box--information\` | Information messages provide information the user needs to acknowledge, but which does not involve a decision. The message provides information that is useful and relevant, but never critical.
        ...
        `}}};const a=()=>m;a.parameters={docs:{story:{iframeHeight:n*4},description:{story:`
...
Enable cozy mode when message box is being displayed on mobile. To display message box in cozy mode, add the \`fd-bar--cozy\` modifier class to the header and footer (this will also apply to the buttons). It's also important to note that the content container should always take the full height and width of mobile screens. To achieve this, add the \`fd-message-box__content--mobile\` modifier class to the content container.
         `}}};var t,o,d;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:"() => structureExampleHtml",...(d=(o=e.parameters)==null?void 0:o.docs)==null?void 0:d.source}}};var i,r,c;s.parameters={...s.parameters,docs:{...(i=s.parameters)==null?void 0:i.docs,source:{originalSource:"() => typesExampleHtml",...(c=(r=s.parameters)==null?void 0:r.docs)==null?void 0:c.source}}};var b,f,l;a.parameters={...a.parameters,docs:{...(b=a.parameters)==null?void 0:b.docs,source:{originalSource:"() => responsiveExampleHtml",...(l=(f=a.parameters)==null?void 0:f.docs)==null?void 0:l.source}}};const w=["Structure","Types","Responsive"];export{a as Responsive,e as Structure,s as Types,w as __namedExportsOrder,y as default};
//# sourceMappingURL=message-box.stories-8fc36951.js.map
