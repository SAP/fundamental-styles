/* empty css                   *//* empty css                 *//* empty css                 */const d=`<fieldset class="fd-fieldset">
...
`,h={title:"Components/Forms/Checkbox",parameters:{description:`A checkbox lets the user set a binary value such as “true/false”. When the user selects the checkbox, it toggles between:
...
`;a.parameters={docs:{}};const s=()=>d;s.parameters={docs:{description:{story:"Checkboxes can display horizontally in a line. To display them this way, add the `fd-checkbox__label--inline` modifier class to the element."}}};const c=()=>`
${i}
...
`;c.parameters={docs:{description:{story:"Checkboxes can display several interaction states to communicate semantic meaning to the users. To display different states, add the classes below to the `fd-form-item`:\n\n| States | Class |\n| :----------------- | :------------------ |\n| Error | `fd-checkbox is-error` |\n| Success | `fd-checkbox is-success` |\n| Warning | `fd-checkbox is-warning` |\n| Information | `fd-checkbox is-information` |\n| Disabled | `fd-checkbox is-disabled` |\n"}}};const n=()=>`
${i}
<fieldset class="fd-fieldset">
...
`;n.parameters={docs:{description:{story:"By default, long checkbox label truncates with ellipsis. For this behaviour no modifier class is needed. For checkbox label that wraps on a new line to show the entire content, use `.fd-checkbox__label--wrap` modifier class applied with `.fd-checkbox__label`. Keep in mind that for this to work <b>max-width</b> should be set on the label. For a <b>top-left aligned</b> label use the `.fd-checkbox__label--wrap-top-aligned` modifier class.\n        "}}};const l=()=>`
${i}
<fieldset class="fd-fieldset">
...
`;l.parameters={docs:{description:{story:`In the Display Only Mode, the checkbox is replaced by two icons to represent the checked and unchecked states. The control becomes a simple icon. <br>Add the <code>.is-display</code> modifier class to <code>.fd-checkbox</code> for Display Only Mode.
        `}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => requiredExampleHtml",...e.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`() => \`
\${localStyles}
<fieldset class="fd-fieldset">
    <legend class="fd-fieldset__legend">Checkbox</legend>
    <div class="fd-form-group">
...
\``,...a.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => inlineExampleHtml",...s.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`() => \`
\${localStyles}
<div class="checkbox-example-container">
    <fieldset class="fd-fieldset">
        <legend class="fd-fieldset__legend">Error checkboxes</legend>
...
\``,...l.parameters?.docs?.source}}};const f=["Required","Default","Inline","States","TextTruncation","DisplayOnly"];export{a as Default,l as DisplayOnly,s as Inline,e as Required,c as States,n as TextTruncation,f as __namedExportsOrder,h as default};
