/* empty css             *//* empty css               *//* empty css                     */const n=`<p>Default state:</p>
...
`,s={title:"Components/Buttons/Button Split",parameters:{description:`The split menu button has two separate areas: the text label and the arrow down icon.
...
`,tags:[]}},t=()=>n;t.storyName="Split menu button";t.parameters={docs:{description:{story:`
`}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => splitMenuButtonExampleHtml",...t.parameters?.docs?.source}}};const i=["SplitMenuButton"];export{t as SplitMenuButton,i as __namedExportsOrder,s as default};
