/* empty css                *//* empty css              */const I=`<div class="docs-column-flex docs-layout-margins-paddings--padded">
...
`,j=`<div class="docs-column-flex docs-column-flex--align-start">
        <div class="docs-layout-margins-paddings--secondary-bg">
...
`,q=`<div class="docs-column-flex docs-column-flex--align-start">
        <div class="docs-layout-margins-paddings--secondary-bg">
...
`,G=`<div class="docs-column-flex docs-column-flex--align-start">
        <div class="docs-layout-margins-paddings--secondary-bg">
...
`,K=`<div class="docs-column-flex docs-column-flex--align-start">
        <div class="docs-layout-margins-paddings--secondary-bg">
...
`,V=`<div class="docs-column-flex docs-column-flex--align-start">
        <div class="docs-layout-margins-paddings--secondary-bg">
...
`,Z={title:"Layouts/Margins",parameters:{description:`The CSS margin properties are used to create space around elements, outside of any defined borders.
        With CSS, you have full control over the margins. There are properties for setting the margin for each side of an element.
        We now provide a number of predefined margin clases which add predefined margin values.`,tags:["f3","theme"]}},d=()=>V;d.storyName="All-Round Margin";d.parameters={docs:{description:{story:"All-round margin appears on all sides of the container they are applied to. Use `fd-margin`\n        class with any of the following modifiers:\n\n| Element | Modifier class | Margin applied |\n| ----------------: | :------------ | :------------ |\n| Tiny | `fd-margin--tiny` | 0.5rem |\n| Small | `fd-margin--sm` | 1rem |\n| Medium | `fd-margin--md` | 2rem |\n| Large | `fd-margin--lg` | 3rem |\n"}}};const n=()=>Q;n.storyName="Single-Sided Margin Top";n.parameters={docs:{description:{story:`Single sided margins appear on only one of the sides of the element:
...
`}}};const i=()=>K;i.storyName="Single-Sided Margin End";const o=()=>J;o.storyName="Single-Sided Margin Bottom";const e=()=>G;e.storyName="Single-Sided Margin Begin";const a=()=>F;a.storyName="Double-Sided Margin Top-Bottom";a.parameters={docs:{description:{story:`Double sided margins appear on two opposite sides of the element.

- top-bottom - displayed on top and bottom of the element
- begin-end - displayed on left and right side of the element

Use \`fd-margin-top-bottom\` or \`fd-margin-begin-end\` class with any of the size modifiers as mentioned above.`}}};const r=()=>q;r.storyName="Double-Sided Margin Begin-End";const g=()=>j;g.parameters={docs:{description:{story:'No margin classes remove existing container margins. Use `fd-margin--none` or  `fd-margin-top--none`\n        or `fd-margin-end--none` or `fd-margin-bottom--none` or `fd-margin-begin--none`\n        modifier classes to remove existing margin. Place the no margin classes last to make sure they will be applied.\n        In the case of `fd-margin-begin--none` and `fd-margin-end--none`, `!important` is not applied since we want\n        the user-specified margins(if any) to be reapplied in the RTL mode. Please note that for RTL to work correctly,\n        you must add `[dir="rtl"]` style on the class where these modifiers will be applied.'}}};const t=()=>O;t.parameters={docs:{description:{story:"The responsive margins class adds a margin around an element based on the width of the container the element is in. Use `fd-margin-responsive`\n        class with any of the following modifiers:\n\n| Element | Modifier class |\n| ----------------: | :------------ |\n| Small | `fd-margin-responsive--sm` |\n| Medium | `fd-margin-responsive--md` |\n| Large | `fd-margin-responsive--lg` |\n| Extra-large | `fd-margin-responsive--xl` |\n"}}};const s=()=>I;s.storyName="Double-Sided Negative Margin Begin-End";s.parameters={docs:{description:{story:"The negative margin class adds a double sided negative margin to an element. This is useful when aligning elements with built-in paddings.\n  Use `fd-margin-negative-begin-end` class with any of the size modifiers as mentioned above."}}};var l,c,m;d.parameters={...d.parameters,docs:{...(l=d.parameters)==null?void 0:l.docs,source:{originalSource:"() => allRoundMarginExampleHtml",...(m=(c=d.parameters)==null?void 0:c.docs)==null?void 0:m.source}}};var p,u,y;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:"() => singleSidedMarginTopExampleHtml",...(y=(u=n.parameters)==null?void 0:u.docs)==null?void 0:y.source}}};var v,f,b;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:"() => singleSidedMarginEndExampleHtml",...(b=(f=i.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var h,S,w;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:"() => singleSidedMarginBottomExampleHtml",...(w=(S=o.parameters)==null?void 0:S.docs)==null?void 0:w.source}}};var M,x,E;e.parameters={...e.parameters,docs:{...(M=e.parameters)==null?void 0:M.docs,source:{originalSource:"() => singleSidedMarginBeginExampleHtml",...(E=(x=e.parameters)==null?void 0:x.docs)==null?void 0:E.source}}};var B,H,_;a.parameters={...a.parameters,docs:{...(B=a.parameters)==null?void 0:B.docs,source:{originalSource:"() => doubleSidedMarginTopBottomExampleHtml",...(_=(H=a.parameters)==null?void 0:H.docs)==null?void 0:_.source}}};var T,N,D;r.parameters={...r.parameters,docs:{...(T=r.parameters)==null?void 0:T.docs,source:{originalSource:"() => doubleSidedMarginBeginEndExampleHtml",...(D=(N=r.parameters)==null?void 0:N.docs)==null?void 0:D.source}}};var P,R,U;g.parameters={...g.parameters,docs:{...(P=g.parameters)==null?void 0:P.docs,source:{originalSource:"() => noMarginExampleHtml",...(U=(R=g.parameters)==null?void 0:R.docs)==null?void 0:U.source}}};var L,A,z;t.parameters={...t.parameters,docs:{...(L=t.parameters)==null?void 0:L.docs,source:{originalSource:"() => responsiveMarginExampleHtml",...(z=(A=t.parameters)==null?void 0:A.docs)==null?void 0:z.source}}};var k,C,W;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:"() => doubleSidedNegativeMarginBeginEndExampleHtml",...(W=(C=s.parameters)==null?void 0:C.docs)==null?void 0:W.source}}};const $=["AllRoundMargin","SingleSidedMarginTop","SingleSidedMarginEnd","SingleSidedMarginBottom","SingleSidedMarginBegin","DoubleSidedMarginTopBottom","DoubleSidedMarginBeginEnd","NoMargin","ResponsiveMargin","DoubleSidedNegativeMarginBeginEnd"];export{d as AllRoundMargin,r as DoubleSidedMarginBeginEnd,a as DoubleSidedMarginTopBottom,s as DoubleSidedNegativeMarginBeginEnd,g as NoMargin,t as ResponsiveMargin,e as SingleSidedMarginBegin,o as SingleSidedMarginBottom,i as SingleSidedMarginEnd,n as SingleSidedMarginTop,$ as __namedExportsOrder,Z as default};
//# sourceMappingURL=margins.stories-148d039d.js.map
