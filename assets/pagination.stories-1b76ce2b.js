/* empty css               *//* empty css               *//* empty css             *//* empty css                   *//* empty css              *//* empty css                   *//* empty css                *//* empty css             */const k=`<div style="height: 200px;">
...
`,R={title:"Components/Pagination",parameters:{description:`Pagination allows users to separate their content into discrete pages, making it easier to digest and navigate through. Pagination is commonly used for tables and tiles.
...
<br>
<br>
      `,tags:["a11y","theme"]}},a=()=>L;a.storyName="First page";a.parameters={docs:{story:{iframeHeight:500},description:{story:`First and Previous page buttons are disabled when first page is active.
    `}}};const n=()=>C;n.storyName="Middle pages";n.parameters={docs:{story:{iframeHeight:500},description:{story:`Pagination can display middle pages to increase reachability.
    ...
    `}}};const t=()=>S;t.storyName="Last page";t.parameters={docs:{story:{iframeHeight:500},description:{story:`Last and Next page buttons are disabled when last page is active.
    `}}};const e=()=>G;e.storyName="Per page";e.parameters={docs:{story:{iframeHeight:500},description:{story:`Additionally, per page section can be displayed with select to specify which number of items should be shown on the every page.
    `}}};const i=()=>I;i.parameters={docs:{story:{iframeHeight:500},description:{story:`Showing pagination in Cozy mode is preferable on tablets & mobile.
    `}}};const s=()=>k;s.parameters={docs:{story:{iframeHeight:500},description:{story:"Pagination component is responsive by default. When the screen's size is smaller than 1024px in width mobile mode is shown and you have nothing to do.\n        If you want to display pagination component always in mobile mode please add `.fd-pagination--mobile` modifier class to the component.\n    "}}};var l,o,r;a.parameters={...a.parameters,docs:{...(l=a.parameters)==null?void 0:l.docs,source:{originalSource:"() => firstPageExampleHtml",...(r=(o=a.parameters)==null?void 0:o.docs)==null?void 0:r.source}}};var d,p,f;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:"() => middlePageExampleHtml",...(f=(p=n.parameters)==null?void 0:p.docs)==null?void 0:f.source}}};var b,g,c;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:"() => lastPageExampleHtml",...(c=(g=t.parameters)==null?void 0:g.docs)==null?void 0:c.source}}};var u,_,m;e.parameters={...e.parameters,docs:{...(u=e.parameters)==null?void 0:u.docs,source:{originalSource:"() => perPageExampleHtml",...(m=(_=e.parameters)==null?void 0:_.docs)==null?void 0:m.source}}};var h,v,P;i.parameters={...i.parameters,docs:{...(h=i.parameters)==null?void 0:h.docs,source:{originalSource:"() => cozyExampleHtml",...(P=(v=i.parameters)==null?void 0:v.docs)==null?void 0:P.source}}};var w,y,x;s.parameters={...s.parameters,docs:{...(w=s.parameters)==null?void 0:w.docs,source:{originalSource:"() => mobileExampleHtml",...(x=(y=s.parameters)==null?void 0:y.docs)==null?void 0:x.source}}};const q=["FirstPage","MiddlePage","LastPage","PerPage","Cozy","Mobile"];export{i as Cozy,a as FirstPage,t as LastPage,n as MiddlePage,s as Mobile,e as PerPage,q as __namedExportsOrder,R as default};
//# sourceMappingURL=pagination.stories-1b76ce2b.js.map
