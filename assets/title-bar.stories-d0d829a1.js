/* empty css             *//* empty css             *//* empty css               *//* empty css                *//* empty css                   *//* empty css                         */const u=`<div class="fd-toolbar fd-toolbar--clear fd-toolbar--title-bar" role="toolbar" aria-label="Left, center, and right-aligned toolbar">
...
</div>`,p=`<div style="max-width: 860px;">
    <div class="fd-toolbar fd-toolbar--clear fd-toolbar--title-bar" role="toolbar" aria-label="Left, center, and right-aligned toolbar">
        <div class="fd-title-bar">
            <div class="fd-title-bar__container">
...
</div>`,f=`<div style="max-width: 600px;">
    <div class="fd-toolbar fd-toolbar--clear fd-toolbar--title-bar" role="toolbar" aria-label="Left, center, and right-aligned toolbar">
        <div class="fd-title-bar">
            <div class="fd-title-bar__container">
                <button class="fd-button fd-button--transparent" aria-label="Back">
...
</div>`;const S={title:"BTP/Title Bar",parameters:{description:`Title Bar is a composite control that uses a toolbar as a container and a title for labeling. It varies from the standard title control in its bold visual state and text size. In addition, the title bar comes in three variants:
...
`,tags:["btp","development","horizon-only"]}},t=()=>u;t.parameters={docs:{description:{story:""}}};const n=()=>p;n.parameters={docs:{description:{story:""}}};const a=()=>f;a.parameters={docs:{description:{story:""}}};var o,s,e;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:"() => desktopExampleHtml",...(e=(s=t.parameters)==null?void 0:s.docs)==null?void 0:e.source}}};var l,i,r;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:"() => tabletExampleHtml",...(r=(i=n.parameters)==null?void 0:i.docs)==null?void 0:r.source}}};var b,d,c;a.parameters={...a.parameters,docs:{...(b=a.parameters)==null?void 0:b.docs,source:{originalSource:"() => mobileExampleHtml",...(c=(d=a.parameters)==null?void 0:d.docs)==null?void 0:c.source}}};const x=["Desktop","Tablet","Mobile"];export{t as Desktop,a as Mobile,n as Tablet,x as __namedExportsOrder,S as default};
//# sourceMappingURL=title-bar.stories-d0d829a1.js.map
