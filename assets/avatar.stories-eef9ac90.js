...
`,z={title:"BTP/Avatar",parameters:{description:`This is an extension to the <a href="https://fundamental-styles.netlify.app/?path=/docs/components-avatar--icon">Avatar</a> which introduces additional avatar sizes that are consumed by components and patterns in the BTP area. 
...
<br><br><br>
`,tags:["btp","horizon-only"]}},a=()=>I;a.parameters={docs:{story:{},description:{story:'The icon avatar can be used to display non-interactive icons. If you want the icon to be interactive, use the **Button** component with an icon inside instead. <br><br>When using the icon avatar for illustrative purposes only, include `role="presentation"` in the element.'}}};const e=()=>W;e.parameters={docs:{story:{},description:{story:"The initials avatar can display up to three alphabetical characters representing the first and last name(s) of a person, for example: MvV for Marjolein van Veen. The order in which the first and last name(s) are displayed depends on the language-specific settings.<br><br> When there is no equivalent text for the avatar, include `aria-label` in the element. This isn’t necessary if the avatar is used for illustrative purposes only. See **Icon** above."}}};const s=()=>H;s.parameters={docs:{story:{},description:{story:"A circle style can be displayed by adding the `fd-avatar--circle` modifier class to the `fd-avatar` base class."}}};const r=()=>C;r.parameters={docs:{story:{},description:{story:"\nA background image can be displayed by adding the `fd-avatar--thumbnail` modifier class.\nThere are two options to set the background: Cover (default) and Contain.\n\n- <b>Cover:</b> The size of the image is scaled up to completely cover the control area. As a result, parts of the image may be outside the shape.\n- <b>Contain:</b> The image is scaled down to fit into the control area. The entire image is displayed, but might not fully fill the shape. In this case, the control displays a default background color. The image itself is always centered inside the shape.\n\nChanging the default `background-size: cover` to `background-size: contain` CSS property can be achieved by adding `fd-avatar--background-contain` modifier class."}}};const n=()=>E;n.parameters={docs:{story:{},description:{story:"A transparent style can be displayed by adding the `fd-avatar--transparent` modifier class to the `fd-avatar` base class. This can be useful for displaying descriptive illustrations and decorative pictures, for example."}}};const t=()=>k;t.parameters={docs:{story:{},description:{story:"To change the accent background color, add the `fd-avatar--accent-color-*` class with the number indicating the desired color. The color options include numbers ranging from 1 to 10, for example: `fd-avatar--accent-color-10`."}}};var o,i,c;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:"() => iconExampleHtml",...(c=(i=a.parameters)==null?void 0:i.docs)==null?void 0:c.source}}};var l,p,d;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:"() => initialsExampleHtml",...(d=(p=e.parameters)==null?void 0:p.docs)==null?void 0:d.source}}};var v,f,m;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:"() => circleExampleHtml",...(m=(f=s.parameters)==null?void 0:f.docs)==null?void 0:m.source}}};var b,h,u;r.parameters={...r.parameters,docs:{...(b=r.parameters)==null?void 0:b.docs,source:{originalSource:"() => backgroundImageExampleHtml",...(u=(h=r.parameters)==null?void 0:h.docs)==null?void 0:u.source}}};var y,g,_;n.parameters={...n.parameters,docs:{...(y=n.parameters)==null?void 0:y.docs,source:{originalSource:"() => transparentExampleHtml",...(_=(g=n.parameters)==null?void 0:g.docs)==null?void 0:_.source}}};var A,x,T;t.parameters={...t.parameters,docs:{...(A=t.parameters)==null?void 0:A.docs,source:{originalSource:"() => accentColorsExampleHtml",...(T=(x=t.parameters)==null?void 0:x.docs)==null?void 0:T.source}}};const B=["Icon","Initials","Circle","BackgroundImage","Transparent","AccentColors"];export{t as AccentColors,r as BackgroundImage,s as Circle,a as Icon,e as Initials,n as Transparent,B as __namedExportsOrder,z as default};
//# sourceMappingURL=avatar.stories-eef9ac90.js.map
