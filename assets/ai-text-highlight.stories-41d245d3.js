var u=Object.defineProperty,p=Object.defineProperties;var c=Object.getOwnPropertyDescriptors;var o=Object.getOwnPropertySymbols;var f=Object.prototype.hasOwnProperty,_=Object.prototype.propertyIsEnumerable;var l=(a,e,n)=>e in a?u(a,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):a[e]=n,s=(a,e)=>{for(var n in e||(e={}))f.call(e,n)&&l(a,n,e[n]);if(o)for(var n of o(e))_.call(e,n)&&l(a,n,e[n]);return a},t=(a,e)=>p(a,c(e));/* empty css                 *//* empty css                 *//* empty css                   *//* empty css                     *//* empty css                  *//* empty css                   *//* empty css                *//* empty css             *//* empty css               *//* empty css             *//* empty css                */const v=`<div style="max-width: 80%;">
    <h4>Regular</h4>
...
</div>`,H={title:"AI/Patterns/Text Highlight",parameters:{description:`The AI Text Highlight pattern helps users differentiate between AI-generated and human-authored text. This clear distinction is vital for maintaining transparency and trust, especially as AI becomes more prevalent in applications. By visually distinguishing the two types of text, users can easily identify the source of the information, aiding in understanding the context and any potential biases. This pattern is especially useful in scenarios where both AI and human inputs are present.
<br><b>Note: The component is in an experimental state.</b>`,tags:["ai","experimental"]}},i=()=>v;i.parameters={docs:{description:{story:"The AI Text highlight pattern is always used on a block of text shown within components like Text Area, Rich Text Editor etc."}}};var r,d,m;i.parameters=t(s({},i.parameters),{docs:t(s({},(r=i.parameters)==null?void 0:r.docs),{source:s({originalSource:"() => aiTextHighlightExampleHtml"},(m=(d=i.parameters)==null?void 0:d.docs)==null?void 0:m.source)})});const S=["AITextHighlight"];export{i as AITextHighlight,S as __namedExportsOrder,H as default};
