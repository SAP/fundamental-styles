const U=`<div class="sap-docs-container">
    <h4>flex-end</h4>
...
`,V=`<div class="sap-docs-container">
...
`,X=`<div class="sap-docs-container">
...
`,Z=`<div class="sap-docs-container">
...
`,ee=`<div class="sap-docs-container">
...
`,te=`<div class="sap-docs-container">
    <h4>nowrap</h4>
...
`,de=`<div class="sap-docs-container">
...
`,ie=`<div class="sap-docs-container">
    <section class="sap-flex" style="max-width:30rem;">
        <div>1</div>
...
`,ne=`<div class="sap-docs-container">
    <section class="sap-flex" style="max-width:30rem;">
        <div>1</div>
...
`,se=`<div class="sap-docs-container">
...
`,ae=`<div class="sap-docs-container">
    <h4>row center</h4>
...
`,le={title:"Flex",parameters:{description:`The Flexbox Layout, commonly known as Flex, provides an efficient way to align and distribute elements within a container.
`}},e=`
<style>
...
`,t=()=>`${e}${V}`;t.storyName="Flex Container";t.parameters={docs:{description:{story:`To turn a parent element into a flex container apply the <code>.sap-flex</code> class to this element. <br>
            <b>SCSS Mixin:</b> 
            <code>@include  sap-flex()</code>
            `}}};const d=()=>`${e}${X}`;d.storyName="Flex Align Content (Flex Container)";d.parameters={docs:{description:{story:`
<table>
    <thead>
    <tr>
...
where <code>type</code> can be one of the following: <code>flex-start | flex-end | center | space-between | space-around | space-evenly | stretch | start | end | baseline</code>`}}};const i=()=>`${e}${se}`;i.storyName="Flex Align Items (Flex Container)";i.parameters={docs:{description:{story:`
<table>
    <thead>
    <tr>
        <th>Modifier Class</th>
...
where <code>type</code> can be one of the following: <code>flex-start | start | self-start | flex-end | end | self-end | center | baseline | stretch </code>`}}};const n=()=>`${e}${ae}`;n.storyName="Flex Center (Flex Container)";n.parameters={docs:{description:{story:`

<b>SCSS Mixin:</b> 
<code>@include sap-flex-center(direction)</code>;<br>
where <code>direction</code> can be one of the following: <code>row (default) | row-reverse | column | column-reverse</code>`}}};const s=()=>`${e}${Y}`;s.storyName="Flex Direction (Flex Container)";s.parameters={docs:{description:{story:`To specify the direction of the items placed in the flex container use one of the following modifier classes: <br><br>
            <table>
                <thead>
                <tr>
                    <th>Modifier Class</th>
            ...
            `}}};const a=()=>`${e}${Z}`;a.storyName="Flex Gap (Flex Container)";a.parameters={docs:{description:{story:`
<table>
    <thead>
    <tr>
        <th>Modifier Class</th>
...
</table>`}}};const l=()=>`${e}${ee}`;l.storyName="Flex Justify Content (Flex Container)";l.parameters={docs:{description:{story:`
<table>
    <thead>
    <tr>
        <th>Modifier Class</th>
...
where <code>type</code> can be one of the following: <code>flex-start(default) | flex-end | center | space-between | space-around | space-evenly | start | end | left | right</code>`}}};const r=()=>`${e}${te}`;r.storyName="Flex Wrap (Flex Container)";r.parameters={docs:{description:{story:`
<table>
    <thead>
    <tr>
        <th>Modifier Class</th>
...
where <code>type</code> can be one of the following: <code>nowrap(default) | wrap | wrap-reverse</code>`}}};const o=()=>`${e}${de}`;o.storyName="Flex Order (Flex Items)";o.parameters={docs:{description:{story:`
...
where <code>value</code> is an integer.`}}};const c=()=>`${e}${ie}`;c.storyName="Flex Shrink (Flex Items)";c.parameters={docs:{description:{story:`
...
where <code>value</code> is a positive integer.`}}};const v=()=>`${e}${ne}`;v.storyName="Flex Grow (Flex Items)";v.parameters={docs:{description:{story:`
...
where <code>value</code> is a positive integer.`}}};const p=()=>`${e}${U}`;p.storyName="Flex Align Self (Flex Items)";p.parameters={docs:{description:{story:`
...
where <code>value</code> can be one of the following <code>auto | flex-start | flex-end | center | baseline | stretch;</code>.`}}};var x,f,m;t.parameters={...t.parameters,docs:{...(x=t.parameters)==null?void 0:x.docs,source:{originalSource:"() => `${localStyles}${flexExampleHtml}`",...(m=(f=t.parameters)==null?void 0:f.docs)==null?void 0:m.source}}};var h,b,g;d.parameters={...d.parameters,docs:{...(h=d.parameters)==null?void 0:h.docs,source:{originalSource:"() => `${localStyles}${flexAlignContentExampleHtml}`",...(g=(b=d.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};var u,y,w;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:"() => `${localStyles}${flexAlignItemsExampleHtml}`",...(w=(y=i.parameters)==null?void 0:y.docs)==null?void 0:w.source}}};var S,F,$;n.parameters={...n.parameters,docs:{...(S=n.parameters)==null?void 0:S.docs,source:{originalSource:"() => `${localStyles}${flexCenterExampleHtml}`",...($=(F=n.parameters)==null?void 0:F.docs)==null?void 0:$.source}}};var C,E,H;s.parameters={...s.parameters,docs:{...(C=s.parameters)==null?void 0:C.docs,source:{originalSource:"() => `${localStyles}${flexDirectionExampleHtml}`",...(H=(E=s.parameters)==null?void 0:E.docs)==null?void 0:H.source}}};var j,k,M;a.parameters={...a.parameters,docs:{...(j=a.parameters)==null?void 0:j.docs,source:{originalSource:"() => `${localStyles}${flexGapExampleHtml}`",...(M=(k=a.parameters)==null?void 0:k.docs)==null?void 0:M.source}}};var A,N,D;l.parameters={...l.parameters,docs:{...(A=l.parameters)==null?void 0:A.docs,source:{originalSource:"() => `${localStyles}${flexJustifyExampleHtml}`",...(D=(N=l.parameters)==null?void 0:N.docs)==null?void 0:D.source}}};var T,G,I;r.parameters={...r.parameters,docs:{...(T=r.parameters)==null?void 0:T.docs,source:{originalSource:"() => `${localStyles}${flexWrapExampleHtml}`",...(I=(G=r.parameters)==null?void 0:G.docs)==null?void 0:I.source}}};var R,O,J;o.parameters={...o.parameters,docs:{...(R=o.parameters)==null?void 0:R.docs,source:{originalSource:"() => `${localStyles}${flexOrderExampleHtml}`",...(J=(O=o.parameters)==null?void 0:O.docs)==null?void 0:J.source}}};var L,W,q;c.parameters={...c.parameters,docs:{...(L=c.parameters)==null?void 0:L.docs,source:{originalSource:"() => `${localStyles}${flexShrinkExampleHtml}`",...(q=(W=c.parameters)==null?void 0:W.docs)==null?void 0:q.source}}};var _,z,B;v.parameters={...v.parameters,docs:{...(_=v.parameters)==null?void 0:_.docs,source:{originalSource:"() => `${localStyles}${flexGrowExampleHtml}`",...(B=(z=v.parameters)==null?void 0:z.docs)==null?void 0:B.source}}};var K,P,Q;p.parameters={...p.parameters,docs:{...(K=p.parameters)==null?void 0:K.docs,source:{originalSource:"() => `${localStyles}${flexAlignSelfExampleHtml}`",...(Q=(P=p.parameters)==null?void 0:P.docs)==null?void 0:Q.source}}};const re=["Flex","FlexAlignContent","FlexAlignItems","FlexCenter","FlexDirection","FlexGap","FlexJustify","FlexWrap","FlexOrder","FlexShrink","FlexGrow","FlexAlignSelf"];export{t as Flex,d as FlexAlignContent,i as FlexAlignItems,p as FlexAlignSelf,n as FlexCenter,s as FlexDirection,a as FlexGap,v as FlexGrow,l as FlexJustify,o as FlexOrder,c as FlexShrink,r as FlexWrap,re as __namedExportsOrder,le as default};
