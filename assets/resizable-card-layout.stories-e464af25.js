/* empty css               *//* empty css               *//* empty css              *//* empty css             *//* empty css                      *//* empty css                        *//* empty css              *//* empty css                 *//* empty css             *//* empty css             *//* empty css             */const u=`<div id="grid1" class="fd-resizable-card-layout">
...
`,m=`<div id="grid1" class="fd-resizable-card-layout">
...
Cards can be resized vertically in rows of 1 rem and horizontally in steps of 20 rem (minimum width).
        `,tags:["f3","theme","development"],components:["resizable-card-layout","button","avatar","badge","card","object-status","numeric-content","table","checkbox","list","link","icon"]}},a=()=>h;a.storyName="Resizable card layout";a.parameters={docs:{description:{story:`Resizable card layout with multiple cards.
        `}}};const i=()=>z;i.storyName="Card resize in horizontal and vertical directions";i.parameters={docs:{description:{story:`Cards can be resized in horizontal direction as well as vertical direction. Resize handle will expand on right border for horizontal resize and bottom border for vertical resize.
        `}}};const s=()=>m;s.storyName="Card resize in horizontal directions";s.parameters={docs:{description:{story:`Cards can also be resized in horizontal direction only. Resize handle will expand on right border.
        `}}};const e=()=>u;e.storyName="Card resize in vertical directions";e.parameters={docs:{description:{story:`Cards can be resized in vertical direction only. Resize handle will expand on bottom border.
...
//# sourceMappingURL=resizable-card-layout.stories-e464af25.js.map
