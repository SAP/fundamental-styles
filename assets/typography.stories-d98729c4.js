...
`;const z={title:"Typography",parameters:{description:`
      `}},e=()=>x;e.parameters={docs:{description:{story:`To set the <b>font-family</b> of an element use the <code>.sap-font-family-<i style="color: red;">type</i></code>class or the <code>@include sap-font-family(<i style="color: red;">type</i>)</code> mixin with <i style="color: red;">type</i> being one of the following:<br> regular | light | bold | semibold | semibold-duplex | monospaced-regular | monospaced-bold | black | header 
...
</table>`}}};const a=()=>h;a.parameters={docs:{description:{story:`In general, there is no line height applied to text, as the line height e.g. affects the padding.
...
`}}};const d=()=>b;d.parameters={docs:{description:{story:`<table style="width: 100%; border-collapse: collapse; margin-top: 1rem;">
    <tr>
...
</table>`}}};var s,n,l;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:"() => fontFamilyExampleHtml",...(l=(n=e.parameters)==null?void 0:n.docs)==null?void 0:l.source}}};var r,i,p;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:"() => fontSizeExampleHtml",...(p=(i=t.parameters)==null?void 0:i.docs)==null?void 0:p.source}}};var o,m,f;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:"() => lineHeightExampleHtml",...(f=(m=a.parameters)==null?void 0:m.docs)==null?void 0:f.source}}};var y,c,g;d.parameters={...d.parameters,docs:{...(y=d.parameters)==null?void 0:y.docs,source:{originalSource:"() => commonCasesExampleHtml",...(g=(c=d.parameters)==null?void 0:c.docs)==null?void 0:g.source}}};const H=["FontFamily","FontSize","LineHeight","CommonCases"];export{d as CommonCases,e as FontFamily,t as FontSize,a as LineHeight,H as __namedExportsOrder,z as default};
