/* empty css             *//* empty css              *//* empty css              *//* empty css            *//* empty css             *//* empty css               *//* empty css                *//* empty css                     *//* empty css               */const s=`<section class="fd-dialog-docs-static fd-dialog fd-settings fd-dialog--active">
...
</section>`,n=`<section class="fd-dialog-docs-static fd-dialog fd-settings fd-dialog--active">
    <div class="fd-dialog__content fd-settings__dialog-content" role="dialog" aria-modal="true" aria-labelledby="dialog-title-1" style="height: 800px;">
        <div class="fd-dialog__body fd-settings__dialog-body" >
            <div class="fd-settings__container">
                <div class="fd-settings__list-area">
...
</section>`,l=`<div style="display: flex; gap: 1rem; max-width: 1200px;">
...
</div>`,o=`<div style="display: flex; gap: 1rem; max-width: 1200px;">
            ...
            <div class="fd-dialog__body fd-settings__dialog-body">
                <div class="fd-settings__container fd-settings__container--sm">
                    <div class="fd-settings__detail-area">
                        ...
                        <section class="fd-icon-tab-bar__panel fd-settings__content fd-settings__content--no-background" id="section1" aria-labelledby="tab1">
                            Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?
...
</div>`,v={title:"Components/Settings",parameters:{description:`The Settings Dialog allows users to personalize their Fiori experience by adjusting various settings.<br><br> <h3>Layout and Structure</h3>
...
- <code>.fd-settings</code> applied on an element with class <code>.fd-dialog</code>
  - <code>.fd-settings\\_\\_dialog-content</code> applied on an element with class <code>.fd-dialog\\_\\_content</code>
    ...
    `,tags:["uxc"]}},i=()=>s;i.storyName="L-XL-XXL";i.parameters={docs:{description:{story:""}}};const t=()=>n;t.storyName="L-XL-XXL (with Tabs and overflowing content)";t.parameters={docs:{description:{story:""}}};const e=()=>l;e.storyName="MD";e.parameters={docs:{description:{story:""}}};const a=()=>o;a.storyName="SM";a.parameters={docs:{description:{story:""}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => defaultExampleHtml",...i.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => xlExampleHtml",...t.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => mdExampleHtml",...e.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => smExampleHtml",...a.parameters?.docs?.source}}};const g=["XLDefault","Xl","Md","Sm"];export{e as Md,a as Sm,i as XLDefault,t as Xl,g as __namedExportsOrder,v as default};
