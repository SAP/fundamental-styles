/* empty css             *//* empty css              *//* empty css               *//* empty css                        *//* empty css             */const D=`<div class="fddocs-container">
...
</div>`,K=`<h4>Link tile: Floating behaviour</h4>
...
</div>`,R=`<div class="fddocs-container">
...
</div>`,W=`<div class="fddocs-container">
...
</div>`,U=`<div class="fddocs-container">
    <div role="button" tabindex="0" class="fd-tile fd-tile--double fd-tile--feed">
        <div class="fd-tile__header">
            <div class="fd-tile__title">Title: Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</div>
            <div class="fd-tile__subtitle">Subtitle</div>
...
</div>`,j=`<h4>KPI tile with numeric content (size L)</h4>
...
`,V=`<h4>Launch tile with numeric content and launch icon</h4>
<br>
<div class="fddocs-container">
    <div role="button" tabindex="0" class="fd-tile fd-tile--launch">
        <div class="fd-tile__header">
...
</div>`,O=`<div class="fddocs-container">
...
</div>`,ie={title:"Components/Generic Tiles",parameters:{description:`
...
<br>
      `,tags:["f3","a11y","theme"],docs:{story:{iframeHeight:500}}}},e=()=>X;e.storyName="Sizes";e.parameters={docs:{story:{iframeHeight:500},description:{story:`
...
- Small tile (2 x 1) - 19 x 9.25rem
        `}}};const i=()=>J;i.storyName="Layout";i.parameters={docs:{story:{iframeHeight:500},description:{story:`
...
L | 4 characters can be displayed within numeric content.
        `}}};const d=()=>j;d.storyName="KPI tile";d.parameters={docs:{story:{iframeHeight:500},description:{story:`
...
**Note:** The KPI tile supports a limited number of characters, which varies depending on the tile size (see launch tile above for more details).
        `}}};const l=()=>U;l.storyName="Feed tile";l.parameters={docs:{story:{iframeHeight:500},description:{story:"The feed tile displays a news feed with a news headline, the source, and a time stamp. It shows new notifications in 10-second intervals, and tile content is updated every five minutes. If there are no new notifications, the most recent notifications are displayed. The feed tile’s headline uses the full width of the container and does not contain an icon. To display a feed tile, add the `fd-tile--feed` modifier class to the main element.\n        "}}};const s=()=>W;s.storyName="Badge tile";s.parameters={docs:{story:{iframeHeight:500},description:{story:`The badge tile displays very short and important information at the top right corner of the tile. It's recommended to add a badge to a tile when it has been newly added. Badges are not displayed when in action/edit mode.
        `}}};const a=()=>R;a.storyName="Slide tile";a.parameters={docs:{story:{iframeHeight:500},description:{story:`
...
When in action mode, default (floating) link tiles display the actions and close button immediately after the text. However, when they are in list format, link tiles display the actions and close button along the right side of the container. To display link tile in action mode, add \`fd-tile__action-container\` after the header element. Gradient masking is also supported in edit mode.
        ...
        `}}};const c=()=>D;c.storyName="Action mode";c.parameters={docs:{story:{iframeHeight:500},description:{story:"\nWhile a tile is in action mode, a close button is displayed on the top right-hand corner of the tile. The action icon is displayed on the bottom right-hand corner, and is only an indicator. The click/touch area fills the entire tile, excluding the area reserved for the close button. To display generic tile in action mode, add the `fd-tile--action` modifier class to the main element.\n        "}}};var r,v,_;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:"() => genericTileSizesExampleHtml",...(_=(v=e.parameters)==null?void 0:v.docs)==null?void 0:_.source}}};var f,u,p;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:"() => genericTileLayoutExampleHtml",...(p=(u=i.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};var m,b,h;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:"() => genericTileContentColumnsExampleHtml",...(h=(b=t.parameters)==null?void 0:b.docs)==null?void 0:h.source}}};var g,x,y;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:"() => launchTileExampleHtml",...(y=(x=n.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};var k,T,w;d.parameters={...d.parameters,docs:{...(k=d.parameters)==null?void 0:k.docs,source:{originalSource:"() => kpiTileExampleHtml",...(w=(T=d.parameters)==null?void 0:T.docs)==null?void 0:w.source}}};var S,q,L;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:"() => feedTileExampleHtml",...(L=(q=l.parameters)==null?void 0:q.docs)==null?void 0:L.source}}};var I,N,P;s.parameters={...s.parameters,docs:{...(I=s.parameters)==null?void 0:I.docs,source:{originalSource:"() => badgeTileExampleHtml",...(P=(N=s.parameters)==null?void 0:N.docs)==null?void 0:P.source}}};var A,H,F;a.parameters={...a.parameters,docs:{...(A=a.parameters)==null?void 0:A.docs,source:{originalSource:"() => slideTileExampleHtml",...(F=(H=a.parameters)==null?void 0:H.docs)==null?void 0:F.source}}};var M,E,z;o.parameters={...o.parameters,docs:{...(M=o.parameters)==null?void 0:M.docs,source:{originalSource:"() => linkTileExampleHtml",...(z=(E=o.parameters)==null?void 0:E.docs)==null?void 0:z.source}}};var B,C,G;c.parameters={...c.parameters,docs:{...(B=c.parameters)==null?void 0:B.docs,source:{originalSource:"() => tileInActionModeExampleHtml",...(G=(C=c.parameters)==null?void 0:C.docs)==null?void 0:G.source}}};const te=["GenericTileSizes","GenericTileLayout","GenericTileContentColumns","LaunchTile","KpiTile","FeedTile","BadgeTile","SlideTile","LinkTile","TileInActionMode"];export{s as BadgeTile,l as FeedTile,t as GenericTileContentColumns,i as GenericTileLayout,e as GenericTileSizes,d as KpiTile,n as LaunchTile,o as LinkTile,a as SlideTile,c as TileInActionMode,te as __namedExportsOrder,ie as default};
//# sourceMappingURL=generic-tile.stories-b521f003.js.map
