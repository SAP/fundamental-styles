...
`,t={title:"Border",parameters:{description:`Border utilities provide ready-to-use classes for commonly used border parameters—style, width, and color. In addition to these predefined classes, SCSS mixins are available for applying the same styles in custom classes, allowing flexibility while ensuring design consistency.
...
`}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => borderExampleHtml",...e.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => borderMixinExampleHtml",...d.parameters?.docs?.source}}};const i=["Border","BorderMixin"];export{e as Border,d as BorderMixin,i as __namedExportsOrder,t as default};
