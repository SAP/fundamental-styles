var D=Object.defineProperty,L=Object.defineProperties;var P=Object.getOwnPropertyDescriptors;var c=Object.getOwnPropertySymbols;var C=Object.prototype.hasOwnProperty,O=Object.prototype.propertyIsEnumerable;var f=(s,n,a)=>n in s?D(s,n,{enumerable:!0,configurable:!0,writable:!0,value:a}):s[n]=a,i=(s,n)=>{for(var a in n||(n={}))C.call(n,a)&&f(s,a,n[a]);if(c)for(var a of c(n))O.call(n,a)&&f(s,a,n[a]);return s},t=(s,n)=>L(s,P(n));/* empty css                  *//* empty css                    *//* empty css                *//* empty css               *//* empty css             *//* empty css              *//* empty css              *//* empty css                 *//* empty css               *//* empty css             *//* empty css                      */const B=`<div style="min-height: 300px;">
...
`,V={title:"Components/Grid List/Selection",parameters:{description:`
...
- You want to manage complex datasets that need to be extensively sorted, grouped, filtered, or edited. In this case, use a table.
    `,tags:["f3","a11y","theme","development"],components:["grid-list","layout-grid","toolbar","button","icon","title","radio","checkbox","avatar","link","object-status"]}},d=()=>R;d.storyName="None mode";d.parameters={docs:{description:{story:'Items cannot be selected but can still use "navigation", which allows click handling on specific items.'}}};const l=()=>U;l.storyName="Single select mode";l.parameters={docs:{description:{story:`
...
To turn on the Single select mode, add the \`fd-grid-list--mode-single-select\` modifier class to the main element.
        `}}};const e=()=>j;e.storyName="Single select left mode";e.parameters={docs:{description:{story:`
...
`}}};const o=()=>J;o.storyName="Single select right mode";o.parameters={docs:{description:{story:`
One item in the grid list can be selected. For this, the grid list provides radio buttons on the left side of each item toolbar.
To turn on the Single select right mode, add the \`fd-grid-list--mode-single-select-right\` modifier class to the main element.
`}}};const r=()=>B;r.storyName="Multi select mode";r.parameters={docs:{description:{story:`
...
`}}};var p,_,m;d.parameters=t(i({},d.parameters),{docs:t(i({},(p=d.parameters)==null?void 0:p.docs),{source:i({originalSource:"() => noneModeExampleHtml"},(m=(_=d.parameters)==null?void 0:_.docs)==null?void 0:m.source)})});var v,b,g;l.parameters=t(i({},l.parameters),{docs:t(i({},(v=l.parameters)==null?void 0:v.docs),{source:i({originalSource:"() => singleSelectMasterModeExampleHtml"},(g=(b=l.parameters)==null?void 0:b.docs)==null?void 0:g.source)})});var h,u,x;e.parameters=t(i({},e.parameters),{docs:t(i({},(h=e.parameters)==null?void 0:h.docs),{source:i({originalSource:"() => singleSelectLeftModeExampleHtml"},(x=(u=e.parameters)==null?void 0:u.docs)==null?void 0:x.source)})});var y,S,w;o.parameters=t(i({},o.parameters),{docs:t(i({},(y=o.parameters)==null?void 0:y.docs),{source:i({originalSource:"() => singleSelectRightModeExampleHtml"},(w=(S=o.parameters)==null?void 0:S.docs)==null?void 0:w.source)})});var k,A,M;r.parameters=t(i({},r.parameters),{docs:t(i({},(k=r.parameters)==null?void 0:k.docs),{source:i({originalSource:"() => multiSelectModeExampleHtml"},(M=(A=r.parameters)==null?void 0:A.docs)==null?void 0:M.source)})});const W=["NoneMode","SingleSelectMasterMode","SingleSelectLeftMode","SingleSelectRightMode","MultiSelectMode"];export{r as MultiSelectMode,d as NoneMode,e as SingleSelectLeftMode,l as SingleSelectMasterMode,o as SingleSelectRightMode,W as __namedExportsOrder,V as default};
