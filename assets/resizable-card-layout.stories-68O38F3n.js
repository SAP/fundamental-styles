/* empty css               *//* empty css               *//* empty css              *//* empty css             *//* empty css                      *//* empty css                        *//* empty css              *//* empty css                 *//* empty css             *//* empty css             *//* empty css             */const d=`<div id="grid1" class="fd-resizable-card-layout">
...
`,h={title:"Layouts/Resizable Card Layout",parameters:{description:`The resizable card layout is a layout for the overview page. It enables users to define a personalized card layout by changing not only the position of a card, but also its size, and thus how the card content is presented.
...
Cards can be resized vertically in rows of 1 rem and horizontally in steps of 20 rem (minimum width).
        `,tags:[],components:["resizable-card-layout","button","avatar","badge","card","object-status","numeric-content","table","checkbox","list","link","icon"]}},a=()=>l;a.storyName="Resizable card layout";a.parameters={docs:{description:{story:`Resizable card layout with multiple cards.
