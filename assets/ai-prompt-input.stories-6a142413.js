var l=Object.defineProperty,c=Object.defineProperties;var f=Object.getOwnPropertyDescriptors;var i=Object.getOwnPropertySymbols;var m=Object.prototype.hasOwnProperty,b=Object.prototype.propertyIsEnumerable;var s=(p,n,t)=>n in p?l(p,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):p[n]=t,r=(p,n)=>{for(var t in n||(n={}))m.call(n,t)&&s(p,t,n[t]);if(i)for(var t of i(n))b.call(n,t)&&s(p,t,n[t]);return p},o=(p,n)=>c(p,f(n));/* empty css               *//* empty css             *//* empty css             *//* empty css                     *//* empty css              *//* empty css                    *//* empty css                     *//* empty css                */const _=`<h4>User prompt with no input</h4>
<div>
...
</div>`,E={title:"AI/Components/Prompt Input",parameters:{description:`The Prompt Input component allows the user to write custom instructions in natural language, so that AI is guided to generate content tailored to user needs.
<br><b>Note: The component is in an experimental state.</b>`,tags:["ai","experimental"]}},a=()=>_;a.parameters={docs:{description:{story:"The Prompt Input is built on top of [Input Group](https://fundamental-styles.netlify.app/?path=/docs/sap-fiori-components-forms-input-group--docs) and inherits its states (disabled, read-only, information, etc.)."}}};var e,d,u;a.parameters=o(r({},a.parameters),{docs:o(r({},(e=a.parameters)==null?void 0:e.docs),{source:r({originalSource:"() => aiPromptInputExampleHtml"},(u=(d=a.parameters)==null?void 0:d.docs)==null?void 0:u.source)})});const U=["AIPromptInput"];export{a as AIPromptInput,U as __namedExportsOrder,E as default};
