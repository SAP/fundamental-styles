/* empty css              *//* empty css                   *//* empty css                  *//* empty css                     *//* empty css                *//* empty css              *//* empty css              *//* empty css                  *//* empty css                    *//* empty css                 *//* empty css             *//* empty css               *//* empty css             *//* empty css            *//* empty css               *//* empty css             *//* empty css             */const H=`<div style="min-height: 250px;">
...
`,I=`<section role="dialog" aria-labelledby="mobileModeMultiInputHeader"
...
`,O=`<div style="display:flex;height:250px;margin-top:1em;">
    <div>
...
`,Z={title:"Patterns/Multi Input",parameters:{description:`
...
`,tags:["f3","a11y","theme"],components:["input","form-label","form-item","form-message","popover","radio","title","token","tokenizer","input-group","checkbox","list","button","icon","bar","dialog","link","menu"]}},t=()=>X;t.parameters={docs:{story:{iframeHeight:900},description:{story:`
...
`}}};const e=()=>B;e.parameters={docs:{story:{iframeHeight:500},description:{story:"In cases where the list items need to be categorized into groups, it is possible to add headers for each category as seen below."}}};const n=()=>G;n.parameters={docs:{story:{iframeHeight:300},description:{story:"\nThe default length size of the popover body is often different from the text length.\nThe body length can be adjusted to match the text length by adding the `fd-popover__body--dropdown-fill` class to the `fd-popover__body`.\n\nThis class has been added to all the `Multi Input` examples above.\nIn the example you can see how the `Multi Input` component looks without the `fd-popover__body--dropdown-fill` modifier.\n"}}};const a=()=>O;a.parameters={docs:{story:{iframeHeight:100},description:{story:'\nTo make the `Multi Input` component read-only, the readonly attribute needs to be added to the `fd-nput-group` element.\nThis can also be done by using the `.is-readonly` class or `aria-readonly="true"` attribute.\n\nTo disable a `Multi Input` component, the disabled attribute needs to be added to the `fd-popover__control` and the `fd-input__control` elements.\nThe disabled state can also be achieved by adding the `.is-disabled` class or the `aria-disabled="true"` attribute.\n'}}};const s=()=>S;s.parameters={docs:{story:{iframeHeight:350},description:{story:"\nFor a complete list of states supported by the `Multi Input` component, please see the documentation for the form or select components.\n\nThe semantic mode can be used to modify the combobox component by adding one of\n`is-error` | `is-success` | `is-warning` | `is-information` classes into `fd-input-group` element.\nTo add text in the `body` of the component, simply include your text in the `fd-list__message` under the `ul` element."}}};const i=()=>I;i.parameters={docs:{story:{iframeHeight:450},description:{story:"\nFor mobile devices, or tablets, multi input component should be displayed in fullscreen mode.\nSo instead of using popover and dropdown, it should be wrapped in `dialog` and `bar` components."}}};const l=()=>H;l.parameters={docs:{story:{iframeHeight:300},description:{story:`
The user can filter selectable options by typing in the input. A button with the text "Show All" should be displayed, that when clicked, will clear the text in the input and show all options in the list.`}}};var o,d,r;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:"() => asFormItemExampleHtml",...(r=(d=t.parameters)==null?void 0:d.docs)==null?void 0:r.source}}};var c,p,b;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:"() => groupingExampleHtml",...(b=(p=e.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};var f,_,u;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:"() => matchPopoverBodySizeExampleHtml",...(u=(_=n.parameters)==null?void 0:_.docs)==null?void 0:u.source}}};var m,v,h;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:"() => readOnlyAndDisabledExampleHtml",...(h=(v=a.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var x,k,g;s.parameters={...s.parameters,docs:{...(x=s.parameters)==null?void 0:x.docs,source:{originalSource:"() => semanticExampleHtml",...(g=(k=s.parameters)==null?void 0:k.docs)==null?void 0:g.source}}};var y,z,A;i.parameters={...i.parameters,docs:{...(y=i.parameters)==null?void 0:y.docs,source:{originalSource:"() => mobileModeExampleHtml",...(A=(z=i.parameters)==null?void 0:z.docs)==null?void 0:A.source}}};var w,F,M;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:"() => filteringExampleHtml",...(M=(F=l.parameters)==null?void 0:F.docs)==null?void 0:M.source}}};const $=["AsFormItem","Grouping","MatchPopoverBodySize","ReadOnlyAndDisabled","Semantic","MobileMode","Filtering"];export{t as AsFormItem,l as Filtering,e as Grouping,n as MatchPopoverBodySize,i as MobileMode,a as ReadOnlyAndDisabled,s as Semantic,$ as __namedExportsOrder,Z as default};
//# sourceMappingURL=multi-input.stories-1c99610c.js.map
