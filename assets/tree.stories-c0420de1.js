/* empty css               *//* empty css                 *//* empty css             *//* empty css              */const y=`<ul role="tree" aria-label="Root Tree" id="TREE1RTLND1" class="fd-tree fd-tree--no-data">
...
`,w=`<h3>Left multi-selection(Dependent Selections)</h3>
...
<br>
`,tags:["f3","a11y","theme","development"]}},t=()=>z;t.parameters={docs:{description:{story:"\nThe primary tree component displays level 1 expanded to show level 2, which is indented by 1.5rem. Only the root tree (ul element) needs to have the `expanded-level-*` modifier class to indicate which level is currently expanded."}}};const n=()=>A;n.parameters={docs:{description:{story:"\nTree can be displayed without borders. To remove the borders from the first level items, add the `fd-tree--no-border` modifier class to the root tree. Additionally, tree list items can display actions, which are added as children of the `fd-tree__item-container` class.\n\n####Icons\nIcons can be added before and/or after the text as children of the `fd-tree__content` class.\n        "}}};const e=()=>R;e.storyName="Highlight indicators";e.parameters={docs:{description:{story:`
