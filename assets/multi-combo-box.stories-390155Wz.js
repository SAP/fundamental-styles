/* empty css                   *//* empty css                *//* empty css              *//* empty css              *//* empty css              *//* empty css                    *//* empty css                 *//* empty css             *//* empty css               *//* empty css             *//* empty css                  *//* empty css               *//* empty css            *//* empty css              *//* empty css                    *//* empty css             */const d=` <div style="height: 350px;">
...
`,r=`<div class="fd-dialog fd-dialog-docs-static fd-select-docs-max-height fd-dialog--active" id="select-dialog-example">
...
`,G={title:"Patterns/Multi ComboBox",parameters:{description:`
...
`,tags:[],components:["form-label","popover","radio","title","token","input-group","checkbox","list","button","icon","tokenizer","dialog","bar","input","layout-grid","link"]}},t=()=>u;t.parameters={docs:{description:{story:`
...
`}}};const e=()=>_;e.parameters={docs:{description:{story:"In cases where the list items need to be categorized into groups, it is possible to add headers for each category as seen below."}}};const n=()=>f;n.parameters={docs:{description:{story:"\nThe default length size of the popover body is often different from the text length.\nThe body length can be adjusted to match the text length by adding the `fd-popover__body--dropdown-fill` class to the `fd-popover__body`.\n\nThis class has been added to all the `Multi ComboBox` examples above.\nIn the example you can see how the `Multi ComboBox` component looks without the `fd-popover__body--dropdown-fill` modifier.\n"}}};const a=()=>b;a.parameters={docs:{description:{story:'\nTo make the `Multi ComboBox` component read-only, the readonly attribute needs to be added to the `fd-nput-group` element.\nThis can also be done by using the `.is-readonly` class or `aria-readonly="true"` attribute.\n\nTo disable a `Multi ComboBox` component, the disabled attribute needs to be added to the `fd-popover__control` and the `fd-input__control` elements.\nThe disabled state can also be achieved by adding the `.is-disabled` class or the `aria-disabled="true"` attribute.\n'}}};const s=()=>p;s.parameters={docs:{description:{story:"\nFor a complete list of states supported by the `Multi ComboBox` component, please see the documentation for the form or select components.\n\nThe semantic mode can be used to modify the combobox component by adding one of\n`is-error` | `is-success` | `is-warning` | `is-information` classes into `fd-input-group` element.\nTo add text in the `body` of the component, simply include your text in the `fd-list__message` under the `ul` element."}}};const i=()=>r;i.parameters={docs:{description:{story:"\nFor mobile devices, or tablets, Multi ComboBox component should be displayed in fullscreen mode.\nSo instead of using popover and dropdown, it should be wrapped in `dialog` and `bar` components."}}};const l=()=>c;l.parameters={docs:{description:{story:`
The user can filter selectable options by typing in the input. A button with the text "Show All" should be displayed, that when clicked, will clear the text in the input and show all options in the list.`}}};const o=()=>d;o.parameters={docs:{description:{story:`
The user can filter selectable having 2 options by typing in the input. A button with the text "Show All" should be displayed, that when clicked, will clear the text in the input and show all options in the list.`}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => asFormItemExampleHtml",...t.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => groupingExampleHtml",...e.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => matchPopoverBodySizeExampleHtml",...n.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => readOnlyAndDisabledExampleHtml",...a.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => semanticExampleHtml",...s.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => mobileModeExampleHtml",...i.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"() => filteringExampleHtml",...l.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => twoColumnComboBoxExampleHtml",...o.parameters?.docs?.source}}};const X=["AsFormItem","Grouping","MatchPopoverBodySize","ReadOnlyAndDisabled","Semantic","MobileMode","Filtering","TwoColumnComboBox"];export{t as AsFormItem,l as Filtering,e as Grouping,n as MatchPopoverBodySize,i as MobileMode,a as ReadOnlyAndDisabled,s as Semantic,o as TwoColumnComboBox,X as __namedExportsOrder,G as default};
