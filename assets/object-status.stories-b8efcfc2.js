/* empty css                      *//* empty css             */const J=`<div class="fddocs-container">
...
`,dt={title:"Components/Object Status",parameters:{description:`Object Status is a short text that represents the semantic status of an object. It has a semantic
color and an optional icon. Typically, the object status is used in the dynamic page header and as a status
attribute of a line item in a table. `,tags:["f3","a11y","theme"]}},s=()=>ct;s.parameters={docs:{description:{story:"\n  Object Status can display the semantic status of an object: negative (class: `fd-object-status--negative`), critical\n  (class: `fd-object-status--critical`), positive (class: `fd-object-status--positive`),\n  informative (class: `fd-object-status--informative`), or none.\n            "}}};const a=()=>et;a.parameters={docs:{description:{story:"Object status icon only"}}};const n=()=>nt;n.parameters={docs:{description:{story:"Object status text only"}}};const e=()=>at;e.parameters={docs:{description:{story:"Object status icon and text"}}};const c=()=>st;c.parameters={docs:{description:{story:"Object Status with Generic Indication Colors"}}};const o=()=>tt;o.parameters={docs:{description:{story:`
 ...
 `}}};const f=()=>$,i=()=>X;i.parameters={docs:{description:{story:`
 ...
 Inverted Object Status is achieved by adding the \`fd-object-status--inverted\` modifier class.
            `}}};const d=()=>Z;d.parameters={docs:{description:{story:`
 
            `}}};const b=()=>K;b.parameters={docs:{description:{story:"Inverted indication colors"}}};const u=()=>Q;u.parameters={docs:{description:{story:"Secondary Set of Inverted indication colors"}}};const t=()=>J;t.storyName="Object Status with single line text with ellipsis";t.parameters={docs:{description:{story:`
  By default, Object Status text goes on multiple lines based on the max width that is set for the element. For a single line text with ellipsis add the <code>fd-object-status--truncate</code> modifier class to the <code>fd-object-status</code> base class.
            `}}};var p,j,l;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:"() => primaryExampleHtml",...(l=(j=s.parameters)==null?void 0:j.docs)==null?void 0:l.source}}};var r,_,v;a.parameters={...a.parameters,docs:{...(r=a.parameters)==null?void 0:r.docs,source:{originalSource:"() => iconExampleHtml",...(v=(_=a.parameters)==null?void 0:_.docs)==null?void 0:v.source}}};var x,k,m;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:"() => textExampleHtml",...(m=(k=n.parameters)==null?void 0:k.docs)==null?void 0:m.source}}};var h,I,g;e.parameters={...e.parameters,docs:{...(h=e.parameters)==null?void 0:h.docs,source:{originalSource:"() => iconAndTextExampleHtml",...(g=(I=e.parameters)==null?void 0:I.docs)==null?void 0:g.source}}};var y,S,N;c.parameters={...c.parameters,docs:{...(y=c.parameters)==null?void 0:y.docs,source:{originalSource:"() => genericIndicationColorsExampleHtml",...(N=(S=c.parameters)==null?void 0:S.docs)==null?void 0:N.source}}};var C,w,O;o.parameters={...o.parameters,docs:{...(C=o.parameters)==null?void 0:C.docs,source:{originalSource:"() => clickableObjectStatusExampleHtml",...(O=(w=o.parameters)==null?void 0:w.docs)==null?void 0:O.source}}};var P,E,H;f.parameters={...f.parameters,docs:{...(P=f.parameters)==null?void 0:P.docs,source:{originalSource:"() => largeObjectStatusExampleHtml",...(H=(E=f.parameters)==null?void 0:E.docs)==null?void 0:H.source}}};var R,T,D;i.parameters={...i.parameters,docs:{...(R=i.parameters)==null?void 0:R.docs,source:{originalSource:"() => invertedExampleHtml",...(D=(T=i.parameters)==null?void 0:T.docs)==null?void 0:D.source}}};var G,B,A;d.parameters={...d.parameters,docs:{...(G=d.parameters)==null?void 0:G.docs,source:{originalSource:"() => invertedStatesExampleHtml",...(A=(B=d.parameters)==null?void 0:B.docs)==null?void 0:A.source}}};var F,Y,L;b.parameters={...b.parameters,docs:{...(F=b.parameters)==null?void 0:F.docs,source:{originalSource:"() => invertedIndicationExampleHtml",...(L=(Y=b.parameters)==null?void 0:Y.docs)==null?void 0:L.source}}};var W,z,M;u.parameters={...u.parameters,docs:{...(W=u.parameters)==null?void 0:W.docs,source:{originalSource:"() => invertedIndicationSecondaryExampleHtml",...(M=(z=u.parameters)==null?void 0:z.docs)==null?void 0:M.source}}};var U,V,q;t.parameters={...t.parameters,docs:{...(U=t.parameters)==null?void 0:U.docs,source:{originalSource:"() => truncateExampleExampleHtml",...(q=(V=t.parameters)==null?void 0:V.docs)==null?void 0:q.source}}};const bt=["Primary","Icon","Text","IconAndText","GenericIndicationColors","ClickableObjectStatus","LargeObjectStatus","Inverted","InvertedStates","InvertedIndication","InvertedIndicationSecondary","TruncateExample"];export{o as ClickableObjectStatus,c as GenericIndicationColors,a as Icon,e as IconAndText,i as Inverted,b as InvertedIndication,u as InvertedIndicationSecondary,d as InvertedStates,f as LargeObjectStatus,s as Primary,n as Text,t as TruncateExample,bt as __namedExportsOrder,dt as default};
//# sourceMappingURL=object-status.stories-b8efcfc2.js.map
