/* empty css               *//* empty css                      *//* empty css             *//* empty css             */const j=`<div class="fd-message-strip fd-message-strip--dismissible fd-message-strip--indication-color-1" role="note" aria-live="assertive" id="message-strip-17" aria-labelledby="message-strip-17">
...
`,B=`<div class="fd-message-strip fd-message-strip--dismissible" role="note" aria-live="assertive" id="message-strip-15" aria-labelledby="message-strip-15">
  <div class="fd-message-strip__icon-container" aria-hidden="true">
    <span class="sap-icon sap-icon--master-task-triangle-2" focusable="false" role="presentation" aria-hidden="true"></span>
  </div>
  <p class="fd-message-strip__text">
...
`,G=`<div class="fd-message-strip fd-message-strip--error fd-message-strip--dismissible fd-message-strip--link" role="note" aria-live="assertive" id="message-strip-14" aria-labelledby="message-strip-14">
  <div class="fd-message-strip__icon-container" aria-hidden="true">
...
`,P=`<div class="fd-message-strip fd-message-strip--information fd-message-strip--no-icon"
...
`,R=`<div class="fd-message-strip fd-message-strip--information fd-message-strip--no-icon fd-message-strip--dismissible"
...
`,O=`<div class="fd-message-strip fd-message-strip--warning fd-message-strip--dismissible" role="note" aria-live="assertive" id="message-strip-4" aria-labelledby="message-strip-4">
  <div class="fd-message-strip__icon-container" aria-hidden="true">
...
`,F=`<div class="fd-message-strip fd-message-strip--success fd-message-strip--dismissible" role="note" aria-live="assertive" id="message-strip-3" aria-labelledby="message-strip-3">
  <div class="fd-message-strip__icon-container" aria-hidden="true">
...
`,J=`<div class="fd-message-strip fd-message-strip--information fd-message-strip--dismissible" role="note" aria-live="assertive" id="message-strip-2" aria-labelledby="message-strip-2">
  <div class="fd-message-strip__icon-container" aria-hidden="true">
...
`,K=`<div class="fd-message-strip fd-message-strip--no-icon" role="note" aria-live="assertive" id="message-strip-1" aria-labelledby="message-strip-1">
  <p class="fd-message-strip__text">
    Vivamus sagittis diam in vehicula lobortis sapien arcu mattis erat vel aliquet sem urna et.
  </p>
</div>
`,ss={title:"Components/Message Strip",parameters:{description:`Message Strip is a component that enables the embedding of application-related messages in the application. They are useed to draw the user’s attention to information that is important in the context of the page content. This could be a warning or a change of state, that would be easy to miss it.
...
- <b>Close button (optional) </b>- each message can have a Close button so it can be removed from the UI, if needed. Add the \`.fd-message-strip--dismissible\` modifier class for a dismissible message strip.
        ...
        `,tags:["f3","theme"]}},s=()=>K;s.storyName="Default";s.parameters={docs:{description:{story:"The default message strip can be used for general messages that don’t fit into any of the semantic type use cases."}}};const r=()=>J;r.parameters={docs:{description:{story:"To display an information message strip, add the `fd-message-strip--information` modifier class to the main element."}}};const o=()=>F;o.parameters={docs:{description:{story:"To display a success message strip, add the `fd-message-strip--success` modifier class to the main element."}}};const l=()=>O;l.parameters={docs:{description:{story:"To display a warning message strip, add the `fd-message-strip--warning` modifier class to the main element."}}};const d=()=>z;d.parameters={docs:{description:{story:"To display the error message strip, add the `fd-message-strip--error` modifier class to the main element.\n"}}};const e=()=>R;e.storyName="No icon";e.parameters={docs:{description:{story:"To display message strip without an icon, add the `fd-message-strip--no-icon` modifier class to the main element. Add the `fd-message-strip--dismissible` modifier class if the element is dismissible."}}};const a=()=>P;a.storyName="No icon and no dismiss button";a.parameters={docs:{description:{story:"To display message strip without an icon, add the `fd-message-strip--no-icon` modifier class to the main element."}}};const i=()=>G;i.storyName="Text with link";i.parameters={docs:{description:{story:"The Link inside Message Strip has additional styling. Add the `fd-message-strip--link` modifier class if the message contains a link element."}}};const t=()=>B;t.storyName="Custom icon";t.parameters={docs:{description:{story:'The message strip can be customized by changing the status icon. Check <a href="https://sap.github.io/fundamental-styles/?path=/docs/components-icons-sap-icons--sizes" target="_blank" rel="noopener noreferrer" title="click to open Avatar component. Opens in a new window.">Icons</a> control for more icon types.'}}};const n=()=>j;n.storyName="Custom Message Strip";n.parameters={docs:{description:{story:"If the application needs a custom Message Strip, other than the semantic variations, then the colours from Inverted Object Status/Tag control should be used. Use the modifier classes `.fd-message-strip--indication-color-*`, where `*` is a number from 1 to 10 for the first set, and 1b to 10b for the second set. "}}};var p,c,m;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:"() => defaultStripExampleHtml",...(m=(c=s.parameters)==null?void 0:c.docs)==null?void 0:m.source}}};var g,f,u;r.parameters={...r.parameters,docs:{...(g=r.parameters)==null?void 0:g.docs,source:{originalSource:"() => informationExampleHtml",...(u=(f=r.parameters)==null?void 0:f.docs)==null?void 0:u.source}}};var b,v,h;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:"() => successExampleHtml",...(h=(v=o.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var _,y,x;l.parameters={...l.parameters,docs:{...(_=l.parameters)==null?void 0:_.docs,source:{originalSource:"() => warningExampleHtml",...(x=(y=l.parameters)==null?void 0:y.docs)==null?void 0:x.source}}};var S,w,C;d.parameters={...d.parameters,docs:{...(S=d.parameters)==null?void 0:S.docs,source:{originalSource:"() => errorExampleHtml",...(C=(w=d.parameters)==null?void 0:w.docs)==null?void 0:C.source}}};var k,M,E;e.parameters={...e.parameters,docs:{...(k=e.parameters)==null?void 0:k.docs,source:{originalSource:"() => noIconsExampleHtml",...(E=(M=e.parameters)==null?void 0:M.docs)==null?void 0:E.source}}};var H,I,T;a.parameters={...a.parameters,docs:{...(H=a.parameters)==null?void 0:H.docs,source:{originalSource:"() => noIconsNotDismissibleExampleHtml",...(T=(I=a.parameters)==null?void 0:I.docs)==null?void 0:T.source}}};var q,N,V;i.parameters={...i.parameters,docs:{...(q=i.parameters)==null?void 0:q.docs,source:{originalSource:"() => messageStripWithLinkExampleHtml",...(V=(N=i.parameters)==null?void 0:N.docs)==null?void 0:V.source}}};var W,D,A;t.parameters={...t.parameters,docs:{...(W=t.parameters)==null?void 0:W.docs,source:{originalSource:"() => messageStripWithCustomIconExampleHtml",...(A=(D=t.parameters)==null?void 0:D.docs)==null?void 0:A.source}}};var L,Y,U;n.parameters={...n.parameters,docs:{...(L=n.parameters)==null?void 0:L.docs,source:{originalSource:"() => messageStripWithAccentColorsExampleHtml",...(U=(Y=n.parameters)==null?void 0:Y.docs)==null?void 0:U.source}}};const es=["DefaultStrip","Information","Success","Warning","Error","NoIcons","NoIconsNotDismissible","MessageStripWithLink","MessageStripWithCustomIcon","MessageStripWithAccentColors"];export{s as DefaultStrip,d as Error,r as Information,n as MessageStripWithAccentColors,t as MessageStripWithCustomIcon,i as MessageStripWithLink,e as NoIcons,a as NoIconsNotDismissible,o as Success,l as Warning,es as __namedExportsOrder,ss as default};
//# sourceMappingURL=message-strip.stories-fc250c87.js.map
