/* empty css               *//* empty css             *//* empty css                     *//* empty css                *//* empty css               *//* empty css                *//* empty css             *//* empty css                      *//* empty css            *//* empty css              *//* empty css             *//* empty css                      *//* empty css               */const t=`<div style="margin-bottom: 1300px">
...
`,o=`<div class="fd-notification" tabindex="0">
    <div class="fd-notification__body">
        <span class="fd-avatar fd-avatar--accent-color-10 fd-avatar--xs" role="img" aria-label="Avatar">
            <i role="presentation" aria-hidden="true" aria-label="Product placeholder" class="fd-avatar__icon sap-icon--product"></i>
        </span>
...
* You intend to reduce the amount of information and actions to a minimum, but provide enough information to highlight the level of importance.
            `,components:["button","icon","notification","tabs","avatar","popover","menu","message-strip","dialog","bar","title"]}},i=()=>o;i.storyName="Notification Item";i.parameters={docs:{description:{story:`Notification items display a container with:
      <ul>
...
`}}};const a=()=>t;a.parameters={docs:{description:{story:`You can display a group of notifications in a list format, and the user can sort them from the header. A Message Strip can be places after the group header. To load more notifications, the list can have a Growing Item placed at the bottom of the group. 
    `}}};const n=()=>e;n.parameters={docs:{description:{story:"Notifications can be displayed as banners in the top right corner. Apply the modifier class `fd-notification--banner` for this option."}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => primaryExampleHtml",...i.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => notificationGroupExampleHtml",...a.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => bannerExampleHtml",...n.parameters?.docs?.source}}};const q=["Primary","NotificationGroup","NotificationBanner"];export{n as NotificationBanner,a as NotificationGroup,i as Primary,q as __namedExportsOrder,h as default};
