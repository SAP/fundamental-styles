var Ta=Object.defineProperty,Aa=Object.defineProperties;var Ia=Object.getOwnPropertyDescriptors;var y=Object.getOwnPropertySymbols;var Ca=Object.prototype.hasOwnProperty,Oa=Object.prototype.propertyIsEnumerable;var S=(s,t,i)=>t in s?Ta(s,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):s[t]=i,a=(s,t)=>{for(var i in t||(t={}))Ca.call(t,i)&&S(s,i,t[i]);if(y)for(var i of y(t))Oa.call(t,i)&&S(s,i,t[i]);return s},n=(s,t)=>Aa(s,Ia(t));/* empty css             *//* empty css                     *//* empty css                *//* empty css             *//* empty css               *//* empty css             */const Ha=`<div class="fddocs-icon-tab-container" style="min-height: 600px;">
...
`,Ea=`<div class="fddocs-icon-tab-container" style="min-height: 100px;">
...
`,Da=`<div class="fddocs-icon-tab-container" style="min-height: 600px;">
<h4>With Overflow</h4>
...
`,Pa=`<div class="fd-icon-tab-bar fd-icon-tab-bar--responsive-paddings">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item">
...
`,Fa=`<div class="fddocs-icon-tab-container" style="min-height: 400px;">
    <div class="fd-icon-tab-bar fd-icon-tab-bar--md">
        <ul role="tablist" class="fd-icon-tab-bar__header">
            <li role="presentation" class="fd-icon-tab-bar__item">
...
`,Ma=`<div class='fddocs-icon-tab-container' style="min-height: 800px;">
    <div class="fd-icon-tab-bar fd-icon-tab-bar--xl">
        <ul role="tablist" class="fd-icon-tab-bar__header">
            <li role="presentation" class="fd-icon-tab-bar__item">
...
`,za=`<div class="fddocs-icon-tab-container">
...
</div>`,Ya=`<div class="fd-icon-tab-bar fd-icon-tab-bar--filter">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item">
...
</div>`,ja=`<div class="fd-icon-tab-bar fd-icon-tab-bar--icon fd-icon-tab-bar--process">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item">
            <a role="tab" class="fd-icon-tab-bar__tab" href="#" aria-selected="true" id="tab1">
                <div class="fd-icon-tab-bar__container">
...
`,La=`<div class="fd-icon-tab-bar fd-icon-tab-bar--icon">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item">
...
`,Ua=`<div class="fd-icon-tab-bar fd-icon-tab-bar--icon-only">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item fd-icon-tab-bar__item--positive">
            <a role="tab" class="fd-icon-tab-bar__tab" href="#" id="tab1">
                <div class="fd-icon-tab-bar__container">
...
</div>`,Wa=`<div class="fd-icon-tab-bar fd-icon-tab-bar--icon-only">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item">
...
`,Ra=`<div class="fd-icon-tab-bar fd-icon-tab-bar--counters">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item">
            <a role="tab" class="fd-icon-tab-bar__tab" href="#section1" id="tab1">
...
`,nn={title:"Components/Icon Tab Bar",parameters:{description:`
...
<br><br><br>
      `,tags:["f3","theme","development"]}},e=()=>Ga;e.storyName="Text Only (Inline mode)";e.parameters={docs:{description:{story:"The text-only variant is one of the most common types. It allows longer labels, and can also display counters next to the text to indicate the number of items on the tab page. The labels of the tabs do not get truncated. The full text is always shown. As a result, you need to ensure that your labels do not become too long. They should still be easy to read on smaller screens. The control has the same look and feel in Cozy and Compact mode."}}};const v=()=>Xa;v.storyName="Text Only (Inline mode) Semantic Colors";const o=()=>Ra;o.storyName="Counters and Text";o.parameters={docs:{description:{story:"<code>NOTE: This is no longer recommended.</code> Counters can be shown on top of labels. In this case you need to apply the `fd-icon-tab-bar--counters` modifier class. <br> The control has the same look and feel in Cozy and Compact mode."}}};const u=()=>Wa;u.parameters={docs:{description:{story:"The Icon tabs are rounded tabs that can be populated with any icon. The labels in this case are omitted and counters are optional. You need to apply the `fd-icon-tab-bar--icon-only` modifier class for this type of tabs."}}};const h=()=>Ua;h.storyName="Icon Only Semantic Colors";const g=()=>La;g.parameters={docs:{description:{story:"To display Icon Tabs with labels and counters you need to apply the `fd-icon-tab-bar--icon` modifier class. The counters are optional and can be ommited. The label is always positioned at the bottom. If you decide to use labels, use them for all tabs. The badge is rendered at the top right hand corner of the icon container. Consider using shorter labels or text tabs (without icons), since text tabs cannot get truncated."}}};const x=()=>ja;x.parameters={docs:{description:{story:"You can also use the tab bar to depict a process. In this case, each tab stands for one step. You need to add the `fd-icon-tab-bar--process` modifier class and a sibling html element with `fd-icon-tab-bar__separator` class to the tab."}}};const w=()=>Ya;w.parameters={docs:{description:{story:"The tab bar as a filter has two parts: <br>- An “all” tab on the left - shows the total number of items, and describes the type of item (for example, 189 Products).<br>-  Tabs for specific filters - the tab text indicates the filter attribute. It is recommended to show a counter on every tab.<br>You need to add the `fd-icon-tab-bar--filter` modifier class for this type of tabs."}}};const k=()=>za;k.parameters={docs:{description:{story:`Tabs can have an overflow to either sides of the control. Depending on if the order is fixed (process steps) or can be rearranged (tabs).
        For processes with a fixed order, an overflow to both sides is used. For tabs that can be rearranged, only one overflow will be displayed on the right side.`}}};const l=()=>Ma;l.storyName="Universal Icon Tab Bar Single Click Area";l.parameters={docs:{description:{story:"When there is only one click area per tab (also including tabs with sub-items), regular tabs get selected immediately after the click is released. Tabs with sub-items trigger the expansion of a menu (Popover) showing its sub-items. The parent tab title remains displayed when its child is select.\n        <br>\n        You need to apply the `fd-icon-tab-bar__item--single-click` modifier class to `fd-icon-tab-bar__item` element. The List component inside the Popover has an additional modifier class `fd-icon-tab-bar__list` to achieve the nesting (indentation) of the elements. The list menu can be borderless, with line separators (`fd-icon-tab-bar__line-separator`) or icon separators (`fd-icon-tab-bar__icon-separator`) "}}};const r=()=>Fa;r.storyName="Universal Icon Tab Bar Multi Click Area";r.parameters={docs:{description:{story:"In case of two click areas for tabs with sub-tabs, the behaviour for regular tabs (without sub-items) remains unchanged, like described above the tabs get selected immediately. Tabs with two click areas behave differently: when the main part of the tab is clicked, it is highlighted and then selected immediately. Clicking the second area opens a menu (Popover) containing the sub-items. Once a sub-item is clicked, the main tab is highlighted as selected. "}}};const c=()=>Ba;c.storyName="Badges";c.parameters={docs:{description:{story:"The Tab attention badge is applied as a visual eye-catcher to indicate a change within a Tab. <br>\n        The badge is a span element with `fd-icon-tab-bar__badge` class. It can be animated by adding an additional ` fd-icon-tab-bar__badge--animated` modifier class. In this case the badge appears for a few milliseconds and then disappears."}}};const b=()=>Pa;b.storyName="Responsive Paddings";b.parameters={docs:{description:{story:"For an Icon Tab Bar with responsive paddings that adjust based on the screen size add the `fd-icon-tab-bar--responsive-paddings` modifier class."}}};const d=()=>Na;d.storyName="Sizes and Horizontal Paddings";d.parameters={docs:{description:{story:'You can set horizontal paddings by adding a modifier class and specifying the size of the paddings. Please refer to the "Paddings" section at the top of the page for the available sizes.'}}};const _=()=>Da;_.storyName="Navigation Icon Tab Bar (Shell Navigation)";_.parameters={docs:{description:{story:`The Navigation Tab Bar is the main/default navigation displayed on the SAP Fiori launchpad home page. It offers the user an easy access to multiple pages per space. The background color of the Shell Navigation is connected the Home/Shell Header to properly differentiate the global shell navigation versus any application specific navigation. The Navigation Bar snaps to top and remains visible while scrolling. It is not visible in App view. <br>
        ...
        `}}};const m=()=>qa;m.storyName="Closable Tabs";m.parameters={docs:{description:{story:"For closable tabs add the `.fd-icon-tab-bar__item--closable` modifier class to the `.fd-icon-tab-bar__item`. The close button is placed inside a button container, responsible for the proper spacing between the elements.<br>Closable tabs can also be moved into the overflow. There the close button remains shown for each tab. The modifier class in this case is `.fd-icon-tab-bar__list-item--closable` added to the list item with base class `.fd-icon-tab-bar__list-item`.\n\n        "}}};var T,A,I;e.parameters=n(a({},e.parameters),{docs:n(a({},(T=e.parameters)==null?void 0:T.docs),{source:a({originalSource:"() => textOnlyExampleHtml"},(I=(A=e.parameters)==null?void 0:A.docs)==null?void 0:I.source)})});var C,O,H;v.parameters=n(a({},v.parameters),{docs:n(a({},(C=v.parameters)==null?void 0:C.docs),{source:a({originalSource:"() => textOnlySemanticExampleHtml"},(H=(O=v.parameters)==null?void 0:O.docs)==null?void 0:H.source)})});var E,D,N;o.parameters=n(a({},o.parameters),{docs:n(a({},(E=o.parameters)==null?void 0:E.docs),{source:a({originalSource:"() => counterExampleHtml"},(N=(D=o.parameters)==null?void 0:D.docs)==null?void 0:N.source)})});var P,B,F;u.parameters=n(a({},u.parameters),{docs:n(a({},(P=u.parameters)==null?void 0:P.docs),{source:a({originalSource:"() => iconOnlyExampleHtml"},(F=(B=u.parameters)==null?void 0:B.docs)==null?void 0:F.source)})});var M,z,Y;h.parameters=n(a({},h.parameters),{docs:n(a({},(M=h.parameters)==null?void 0:M.docs),{source:a({originalSource:"() => iconOnlySemanticExampleHtml"},(Y=(z=h.parameters)==null?void 0:z.docs)==null?void 0:Y.source)})});var j,L,U;g.parameters=n(a({},g.parameters),{docs:n(a({},(j=g.parameters)==null?void 0:j.docs),{source:a({originalSource:"() => iconExampleHtml"},(U=(L=g.parameters)==null?void 0:L.docs)==null?void 0:U.source)})});var W,R,X;x.parameters=n(a({},x.parameters),{docs:n(a({},(W=x.parameters)==null?void 0:W.docs),{source:a({originalSource:"() => processExampleHtml"},(X=(R=x.parameters)==null?void 0:R.docs)==null?void 0:X.source)})});var G,q,J;w.parameters=n(a({},w.parameters),{docs:n(a({},(G=w.parameters)==null?void 0:G.docs),{source:a({originalSource:"() => filterExampleHtml"},(J=(q=w.parameters)==null?void 0:q.docs)==null?void 0:J.source)})});var K,Q,V;k.parameters=n(a({},k.parameters),{docs:n(a({},(K=k.parameters)==null?void 0:K.docs),{source:a({originalSource:"() => overflowExampleHtml"},(V=(Q=k.parameters)==null?void 0:Q.docs)==null?void 0:V.source)})});var Z,$,aa;l.parameters=n(a({},l.parameters),{docs:n(a({},(Z=l.parameters)==null?void 0:Z.docs),{source:a({originalSource:"() => singleClickExampleHtml"},(aa=($=l.parameters)==null?void 0:$.docs)==null?void 0:aa.source)})});var na,ta,ia;r.parameters=n(a({},r.parameters),{docs:n(a({},(na=r.parameters)==null?void 0:na.docs),{source:a({originalSource:"() => multiClickExampleHtml"},(ia=(ta=r.parameters)==null?void 0:ta.docs)==null?void 0:ia.source)})});var sa,ea,oa;c.parameters=n(a({},c.parameters),{docs:n(a({},(sa=c.parameters)==null?void 0:sa.docs),{source:a({originalSource:"() => badgeExampleHtml"},(oa=(ea=c.parameters)==null?void 0:ea.docs)==null?void 0:oa.source)})});var la,ra,ca;b.parameters=n(a({},b.parameters),{docs:n(a({},(la=b.parameters)==null?void 0:la.docs),{source:a({originalSource:"() => respPaddingsExampleHtml"},(ca=(ra=b.parameters)==null?void 0:ra.docs)==null?void 0:ca.source)})});var ba,da,_a;d.parameters=n(a({},d.parameters),{docs:n(a({},(ba=d.parameters)==null?void 0:ba.docs),{source:a({originalSource:"() => paddingsExampleHtml"},(_a=(da=d.parameters)==null?void 0:da.docs)==null?void 0:_a.source)})});var pa,fa,ma;_.parameters=n(a({},_.parameters),{docs:n(a({},(pa=_.parameters)==null?void 0:pa.docs),{source:a({originalSource:"() => navigationExampleHtml"},(ma=(fa=_.parameters)==null?void 0:fa.docs)==null?void 0:ma.source)})});var va,ua,ha;p.parameters=n(a({},p.parameters),{docs:n(a({},(va=p.parameters)==null?void 0:va.docs),{source:a({originalSource:"() => navigationFlatExampleHtml"},(ha=(ua=p.parameters)==null?void 0:ua.docs)==null?void 0:ha.source)})});var ga,xa,wa;f.parameters=n(a({},f.parameters),{docs:n(a({},(ga=f.parameters)==null?void 0:ga.docs),{source:a({originalSource:"() => dragAndDropExampleHtml"},(wa=(xa=f.parameters)==null?void 0:xa.docs)==null?void 0:wa.source)})});var ka,ya,Sa;m.parameters=n(a({},m.parameters),{docs:n(a({},(ka=m.parameters)==null?void 0:ka.docs),{source:a({originalSource:"() => textOnlyClosableExampleHtml"},(Sa=(ya=m.parameters)==null?void 0:ya.docs)==null?void 0:Sa.source)})});const tn=["TextOnly","TextOnlySemantic","Counter","IconOnly","IconOnlySemantic","Icon","Process","Filter","Overflow","SingleClick","MultiClick","Badge","RespPaddings","Paddings","Navigation","NavigationFlat","DragAndDrop","TextOnlyClosable"];export{c as Badge,o as Counter,f as DragAndDrop,w as Filter,g as Icon,u as IconOnly,h as IconOnlySemantic,r as MultiClick,_ as Navigation,p as NavigationFlat,k as Overflow,d as Paddings,x as Process,b as RespPaddings,l as SingleClick,e as TextOnly,m as TextOnlyClosable,v as TextOnlySemantic,tn as __namedExportsOrder,nn as default};
