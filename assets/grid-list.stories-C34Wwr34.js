/* empty css                  *//* empty css                    *//* empty css                *//* empty css               *//* empty css             *//* empty css              *//* empty css              *//* empty css                 *//* empty css               *//* empty css             *//* empty css                      */const o=`<div style="min-height: 300px;">
...
`,C={title:"Components/Grid List/Grid List",parameters:{description:`
...
- You want to manage complex datasets that need to be extensively sorted, grouped, filtered, or edited. In this case, use a table.
    `,tags:[],components:["grid-list","layout-grid","toolbar","button","icon","title","radio","checkbox","avatar","link","object-status"]}},i=()=>v;i.storyName="Delete mode";i.parameters={docs:{description:{story:`
...
`}}};const e=()=>r;e.parameters={docs:{description:{story:`
...
`}}};const t=()=>o;t.storyName="No height / Partial Items";t.parameters={docs:{description:{story:`
...
`}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => deleteModeExampleHtml",...i.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => groupExampleHtml",...s.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => statesExampleHtml",...a.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => highlightExampleHtml",...d.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"() => filterInfobarExampleHtml",...l.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => moreExampleHtml",...n.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => footerExampleHtml",...e.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => partialItemsExampleHtml",...t.parameters?.docs?.source}}};const P=["DeleteMode","Group","States","Highlight","FilterInfobar","More","Footer","PartialItems"];export{i as DeleteMode,l as FilterInfobar,e as Footer,s as Group,d as Highlight,n as More,t as PartialItems,a as States,P as __namedExportsOrder,C as default};
