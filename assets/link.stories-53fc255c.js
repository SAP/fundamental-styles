/* empty css             *//* empty css             */const c={title:"Components/Link",parameters:{description:`A link (also known as hyperlink) is an interactive text element that allows users to navigate to another page or trigger a certain event.
...
`;n.storyName="Types";n.parameters={docs:{story:{iframeHeight:300},description:{story:`There are different types of links for various use cases.
...
`}}};var s,a,e;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:`() => \`\${localStyles}
...
//# sourceMappingURL=link.stories-53fc255c.js.map
