/* empty css               *//* empty css               *//* empty css                   *//* empty css             *//* empty css                    *//* empty css                      *//* empty css             *//* empty css              *//* empty css                    */const x=`<h4>Size S (1rem)</h4>
...
<div class="fd-tool-header fd-tool-header--lg" style="max-width: 1050px;">
    <div class="fd-tool-header__group">
        ...
        <div class="fd-tool-header__element">
            <button class="fd-button fd-button--transparent fd-button--menu fd-tool-header__button" aria-label="megamenu">
                <h4 class="fd-title fd-title--h5 fd-tool-header__title">Product Name</h4>
                <i class="sap-icon--megamenu"></i>
            </button>
        </div>
...
`,y=`<div class="fd-tool-header fd-tool-header--responsive-paddings">
    <div class="fd-tool-header__group">
        <div class="fd-tool-header__element">
            <img class="fd-tool-header__logo" src="//unpkg.com/fundamental-styles/dist/images/sap-logo.png" srcset="//unpkg.com/fundamental-styles/dist/images/sap-logo@2x.png 1x, //unpkg.com/fundamental-styles/dist/images/sap-logo@3x.png 2x, //unpkg.com/fundamental-styles/dist/images/sap-logo@4x.png 3x" alt="SAP">
...
`,w=`<div class="fd-tool-header fd-tool-header--menu">
    <div class="fd-tool-header__group">
        <div class="fd-tool-header__element">
        ...
        <div class="fd-tool-header__element">
            <button class="fd-button fd-button--transparent fd-button--menu fd-tool-header__button" aria-label="menu button file">
                <span class="fd-button__text">File</span>
                <i class="sap-icon--slim-arrow-down"></i>
            </button>
        </div>
        <div class="fd-tool-header__element">
            <button class="fd-button fd-button--transparent fd-button--menu fd-tool-header__button" aria-label="menu button edit">
                <span class="fd-button__text">Edit</span>
                <i class="sap-icon--slim-arrow-down"></i>
            </button>
        </div>
        <div class="fd-tool-header__element">
            <button class="fd-button fd-button--transparent fd-button--menu fd-tool-header__button" aria-label="menu button view">
                <span class="fd-button__text">View</span>
                <i class="sap-icon--slim-arrow-down"></i>
            </button>
        </div>
        <div class="fd-tool-header__element">
            <button class="fd-button fd-button--transparent fd-button--menu fd-tool-header__button" aria-label="menu button delete">
...
`,k=`<div class="fd-tool-header fd-tool-header--menu">
    <div class="fd-tool-header__group">
        <div class="fd-tool-header__element">
            <button class="fd-button fd-button--transparent fd-tool-header__button" aria-label="menu">
                <i class="sap-icon--menu2"></i>
...
`,I={title:"Components/Tool Header",parameters:{description:`The tool header is a control that is found in most SAP Cloud Platform products, most commonly as a part of the Tool Page Layout. The tool header inherits its functionality from the overflow toolbar and its visual design from the shell bar.
...
`,tags:["btp","theme","development"]}},t=()=>S;t.storyName="Tool Header with Controls";const e=()=>k;e.storyName="Tool Header with Side Navigation Menu Button";e.parameters={docs:{description:{story:"The side navigation menu button is used to collapse/expand the side navigation. It is not recommended to use horizontal and responsive paddings when this button is present."}}};const a=()=>w;a.storyName="Tool Header with Menu Buttons";const o=()=>y;o.parameters={docs:{description:{story:"Horizontal responsive paddings (based on the screen size) can be applied to the tool header by adding the `fd-tool-header--responsive-paddings` modifier class to the container class. In this case the left and right spacing will change as the screen size changes."}}};const n=()=>x;n.parameters={docs:{description:{story:"You can add horizontal paddings by applying a modifier class to the container. For example, `.fd-tool-header--sm` modifier class will add 1rem horizontal paddings on the tool bar container."}}};var s,d,l;t.parameters={...t.parameters,docs:{...(s=t.parameters)==null?void 0:s.docs,source:{originalSource:"() => primaryExampleHtml",...(l=(d=t.parameters)==null?void 0:d.docs)==null?void 0:l.source}}};var i,r,c;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:"() => menuExampleHtml",...(c=(r=e.parameters)==null?void 0:r.docs)==null?void 0:c.source}}};var u,p,f;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:"() => menuButtonsExampleHtml",...(f=(p=a.parameters)==null?void 0:p.docs)==null?void 0:f.source}}};var m,h,b;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:"() => responsivePaddingsExampleHtml",...(b=(h=o.parameters)==null?void 0:h.docs)==null?void 0:b.source}}};var _,g,v;n.parameters={...n.parameters,docs:{...(_=n.parameters)==null?void 0:_.docs,source:{originalSource:"() => horizontalPaddingsExampleHtml",...(v=(g=n.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};const M=["Primary","Menu","MenuButtons","ResponsivePaddings","HorizontalPaddings"];export{n as HorizontalPaddings,e as Menu,a as MenuButtons,t as Primary,o as ResponsivePaddings,M as __namedExportsOrder,I as default};
//# sourceMappingURL=tool-header.stories-1e676c7e.js.map
