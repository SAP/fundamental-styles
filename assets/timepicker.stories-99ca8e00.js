...
`},tags:["f3","theme"]},e=()=>M;e.storyName="Time Picker with 24-hour Clock Face";e.parameters={docs:{description:{story:`The 24-hour clock face shows an additional inner circle for the times from 13:00 to 24:00 hours.
`}}};const i=()=>x;i.storyName="Time Picker with 12-hour Clock Face";i.parameters={docs:{description:{story:`The 12-hour clock face shows only one circle and an AM/PM switch is displayed.
`}}};const s=()=>w;s.storyName="Minutes Face";s.parameters={docs:{description:{story:"When the minutes value is selected in the time display, the minutes clock face is shown."}}};const n=()=>h;n.storyName="Seconds Face";n.parameters={docs:{description:{story:"When the seconds value is selected in the time display, the seconds clock face is shown."}}};const t=()=>y;t.parameters={docs:{description:{story:`On phones, focusing on the time input field opens a time input popover. The user can then use the mobile keyboard to enter the time. For the 12-hour time format, the popover also offers an AM/PM switch.
...
//# sourceMappingURL=timepicker.stories-99ca8e00.js.map
