/* empty css                         *//* empty css                   *//* empty css                  *//* empty css                   *//* empty css              */const g=`<div class="fd-container fd-form-layout-grid-container">
        <div class="fd-row">
...
`,h=`<div class="fd-form-group" role="group" aria-labelledby="basicGroupHeader">
        <div class="fd-form-group__header">
...
`,N={title:"Components/Forms/Form Group",parameters:{description:`
...
These components can be used alone. For example, the \`form__item\` element with the label and control could be used without the full form group since not every form field will need error messages.
        ...
        `,tags:["f3","a11y","theme"]}},e=()=>x;e.storyName="Default";e.parameters={docs:{description:{story:`
The default form group component displays an inline label and an input field that is highlighted in blue when selected.
`}}};const r=()=>b;r.parameters={docs:{description:{story:"\nTo indicate to the user that it’s required to fill out an input field, add the `--required` modifier class to the `fd-form-label` element.\n"}}};const d=()=>h;d.storyName="Group header";d.parameters={docs:{description:{story:"\nForm groups can be grouped together under a header with the `fd-form-group__header` class.\n"}}};const l=()=>g;l.storyName="Group header (form grid)";l.parameters={docs:{description:{story:`
When group headers are displayed in a **Form Grid**, paddings are added to the groups.
        `}}};var a,o,i;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:"() => primaryExampleHtml",...(i=(o=e.parameters)==null?void 0:o.docs)==null?void 0:i.source}}};var s,n,t;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:"() => requiredExampleHtml",...(t=(n=r.parameters)==null?void 0:n.docs)==null?void 0:t.source}}};var c,f,m;d.parameters={...d.parameters,docs:{...(c=d.parameters)==null?void 0:c.docs,source:{originalSource:"() => groupHeaderExampleHtml",...(m=(f=d.parameters)==null?void 0:f.docs)==null?void 0:m.source}}};var p,u,v;l.parameters={...l.parameters,docs:{...(p=l.parameters)==null?void 0:p.docs,source:{originalSource:"() => groupHeaderInFormGridExampleHtml",...(v=(u=l.parameters)==null?void 0:u.docs)==null?void 0:v.source}}};const w=["Primary","Required","GroupHeader","GroupHeaderInFormGrid"];export{d as GroupHeader,l as GroupHeaderInFormGrid,e as Primary,r as Required,w as __namedExportsOrder,N as default};
//# sourceMappingURL=form-group.stories-9131e746.js.map
