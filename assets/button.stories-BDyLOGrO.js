/* empty css                *//* empty css                         *//* empty css             *//* empty css             *//* empty css               *//* empty css                     */const u=`
...
</div>`,v={title:"Components/Buttons/Button",parameters:{description:`The button component is used to trigger an action. All buttons are characterized by the \`fd-button\` class and an additional modifier classes to specify each button type.
...
`,tags:[]}},t=()=>f;t.storyName="Button styles";t.parameters={docs:{description:{story:`
...
For **Attention Badge** use the <code>fd-button__badge--attention</code> modifier class with <code>fd-button__badge</code> base class. `}}};const o=()=>b;o.storyName="Menu button";o.parameters={docs:{description:{story:`The Menu Button is the default trigger for the Menu (Horizon) component and is tightly coupled with it—it cannot be used independently. While the Menu component can function on its own, the Menu Button relies on it to provide a dropdown.
<br>
...
If a fixed width is applied to the Menu Button, the dropdown arrow icon should be right-aligned. The recommended maximum width is 12rem..
            `}}};const a=()=>r;a.storyName="Icon or text";a.parameters={docs:{description:{story:`
