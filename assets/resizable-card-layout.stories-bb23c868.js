/* empty css               *//* empty css               *//* empty css              *//* empty css             *//* empty css                      *//* empty css                        *//* empty css              *//* empty css                 *//* empty css             *//* empty css             *//* empty css             */const m=`<div id="grid1" class="fd-resizable-card-layout">
...
`,u=`<div id="grid1" class="fd-resizable-card-layout">
...
`,z=`<div id="grid1" class="fd-resizable-card-layout">
...
`,h=`<div id="layout1" class="fd-resizable-card-layout fd-resizable-card-layout--md fd-custom-resizable-card-layout-flex">
...
`;const T={title:"Layouts/Resizable Card Layout",parameters:{description:`The resizable card layout is a layout for the overview page. It enables users to define a personalized card layout by changing not only the position of a card, but also its size, and thus how the card content is presented.
...
Cards can be resized vertically in rows of 1 rem and horizontally in steps of 20 rem (minimum width).
        `,tags:["f3","theme","development"],components:["resizable-card-layout","button","avatar","badge","card","object-status","numeric-content","table","checkbox","list","link","icon"]}},a=()=>h;a.storyName="Resizable card layout";a.parameters={docs:{story:{iframeHeight:900},description:{story:`Resizable card layout with multiple cards.
        `}}};const i=()=>z;i.storyName="Card resize in horizontal and vertical directions";i.parameters={docs:{story:{iframeHeight:900},description:{story:`Cards can be resized in horizontal direction as well as vertical direction. Resize handle will expand on right border for horizontal resize and bottom border for vertical resize.
        `}}};const s=()=>u;s.storyName="Card resize in horizontal directions";s.parameters={docs:{story:{iframeHeight:900},description:{story:`Cards can also be resized in horizontal direction only. Resize handle will expand on right border.
        `}}};const e=()=>m;e.storyName="Card resize in vertical directions";e.parameters={docs:{story:{iframeHeight:900},description:{story:`Cards can be resized in vertical direction only. Resize handle will expand on bottom border.
        `}}};var t,l,n;a.parameters={...a.parameters,docs:{...(t=a.parameters)==null?void 0:t.docs,source:{originalSource:"() => resizeCardLayoutExampleHtml",...(n=(l=a.parameters)==null?void 0:l.docs)==null?void 0:n.source}}};var d,r,c;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:"() => resizeCardHorizontalVerticalDirectionExampleHtml",...(c=(r=i.parameters)==null?void 0:r.docs)==null?void 0:c.source}}};var o,_,f;s.parameters={...s.parameters,docs:{...(o=s.parameters)==null?void 0:o.docs,source:{originalSource:"() => resizeCardHorizontalDirectionExampleHtml",...(f=(_=s.parameters)==null?void 0:_.docs)==null?void 0:f.source}}};var v,p,b;e.parameters={...e.parameters,docs:{...(v=e.parameters)==null?void 0:v.docs,source:{originalSource:"() => resizeCardVerticalDirectionExampleHtml",...(b=(p=e.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};const D=["ResizeCardLayout","ResizeCardHorizontalVerticalDirection","ResizeCardHorizontalDirection","ResizeCardVerticalDirection"];export{s as ResizeCardHorizontalDirection,i as ResizeCardHorizontalVerticalDirection,a as ResizeCardLayout,e as ResizeCardVerticalDirection,D as __namedExportsOrder,T as default};
//# sourceMappingURL=resizable-card-layout.stories-bb23c868.js.map
