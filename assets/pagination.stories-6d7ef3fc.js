/* empty css               *//* empty css               *//* empty css             *//* empty css                   *//* empty css              *//* empty css                   *//* empty css                *//* empty css             */const s=`<div style="height: 200px;">
...
`,h={title:"Components/Pagination",parameters:{description:`Pagination allows users to separate their content into discrete pages, making it easier to digest and navigate through. Pagination is commonly used for tables and tiles.
...
<br>
<br>
      `,tags:["btp"]}},a=()=>p;a.storyName="First page";a.parameters={docs:{description:{story:`First and Previous page buttons are disabled when first page is active.
    `}}};const n=()=>r;n.storyName="Middle pages";n.parameters={docs:{description:{story:`Pagination can display middle pages to increase reachability.
    ...
    `}}};const t=()=>l;t.storyName="Last page";t.parameters={docs:{description:{story:`Last and Next page buttons are disabled when last page is active.
    `}}};const e=()=>o;e.storyName="Per page";e.parameters={docs:{description:{story:`Additionally, per page section can be displayed with select to specify which number of items should be shown on the every page.
    `}}};const i=()=>s;i.parameters={docs:{description:{story:"Pagination component is responsive by default. When the screen's size is smaller than 1024px in width mobile mode is shown and you have nothing to do.\n        If you want to display pagination component always in mobile mode please add `.fd-pagination--mobile` modifier class to the component.\n    "}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => firstPageExampleHtml",...a.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => middlePageExampleHtml",...n.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => lastPageExampleHtml",...t.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => perPageExampleHtml",...e.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => mobileExampleHtml",...i.parameters?.docs?.source}}};const v=["FirstPage","MiddlePage","LastPage","PerPage","Mobile"];export{a as FirstPage,t as LastPage,n as MiddlePage,i as Mobile,e as PerPage,v as __namedExportsOrder,h as default};
