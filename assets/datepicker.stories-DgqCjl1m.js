/* empty css                 *//* empty css                    *//* empty css                *//* empty css              *//* empty css               *//* empty css              *//* empty css                   *//* empty css             *//* empty css            *//* empty css               *//* empty css                         */const t=`<div class="fd-dialog-docs-static fd-calendar-mobile-docs-static--portrait fd-dialog fd-dialog--active">
...
`,l=`<div class="fd-dialog-docs-static fd-calendar-mobile-docs-static--landscape fd-dialog fd-dialog--active">
<div class="fd-dialog__content fd-dialog__content--s fd-dialog__content--mobile">
...
`,r=`<div class="fd-docs-date-picker" style="height:500px">
...
`,s=`<div class="fd-docs-date-picker" style="height:450px">
<div class="fd-popover">
  <div class="fd-popover__control is-expanded">
...
`,g={title:"Patterns/Date Picker",parameters:{description:`The date picker provides responsive behavior that allows for simple operation on all devices. It is smaller in compact mode and provides a touch-friendly size in cozy mode.
...
-    The user needs to navigate directly from one month or year to another.
      `,tags:[]}},n=()=>s;n.parameters={docs:{description:{story:`
...
`}}};const d=()=>r;d.parameters={docs:{description:{story:`
...
`}}};const a=()=>l;a.storyName="Mobile landscape mode with today navigation";a.parameters={docs:{description:{story:"The additional `Today` button displayed in the navigation part of the calendar, sets the focus to the current date. The landscape sizing and roation of thw the date picker is done by adding the `fd-calendar--mobile-landscape` class."}}};const e=()=>t;e.storyName="Mobile portrait mode with today navigation";e.parameters={docs:{description:{story:"Similar to the mobile landscape example, mobile portrait mode has a `Today` button. To make date picker visible in portrait mode, add the`fd-calendar--mobile-portrait` class."}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => todaySelectionButtonExampleHtml",...n.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => todayNavigationButtonExampleHtml",...d.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => mobileLandscapeExampleHtml",...a.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => mobilePortraitExampleHtml",...e.parameters?.docs?.source}}};const w=["TodaySelectionButton","TodayNavigationButton","MobileLandscape","MobilePortrait"];export{a as MobileLandscape,e as MobilePortrait,d as TodayNavigationButton,n as TodaySelectionButton,w as __namedExportsOrder,g as default};
