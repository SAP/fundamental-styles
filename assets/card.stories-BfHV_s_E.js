/* empty css               *//* empty css               *//* empty css              *//* empty css             *//* empty css                      *//* empty css                        *//* empty css              *//* empty css                 *//* empty css             *//* empty css             *//* empty css             *//* empty css                   *//* empty css                         *//* empty css                            */const f=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
...
`,p=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
...
`,u=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
...
`,b=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
...
`,m=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
    <div style="width: 300px; height: 400px; margin: 1rem;">
...
`,x=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
    <div style="width: 300px; height: 400px; margin: 1rem;">
            ...
            <div class="fd-card__header fd-card__header--interactive" role="group" aria-roledescription="Card Header">
                <div class="fd-card__header-main">
                    ...
                    <div class="fd-card__header-main-actions">
                        ...
                        <span class="fd-object-status fd-card__counter">1 of 3</span>
                        <div class="fd-card__timestamp">
                            <button role="button" title="Refresh" class="fd-button fd-button--transparent">
                                <i class="sap-icon--refresh" role="presentation" aria-hidden="true"></i>
                            </button>
...
</div>`,C=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
    <div style="width: 300px; height: 400px; margin: 1rem;">
...
`,w=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
    <div style="width: 300px; height: fit-content; margin: 1rem;">
        <div class="fd-card">
            <div 
...
`,j=`<div role="region" aria-label="Interactive Cards and States">
...
`,k=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
    <div style="width: 300px; height: 400px; margin: 1rem;">
        <div class="fd-card" role="region" aria-roledescription="Card" aria-labelledby="card-title-1a">
            ...
            <div class="fd-card__header" role="group" aria-roledescription="Card Header">
                <div class="fd-card__header-main">
                    <div class="fd-card__header-main-container">
                        <span class="sap-icon sap-icon--error sap-icon--color-negative" role="presentation" aria-hidden="true" aria-label="negative notification"></span>
    ...
    <div style="width: 300px; height: 400px; margin: 1rem;">
        <div class="fd-card" role="region" aria-labelledby="card-title-2a">
            <div class="fd-card__header fd-card__header--interactive" role="group" aria-roledescription="Card Header">
                <div class="fd-card__header-main">
                    <div class="fd-card__header-main-container"role="button" tabindex="0" aria-description="Activate for action/navigation" aria-label="Activate for action/navigation" title="Activate for action/navigation">
                        <span class="sap-icon sap-icon--alert sap-icon--color-critical sap-icon--md" role="presentation" aria-hidden="true" aria-label="critical notification"></span>
    ...
    <div style="width: 300px; height: fit-content; margin: 1rem;">
        <div class="fd-card" role="region" aria-roledescription="Card" aria-labelledby="card-title-33a">
            <div class="fd-card__header" role="group" aria-roledescription="Card Header">
                <div class="fd-card__header-main">
                    <div class="fd-card__header-main-container">
                        <span class="sap-icon sap-icon--sys-enter-2 sap-icon--color-positive sap-icon--lg" role="presentation" aria-hidden="true" aria-label="positive notification"></span>
...
</div>`,O={title:"Components/Card/Card",parameters:{description:`The Card is a container that consists of a <b>Header</b>, <b>Extended Header</b>, <b>Numeric Content</b>, <b>Content</b> and <b>Footer area</b>. 
...
`,tags:["development"]}},a=()=>x;a.storyName="Non-interactive card";a.parameters={docs:{description:{story:`Non-interactive cards have <code>role="region"</code>. In this case the card can be placed in any container. This role covers the interactive variants:
- no interactivity
- no interactivity with interactive elements inside (including interactive header).
`}}};const n=()=>C;n.storyName="Header Interaction - non-interactive Cards";n.parameters={docs:{description:{story:`For interactive header use the modifier class <code>.fd-card__header--interactive</code> on <code>.fd-card__header</code>.
`}}};const d=()=>w;d.storyName="Interactive card with role button";d.parameters={docs:{description:{story:`The role <b>button</b> can be assigned to an interactive card that has <b>NO</b> interactive element inside. In this case, the card could be placed in any container.
`}}};const e=()=>j;e.storyName="Interactive card with role listitem";e.parameters={docs:{description:{story:`The <b>listitem</b> is the recommended role for card. With this role, all interactive variants of the card can be covered: 
...
The card container must be a list, even when there's only one card. The container of the list has role region and aria-label. If there's no container for the list, the label has to be placed on the card container list.`}}};const t=()=>m;t.storyName="Standard card | Main Header";t.parameters={docs:{description:{story:`The main card header block shows the basic information of the card. It comes in two interactivity variants: 
...
`}}};const _=()=>g;_.parameters={docs:{description:{story:`The numeric header block is designed for displaying numeric information.
`}}};const i=()=>k;i.storyName="Alternative Icon on Card Header";i.parameters={docs:{description:{story:`Alternatively to an Avatar a Message Icon can be displayed within the Main Header. This will be available in three different sizes (this is only applicable for Message Icons not Avatar component on Card Header). The Message Icons are non-interactive.
...
`}}};const r=()=>y;r.storyName="Empty State";r.parameters={docs:{description:{story:"Use Illustrated Messages component inside the Card content to represent an empty state. The content container has 1rem spacing."}}};const s=()=>b;s.storyName="Analytical card";s.parameters={docs:{description:{story:`The analytical card is used for data visualization. It can display a KPI header and various chart types in the content. The only difference between a KPI header and a standard header is that the former requires a subtitle, a KPI area and can display an optional second subtitle. To display an analytical card, add the \`fd-card--analytical\` modifier class to the main element.
...
- Donut
- Combined
- Scatter plot`}}};const c=()=>u;c.storyName="List card";c.parameters={docs:{description:{story:`A card can display various types of lists. All components placed inside should behave natively. For this kind of card it is not recommended to keep header interactive, or navigable.
        `}}};const l=()=>p;l.storyName="Table card";l.parameters={docs:{description:{story:"Cards can display tables within the content area. To display a table card, add the `fd-card--table` modifier class to the main element."}}};const o=()=>f;o.storyName="Object card";o.parameters={docs:{description:{story:"The object card can display a single object or a group of objects. Contrary to other cards, object card has 1rem padding on all sides of the content area. To display an object card, add the `fd-card--object` modifier class to the main element.\n\n**Within the content area, there are several components:**\n\n| Component (class) | Description |\n|:-------------------|:-------------|\n| `fd-card__content-container` | A wrapper for the content sections. By default, the content is displayed in one column. To display the content in two columns, add the `fd-card__content-container--horizontal` modifier class. |\n| `fd-card__content-section` | A content section. A section contains a group title and one or multiple groups. The min-width of the section is 12rem and it can reach a maximum of 24rem. |\n| `fd-card__content-title-container` | A container for the title. |\n| `fd-card__content-group` | A container for the content group. It can also contain an avatar with size XS, a group label and a group value. |\n| `fd-card__content-label-container` | A container for the label of the group. |\n| `fd-card__content-group-container` | A container for the value of the group. |\n"}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => cardNonInteractiveExampleHtml",...a.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => cardNonInteractiveHeaderExampleHtml",...n.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => cardInteractiveButtonExampleHtml",...d.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => cardInteractiveListitemExampleHtml",...e.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => cardAnatomyExampleHtml",...t.parameters?.docs?.source}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:"() => extendedHeaderExampleHtml",...v.parameters?.docs?.source}}};_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:"() => numericHeaderExampleHtml",..._.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => cardStatusIconExampleHtml",...i.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => cardEmptyStateExampleHtml",...r.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => analyticalCardExampleHtml",...s.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:"() => listCardExampleHtml",...c.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"() => tableCardExampleHtml",...l.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => objectCardExampleHtml",...o.parameters?.docs?.source}}};const z=["CardNonInteractive","CardNonInteractiveHeader","CardInteractiveButton","CardInteractiveListitem","CardAnatomy","ExtendedHeader","NumericHeader","StatusIcon","CardEmptyState","AnalyticalCard","ListCard","TableCard","ObjectCard"];export{s as AnalyticalCard,t as CardAnatomy,r as CardEmptyState,d as CardInteractiveButton,e as CardInteractiveListitem,a as CardNonInteractive,n as CardNonInteractiveHeader,v as ExtendedHeader,c as ListCard,_ as NumericHeader,o as ObjectCard,i as StatusIcon,l as TableCard,z as __namedExportsOrder,O as default};
