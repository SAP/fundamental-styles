...
`,tags:["f3","a11y","theme"]}},e=()=>w;e.storyName="Default";e.parameters={docs:{description:{story:"File Uploader is a composition of the `fd-input` class and the `fd-button` one. The button triggers the action of searching for\n            the file which needs to be uploaded. The input field shows the predetermined title i.e. Choose a file for upload."}}};const l=()=>v;l.storyName="After Selecting";l.parameters={docs:{description:{story:"Once the user selects files, update the input and the hidden div to include the file names. The hidden div will announce the file names only once when the value changes."}}};const i=()=>h;i.parameters={docs:{description:{story:"For Status File Uploader apply the corresponding status class `is-success, is-error, is-warning, is-information ` modifier to the input element."}}};const n=()=>m;n.storyName="File Uploader with File List";n.parameters={docs:{description:{story:'<span class="fd-info-label fd-info-label--accent-color-3"><span class="fd-info-label__text">non-fiori 3</span></span><span style="margin-right: 0.5rem;"></span><span class="fd-info-label fd-info-label--accent-color-4"><span class="fd-info-label__text">CX</span></span>'}}};var t,a,s;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:"() => primaryExampleHtml",...(s=(a=e.parameters)==null?void 0:a.docs)==null?void 0:s.source}}};var o,d,r;l.parameters={...l.parameters,docs:{...(o=l.parameters)==null?void 0:o.docs,source:{originalSource:"() => selectedExampleHtml",...(r=(d=l.parameters)==null?void 0:d.docs)==null?void 0:r.source}}};var p,c,f;i.parameters={...i.parameters,docs:{...(p=i.parameters)==null?void 0:p.docs,source:{originalSource:"() => statusExampleHtml",...(f=(c=i.parameters)==null?void 0:c.docs)==null?void 0:f.source}}};var u,b,_;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:"() => fileUploaderWithFilesExampleHtml",...(_=(b=n.parameters)==null?void 0:b.docs)==null?void 0:_.source}}};const k=["Primary","Selected","Status","FileUploaderWithFiles"];export{n as FileUploaderWithFiles,e as Primary,l as Selected,i as Status,k as __namedExportsOrder,j as default};
//# sourceMappingURL=file-uploader.stories-fd761f79.js.map
