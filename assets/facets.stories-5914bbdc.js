/* empty css                     *//* empty css                   *//* empty css                      *//* empty css              *//* empty css             *//* empty css                      *//* empty css             *//* empty css               *//* empty css                         *//* empty css               *//* empty css             *//* empty css            *//* empty css                   *//* empty css             *//* empty css                *//* empty css                *//* empty css                *//* empty css                 */const S=`<div class="mobile-container">
...
`,D=`<section class="fd-dynamic-page fd-dynamic-page--xl" aria-label="Dynamic Page Desktop Example">
        <header class="fd-dynamic-page__header">
...
`,M=`<div class="fd-facet fd-facet--image fd-margin-end--md">
        <span class="fd-avatar fd-avatar--l" aria-label="Avatar">
            <i class="fd-avatar__icon sap-icon--money-bills" role="presentation"></i>
        </span>
    </div>
`,R=`<div class="fd-facet fd-facet--rating-indicator fd-margin-end--md fd-margin-bottom--sm" role="group" aria-labelledby="ratingFacetTitle2">
...
`,L=`<div class="fd-facet fd-facet--form fd-margin-end--md fd-margin-bottom--sm" role="group" aria-labelledby="formFacetTitle3">
...
`,P=`<div class="fd-facet fd-facet--form fd-margin-end--md fd-margin-bottom--sm" role="group" aria-labelledby="formFacetTitle2">
...
`,H=`<div class="fd-facet fd-facet--key-value fd-margin-end--md fd-margin-bottom--sm" role="group" aria-labelledby="kvFacetTitle5">
...
`,I=`<div class="fd-facet-group" role="group">
        <div class="fd-facet fd-facet--image fd-margin-end--md">
            <span class="fd-avatar fd-avatar--l" aria-label="Avatar">
                <i class="fd-avatar__icon sap-icon--money-bills" role="presentation"></i>
            </span>
...
`,ia={title:"Dev/Facets",parameters:{description:`Facets can be used as a standalone component or linked to another component. Facets are usually a part of the *Object Page* header content.
        Each facet adapts its size to the content and makes optimal use of the space without truncating the texts. If the facets do not all fit on one line, those on the right wrap to the line below. `}},a=()=>I;a.storyName="Combination of facets";a.parameters={docs:{description:{story:"Facet types(image, form, and key-value) used together."}}};const e=()=>H;e.storyName="Key-Value Facet";e.parameters={docs:{description:{story:`Key-Value facet is used to highlight important data or KPIs. It consists of a mandatory title
        and a text or number in a larger font size(**Object Status** or **Object Number**). The value can also have an icon to its left.
        `}}};const d=()=>P;d.parameters={docs:{description:{story:`Form facet is used to display datasets. It consists of an optional title and label-value pair.
        Note that the labels can be icons, but need to have a text for accessibility purposes.
        `}}};const t=()=>L;t.storyName="Form Facet with Link";t.parameters={docs:{description:{story:"Text in a form facet can also hold a link by using the Link component."}}};const n=()=>R;n.storyName="Rating Indicator Facet";n.parameters={docs:{description:{story:`The Rating Indicator Facet displays a **Rating Indicator**. It consists of a mandatory title, optional supplementary texts
        like a subtitle or a dynamic text, and the rating indicator.`}}};const i=()=>M;i.storyName="Image/Avatar Facet";i.parameters={docs:{description:{story:"Counter added to a tab"}}};const s=()=>D;s.storyName="Facets in Object Page";s.parameters={docs:{description:{story:"All facet types used together in the context of a dynamic page. To have the image from the image facet appear next to the title, add the class\n        `fd-facet` and apply the modifiers `fd-facet--image` and `fd-facet--image-header-title` to the\n        `fd-dynamic-page__title-container` class. Note that the dynamic page title and subtitle should be placed in the `fd-dynamic-page__title-subtitle-container` class\n        for proper alignment with the image.\n\nThe final structure of a collapsed header with image next to the title is shown below with changes marked in bold:\n\n- `fd-dynamic-page__title-area` The area holding title, KPI content, subtitle, and actions\n  - `fd-dynamic-page__main-container` Main container that holds Breadcrumb, image, title, title content and actions\n    - `fd-dynamic-page__breadcrumb-title-container` Container that holds breadcrumb, title, and title content\n        - `fd-dynamic-page__breadcrumb-container` Breadcrumbs Container, can contain toolbar container\n            - `fd-dynamic-page__breadcrumb` Breadcrumbs\n        - **`fd-dynamic-page__title-container` The container for image, title, subtitle and toolbar**\n            - **`fd-facet fd-facet--image fd-facet--image-header-title` The image facet**\n            - **`fd-facet__title-subtitle-container` The container for title and subtitle**\n                - `fd-dynamic-page__title` Dynamic page title\n                - **`fd-dynamic-page__subtitle` Dynamic page subtitle**\n            - `fd-dynamic-page__title-content` The KPI content\n            - `fd-dynamic-page__toolbar-container` Container that holds toolbar-related actions\n                - `fd-dynamic-page__toolbar` Toolbar container for actions\n                - `fd-dynamic-page__toolbar--actions` Navigation actions\n"}}};const l=()=>S;l.storyName="Facets in Object Page Mobile";var r,o,c;a.parameters={...a.parameters,docs:{...(r=a.parameters)==null?void 0:r.docs,source:{originalSource:"() => combinedExampleHtml",...(c=(o=a.parameters)==null?void 0:o.docs)==null?void 0:c.source}}};var f,m,u;e.parameters={...e.parameters,docs:{...(f=e.parameters)==null?void 0:f.docs,source:{originalSource:"() => keyValueExampleHtml",...(u=(m=e.parameters)==null?void 0:m.docs)==null?void 0:u.source}}};var b,p,g;d.parameters={...d.parameters,docs:{...(b=d.parameters)==null?void 0:b.docs,source:{originalSource:"() => formFacetExampleHtml",...(g=(p=d.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};var _,v,h;t.parameters={...t.parameters,docs:{...(_=t.parameters)==null?void 0:_.docs,source:{originalSource:"() => formFacetLinkExampleHtml",...(h=(v=t.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var y,x,k;n.parameters={...n.parameters,docs:{...(y=n.parameters)==null?void 0:y.docs,source:{originalSource:"() => ratingIndicatorExampleHtml",...(k=(x=n.parameters)==null?void 0:x.docs)==null?void 0:k.source}}};var j,T,E;i.parameters={...i.parameters,docs:{...(j=i.parameters)==null?void 0:j.docs,source:{originalSource:"() => imageFacetExampleHtml",...(E=(T=i.parameters)==null?void 0:T.docs)==null?void 0:E.source}}};var F,q,A;s.parameters={...s.parameters,docs:{...(F=s.parameters)==null?void 0:F.docs,source:{originalSource:"() => objectPageExampleHtml",...(A=(q=s.parameters)==null?void 0:q.docs)==null?void 0:A.source}}};var C,w,B;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:"() => objectPageMobileExampleHtml",...(B=(w=l.parameters)==null?void 0:w.docs)==null?void 0:B.source}}};const sa=["Combined","KeyValue","FormFacet","FormFacetLink","RatingIndicator","ImageFacet","ObjectPage","ObjectPageMobile"];export{a as Combined,d as FormFacet,t as FormFacetLink,i as ImageFacet,e as KeyValue,s as ObjectPage,l as ObjectPageMobile,n as RatingIndicator,sa as __namedExportsOrder,ia as default};
//# sourceMappingURL=facets.stories-5914bbdc.js.map
