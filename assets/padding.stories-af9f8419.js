...
<br>
`,C=`<div class="demo sap-padding-responsive">
    <div></div>
</div>
`,E=`<div style="container-type: inline-size;">
    <div class="demo sap-padding-responsive-container">
        <div></div>
    </div>
</div>
`,R=`<div class="demo sap-padding-none">
    <div></div>
</div>

`,H={title:"Padding",parameters:{description:x}},r=`
<style>
    div.demo {
        display: flex;
        height: 4rem;
...
`,d=()=>`${r}${P}`;d.storyName="All-Round Padding";d.parameters={docs:{description:{story:`All-round padding appear on all sides of the container they are applied to.<br>
        ...
        `}}};const e=()=>`${r}${f}`;e.storyName="Double Sided Padding";e.parameters={docs:{description:{story:`Double sided paddings appear on two opposite sides of the element. The horizontal margins are displayed on left and right side of the element.
            <table style="width: 100%; border-collapse: collapse; margin-top: 1rem;">
                <tr>
            ...
            </table>`}}};const t=()=>`${r}${C}`;t.storyName="Responsive Paddings";t.parameters={docs:{description:{story:`The responsive padding class adds a double sided padding inside a container based on screen width.<br>
            ...
            </table>`}}};const n=()=>`${r}${E}`;n.storyName="Responsive Container Paddings";n.parameters={docs:{description:{story:`The responsive padding class adds a double sided padding inside a container based on its width.<br>
            ...
            </table>`}}};const a=()=>`${r}${R}`;a.parameters={docs:{description:{story:`No padding class removes existing container paddings. <br>
            <b>CSS class: </b> <code>.sap-padding-none</code><br>
            <b>SCSS mixin: </b> <code>@include sap-padding(0);</code><br>
            `}}};var i,s,p;d.parameters={...d.parameters,docs:{...(i=d.parameters)==null?void 0:i.docs,source:{originalSource:"() => `${localStyles}${allRoundPaddingExampleHtml}`",...(p=(s=d.parameters)==null?void 0:s.docs)==null?void 0:p.source}}};var l,o,m;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:"() => `${localStyles}${horizontalPaddingExampleHtml}`",...(m=(o=e.parameters)==null?void 0:o.docs)==null?void 0:m.source}}};var g,c,y;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:"() => `${localStyles}${responsivePaddingExampleHtml}`",...(y=(c=t.parameters)==null?void 0:c.docs)==null?void 0:y.source}}};var u,v,b;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:"() => `${localStyles}${responsivePaddingContainerExampleHtml}`",...(b=(v=n.parameters)==null?void 0:v.docs)==null?void 0:b.source}}};var h,$,S;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:"() => `${localStyles}${noPaddingExampleHtml}`",...(S=($=a.parameters)==null?void 0:$.docs)==null?void 0:S.source}}};const w=["AllRoundPadding","HorizontalPadding","ResponsivePadding","ResponsivePaddingContainer","NoPadding"];export{d as AllRoundPadding,e as HorizontalPadding,a as NoPadding,t as ResponsivePadding,n as ResponsivePaddingContainer,w as __namedExportsOrder,H as default};
