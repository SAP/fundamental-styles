...
`,tags:["f3","a11y","theme","development"]}},i=()=>ni;i.storyName="Default";i.parameters={docs:{story:{iframeHeight:785},description:{story:"The default byline list dislays list items in the standard size, which is ideal for mobile. To display the byline list in compact mode (for desktop), add the `is-compact` modifier class to the main element.\n    "}}};const l=()=>li;l.parameters={docs:{story:{iframeHeight:785},description:{story:`The Attachment List shares the same specification as the Standard List with Byline. The only difference is that if two text items are set within the Byline row, the text aligned to the right is always standard text (i.e. not semantic text)
    `}}};const n=()=>ei;n.parameters={docs:{story:{iframeHeight:355},description:{story:"\nByline list items can contain navigation links. To add navigation, add the `fd-list--navigation` modifier class to the list and the `fd-list__item--link` modifier class to the list elements that contain links. All items should be navigable.\n"}}};const a=()=>si;a.parameters={docs:{story:{iframeHeight:165},description:{story:`
`}}};const d=()=>ti;d.parameters={docs:{story:{iframeHeight:300},description:{story:"The `fd-list__item--interractive` will force list item to handle hover and active states.\n            Usage of this modifier is not needed on `Selection`, `Navigation` and `Action` modes."}}};const t=()=>ii;t.storyName="Navigation indicators";t.parameters={docs:{story:{iframeHeight:275},description:{story:"\nIf only some of the list items are navigable, you should indicate them with an arrow icon. To display navigation indicators, add the `fd-list--navigation-indication` modifier class to the unordered list element. Do not show indicators if all items are navigable. In this case, use a byline list with navigation (in the example above).\n"}}};const o=()=>$;o.parameters={docs:{story:{iframeHeight:305},description:{story:"To display a borderless byline list, add the `fd-list--no-border` modifier class to the main element.\n    "}}};const c=()=>Q;c.parameters={docs:{story:{iframeHeight:625},description:{story:"\nByline list items can display checkboxes that users can select from. To display byline list items with selection, add the `fd-list--selection` modifier class to the main element. To create checkbox form items, add the `fd-list__form-item` class within each list element.\n    "}}};const s=()=>P;s.storyName="Selection with navigation";s.parameters={docs:{story:{iframeHeight:625},description:{story:"To display byline list items with selection and navigation, add these following modifier classes to the main element:\n\n- `fd-list--byline`\n- `fd-list--selection`\n- `fd-list--navigation`\n- `fd-list--navigation-indicator`\n    "}}};const r=()=>J;r.storyName="Byline List with Counter";i.parameters={docs:{iframeHeight:785}};const e=()=>W;e.storyName="List with long Title and Byline";e.parameters={docs:{story:{iframeHeight:625},description:{story:`By default, To allow the title and byline text to wrap, add these following modifier classes to the the title and byline respectively:

- \`fd-list__title--wrap\`
- \`fd-list__byline--wrap\`

When more than 100 characters for small screens or 300 characters for medium to large screens are used, a clickable "MORE" link should be displayed to reveal the entire contents of the text.`}}};const _=()=>R;_.parameters={docs:{story:{iframeHeight:625},description:{story:`<span class="fd-info-label fd-info-label--accent-color-1"><span class="fd-info-label__text">non-fiori 3</span></span><br>
    `}}};var f,m,b;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:"() => standardExampleHtml",...(b=(m=i.parameters)==null?void 0:m.docs)==null?void 0:b.source}}};var v,p,u;l.parameters={...l.parameters,docs:{...(v=l.parameters)==null?void 0:v.docs,source:{originalSource:"() => attachmentExampleHtml",...(u=(p=l.parameters)==null?void 0:p.docs)==null?void 0:u.source}}};var y,h,x;n.parameters={...n.parameters,docs:{...(y=n.parameters)==null?void 0:y.docs,source:{originalSource:"() => navigationExampleHtml",...(x=(h=n.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};var g,k,w;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:"() => buttonsExampleHtml",...(w=(k=a.parameters)==null?void 0:k.docs)==null?void 0:w.source}}};var L,S,T;d.parameters={...d.parameters,docs:{...(L=d.parameters)==null?void 0:L.docs,source:{originalSource:"() => interractiveExampleHtml",...(T=(S=d.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};var B,H,I;t.parameters={...t.parameters,docs:{...(B=t.parameters)==null?void 0:B.docs,source:{originalSource:"() => navigationIndicatorExampleHtml",...(I=(H=t.parameters)==null?void 0:H.docs)==null?void 0:I.source}}};var E,z,N;o.parameters={...o.parameters,docs:{...(E=o.parameters)==null?void 0:E.docs,source:{originalSource:"() => borderlessExampleHtml",...(N=(z=o.parameters)==null?void 0:z.docs)==null?void 0:N.source}}};var q,A,G;c.parameters={...c.parameters,docs:{...(q=c.parameters)==null?void 0:q.docs,source:{originalSource:"() => selectionExampleHtml",...(G=(A=c.parameters)==null?void 0:A.docs)==null?void 0:G.source}}};var O,F,j;s.parameters={...s.parameters,docs:{...(O=s.parameters)==null?void 0:O.docs,source:{originalSource:"() => selectionAndNavigationExampleHtml",...(j=(F=s.parameters)==null?void 0:F.docs)==null?void 0:j.source}}};var U,C,K;r.parameters={...r.parameters,docs:{...(U=r.parameters)==null?void 0:U.docs,source:{originalSource:"() => counterExampleHtml",...(K=(C=r.parameters)==null?void 0:C.docs)==null?void 0:K.source}}};var D,Y,M;e.parameters={...e.parameters,docs:{...(D=e.parameters)==null?void 0:D.docs,source:{originalSource:"() => longTextExampleHtml",...(M=(Y=e.parameters)==null?void 0:Y.docs)==null?void 0:M.source}}};var V,X,Z;_.parameters={..._.parameters,docs:{...(V=_.parameters)==null?void 0:V.docs,source:{originalSource:"() => unreadNotificationExampleHtml",...(Z=(X=_.parameters)==null?void 0:X.docs)==null?void 0:Z.source}}};const mi=["Standard","Attachment","Navigation","Buttons","Interractive","NavigationIndicator","Borderless","Selection","SelectionAndNavigation","Counter","LongText","UnreadNotification"];export{l as Attachment,o as Borderless,a as Buttons,r as Counter,d as Interractive,e as LongText,n as Navigation,t as NavigationIndicator,c as Selection,s as SelectionAndNavigation,i as Standard,_ as UnreadNotification,mi as __namedExportsOrder,fi as default};
//# sourceMappingURL=byline-list.stories-706e6e8c.js.map
