/* empty css            *//* empty css                   *//* empty css             *//* empty css             *//* empty css                *//* empty css              *//* empty css             *//* empty css               *//* empty css                *//* empty css                     *//* empty css                   *//* empty css                      *//* empty css                      *//* empty css                         *//* empty css               *//* empty css                *//* empty css                 *//* empty css             */const W=`<div class="mobile-container">
...
`,N=`<section class="fd-dynamic-page fd-dynamic-page--xl" aria-label="Dynamic Page Desktop Example">
        <header class="fd-dynamic-page__header">
...
`,K=`<section class="fd-dynamic-page fd-dynamic-page--xl" aria-label="Dynamic Page Pinnable Example">
        <header class="fd-dynamic-page__header">
...
`,V=`<section class="fd-dynamic-page fd-dynamic-page--xl" aria-label="Dynamic Page Collapsed Example">
        <header class="fd-dynamic-page__header">
...
`,O=`<section class="fd-dynamic-page fd-dynamic-page--xl" aria-label="Dynamic Page Expandable Example" xmlns="http://www.w3.org/1999/html">
        <header class="fd-dynamic-page__header">
            <div class="fd-dynamic-page__title-area " tabindex="0">
                <div class="fd-dynamic-page__main-container">
                    <div class="fd-dynamic-page__breadcrumb-title-container">
                    ...
                    <div class="fd-dynamic-page__breadcrumb-title-container">
                        ...
                        <div class="fd-dynamic-page__title-container">
                            <h1 class="fd-title fd-dynamic-page__title">
                                <a href="#" class="fd-link" title="Balenciaga Triple S Trainers">
                                    <span class="fd-link__content">Balenciaga Triple S Trainers </span>
                                </a>
                            </h1>
...
`,G=`
    ...
    <br /><br />
`,ba={title:"Layouts/Dynamic Page",parameters:{description:`The dynamic page is the foundation for all pages in SAP Fiori. It is a generic layout designed to support various use cases; therefore, the content of both the header and page can vary.
...
`,tags:["f3","theme","development"],components:["bar","breadcrumb","tabs","link","toolbar","title","icon","button","popover","facet","form-label","object-status","object-number","rating-indicator","avatar","margins","paddings","text","dynamic-page"]}},s=()=>G;s.parameters={docs:{description:{story:"The dynamic page displays on desktop screens with the L, XL, and XXL sizes. To optimize dynamic page for desktop, add modifier class `fd-dynamic-page--xl`.\n\nIn addition, add the modifier classes `--add-shadow` to the unordered list, and `--overflow` at the parent level for the box-shadow styling.\n"}}};const d=()=>Y;d.parameters={docs:{description:{story:"The dynamic page displays on tablet screens with the M size. To optimize dynamic page for tablet, add modifier class `fd-dynamic-page--md`.\n\nIt is recommended that the navigation actions are displayed in a separate row above product actions, and are placed at the same level as the breadcrumb component."}}};const l=()=>X;l.parameters={docs:{description:{story:"The dynamic page displays on mobile screens with the S size. To optimize dynamic page for mobile, add modifier class `fd-dynamic-page--sm`.\n\nTo display the breadcrumb and close button, they must be wrapped in `fd-dynamic-page__breadcrumb-container`. The toolbar overflow actions are functional without being wrapped in an additional container.\nUse `fd-dynamic-page__toolbar--content` for the title content when it is used in an overflow toolbar."}}};const a=()=>U;a.storyName="Collapsed Header (mobile)";a.parameters={docs:{description:{story:"In the example below, the dynamic page is displayed with a collapsed header for mobile screens."}}};const e=()=>I;e.storyName="Summary Line (mobile)";e.parameters={docs:{description:{story:"It is recommended to add a summary line insead of the expand/collapse header feature so users can better focus on the page content. To display a summary line,\n        add `fd-dynamic-page__summarized-title` in the `fd-dynamic-page__summarized-title-area` element."}}};const n=()=>O;n.storyName="Expanded Header";n.parameters={docs:{description:{story:"As demonstrated earlier, the dynamic page header can be either displayed or hidden with the expand/collapse buttons. Users can select the pin button to keep the header displayed (enabling the sticky feature).\n        To collapse the dynamic page, add the `--collapsed` modifier class to the title area and title elements."}}};const o=()=>V;o.parameters={docs:{description:{story:"In the example below, the dynamic page is displayed with a collapsed header for desktop screens."}}};const i=()=>K;i.storyName="Without pin";i.parameters={docs:{description:{story:"The dynamic page can be displayed without a pin button, giving users the option to only expand or collapse the header area."}}};const t=()=>N;t.storyName="With header facets";t.parameters={docs:{description:{story:"To have the image from the image facet appear next to the title, add the class\n        `fd-facet` and apply the modifiers `fd-facet--image` and `fd-facet--image-header-title` to the\n        `fd-dynamic-page__title-container` class.\n        Note that the dynamic page title and subtitle should be placed in the `fd-dynamic-page__title-subtitle-container` class\n        for proper alignment with the image.\n"}}};const r=()=>W;r.storyName="With header facets (mobile)";var c,u,p;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:"() => desktopExampleHtml",...(p=(u=s.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};var m,b,f;d.parameters={...d.parameters,docs:{...(m=d.parameters)==null?void 0:m.docs,source:{originalSource:"() => tabletExampleHtml",...(f=(b=d.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};var _,g,v;l.parameters={...l.parameters,docs:{...(_=l.parameters)==null?void 0:_.docs,source:{originalSource:"() => mobileExampleHtml",...(v=(g=l.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};var h,y,q;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:"() => mobileCollapsedExampleHtml",...(q=(y=a.parameters)==null?void 0:y.docs)==null?void 0:q.source}}};var x,w,k;e.parameters={...e.parameters,docs:{...(x=e.parameters)==null?void 0:x.docs,source:{originalSource:"() => summaryLineExampleHtml",...(k=(w=e.parameters)==null?void 0:w.docs)==null?void 0:k.source}}};var E,T,C;n.parameters={...n.parameters,docs:{...(E=n.parameters)==null?void 0:E.docs,source:{originalSource:"() => expandableExampleHtml",...(C=(T=n.parameters)==null?void 0:T.docs)==null?void 0:C.source}}};var S,z,A;o.parameters={...o.parameters,docs:{...(S=o.parameters)==null?void 0:S.docs,source:{originalSource:"() => collapsedHeaderExampleHtml",...(A=(z=o.parameters)==null?void 0:z.docs)==null?void 0:A.source}}};var L,D,M;i.parameters={...i.parameters,docs:{...(L=i.parameters)==null?void 0:L.docs,source:{originalSource:"() => onlyCollapseExampleHtml",...(M=(D=i.parameters)==null?void 0:D.docs)==null?void 0:M.source}}};var j,B,R;t.parameters={...t.parameters,docs:{...(j=t.parameters)==null?void 0:j.docs,source:{originalSource:"() => withFacetsExampleHtml",...(R=(B=t.parameters)==null?void 0:B.docs)==null?void 0:R.source}}};var H,P,F;r.parameters={...r.parameters,docs:{...(H=r.parameters)==null?void 0:H.docs,source:{originalSource:"() => withFacetsMobileExampleHtml",...(F=(P=r.parameters)==null?void 0:P.docs)==null?void 0:F.source}}};const fa=["Desktop","Tablet","Mobile","MobileCollapsed","SummaryLine","Expandable","CollapsedHeader","OnlyCollapse","WithFacets","WithFacetsMobile"];export{o as CollapsedHeader,s as Desktop,n as Expandable,l as Mobile,a as MobileCollapsed,i as OnlyCollapse,e as SummaryLine,d as Tablet,t as WithFacets,r as WithFacetsMobile,fa as __namedExportsOrder,ba as default};
//# sourceMappingURL=dynamic-page.stories-b4d0a41a.js.map
