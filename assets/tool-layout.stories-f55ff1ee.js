const a=`<div style="height: 30rem; position: relative;">
...
`;const r={title:"BTP/Tool Layout",parameters:{description:`The Tool Layout is an essential part of most BTP tools. The layout combines the Tool Header and the Navigation components in one consistent structure. In addition, it provides necessary interaction between the two components out of the box.
## Anatomy
...
`,tags:["btp","development","horizon-only"]}},e=()=>n;e.parameters={docs:{description:{story:""}}};const t=()=>a;t.parameters={docs:{description:{story:"The <code>fd-tool-layout--sticky</code> modifier class will position the whole layout absolutely with the header container always on top. The navigation and content containers receive the scroll overflow."}}};const i=()=>s;i.parameters={docs:{description:{story:"Apply the <code>fd-tool-layout--tablet</code> modifier class for tablet devices."}}};const o=()=>u;o.parameters={docs:{description:{story:"Apply the <code>fd-tool-layout--phone</code> modifier class for mobile devices."}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => desktopExampleHtml",...e.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => stickyExampleHtml",...t.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => tabletExampleHtml",...i.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => mobileExampleHtml",...o.parameters?.docs?.source}}};const l=["Desktop","Sticky","Tablet","Mobile"];export{e as Desktop,o as Mobile,t as Sticky,i as Tablet,l as __namedExportsOrder,r as default};
