var x=Object.defineProperty,p=Object.defineProperties;var y=Object.getOwnPropertyDescriptors;var r=Object.getOwnPropertySymbols;var w=Object.prototype.hasOwnProperty,T=Object.prototype.propertyIsEnumerable;var c=(n,e,s)=>e in n?x(n,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):n[e]=s,a=(n,e)=>{for(var s in e||(e={}))w.call(e,s)&&c(n,s,e[s]);if(r)for(var s of r(e))T.call(e,s)&&c(n,s,e[s]);return n},t=(n,e)=>p(n,y(e));/* empty css                    *//* empty css              *//* empty css            *//* empty css               *//* empty css             *//* empty css             */const z=`
...
`,S=`<div class="fd-message-box-docs-static fd-message-box fd-message-box--confirmation fd-message-box--active">
...
`,C=`<div class="fd-message-box-docs-static fd-message-box fd-message-box--active">
    <section class="fd-message-box__content">
        <header class="fd-bar fd-bar--header fd-message-box__header">
            <div class="fd-bar__left">
                <div class="fd-bar__element">
...
`,W={title:"Components/Message Box",parameters:{description:`
...
- \`.fd-message-box\`: styles the backdrop and displays the message box container with \`position: fixed\`. The message box becomes visible by adding the \`.fd-message-box--active\` modifier class to the container.
    - \`.fd-message-box__content\`: Content container
        ...
        `,tags:["f3","a11y","theme"]}},o=()=>C;o.storyName="Default";o.parameters={docs:{description:{story:`
The default message box displays a small dialog with a title, message text and action buttons. Use the default if the message does not fit with one of the semantic types.
    `}}};const d=()=>S;d.storyName="Semantic types";d.parameters={docs:{description:{story:`
...
Information | \`fd-message-box--information\` | Information messages provide information the user needs to acknowledge, but which does not involve a decision. The message provides information that is useful and relevant, but never critical.
        ...
        `}}};const i=()=>z;i.parameters={docs:{description:{story:`
...
Enable cozy mode when message box is being displayed on mobile. To display message box in cozy mode, add the \`fd-bar--cozy\` modifier class to the header and footer (this will also apply to the buttons). It's also important to note that the content container should always take the full height and width of mobile screens. To achieve this, add the \`fd-message-box__content--mobile\` modifier class to the content container.
         `}}};var b,f,l;o.parameters=t(a({},o.parameters),{docs:t(a({},(b=o.parameters)==null?void 0:b.docs),{source:a({originalSource:"() => structureExampleHtml"},(l=(f=o.parameters)==null?void 0:f.docs)==null?void 0:l.source)})});var m,h,_;d.parameters=t(a({},d.parameters),{docs:t(a({},(m=d.parameters)==null?void 0:m.docs),{source:a({originalSource:"() => typesExampleHtml"},(_=(h=d.parameters)==null?void 0:h.docs)==null?void 0:_.source)})});var g,u,v;i.parameters=t(a({},i.parameters),{docs:t(a({},(g=i.parameters)==null?void 0:g.docs),{source:a({originalSource:"() => responsiveExampleHtml"},(v=(u=i.parameters)==null?void 0:u.docs)==null?void 0:v.source)})});const D=["Structure","Types","Responsive"];export{i as Responsive,o as Structure,d as Types,D as __namedExportsOrder,W as default};
