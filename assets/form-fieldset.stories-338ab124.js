...
`,x={title:"Components/Forms/Field Set",parameters:{description:`A fieldset is used to give semantic meaning to a group of elements inside a form (e.g. Billing or Shipping Address).
Grouping fields together into a fieldset also provides styling and accessibility benefits.`,tags:["f3","a11y","theme"]}},e=()=>t;e.parameters={docs:{story:{iframeHeight:450},description:{story:"Checkbox groups should always be grouped using fieldset for accessibility reasons."}}};const s=()=>o;s.parameters={docs:{story:{iframeHeight:200},description:{story:"Radio button groups should always be grouped using fieldset for accessibility reasons."}}};var l,d,a;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:"() => checkboxGroupsExampleHtml",...(a=(d=e.parameters)==null?void 0:d.docs)==null?void 0:a.source}}};var i,n,c;s.parameters={...s.parameters,docs:{...(i=s.parameters)==null?void 0:i.docs,source:{originalSource:"() => radioButtonGroupsExampleHtml",...(c=(n=s.parameters)==null?void 0:n.docs)==null?void 0:c.source}}};const _=["CheckboxGroups","RadioButtonGroups"];export{e as CheckboxGroups,s as RadioButtonGroups,_ as __namedExportsOrder,x as default};
//# sourceMappingURL=form-fieldset.stories-338ab124.js.map
