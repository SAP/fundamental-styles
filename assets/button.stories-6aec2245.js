/* empty css                *//* empty css                         *//* empty css             *//* empty css             *//* empty css               *//* empty css                     */const F=`
...
`,O=`<div class="fddocs-button-container">
...
`,z=`<div class="fddocs-button-container">
    <button class="fd-button">
...
</div>`,q=`<h4>Inactive state of toggle button</h4>
...
</div>`,V=`<div class="fddocs-container fddocs-button-container">
    <button class="fd-button">
        <span class="fd-button__text">Default Button</span>
    </button>
    <button class="fd-button fd-button--emphasized">
...
</div>`,P={title:"Components/Buttons/Button",parameters:{description:`The button component is used to trigger an action. All buttons are characterized by the \`fd-button\` class and an additional modifier classes to specify each button type.
...
`,tags:["f3","a11y","theme"]}},t=()=>V;t.storyName="Button styles";t.parameters={docs:{description:{story:`
...
`}}};const n=()=>q;n.storyName="Toggle button";n.parameters={docs:{description:{story:'A toggle button switches between two states. First is the active state, second is inactive. Use the toggle button for secondary actions.\nActive (toggled) button should have `aria-pressed="true"` and `fd-button--toggled` class and inactive buttons should have `aria-pressed="false"`\n'}}};const e=()=>z;e.storyName="Button With Badge";e.parameters={docs:{description:{story:`Button gets a badge in cases of collecting a number of items from various pages in order to trigger an action.
Currently the Emphasized, Standard, Ghost and Transparent type of buttons are recommended to be used with Badge.

**Badges cannot contain more than 4 characters**.`}}};const a=()=>O;a.storyName="Menu button";a.parameters={docs:{description:{story:`The menu button displays a dropdown menu upon click and is considered the default menu button.
There are two different type of menu buttons: the default menu button and split menu button.

**Maximum width is 12rem**.
            `}}};const s=()=>E;s.storyName="Icon or text";s.parameters={docs:{description:{story:`
...
`}}};const o=()=>S;o.storyName="Button states";o.parameters={docs:{description:{story:"\nThese button types indicate different states: normal, selected, disabled and focusable disabled.\n\n- **Normal**: The button’s default state. It can be selected to perform a corresponding action.\n- **Disabled**: It cannot be selected. This state can be displayed by using the `disabled` attribute.\n- **Focusable disabled**: It cannot be selected, but it is tabbable and focusable. When the button is selected, a focus ring appears. This state can be displayed by using the `is-disabled` class and the `aria-disabled=”true”` attribute for accessibility without using the `disabled` property. By adding the hidden `_instructions` element, the user will be notified for further instructions on how to enable the button. They will also be notified when the button is enabled when using the `aria-live` property.\n"}}};const i=()=>F;i.storyName="Focusable disabled";i.parameters={docs:{description:{story:"\nThe disabled button can be focusable by adding the `aria-disabled` attribute. To enable the focus ring in a focusable disabled button, ensure that `is-disabled` class is present while `disabled` attribute is not.\n\n####Accessibility\n\nWhen the state of the button has changed, add `aria-live=”assertive”` to prompt the screen reader to read the helper text out loud.\n\nNote: For the text to be read out loud by screen readers, a helper text has been added with `aria-describedby` matching the `id` of the paragraph element with the `_instructions` element. The element uses the `screen-reader-only` styling so that it is not visible.\n\n"}}};var d,u,b;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:"() => stylesExampleHtml",...(b=(u=t.parameters)==null?void 0:u.docs)==null?void 0:b.source}}};var r,l,c;n.parameters={...n.parameters,docs:{...(r=n.parameters)==null?void 0:r.docs,source:{originalSource:"() => toggleExampleHtml",...(c=(l=n.parameters)==null?void 0:l.docs)==null?void 0:c.source}}};var f,p,h;e.parameters={...e.parameters,docs:{...(f=e.parameters)==null?void 0:f.docs,source:{originalSource:"() => badgeOnButtonExampleHtml",...(h=(p=e.parameters)==null?void 0:p.docs)==null?void 0:h.source}}};var g,m,_;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:"() => menuButtonExampleHtml",...(_=(m=a.parameters)==null?void 0:m.docs)==null?void 0:_.source}}};var v,y,w;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:"() => iconAndTextExampleHtml",...(w=(y=s.parameters)==null?void 0:y.docs)==null?void 0:w.source}}};var x,T,A;o.parameters={...o.parameters,docs:{...(x=o.parameters)==null?void 0:x.docs,source:{originalSource:"() => buttonStatesExampleHtml",...(A=(T=o.parameters)==null?void 0:T.docs)==null?void 0:A.source}}};var N,B,D;i.parameters={...i.parameters,docs:{...(N=i.parameters)==null?void 0:N.docs,source:{originalSource:"() => focusableDisabledExampleHtml",...(D=(B=i.parameters)==null?void 0:B.docs)==null?void 0:D.source}}};const M=["Styles","Toggle","BadgeOnButton","MenuButton","IconAndText","ButtonStates","FocusableDisabled"];export{e as BadgeOnButton,o as ButtonStates,i as FocusableDisabled,s as IconAndText,a as MenuButton,t as Styles,n as Toggle,M as __namedExportsOrder,P as default};
//# sourceMappingURL=button.stories-6aec2245.js.map
