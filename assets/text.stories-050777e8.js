...
`,L=`<p class="fd-text">
    ...
    eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
    deserunt mollit anim id est laborum.</p>
`,H={title:"Components/Text",parameters:{description:`The text component displays text inside a form, table, or any other content area.
        It is generally used throughout the entire application and is responsive to all screen sizes.`,tags:["f3","a11y","theme"]}},e=()=>L;e.storyName="Default";e.parameters={docs:{story:{iframeHeight:100},description:{story:`The default text component can display lines of text that wrap to the next line
        once they reach the end of the content container width.`}}};const t=()=>w;t.parameters={docs:{story:{iframeHeight:300},description:{story:"The text component has a property that allows browsers to render specified indents and\n        whitespace. To display indents and/or whitespace, add a\n        `fd-text--pre-wrap` modifier class to the main element."}}};const i=()=>E;i.storyName="Max lines";i.parameters={docs:{story:{iframeHeight:300},description:{story:'The text component can be displayed with a maximum number of lines.\nWhen the maximum is reached, the text truncates and displays an ellipsis. To display text with a maximum line count,\nadd the `fd-text--max-lines` modifier class and an inline style rule with the number of\nlines to the main element. For example, add `style="-webkit-line-clamp: 3;"` to display\nthree lines of text.\n\n**Note**: The property `-webkit-line-clamp` doesn\'t work in IE11 and should be changed\nto `height`. For example, `style="height: 200px;"`.\n'}}};const s=()=>y;s.parameters={docs:{story:{iframeHeight:200},description:{story:`Along with max lines, text component can display "MORE" and "LESS" links that can show
more or less of the text.`}}};const a=()=>q;a.parameters={docs:{story:{iframeHeight:200},description:{story:`The text component can display words that are broken at appropriate hyphenation
...
In HTML, add the \`&shy;\` Unicode to insert a soft hyphen.`}}};var n,r,u;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:"() => defaultExampleExampleHtml",...(u=(r=e.parameters)==null?void 0:r.docs)==null?void 0:u.source}}};var l,o,m;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:"() => whitespaceExampleHtml",...(m=(o=t.parameters)==null?void 0:o.docs)==null?void 0:m.source}}};var c,d,p;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:"() => maxLinesExampleHtml",...(p=(d=i.parameters)==null?void 0:d.docs)==null?void 0:p.source}}};var h,f,g;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:"() => expandExampleHtml",...(g=(f=s.parameters)==null?void 0:f.docs)==null?void 0:g.source}}};var b,x,v;a.parameters={...a.parameters,docs:{...(b=a.parameters)==null?void 0:b.docs,source:{originalSource:"() => hyphenationExampleHtml",...(v=(x=a.parameters)==null?void 0:x.docs)==null?void 0:v.source}}};const M=["DefaultExample","Whitespace","MaxLines","Expand","Hyphenation"];export{e as DefaultExample,s as Expand,a as Hyphenation,i as MaxLines,t as Whitespace,M as __namedExportsOrder,H as default};
//# sourceMappingURL=text.stories-050777e8.js.map
