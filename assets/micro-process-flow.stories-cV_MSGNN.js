/* empty css             *//* empty css             *//* empty css                *//* empty css                         */const t=`<div class="fd-micro-process-flow">
...
`,l=`<div class="fd-micro-process-flow">
    <div class="fd-micro-process-flow__overflow-container">
        <div class="fd-micro-process-flow__wrapper">
            <div class="fd-micro-process-flow__item">
                <div class="fd-micro-process-flow__content">
...
`,p=`<div class="fd-micro-process-flow">
    <div class="fd-micro-process-flow__overflow-container">
        <div class="fd-micro-process-flow__wrapper">
            <div class="fd-micro-process-flow__item">
                <div class="fd-micro-process-flow__content">
...
`,f=`<div class="fd-micro-process-flow fd-micro-process-flow--independent-steps">
    <div class="fd-micro-process-flow__overflow-container">
        <div class="fd-micro-process-flow__wrapper">
            <div class="fd-micro-process-flow__item">
                <div class="fd-micro-process-flow__content">
...
`,_=`<div class="fd-micro-process-flow">
    <div class="fd-micro-process-flow__overflow-container">
        <div class="fd-micro-process-flow__wrapper">
            <div class="fd-micro-process-flow__item">
                <div class="fd-micro-process-flow__content">
...
`,u={title:"Components/Micro Process Flow",parameters:{description:`The micro process flow control enables you to visualize the state of individual items in a linear workflow. You can embed it into a list or a table.
...
- **With independent steps**:  the steps are not connected and can be processed in any order. This type can be used when the user doesn’t need to perform the steps in a linear sequence.
        ...
        `,tags:["f3","a11y","theme"]}},o=()=>_;o.storyName="Micro process flow with dependent steps (Default)";o.parameters={docs:{description:{story:`
        `}}};const s=()=>f;s.storyName="Micro process flow with independent steps";s.parameters={docs:{description:{story:"Add the `.fd-micro-process-flow--independent-steps` modifier class to `.fd-micro-process-flow` class to remove the connector line.\n        "}}};const i=()=>p;i.storyName="Micro process flow with custom steps";i.parameters={docs:{description:{story:`
        `}}};const e=()=>d;e.storyName="Micro process flow with popover";e.parameters={docs:{description:{story:`Information displayed in micro flow process items can be extended by adding popovers with additional context.
        `}}};const c=()=>l;c.storyName="Micro process flow with overflow";c.parameters={docs:{description:{story:`
        `}}};const n=()=>a;n.storyName="Micro process flow with elements inserted between nodes";n.parameters={docs:{description:{story:`
        `}}};const r=()=>t;r.storyName="Micro process flow with custom node width";r.parameters={docs:{description:{story:'By default, the width of the item container is calculated based on the actual item width and the connector line. To change the width add inline style to the element with `.fd-micro-process-flow__item` class and provide value for the width.\n\nFor example:\n`<div class="fd-micro-process-flow__item" style="width: 6rem;">`\n        '}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => defaultMicroProcessFlowExampleHtml",...o.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => microProcessFlowIndependentStepsExampleHtml",...s.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => microProcessFlowCustomExampleHtml",...i.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => microProcessFlowWithPopoverExampleHtml",...e.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:"() => overflowMicroProcessFlowExampleHtml",...c.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => microProcessFlowWithObjectsExampleHtml",...n.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => microProcessFlowCustomWidthExampleHtml",...r.parameters?.docs?.source}}};const b=["DefaultMicroProcessFlow","MicroProcessFlowIndependentSteps","MicroProcessFlowCustom","MicroProcessFlowWithPopover","OverflowMicroProcessFlow","MicroProcessFlowWithObjects","MicroProcessFlowCustomWidth"];export{o as DefaultMicroProcessFlow,i as MicroProcessFlowCustom,r as MicroProcessFlowCustomWidth,s as MicroProcessFlowIndependentSteps,n as MicroProcessFlowWithObjects,e as MicroProcessFlowWithPopover,c as OverflowMicroProcessFlow,b as __namedExportsOrder,u as default};
