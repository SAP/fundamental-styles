...
</pre>`,t=`<p>Provides a set of mixins for creating media queries using predefined breakpoints (S, M, L, XL) or custom values. Includes helpers for min/max width, width ranges, orientation, and print styles to support a mobile-first or desktop-first approach.</p>
