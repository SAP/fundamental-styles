...
`,l={title:"Layouts/Dynamic Side Content",parameters:{description:`
...
`,tags:[]}},s=()=>r;s.storyName="Left";s.parameters={docs:{description:{story:"To display side content from the left, put `fd-dynamic-side__side` as the first child element of `fd-dynamic-side`."}}};const i=()=>c;i.storyName="Right";i.parameters={docs:{description:{story:"To display side content from the right, put `fd-dynamic-side__side` as the second child element of `fd-dynamic-side`."}}};const e=()=>o;e.storyName="Below";e.parameters={docs:{description:{story:"To display side content below the main content area, keep `fd-dynamic-side__side` as the last child element and add the `fd-dynamic-side--below` modifier class."}}};const d=()=>t;d.storyName="Equal split";d.parameters={docs:{description:{story:"The equal split mode provides users with a 50:50 view of the main content and side content, which enables users to show more data i.e. for comparison purposes. To enable equal split mode, add the `fd-dynamic-side--equal-split` modifier class to the container."}}};const a=()=>n;a.parameters={docs:{description:{story:`
