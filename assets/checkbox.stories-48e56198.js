/* empty css                   *//* empty css                 *//* empty css                 */const g=`<fieldset class="fd-fieldset">
...
`,w={title:"Components/Forms/Checkbox",parameters:{description:`A checkbox lets the user set a binary value such as “true/false”. When the user selects the checkbox, it toggles between:
...
`,e=()=>A;e.parameters={docs:{story:{iframeHeight:330},description:{story:"To show that a checkbox input is required, use the `fd-checkbox__label--required` class.\n        "}}};const c=()=>`
${i}
...
`;c.parameters={docs:{story:{iframeHeight:330}}};const s=()=>g;s.parameters={docs:{story:{iframeHeight:400},description:{story:"Checkboxes can display horizontally in a line. To display them this way, add the `fd-checkbox__label--inline` modifier class to the element."}}};const a=()=>`
${i}
...
`;a.parameters={docs:{story:{iframeHeight:400},description:{story:"Checkboxes can display several interaction states to communicate semantic meaning to the users. To display different states, add the classes below to the `fd-form-item`:\n\n| States | Class |\n| :----------------- | :------------------ |\n| Error | `fd-checkbox is-error` |\n| Success | `fd-checkbox is-success` |\n| Warning | `fd-checkbox is-warning` |\n| Information | `fd-checkbox is-information` |\n| Disabled | `fd-checkbox is-disabled` |\n"}}};const l=()=>`
${i}
<fieldset class="fd-fieldset">
...
`;l.parameters={docs:{story:{iframeHeight:330},description:{story:"By default, long checkbox label truncates with ellipsis. For this behaviour no modifier class is needed. For checkbox label that wraps on a new line to show the entire content, use `.fd-checkbox__label--wrap` modifier class applied with `.fd-checkbox__label`. Keep in mind that for this to work <b>max-width</b> should be set on the label. For a <b>top-left aligned</b> label use the `.fd-checkbox__label--wrap-top-aligned` modifier class.\n        "}}};var d,n,o;e.parameters={...e.parameters,docs:{...(d=e.parameters)==null?void 0:d.docs,source:{originalSource:"() => requiredExampleHtml",...(o=(n=e.parameters)==null?void 0:n.docs)==null?void 0:o.source}}};var t,b,f;c.parameters={...c.parameters,docs:{...(t=c.parameters)==null?void 0:t.docs,source:{originalSource:`() => \`
\${localStyles}
<fieldset class="fd-fieldset">
    <legend class="fd-fieldset__legend">Checkbox</legend>
    <div class="fd-form-group">
...
\``,...(f=(b=c.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};var r,h,x;s.parameters={...s.parameters,docs:{...(r=s.parameters)==null?void 0:r.docs,source:{originalSource:"() => inlineExampleHtml",...(x=(h=s.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};var _,p,k;a.parameters={...a.parameters,docs:{...(_=a.parameters)==null?void 0:_.docs,source:{originalSource:`() => \`
\${localStyles}
<div class="checkbox-example-container">
    <fieldset class="fd-fieldset">
        <legend class="fd-fieldset__legend">Error checkboxes</legend>
...
\``,...(k=(p=a.parameters)==null?void 0:p.docs)==null?void 0:k.source}}};var v,m,u;l.parameters={...l.parameters,docs:{...(v=l.parameters)==null?void 0:v.docs,source:{originalSource:`() => \`
\${localStyles}
<fieldset class="fd-fieldset">
    <legend class="fd-fieldset__legend">Truncation Options</legend>
    <div class="fd-form-group">
...
\``,...(u=(m=l.parameters)==null?void 0:m.docs)==null?void 0:u.source}}};const T=["Required","Default","Inline","States","TextTruncation"];export{c as Default,s as Inline,e as Required,a as States,l as TextTruncation,T as __namedExportsOrder,w as default};
//# sourceMappingURL=checkbox.stories-48e56198.js.map
