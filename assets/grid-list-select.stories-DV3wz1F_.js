/* empty css                  *//* empty css                    *//* empty css                *//* empty css               *//* empty css             *//* empty css              *//* empty css              *//* empty css                 *//* empty css               *//* empty css             *//* empty css                      */const d=`<div style="min-height: 300px;">
...
`,y={title:"Components/Grid List/Selection",parameters:{description:`
...
- You want to manage complex datasets that need to be extensively sorted, grouped, filtered, or edited. In this case, use a table.
    `,tags:[],components:["grid-list","layout-grid","toolbar","button","icon","title","radio","checkbox","avatar","link","object-status"]}},i=()=>r;i.storyName="None mode";i.parameters={docs:{description:{story:'Items cannot be selected but can still use "navigation", which allows click handling on specific items.'}}};const n=()=>o;n.storyName="Single select mode";n.parameters={docs:{description:{story:`
...
To turn on the Single select mode, add the \`fd-grid-list--mode-single-select\` modifier class to the main element.
        `}}};const t=()=>e;t.storyName="Single select left mode";t.parameters={docs:{description:{story:`
...
`}}};const a=()=>l;a.storyName="Single select right mode";a.parameters={docs:{description:{story:`
One item in the grid list can be selected. For this, the grid list provides radio buttons on the left side of each item toolbar.
To turn on the Single select right mode, add the \`fd-grid-list--mode-single-select-right\` modifier class to the main element.
`}}};const s=()=>d;s.storyName="Multi select mode";s.parameters={docs:{description:{story:`
...
`}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => noneModeExampleHtml",...i.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => singleSelectMasterModeExampleHtml",...n.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => singleSelectLeftModeExampleHtml",...t.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => singleSelectRightModeExampleHtml",...a.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => multiSelectModeExampleHtml",...s.parameters?.docs?.source}}};const S=["NoneMode","SingleSelectMasterMode","SingleSelectLeftMode","SingleSelectRightMode","MultiSelectMode"];export{s as MultiSelectMode,i as NoneMode,t as SingleSelectLeftMode,n as SingleSelectMasterMode,a as SingleSelectRightMode,S as __namedExportsOrder,y as default};
