const t={title:"Elevation",parameters:{description:`The z-index property specifies the stack order of an element. In order for z-index to work the elements need to be positioned: relative (default), absolute, fixed, sticky.
        <br><br>
        <b>CSS Class: </b>
...
</div>`;e.parameters={docs:{description:{story:""}}};var i,s,a;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`() => \`\${localStyles}
<div class="sap-docs-container">
    <div class="sap-elevation-0">0</div>
    <div class="sap-elevation-1">1</div>
    <div class="sap-elevation-2">2</div>
