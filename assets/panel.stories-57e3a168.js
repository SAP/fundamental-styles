...
`,V=`<div class="fd-panel" aria-labelledby="__panel-title-10" role="form">
    <div class="fd-panel__header">
        <div class="fd-panel__expand">
...
`,P={title:"Components/Panel",parameters:{description:`
...
There are two types of panels: fixed and expandable.
  ...
  `}},a=()=>M;a.parameters={docs:{story:{iframeHeight:200},description:{story:`When the height of the panel's content is set to a fixed size, the content area becomes scrollable.
        `}}};const t=()=>y;t.parameters={docs:{story:{iframeHeight:200},description:{story:`Expandable panels are much like fixed panels, except their content can be expanded and collapsed (including the info toolbar, if available).
        `}}};const e=()=>V;e.storyName="Fixed height";e.parameters={docs:{story:{iframeHeight:300},description:{story:`When the height of the panel's content is set to a fixed size, the content area becomes scrollable.
        `}}};const i=()=>q;i.parameters={docs:{iframeHeight:200,description:{story:"Panel may have a border or not. For Panel without border use the `.fd-panel--borderless ` modifier class.\n        "}}};const n=()=>x;n.parameters={docs:{iframeHeight:200,description:{story:"The background of the content can be set to transparent by applying the `.fd-panel--transparent ` modifier class.\n        "}}};var s,l,r;a.parameters={...a.parameters,docs:{...(s=a.parameters)==null?void 0:s.docs,source:{originalSource:"() => fixedExampleHtml",...(r=(l=a.parameters)==null?void 0:l.docs)==null?void 0:r.source}}};var o,u,d;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:"() => expandableExampleHtml",...(d=(u=t.parameters)==null?void 0:u.docs)==null?void 0:d.source}}};var c,p,m;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:"() => fixedHeightContentExampleHtml",...(m=(p=e.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};var b,f,v;i.parameters={...i.parameters,docs:{...(b=i.parameters)==null?void 0:b.docs,source:{originalSource:"() => borderlessExampleHtml",...(v=(f=i.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};var _,g,h;n.parameters={...n.parameters,docs:{...(_=n.parameters)==null?void 0:_.docs,source:{originalSource:"() => transparentExampleHtml",...(h=(g=n.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};const C=["Fixed","Expandable","FixedHeightContent","Borderless","Transparent"];export{i as Borderless,t as Expandable,a as Fixed,e as FixedHeightContent,n as Transparent,C as __namedExportsOrder,P as default};
//# sourceMappingURL=panel.stories-57e3a168.js.map
