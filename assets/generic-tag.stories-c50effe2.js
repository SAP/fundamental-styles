...
</div>`;const c={title:"Components/Generic Tag",parameters:{description:`The generic tag control displays complementary information related to the current page, such as key performance indicators (KPI) and situations.
...
`}},n=()=>r;n.storyName="Types";n.parameters={docs:{iframeHeight:300,description:{story:""}}};var a,e,s;n.parameters={...n.parameters,docs:{...(a=n.parameters)==null?void 0:a.docs,source:{originalSource:"() => primaryExampleHtml",...(s=(e=n.parameters)==null?void 0:e.docs)==null?void 0:s.source}}};const t=["Primary"];export{n as Primary,t as __namedExportsOrder,c as default};
//# sourceMappingURL=generic-tag.stories-c50effe2.js.map
