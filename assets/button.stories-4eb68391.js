/* empty css                *//* empty css                         *//* empty css             *//* empty css             *//* empty css               *//* empty css                     */const V=`
...
`,M=`<div class="fddocs-button-container">
...
`,k=`<div class="fddocs-button-container">
...
</div>`,C=`<div class="fddocs-button-container">
...
`,U=`<h4>Inactive state of toggle button</h4>
...
</div>`,Q={title:"Components/Button",parameters:{description:`The button component is used to trigger an action. All buttons are characterized by the \`fd-button\` class and an additional modifier classes to specify each button type.
...
`}},t=()=>j;t.storyName="Button styles";t.parameters={docs:{description:{story:`
...
`}}};const n=()=>U;n.storyName="Toggle button";n.parameters={docs:{description:{story:'A toggle button switches between two states. First is the active state, second is inactive. Use the toggle button for secondary actions.\nActive (toggled) button should have `aria-pressed="true"` and `fd-button--toggled` class and inactive buttons should have `aria-pressed="false"`\n'}}};const e=()=>C;e.storyName="Segmented button";e.parameters={docs:{description:{story:'The segmented button displays a group of options. Only one option can be active at a time, while the others remain or become inactive when the initial option is selected.\nThis button type was previously known as "button group" and is comparable to a radio button group.\nIt can be displayed by using the container with `fd-segmented-button` class with `role="group"` and the `aria-label="Group label"` attribute.\nActive button should have `aria-pressed="true"` and `fd-button--toggled` class and inactive buttons should have `aria-pressed="false"`.\n'}}};const a=()=>k;a.storyName="Button With Badge";a.parameters={docs:{description:{story:`Button gets a badge in cases of collecting a number of items from various pages in order to trigger an action.
Currently the Emphasized, Standard, Ghost and Transparent type of buttons are recommended to be used with Badge.

**Badges cannot contain more than 4 characters**.`}}};const o=()=>P;o.storyName="Menu button";o.parameters={docs:{description:{story:`The menu button displays a dropdown menu upon click and is considered the default menu button.
There are two different type of menu buttons: the default menu button and split menu button.

**Maximum width is 12rem**.
            `}}};const s=()=>M;s.storyName="Split menu button";s.parameters={docs:{description:{story:`The split menu button has two separate areas: the text label and the arrow down icon.
...
`}}};const i=()=>G;i.storyName="Icon or text";i.parameters={docs:{description:{story:`
...
`}}};const d=()=>X;d.storyName="Button states";d.parameters={docs:{description:{story:"\nThese button types indicate different states: normal, selected, disabled and focusable disabled.\n\n- **Normal**: The button’s default state. It can be selected to perform a corresponding action.\n- **Disabled**: It cannot be selected. This state can be displayed by using the `disabled` attribute.\n- **Focusable disabled**: It cannot be selected, but it is tabbable and focusable. When the button is selected, a focus ring appears. This state can be displayed by using the `is-disabled` class and the `aria-disabled=”true”` attribute for accessibility without using the `disabled` property. By adding the hidden `_instructions` element, the user will be notified for further instructions on how to enable the button. They will also be notified when the button is enabled when using the `aria-live` property.\n"}}};const u=()=>V;u.storyName="Focusable disabled";u.parameters={docs:{description:{story:"\nThe disabled button can be focusable by adding the `aria-disabled` attribute. To enable the focus ring in a focusable disabled button, ensure that `is-disabled` class is present while `disabled` attribute is not.\n\n####Accessibility\n\nWhen the state of the button has changed, add `aria-live=”assertive”` to prompt the screen reader to read the helper text out loud.\n\nNote: For the text to be read out loud by screen readers, a helper text has been added with `aria-describedby` matching the `id` of the paragraph element with the `_instructions` element. The element uses the `screen-reader-only` styling so that it is not visible.\n\n"}}};var b,r,l;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:"() => stylesExampleHtml",...(l=(r=t.parameters)==null?void 0:r.docs)==null?void 0:l.source}}};var c,f,p;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:"() => toggleExampleHtml",...(p=(f=n.parameters)==null?void 0:f.docs)==null?void 0:p.source}}};var h,g,m;e.parameters={...e.parameters,docs:{...(h=e.parameters)==null?void 0:h.docs,source:{originalSource:"() => segmentedButtonExampleHtml",...(m=(g=e.parameters)==null?void 0:g.docs)==null?void 0:m.source}}};var v,y,w;a.parameters={...a.parameters,docs:{...(v=a.parameters)==null?void 0:v.docs,source:{originalSource:"() => badgeOnButtonExampleHtml",...(w=(y=a.parameters)==null?void 0:y.docs)==null?void 0:w.source}}};var x,_,T;o.parameters={...o.parameters,docs:{...(x=o.parameters)==null?void 0:x.docs,source:{originalSource:"() => menuButtonExampleHtml",...(T=(_=o.parameters)==null?void 0:_.docs)==null?void 0:T.source}}};var B,N,S;s.parameters={...s.parameters,docs:{...(B=s.parameters)==null?void 0:B.docs,source:{originalSource:"() => splitMenuButtonExampleHtml",...(S=(N=s.parameters)==null?void 0:N.docs)==null?void 0:S.source}}};var A,F,D;i.parameters={...i.parameters,docs:{...(A=i.parameters)==null?void 0:A.docs,source:{originalSource:"() => iconAndTextExampleHtml",...(D=(F=i.parameters)==null?void 0:F.docs)==null?void 0:D.source}}};var E,O,z;d.parameters={...d.parameters,docs:{...(E=d.parameters)==null?void 0:E.docs,source:{originalSource:"() => buttonStatesExampleHtml",...(z=(O=d.parameters)==null?void 0:O.docs)==null?void 0:z.source}}};var H,I,q;u.parameters={...u.parameters,docs:{...(H=u.parameters)==null?void 0:H.docs,source:{originalSource:"() => focusableDisabledExampleHtml",...(q=(I=u.parameters)==null?void 0:I.docs)==null?void 0:q.source}}};const Z=["Styles","Toggle","SegmentedButton","BadgeOnButton","MenuButton","SplitMenuButton","IconAndText","ButtonStates","FocusableDisabled"];export{a as BadgeOnButton,d as ButtonStates,u as FocusableDisabled,i as IconAndText,o as MenuButton,e as SegmentedButton,s as SplitMenuButton,t as Styles,n as Toggle,Z as __namedExportsOrder,Q as default};
//# sourceMappingURL=button.stories-4eb68391.js.map
