/* empty css                       *//* empty css                *//* empty css               *//* empty css             *//* empty css                 *//* empty css               */const c=`<div style="width:450px;">
    <div class="fd-product-switch__body fd-product-switch__body--mobile">
        <ul class="fd-product-switch__list">
            ...
            <li class="fd-product-switch__item" tabindex="0">
                <span class="fd-avatar fd-avatar--sm fd-avatar--thumbnail" style="background-image: url('/assets/images/landscape/L1.jpg')" role="img" aria-label="Avatar landscape"></span>
                <div class="fd-product-switch__text">
...
`,a=`<div class="fd-product-switch__body fd-product-switch__body--col-3">
    <ul class="fd-product-switch__list">
        <li class="fd-product-switch__item" tabindex="0">
            <i role="presentation" class="fd-product-switch__icon sap-icon--home"></i>
            <div class="fd-product-switch__text">
...
`,e=`<div class="fd-product-switch__body">
   <ul class="fd-product-switch__list">
      <li class="fd-product-switch__item" tabindex="0">
         <i role="presentation" class="fd-product-switch__icon sap-icon--home"></i>
         <div class="fd-product-switch__text">
...
`;i.parameters={docs:{description:{story:`The product switch button is typically displayed within a **Shellbar** on the far-right side. <br> <b>Note: </b>Products are represented by application icons, implemented using either SAP Icon Fonts or the Avatar component in size S (48x48 px). The Avatar component supports PNG, JPG, and SVG formats. To maintain visual consistency, all icons must be rendered within a 48x48 px bounding box.
        `}}};const t=()=>e;t.parameters={docs:{description:{story:"Product switch is displayed with a maximum of 4 columns on large desktop screens. When the popover contains too many items, it will grow until the maximum is reached. Once the maximum is reached, the popover can be scrolled vertically."}}};const s=()=>a;s.parameters={docs:{description:{story:"If there are 6 (or less) items to display, it is recommended to use the 3-column layout (medium). To display a medium-sized product switch, add the `fd-product-switchbody--col-3` modifier class to the main element.\n        "}}};const d=()=>c;d.parameters={docs:{description:{story:"For smaller screens (mobile), the product switch is displayed in list format. To achieve this style, add the `fd-product-switch__body--mobile` modifier class to the main element.\n        "}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`() => \`\${localStyles}
<div class="fd-shellbar">
    <div class="fd-shellbar__group fd-shellbar__group--full-width fd-shellbar__group--actions">
        <div class="fd-shellbar__action">
            <div class="fd-product-switch">
...
<div style="min-height: 530px"></div>
\``,...i.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => largeExampleHtml",...t.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => mediumExampleHtml",...s.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => smallExampleHtml",...d.parameters?.docs?.source}}};const h=["Shellbar","Large","Medium","Small"];export{t as Large,s as Medium,i as Shellbar,d as Small,h as __namedExportsOrder,v as default};
