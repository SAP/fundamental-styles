/* empty css                       *//* empty css                *//* empty css               *//* empty css             *//* empty css                 */const d=`<div style="width:450px;">
...
`,e=`<div class="fd-product-switch__body fd-product-switch__body--col-3">
    <ul class="fd-product-switch__list">
        <li class="fd-product-switch__item" tabindex="0">
            <i role="presentation" class="fd-product-switch__icon sap-icon--home"></i>
            <div class="fd-product-switch__text">
...
`,o=`<div class="fd-product-switch__body">
   <ul class="fd-product-switch__list">
      <li class="fd-product-switch__item" tabindex="0">
         <i role="presentation" class="fd-product-switch__icon sap-icon--home"></i>
         <div class="fd-product-switch__text">
...
`;i.parameters={docs:{description:{story:`The product switch button is typically displayed within a **Shellbar** on the far-right side.
        `}}};const t=()=>o;t.parameters={docs:{description:{story:"Product switch is displayed with a maximum of 4 columns on large desktop screens. When the popover contains too many items, it will grow until the maximum is reached. Once the maximum is reached, the popover can be scrolled vertically."}}};const s=()=>e;s.parameters={docs:{description:{story:"If there are 6 (or less) items to display, it is recommended to use the 3-column layout (medium). To display a medium-sized product switch, add the `fd-product-switchbody--col-3` modifier class to the main element.\n        "}}};const c=()=>d;c.parameters={docs:{description:{story:"For smaller screens (mobile), the product switch is displayed in list format. To achieve this style, add the `fd-product-switch__body--mobile` modifier class to the main element.\n        "}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`() => \`\${localStyles}
<div class="fd-shellbar">
    <div class="fd-shellbar__group fd-shellbar__group--full-width fd-shellbar__group--actions">
        <div class="fd-shellbar__action">
            <div class="fd-product-switch">
...
<div style="min-height: 530px"></div>
\``,...i.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => largeExampleHtml",...t.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => mediumExampleHtml",...s.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:"() => smallExampleHtml",...c.parameters?.docs?.source}}};const h=["Shellbar","Large","Medium","Small"];export{t as Large,s as Medium,i as Shellbar,c as Small,h as __namedExportsOrder,u as default};
