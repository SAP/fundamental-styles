...
`,t=()=>`${e}${f}`;t.storyName="Flex Container";t.parameters={docs:{description:{story:"To turn a parent element into a flex container apply the <code>.sap-flex</code> class to this element. <br><b>SCSS Mixin:</b><code>@include  sap-flex()</code>"}}};const d=()=>`${e}${m}`;d.storyName="Flex Align Content (Flex Container)";d.parameters={docs:{description:{story:`
<table>
    <thead>
    <tr>
...
<b>SCSS Mixin:</b> 
<code>@include sap-flex-align-content(type)</code><br>where <code>type</code> can be one of the following: <code>flex-start | flex-end | center | space-between | space-around | space-evenly | stretch | start | end | baseline</code>`}}};const i=()=>`${e}${F}`;i.storyName="Flex Align Items (Flex Container)";i.parameters={docs:{description:{story:`
<table>
    <thead>
    <tr>
        <th>Modifier Class</th>
...
<b>SCSS Mixin:</b> 
<code>@include sap-flex-align-items(type)</code><br>where <code>type</code> can be one of the following: <code>flex-start | start | self-start | flex-end | end | self-end | center | baseline | stretch </code>`}}};const n=()=>`${e}${$}`;n.storyName="Flex Center (Flex Container)";n.parameters={docs:{description:{story:`

<b>SCSS Mixin:</b> 
<code>@include sap-flex-center(direction)</code><br>where <code>direction</code> can be one of the following: <code>row (default) | row-reverse | column | column-reverse</code>`}}};const s=()=>`${e}${h}`;s.storyName="Flex Direction (Flex Container)";s.parameters={docs:{description:{story:`
<table>
    <thead>
    <tr>
        <th>Modifier Class</th>
