var g=Object.defineProperty,A=Object.defineProperties;var S=Object.getOwnPropertyDescriptors;var i=Object.getOwnPropertySymbols;var x=Object.prototype.hasOwnProperty,y=Object.prototype.propertyIsEnumerable;var r=(a,e,n)=>e in a?g(a,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):a[e]=n,t=(a,e)=>{for(var n in e||(e={}))x.call(e,n)&&r(a,n,e[n]);if(i)for(var n of i(e))y.call(e,n)&&r(a,n,e[n]);return a},o=(a,e)=>A(a,S(e));/* empty css               *//* empty css               *//* empty css             *//* empty css                     *//* empty css                    */const k=`<h4>Without Menu Button (default)</h4>
...
`,J={title:"BTP/Tool Header",parameters:{description:`The Tool Header exists on all BTP tools. It is the uppermost section of the tool. It is always visible to give users access to various functions.
...
`,tags:["btp","development","horizon-only"]}},d=()=>k;d.parameters={docs:{description:{story:"When <b>menu button</b> is present use the <code>fd-tool-header--menu</code> modifier class with the <code>fd-tool-header</code> base class. Additionally, apply the <code>fd-tool-header__group--menu</code> modifier to the <code>fd-tool-header__group</code> wrapping element."}}};const l=()=>w;l.parameters={docs:{description:{story:"The <b>second title</b> is not displayed on tablets. The <b>separator</b> between the actions areas is hidden on tablet portrait orientation. The separator between the actions and the user avatar is present in all views."}}};const s=()=>P;s.parameters={docs:{description:{story:"Phone specification depicts only deltas from the tablet specification. It is possible that actions will overflow on phones. In such cases, the overflowing actions are displayed in a dropdown menu. The <b>Product Name</b>, <b>Second Title</b>, and <b>Separator</b> between the actions areas are not displayed on phones."}}};var c,h,f;d.parameters=o(t({},d.parameters),{docs:o(t({},(c=d.parameters)==null?void 0:c.docs),{source:t({originalSource:"() => desktopExampleHtml"},(f=(h=d.parameters)==null?void 0:h.docs)==null?void 0:f.source)})});var _,u,p;l.parameters=o(t({},l.parameters),{docs:o(t({},(_=l.parameters)==null?void 0:_.docs),{source:t({originalSource:"() => tabletExampleHtml"},(p=(u=l.parameters)==null?void 0:u.docs)==null?void 0:p.source)})});var b,v,m;s.parameters=o(t({},s.parameters),{docs:o(t({},(b=s.parameters)==null?void 0:b.docs),{source:t({originalSource:"() => mobileExampleHtml"},(m=(v=s.parameters)==null?void 0:v.docs)==null?void 0:m.source)})});const C=["Desktop","Tablet","Mobile"];export{d as Desktop,s as Mobile,l as Tablet,C as __namedExportsOrder,J as default};
