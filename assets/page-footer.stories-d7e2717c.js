...
Note: You may want to display components from right to left on the screen for international purposes. To display them as such, add the \`rtl\` directive to the main element.`,tags:["non-f3","a11y","theme"]}},t=()=>u;t.parameters={docs:{description:{story:"The Page Footer contains Image/logo, And list of links in the footer. It is responsive to tablet and mobile screen sizes."}}};const e=()=>v;e.parameters={docs:{description:{story:"The Page Footer contains Image/logo, And list of links in the footer. To apply multiline link, add the `fd-page-footer__row` modifier class to the container element."}}};const a=()=>h;a.parameters={docs:{description:{story:"Example of The Page Footer representing multiline link,and adding images in the code to represent the clickable images and multiline is achived by adding the `fd-page-footer__row` modifier class to the container element."}}};const n=()=>k;n.parameters={docs:{description:{story:"Example of The Page Footer representing multiline lin, add the `--xl` `--lg` `--md` `--sm` size modifier class to the container element."}}};var o,i,s;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:"() => singleLineLinkExampleHtml",...(s=(i=t.parameters)==null?void 0:i.docs)==null?void 0:s.source}}};var l,r,d;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:"() => multiLineLinkExampleHtml",...(d=(r=e.parameters)==null?void 0:r.docs)==null?void 0:d.source}}};var f,c,p;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:"() => imageAndIconLinkExampleHtml",...(p=(c=a.parameters)==null?void 0:c.docs)==null?void 0:p.source}}};var g,_,m;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:"() => footerWithDiffrentSizeExampleHtml",...(m=(_=n.parameters)==null?void 0:_.docs)==null?void 0:m.source}}};const x=["SingleLineLink","MultiLineLink","ImageAndIconLink","FooterWithDiffrentSize"];export{n as FooterWithDiffrentSize,a as ImageAndIconLink,e as MultiLineLink,t as SingleLineLink,x as __namedExportsOrder,P as default};
//# sourceMappingURL=page-footer.stories-d7e2717c.js.map
