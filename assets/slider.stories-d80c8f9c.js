var R=Object.defineProperty,z=Object.defineProperties;var I=Object.getOwnPropertyDescriptors;var _=Object.getOwnPropertySymbols;var N=Object.prototype.hasOwnProperty,j=Object.prototype.propertyIsEnumerable;var o=(s,d,a)=>d in s?R(s,d,{enumerable:!0,configurable:!0,writable:!0,value:a}):s[d]=a,e=(s,d)=>{for(var a in d||(d={}))N.call(d,a)&&o(s,a,d[a]);if(_)for(var a of _(d))j.call(d,a)&&o(s,a,d[a]);return s},i=(s,d)=>z(s,I(d));const B=`
...
`;const W={title:"Components/Slider",parameters:{description:`There are two types of sliders, <a href="https://experience.sap.com/internal/fiori-design-web/slider/">Standard Slider</a> and  <a href="https://experience.sap.com/internal/fiori-design-web/range-slider/">Range Slider</a>. The standard slider is a control that enables the user to adjust single values within a specified numerical range. The range slider enables the user to select a value range within a predefined numerical interval.
