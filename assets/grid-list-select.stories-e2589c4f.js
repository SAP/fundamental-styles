/* empty css                  *//* empty css                    *//* empty css                *//* empty css               *//* empty css             *//* empty css              *//* empty css              *//* empty css                 *//* empty css               *//* empty css             *//* empty css                      */const x=`<div style="min-height: 300px;">
            ...
            <div  class="fd-col fd-col--12 fd-col-md--6 fd-col-lg--4 fd-col-xl--3">
                <div tabindex="0" class="fd-grid-list__item fd-grid-list__item--link is-selected">
                    <div class="fd-toolbar is-compact fd-grid-list__item-toolbar">
                        ...
                        <label class="fd-checkbox__label fd-grid-list__checkbox-label" for="Ai4ez611c" tabindex="-1"></label>
            ...
            <div  class="fd-col fd-col--12 fd-col-md--6 fd-col-lg--4 fd-col-xl--3">
                <div tabindex="0" class="fd-grid-list__item">
                    <div class="fd-toolbar is-compact fd-grid-list__item-toolbar">
                        ...
                        <label class="fd-checkbox__label fd-grid-list__checkbox-label" for="Ai4ez611c2" tabindex="-1"></label>
            ...
            <div  class="fd-col fd-col--12 fd-col-md--6 fd-col-lg--4 fd-col-xl--3">
                <div tabindex="0" class="fd-grid-list__item is-selected">
                    <div class="fd-toolbar is-compact fd-grid-list__item-toolbar">
                        ...
                        <label class="fd-checkbox__label fd-grid-list__checkbox-label" for="Ai4ez611c3" tabindex="-1"></label>
            ...
            <div  class="fd-col fd-col--12 fd-col-md--6 fd-col-lg--4 fd-col-xl--3">
                <div tabindex="0" class="fd-grid-list__item">
                    <div class="fd-toolbar is-compact fd-grid-list__item-toolbar">
                        ...
                        <label class="fd-checkbox__label fd-grid-list__checkbox-label" for="Ai4ez611c4" tabindex="-1"></label>
...
`,R={title:"Components/Grid List/Selection",parameters:{description:`
...
- You want to manage complex datasets that need to be extensively sorted, grouped, filtered, or edited. In this case, use a table.
    `,tags:["f3","a11y","theme","development"],components:["grid-list","layout-grid","toolbar","button","icon","title","radio","checkbox","avatar","link","object-status"]}},i=()=>k;i.storyName="None mode";i.parameters={docs:{description:{story:'Items cannot be selected but can still use "navigation", which allows click handling on specific items.'}}};const n=()=>w;n.storyName="Single select mode";n.parameters={docs:{description:{story:`
...
To turn on the Single select mode, add the \`fd-grid-list--mode-single-select\` modifier class to the main element.
        `}}};const t=()=>S;t.storyName="Single select left mode";t.parameters={docs:{description:{story:`
...
`}}};const a=()=>y;a.storyName="Single select right mode";a.parameters={docs:{description:{story:`
One item in the grid list can be selected. For this, the grid list provides radio buttons on the left side of each item toolbar.
To turn on the Single select right mode, add the \`fd-grid-list--mode-single-select-right\` modifier class to the main element.
`}}};const s=()=>x;s.storyName="Multi select mode";s.parameters={docs:{description:{story:`
...
`}}};var d,l,e;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:"() => noneModeExampleHtml",...(e=(l=i.parameters)==null?void 0:l.docs)==null?void 0:e.source}}};var o,r,c;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:"() => singleSelectMasterModeExampleHtml",...(c=(r=n.parameters)==null?void 0:r.docs)==null?void 0:c.source}}};var f,p,_;t.parameters={...t.parameters,docs:{...(f=t.parameters)==null?void 0:f.docs,source:{originalSource:"() => singleSelectLeftModeExampleHtml",...(_=(p=t.parameters)==null?void 0:p.docs)==null?void 0:_.source}}};var m,b,v;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:"() => singleSelectRightModeExampleHtml",...(v=(b=a.parameters)==null?void 0:b.docs)==null?void 0:v.source}}};var g,h,u;s.parameters={...s.parameters,docs:{...(g=s.parameters)==null?void 0:g.docs,source:{originalSource:"() => multiSelectModeExampleHtml",...(u=(h=s.parameters)==null?void 0:h.docs)==null?void 0:u.source}}};const I=["NoneMode","SingleSelectMasterMode","SingleSelectLeftMode","SingleSelectRightMode","MultiSelectMode"];export{s as MultiSelectMode,i as NoneMode,t as SingleSelectLeftMode,n as SingleSelectMasterMode,a as SingleSelectRightMode,I as __namedExportsOrder,R as default};
//# sourceMappingURL=grid-list-select.stories-e2589c4f.js.map
