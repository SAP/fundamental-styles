/* empty css            *//* empty css               *//* empty css             *//* empty css                 *//* empty css               *//* empty css                         *//* empty css             */const v=`<div class="fd-dialog-docs-static fd-calendar-mobile-docs-static--portrait fd-dialog fd-dialog--active">
...
`,w=`<div style="display: flex; justify-content: space-around; margin-bottom: 1rem; flex-wrap: wrap;">
...
`,k=`<div style="display: flex; justify-content: space-around;">
...
`,H={title:"Components/Calendar",parameters:{description:`
...
`,tags:["f3","a11y","theme"]}},t=()=>S;t.parameters={docs:{story:{iframeHeight:400},description:{story:"The calendar component can display days of the month by adding the `fd-calendar__content--dates` class to the container element."}}};const e=()=>k;e.parameters={docs:{story:{iframeHeight:400},description:{story:"The calendar component can display months in a year by adding the `fd-calendar__content--months` class to the container element."}}};const d=()=>w;d.parameters={docs:{story:{iframeHeight:700},description:{story:"The calendar component can display a range of years in various ways: short-term, long-term, year ranges etc. Add the `fd-calendar__content--years` class to the container element, and adjust the number of columns, rows, and content to fit your use case."}}};const a=()=>x;a.storyName="Landscape (mobile)";a.parameters={docs:{story:{iframeHeight:500},description:{story:`
...
`}}};const n=()=>v;n.storyName="Portrait (mobile)";n.parameters={docs:{story:{iframeHeight:500},description:{story:`
...
`}}};var l,s,r;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:"() => daysExampleHtml",...(r=(s=t.parameters)==null?void 0:s.docs)==null?void 0:r.source}}};var c,o,_;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:"() => monthsExampleHtml",...(_=(o=e.parameters)==null?void 0:o.docs)==null?void 0:_.source}}};var i,f,p;d.parameters={...d.parameters,docs:{...(i=d.parameters)==null?void 0:i.docs,source:{originalSource:"() => yearsExampleHtml",...(p=(f=d.parameters)==null?void 0:f.docs)==null?void 0:p.source}}};var u,b,m;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:"() => landscapeMobileExampleHtml",...(m=(b=a.parameters)==null?void 0:b.docs)==null?void 0:m.source}}};var h,g,y;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:"() => portraitMobileExampleHtml",...(y=(g=n.parameters)==null?void 0:g.docs)==null?void 0:y.source}}};const N=["Days","Months","Years","LandscapeMobile","PortraitMobile"];export{t as Days,a as LandscapeMobile,e as Months,n as PortraitMobile,d as Years,N as __namedExportsOrder,H as default};
//# sourceMappingURL=calendar.stories-303f10bf.js.map
