var c=Object.defineProperty,u=Object.defineProperties;var m=Object.getOwnPropertyDescriptors;var r=Object.getOwnPropertySymbols;var b=Object.prototype.hasOwnProperty,h=Object.prototype.propertyIsEnumerable;var n=(i,e,t)=>e in i?c(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t,s=(i,e)=>{for(var t in e||(e={}))b.call(e,t)&&n(i,t,e[t]);if(r)for(var t of r(e))h.call(e,t)&&n(i,t,e[t]);return i},o=(i,e)=>u(i,m(e));/* empty css                 *//* empty css                 *//* empty css                   *//* empty css                  *//* empty css                   *//* empty css               *//* empty css             *//* empty css                          *//* empty css                       *//* empty css                */const g=`<h4>First loading time (while analyzing the request)</h4>
...
<b>Note: The component is in an experimental state.</b>`,tags:["ai","experimental"]}},a=()=>g;a.parameters={docs:{description:{story:`AI Progress Indicator pattern extends the following components to enable new AI-specific interactions:
<ul>
...
</ul>`}}};var l,d,p;a.parameters=o(s({},a.parameters),{docs:o(s({},(l=a.parameters)==null?void 0:l.docs),{source:s({originalSource:"() => aiProgressIndicatorExampleHtml"},(p=(d=a.parameters)==null?void 0:d.docs)==null?void 0:p.source)})});const T=["AIProgressIndicator"];export{a as AIProgressIndicator,T as __namedExportsOrder,S as default};
