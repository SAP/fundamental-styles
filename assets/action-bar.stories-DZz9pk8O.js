/* empty css               *//* empty css             *//* empty css              *//* empty css             *//* empty css                */const l=`<div style="width:319px;">
...
`,b=`<div class="fd-action-bar" role="banner" aria-labelledby="action-bar-title-5">
    <div class="fd-action-bar__header">
        <div class="fd-action-bar__title">
...
<div style="min-height: 200px"></div>
`,p=`<div class="fd-action-bar" role="banner" aria-labelledby="action-bar-title-4" aria-describedby="action-bar-desc-4">
    <div class="fd-action-bar__header">
        <div class="fd-action-bar__back">
            <button type="button" aria-label="Go back" title="Go back" class="fd-button fd-button--transparent">
                <i  role="presentation" aria-hidden="true" class="sap-icon--navigation-left-arrow"></i>
...
`,u=`<div class="fd-action-bar" role="banner" aria-labelledby="action-bar-title-3">
    <div class="fd-action-bar__header">
        <div class="fd-action-bar__back">
            <button type="button" aria-label="Go back" title="Go back" class="fd-button fd-button--transparent">
                <i  role="presentation" aria-hidden="true" class="sap-icon--navigation-left-arrow"></i>
...
`,m=`<div class="fd-action-bar" role="banner" aria-labelledby="action-bar-title-2" aria-describedby="action-bar-desc-2">
    <div class="fd-action-bar__header">
        <div class="fd-action-bar__title">
...
`,f=`<div class="fd-action-bar" role="banner" aria-labelledby="action-bar-title-1" aria-describedby="action-bar-desc-1">
    <div class="fd-action-bar__header">
        <div class="fd-action-bar__back">
            <button type="button" aria-label="Go back" title="Go back" class="fd-button fd-button--transparent">
                <i  role="presentation" aria-hidden="true" class="sap-icon--navigation-left-arrow"></i>
...
`,V={title:"Components/Action Bar",parameters:{description:`The action bar displays at the top of the page, and includes the page’s title, description, back button and action buttons.
...
Note: You may want to display components from right to left on the screen for international purposes. To display them as such, add the \`rtl\` directive to the main element.`,tags:["non-f3"]}},a=()=>f;a.storyName="Default";a.parameters={docs:{description:{story:"The default action bar displays a page title, description, back button and action buttons. To display a back button, add the `fd-action-bar__description--back` modifier class to the description element."}}};const t=()=>m;t.storyName="No back button";t.parameters={docs:{description:{story:"This action bar doesn’t display a back button."}}};const n=()=>u;n.storyName="No description";n.parameters={docs:{description:{story:"This action bar doesn’t display a description."}}};const e=()=>p;e.storyName="Descriptive";e.parameters={docs:{description:{story:"The descriptive action bar displays a long page title and description."}}};const i=()=>b;i.storyName="Contextual";i.parameters={docs:{description:{story:"The contextual action bar displays a page title and contextual menu with several main actions. To display a contextual menu, add the `fd-popover` class to the`fd-action-bar__actions` element."}}};const o=()=>d;o.storyName="Responsive (M-L)";o.parameters={docs:{description:{story:"This action bar is responsive and fits the M and L sizes required for tablet and small desktop screens. To display this size, add the `fd-action-bar--m\\_l` modifier class to the main element."}}};const s=()=>c;s.storyName="Responsive (XL)";s.parameters={docs:{description:{story:"This action bar is responsive and fits the XL size required for larger screens of 1440px or more. To display this size, add the `fd-action-bar--xl` modifier class to the main element."}}};const r=()=>l;r.parameters={docs:{description:{story:"This action bar is mobile responsive. To display the mobile action bar, add the `fd-action-bar--s` modifier class to the main element."}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => backBtnExampleHtml",...a.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => noBackBtnExampleHtml",...t.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => backBtnNoDescriptionExampleHtml",...n.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => longTitleDescriptionExampleHtml",...e.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => actionsExampleHtml",...i.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => responsiveLExampleHtml",...o.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => responsiveXLExampleHtml",...s.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => mobileExampleHtml",...r.parameters?.docs?.source}}};const k=["BackBtn","NoBackBtn","BackBtnNoDescription","LongTitleDescription","Actions","ResponsiveL","ResponsiveXL","Mobile"];export{i as Actions,a as BackBtn,n as BackBtnNoDescription,e as LongTitleDescription,r as Mobile,t as NoBackBtn,o as ResponsiveL,s as ResponsiveXL,k as __namedExportsOrder,V as default};
