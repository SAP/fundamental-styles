/* empty css              *//* empty css              *//* empty css                  */const s=`<div class="fd-tokenizer fd-tokenizer--scrollable">
...
<section class="docs-tokenizer">
    <div>
        <div style="margin-bottom: 1rem">Readonly Mode:</div>
    ...
    <br /><br />
    <div>
        <div style="margin-bottom: 1rem">Display-only Mode:</div>
...
`,r={title:"Components/Tokenizer",parameters:{description:`Tokenizer is a container that wraps multiple tokens. The Tokenizer is used either stand alone or within Input controls such as **MultiInput**.In cozy mode the user can swipe the tokens to the left or right.

##Usage
- Use tokenizer in the **Multi Input**, **Multi Combobox**, or as a standalone component.
        `,tags:["f3","a11y","theme"]}},e=()=>o;e.storyName="Tokenizer";const t=()=>a;t.storyName="Readonly and Display-only Modes";const n=()=>s;n.storyName="Scrollable tokenizer";n.parameters={docs:{description:{story:"The tokenizer can be scrollable by adding the `fd-tokenizer--scrollable` modifier class to the main element. The user can view the tokens by pressing the `Tab` key, then `Shift + Tab` to jump to the next one.\n        "}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => cozyTokenizerExampleHtml",...e.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => tokenizerModesHtml",...t.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => scrollableTokenizerExampleHtml",...n.parameters?.docs?.source}}};const p=["CozyTokenizer","ReadonlyAndDisplayOnlyModes","ScrollableTokenizer"];export{e as CozyTokenizer,t as ReadonlyAndDisplayOnlyModes,n as ScrollableTokenizer,p as __namedExportsOrder,r as default};
