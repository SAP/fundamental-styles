...
`,r=`<div style="display:flex;height:250px;margin-top:1em;">
    <div>
...
`,G={title:"Patterns/Multi Input",parameters:{description:`
...
`,tags:["f3","a11y","theme"],components:["input","form-label","form-item","form-message","popover","radio","title","token","tokenizer","input-group","checkbox","list","button","icon","bar","dialog","link","menu"]}},t=()=>f;t.parameters={docs:{description:{story:`
