/* empty css               *//* empty css               *//* empty css             *//* empty css                   *//* empty css              *//* empty css                   *//* empty css                *//* empty css             */const P=`<div style="height: 200px;">
...
`,O={title:"Components/Pagination",parameters:{description:`Pagination allows users to separate their content into discrete pages, making it easier to digest and navigate through. Pagination is commonly used for tables and tiles.
...
<br>
<br>
      `,tags:["btp"]}},a=()=>k;a.storyName="First page";a.parameters={docs:{description:{story:`First and Previous page buttons are disabled when first page is active.
    `}}};const n=()=>y;n.storyName="Middle pages";n.parameters={docs:{description:{story:`Pagination can display middle pages to increase reachability.
    ...
    `}}};const t=()=>x;t.storyName="Last page";t.parameters={docs:{description:{story:`Last and Next page buttons are disabled when last page is active.
    `}}};const e=()=>w;e.storyName="Per page";e.parameters={docs:{description:{story:`Additionally, per page section can be displayed with select to specify which number of items should be shown on the every page.
    `}}};const i=()=>P;i.parameters={docs:{description:{story:"Pagination component is responsive by default. When the screen's size is smaller than 1024px in width mobile mode is shown and you have nothing to do.\n        If you want to display pagination component always in mobile mode please add `.fd-pagination--mobile` modifier class to the component.\n    "}}};var s,o,l;a.parameters={...a.parameters,docs:{...(s=a.parameters)==null?void 0:s.docs,source:{originalSource:"() => firstPageExampleHtml",...(l=(o=a.parameters)==null?void 0:o.docs)==null?void 0:l.source}}};var r,p,d;n.parameters={...n.parameters,docs:{...(r=n.parameters)==null?void 0:r.docs,source:{originalSource:"() => middlePageExampleHtml",...(d=(p=n.parameters)==null?void 0:p.docs)==null?void 0:d.source}}};var f,b,g;t.parameters={...t.parameters,docs:{...(f=t.parameters)==null?void 0:f.docs,source:{originalSource:"() => lastPageExampleHtml",...(g=(b=t.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};var c,u,_;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:"() => perPageExampleHtml",...(_=(u=e.parameters)==null?void 0:u.docs)==null?void 0:_.source}}};var m,h,v;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:"() => mobileExampleHtml",...(v=(h=i.parameters)==null?void 0:h.docs)==null?void 0:v.source}}};const N=["FirstPage","MiddlePage","LastPage","PerPage","Mobile"];export{a as FirstPage,t as LastPage,n as MiddlePage,i as Mobile,e as PerPage,N as __namedExportsOrder,O as default};
//# sourceMappingURL=pagination.stories-9b6c65dd.js.map
