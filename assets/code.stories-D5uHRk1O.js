...
`,o={title:"Components/Code",parameters:{description:`The code component helps with formating and styling code snippets. It differantiates the code lines from the normal text.
...
`,tags:[]}},e=()=>s;e.storyName="Code Block";e.parameters={docs:{description:{story:"Code Block is a combination of multiple lines of code which can be displayed as a standalone element."}}};const a=()=>n;a.parameters={docs:{description:{story:"Inline Code is used to hightlight a short snippet code inside a paragraph."}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => primaryExampleHtml",...e.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => inlineCodeExampleHtml",...a.parameters?.docs?.source}}};const t=["Primary","InlineCode"];export{a as InlineCode,e as Primary,t as __namedExportsOrder,o as default};
