...
`,s={title:"Elevation",parameters:{description:`The z-index property specifies the stack order of an element. In order for z-index to work the elements need to be positioned: relative (default), absolute, fixed, sticky.
        <br><br>
        <b>CSS Class: </b>
      ...
      `}},e=()=>t;e.parameters={docs:{description:{story:""}}};var i,o,n;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:"() => elevationExampleHtml",...(n=(o=e.parameters)==null?void 0:o.docs)==null?void 0:n.source}}};const a=["Elevation"];export{e as Elevation,a as __namedExportsOrder,s as default};
