...
`,b=`<div class="fdx-side-nav fdx-side-nav--compact fdx-side-nav--narrow">
    <nav class="fdx-side-nav__main-navigation">
        <ul class="fdx-nested-list fdx-nested-list--compact level-1">
            <li class="fdx-nested-list__item">
                <a class="fdx-nested-list__link" href="#" aria-label="Level 1 Item">
...
</div>`,F={title:"Components/Cx Side Navigation",parameters:{description:`The Side Navigation can display structures of up to three levels.
...
- Third level items do not display an icon and are indented by 2 rem (32px)`,tags:["cx","theme"]}},a=()=>S;a.storyName="Cosy Wide With Icon, 1 Level";const s=()=>H;s.storyName="Cosy Wide Text Only, 1 Level";s.parameters={docs:{description:{story:"<b>Important: </b>This type of Side Navigation does not have <code>Narrow</code> variant."}}};const d=()=>M;d.parameters={docs:{description:{story:`Side Navigation can react dynamically to long label texts in navigational items. In such case the width of the Side Navigation is adapted by the longest label. The label does not wrap or truncate. Use the modifier class <code>.fdx-side-nav--dynamic-width</code> for Side Navigation with dynamic width.
        `}}};const n=()=>W;n.storyName="Cosy Wide Text Only, 3 Levels";n.parameters={docs:{description:{story:`<b>Important: </b>This type of Side Navigation does not have <code>Narrow</code> variant.
        `}}};const c=()=>C;c.storyName="Cosy Wide With Icons, 3 Levels, Collapse Only";const _=()=>E;_.storyName="Cosy Wide With Icons, 3 Levels, Navigation and Collapse";const e=()=>N;e.storyName="Compact Wide With Icons, Level 2 Collapsed";e.parameters={docs:{description:{story:`For compact Side Navigation apply the <code>.fdx-side-nav--compact</code> modifier class with <code>.fdx-side-nav</code> base class, and <code>.fdx-nested-list--compact</code> modifier class with <code>.fdx-nested-list</code> base class.
