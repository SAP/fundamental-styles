...
</div>`,i={title:"Components/Generic Tag",parameters:{description:`The generic tag control displays complementary information related to the current page, such as key performance indicators (KPI) and situations.
...
`}},a=()=>n;a.storyName="Types";a.parameters={docs:{description:{story:""}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => primaryExampleHtml",...a.parameters?.docs?.source}}};const r=["Primary"];export{a as Primary,r as __namedExportsOrder,i as default};
