/* empty css               *//* empty css             *//* empty css              *//* empty css              *//* empty css            *//* empty css             *//* empty css               *//* empty css                *//* empty css                     *//* empty css               *//* empty css                      *//* empty css               *//* empty css                *//* empty css               *//* empty css                    *//* empty css                   *//* empty css                  *//* empty css                   */const d=`<section class="fd-dialog-docs-static fd-dialog fd-settings fd-dialog--active">
    <div
...
`,r=`<section class="fd-dialog-docs-static fd-dialog fd-settings fd-dialog--active">
    <div
        class="fd-dialog__content fd-settings__dialog-content"
        role="dialog"
        aria-modal="true"
...
`,c=`<section class="fd-dialog-docs-static fd-dialog fd-settings fd-dialog--active">
    <div
        class="fd-dialog__content fd-settings__dialog-content"
        role="dialog"
        aria-modal="true"
            ...
            <div class="fd-settings__container">
                ...
                <div class="fd-settings__detail-area">
                    ...
                    <div class="fd-settings__content fd-settings__content--no-background">
                        ...
                        <div
                            class="fd-settings__spacing fd-settings__spacing--small"
                            role="presentation"
                            aria-hidden="true"
                        ></div>
                        ...
                        <div class="fd-form-group">
                            ...
                            <div
                                class="fd-settings__spacing fd-settings__spacing--form"
                                role="presentation"
                                aria-hidden="true"
                            ></div>
...
`,_=`<section class="fd-dialog-docs-static fd-dialog fd-settings fd-dialog--active">
    <div
        class="fd-dialog__content fd-settings__dialog-content"
        role="dialog"
        aria-modal="true"
            ...
            <div class="fd-settings__container">
                ...
                <div class="fd-settings__detail-area">
                    ...
                    <div class="fd-settings__content fd-settings__content--no-background">
                        ...
                        <div class="fd-settings__spacing" role="presentation" aria-hidden="true"></div>
...
`,f=`<section class="fd-dialog-docs-static fd-dialog fd-settings fd-dialog--active">
    <div
        class="fd-dialog__content fd-settings__dialog-content"
        role="dialog"
        aria-modal="true"
...
`,u=`<section class="fd-dialog-docs-static fd-dialog fd-settings fd-dialog--active">
    <div
        class="fd-dialog__content fd-settings__dialog-content"
        role="dialog"
        aria-modal="true"
...
`,p=`<div style="display: flex; gap: 1rem; max-width: 1200px">
    <section class="fd-dialog-docs-static fd-dialog fd-settings fd-dialog--active">
        ...
        >
            <div class="fd-dialog__body fd-settings__dialog-body">
                <div class="fd-settings__container fd-settings__container--md">
                    <div class="fd-settings__list-area">
                        <div class="fd-bar fd-bar--header fd-bar--header-with-subheader">
                            <div class="fd-bar__left">
                                <div class="fd-bar__element">
    ...
    <section class="fd-dialog-docs-static fd-dialog fd-settings fd-settings--md fd-dialog--active">
        <div
            class="fd-dialog__content fd-settings__dialog-content"
            role="dialog"
            aria-modal="true"
                    ...
                    <div class="fd-settings__detail-area">
                        ...
                        <div class="fd-icon-tab-bar fd-icon-tab-bar--sm fd-settings__tab-bar">
                            ...
                            >
                                ...
                                pariatur? Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                                doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et
                                ...
                                quo voluptas nulla pariatur? Sed ut perspiciatis unde omnis iste natus error sit
                                ...
                                fugiat quo voluptas nulla pariatur? Sed ut perspiciatis unde omnis iste natus error sit
                                voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo
                                inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim
                                ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur
                                magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui
...
`,m=`<div style="display: flex; gap: 1rem; max-width: 1200px">
    <section class="fd-dialog-docs-static fd-dialog fd-settings fd-settings--sm fd-dialog--active" style="width: 400px">
        <div
            class="fd-dialog__content fd-settings__dialog-content"
            role="dialog"
            aria-modal="true"
        ...
        >
            <div class="fd-dialog__body fd-settings__dialog-body">
                <div class="fd-settings__container fd-settings__container--sm">
                    <div class="fd-settings__list-area">
                        <div class="fd-bar fd-bar--header fd-bar--header-with-subheader">
                            <div class="fd-bar__left">
                                <div class="fd-bar__element">
...
`,U={title:"Components/Settings",parameters:{description:`The Settings Dialog allows users to personalize their Fiori experience by adjusting various settings.<br><br> <h3>Layout and Structure</h3>
...
- <code>.fd-settings</code> applied on an element with class <code>.fd-dialog</code>
  - <code>.fd-settings\\_\\_dialog-content</code> applied on an element with class <code>.fd-dialog\\_\\_content</code>
    ...
    `,tags:["uxc"]}},a=()=>d;a.storyName="User Account (L-XL-XXL)";const s=()=>r;s.storyName="Appearance (L-XL-XXL)";const e=()=>c;e.storyName="Language & Region (L-XL-XXL)";const l=()=>_;l.storyName="Notifications (L-XL-XXL)";const o=()=>f;o.storyName="Notifications Details (L-XL-XXL)";const i=()=>u;i.storyName="L-XL-XXL (with Tabs and overflowing content)";i.parameters={docs:{description:{story:`For large screen sizes, the Settings Dialog uses a fixed-width layout with scrollable content:
<ul>
...
If the content height exceeds the available space, users can scroll through the content area.`}}};const n=()=>p;n.storyName="MD (600 - 1023)";n.parameters={docs:{description:{story:`For medium screen sizes (M 600px - 1023px), the Settings Dialog should adapt to the available space:
<ul>
...
</ul>`}}};const t=()=>m;t.storyName="SM (<= 599)";t.parameters={docs:{description:{story:`The Settings Dialog behaves differently on smartphones (S) compared to tablets or desktops (M and above). On S, the dialog can take up the entire screen. 
On small screen sizes (S), the dialog can either be stretched to full screen or used as a standard dialog. 

For S, it's recommended to use the dialog in full-screen mode to help users focus on the content. This recommendation applies to both portrait and landscape orientations.`}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => userAccountExampleHtml",...a.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => appearanceExampleHtml",...s.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => languageRegionExampleHtml",...e.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"() => notificationsExampleHtml",...l.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => notificationsDetailsExampleHtml",...o.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => xlExampleHtml",...i.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => mdExampleHtml",...n.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => smExampleHtml",...t.parameters?.docs?.source}}};const D=["UserAccount","Appearance","LanguageRegion","Notifications","NotificationsDetails","Xl","Md","Sm"];export{s as Appearance,e as LanguageRegion,n as Md,l as Notifications,o as NotificationsDetails,t as Sm,a as UserAccount,i as Xl,D as __namedExportsOrder,U as default};
