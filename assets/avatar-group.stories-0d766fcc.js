/* empty css               *//* empty css             *//* empty css               *//* empty css                *//* empty css            *//* empty css                    *//* empty css              *//* empty css                   *//* empty css             *//* empty css                         *//* empty css                   *//* empty css                  *//* empty css                   *//* empty css              */const l=`<div style="min-height: 300px;">
...
`,s=`<div style="min-height: 400px;">
    ...
    <br><br><div><b>Active/Toggled</b></div><br>
    <div class="fd-popover">
        <div class="fd-popover__control fd-avatar-group__popover-control"
            role="button"
            tabindex="0"
...
</div>`,i=`<div style="min-height: 400px;">
    <div class="fd-popover">
        <div class="fd-popover__control fd-avatar-group__popover-control"
            role="button"
            tabindex="0"
...
</div>`,o=`<div style="min-height: 400px;">
    <div class="fd-popover">
        <div class="fd-popover__control fd-avatar-group__popover-control"
            role="button"
            tabindex="0"
...
<div class="fd-avatar-group fd-avatar-group--group-type fd-avatar-group--xl">
    ...
    </div>`,c=`<div style="min-height: 400px;">
    <div class="fd-avatar-group fd-avatar-group--individual-type fd-avatar-group--sm">
        <div class="fd-popover">
            <div class="fd-popover__control">
                <span 
...
`;const M={title:"Components/Avatar Group",parameters:{description:`The avatar group displays a number of avatars, which act as a digital representation of a user. This control is useful for visualizing a team, project team members, or a group of employees, for example. <br />
...
`,docs:{story:{}},tags:["v1"]}},a=()=>c;a.parameters={docs:{story:{},description:{story:"The Avatar Individual Type component features avatars and an overflow shape, each with its own click area, catering to scenarios where users prioritize detailed information about specific group members. Avatars are displayed adjacent to each other without overlap, making it ideal for smaller groups like project teams.<br>\n      For Individual type add the `fd-avatar-group--individual-type` modifier class to the `fd-avatar-group` base class."}}};const n=()=>v;n.parameters={docs:{story:{},description:{story:"For vertical orientation of the Avatar Group add the `fd-avatar-group--vertical` modifier class to the `fd-avatar-group` base class."}}};const r=()=>o;r.parameters={docs:{story:{},description:{story:"The avatar group type is one single click/tap area. This means that the entire control is the click/tap area. <br>For Group type add the `fd-avatar-group--group-type` modifier class to the `fd-avatar-group` base class."}}};const e=()=>i;e.parameters={docs:{story:{},description:{story:"For vertical orientation of the Avatar Group add the `fd-avatar-group--vertical` modifier class to the `fd-avatar-group` base class."}}};const t=()=>s;t.parameters={docs:{story:{},description:{story:""}}};const d=()=>l;d.parameters={docs:{description:{story:'The overflow Avatar inherits the styling of the secondary regular Button control. Applications can also choose to set the background color to a random or specific color from the Avatar. The span element has a `role="button"` and `fd-avatar--overflow` modifier class. '}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => individualTypeExampleHtml",...a.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => individualTypeVerticalExampleHtml",...n.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => groupTypeExampleHtml",...r.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => groupTypeVerticalExampleHtml",...e.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => groupTypeInteractionStatesExampleHtml",...t.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => overflowExampleHtml",...d.parameters?.docs?.source}}};const C=["IndividualType","IndividualTypeVertical","GroupType","GroupTypeVertical","GroupTypeInteractionStates","Overflow"];export{r as GroupType,t as GroupTypeInteractionStates,e as GroupTypeVertical,a as IndividualType,n as IndividualTypeVertical,d as Overflow,C as __namedExportsOrder,M as default};
