...
`,w={title:"Components/Quick View",parameters:{description:"The quick view is similar to a popover but has a predefined structure, a fixed set of UI elements, and automatic UI rendering. Should be used in combination with the popover or dialog components",tags:[]}},e=()=>i;e.parameters={docs:{description:{story:"QuickView component as popover"}}};const d=()=>s;d.parameters={docs:{description:{story:"QuickView component as dialog. Because of the dialog structure quick view title should be set within the dialog header but not in the quick view header"}}};const a=()=>n;a.storyName="Without the header";a.parameters={docs:{description:{story:"QuickView without the header"}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => popoverExampleHtml",...e.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => dialogExampleHtml",...d.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => noHeaderExampleHtml",...a.parameters?.docs?.source}}};const x=["Popover","Dialog","NoHeader"];export{d as Dialog,a as NoHeader,e as Popover,x as __namedExportsOrder,w as default};
