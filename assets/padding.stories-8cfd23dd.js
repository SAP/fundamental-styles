const b=`The CSS padding properties are used to generate space around an element's content, inside of any defined borders. <br>
<br>
##Helper mixins:<br>
...
`,h={title:"Padding",parameters:{description:b}},a=`
<style>
    div.demo {
        display: flex;
        height: 4rem;
...
`;t.storyName="Responsive Paddings";t.parameters={docs:{description:{story:`The responsive padding class adds a double sided padding inside a container based on its width.<br>
...
`;n.parameters={docs:{description:{story:`No padding class removes existing container paddings. <br>
...
\``,...(c=(g=t.parameters)==null?void 0:g.docs)==null?void 0:c.source}}};var y,v,u;n.parameters={...n.parameters,docs:{...(y=n.parameters)==null?void 0:y.docs,source:{originalSource:`() => \`\${localStyles}
<div class="demo sap-padding-none">
    <div></div>
</div>

\``,...(u=(v=n.parameters)==null?void 0:v.docs)==null?void 0:u.source}}};const $=["AllRoundPadding","HorizontalPadding","ResponsivePadding","NoPadding"];export{d as AllRoundPadding,e as HorizontalPadding,n as NoPadding,t as ResponsivePadding,$ as __namedExportsOrder,h as default};
//# sourceMappingURL=padding.stories-8cfd23dd.js.map
