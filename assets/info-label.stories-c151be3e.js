/* empty css                   *//* empty css             */const b=`<span class="fd-info-label fd-info-label--accent-color-1 fd-info-label--display">
...
`,r=`<span class="fd-info-label fd-info-label--accent-color-1">
    <i role="presentation" class="fd-info-label__icon sap-icon--dark-mode"></i>
    <span class="fd-info-label__text">Info Label</span>
</span>
...
`,_=`<span class="fd-info-label fd-info-label--accent-color-1">
    <span class="fd-info-label__text">color 1</span>
</span>
<span class="fd-info-label fd-info-label--accent-color-2">
    <span class="fd-info-label__text">color 2</span>
...
`,I={title:"Components/Info Label",parameters:{description:"\nInfo Label is a small non-interactive numeric or text-based label.\nIts primary use is to add user-defined characteristic to an object.\nUse the Info Label base class with following modifiers:\n\n| **Accent** | **Modifier class** |\n| :--------- | :---------------: |\n| Accent 1 - Mango | `fd-info-label--accent-color-1`|\n| Accent 2 - Red | `fd-info-label--accent-color-2`|\n| Accent 3 - Raspberry | `fd-info-label--accent-color-3`|\n| Accent 4 - Pink | `fd-info-label--accent-color-4`|\n| Accent 5 - Indigo | `fd-info-label--accent-color-5`|\n| Accent 6 - Blue | `fd-info-label--accent-color-6`|\n| Accent 7 - Teal (Default) | `fd-info-label--accent-color-7`|\n| Accent 8 - Green | `fd-info-label--accent-color-8`|\n| Accent 9 - Cyan | `fd-info-label--accent-color-9`|\n| Accent 10 - Grey | `fd-info-label--accent-color-10`|\n\n<br><br>\nFor <code>Display</code> mode add the <code>fd-info-label--display</code> modifier class.\n      ",tags:["btp"]}},n=()=>_,a=()=>r,l=()=>b;var o,s,e;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:"() => colorFlavorsExampleHtml",...(e=(s=n.parameters)==null?void 0:s.docs)==null?void 0:e.source}}};var f,c,i;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:"() => infoLabelWithIconExampleHtml",...(i=(c=a.parameters)==null?void 0:c.docs)==null?void 0:i.source}}};var d,p,t;l.parameters={...l.parameters,docs:{...(d=l.parameters)==null?void 0:d.docs,source:{originalSource:"() => displayModeInfoLabelExampleHtml",...(t=(p=l.parameters)==null?void 0:p.docs)==null?void 0:t.source}}};const L=["ColorFlavors","InfoLabelWithIcon","DisplayModeInfoLabel"];export{n as ColorFlavors,l as DisplayModeInfoLabel,a as InfoLabelWithIcon,L as __namedExportsOrder,I as default};
//# sourceMappingURL=info-label.stories-c151be3e.js.map
