/* empty css               *//* empty css             *//* empty css                      *//* empty css                        *//* empty css              *//* empty css                 *//* empty css             *//* empty css             */const l=`<div class="fd-fixed-card-layout__card-layout fd-fixed-card-layout__card-layout--columns-3" style="height: 1102px;" [attr.dir]="dir">
    ...
    </div>`;const p={title:"Layouts/Fixed Card Layout",parameters:{description:`The fixed card layout is a layout for the overview page. The cards have a fixed width, and the height is determined by the card type and the embedded control.
        `,tags:["f3","a11y","theme","development"],components:["fixed-card-layout","avatar","card","object-status","numeric-content","table","checkbox","list","icon"]}},a=()=>l;a.storyName="Fixed card layout with 3 columns";a.parameters={docs:{story:{iframeHeight:900},description:{story:"Cards arrangement in a 3 column layout.\n* Use `fd-fixed-card-layout__card-layout` class for the wrapper element, specify amount of columns with `fd-fixed-card-layout__card-layout--columns-N` class, where `1 < N < 11`.\nLayout is single column by default. Also, set `height` or `max-height` for the wrapper element.\n* Apply `fd-fixed-card-layout__card` class to the every card element."}}};var t,n,s;a.parameters={...a.parameters,docs:{...(t=a.parameters)==null?void 0:t.docs,source:{originalSource:"() => fixedCardLayoutExampleHtml",...(s=(n=a.parameters)==null?void 0:n.docs)==null?void 0:s.source}}};const b=["FixedCardLayout"];export{a as FixedCardLayout,b as __namedExportsOrder,p as default};
//# sourceMappingURL=fixed-card-layout.stories-9ed6e271.js.map
