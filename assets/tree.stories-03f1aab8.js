/* empty css               *//* empty css                 *//* empty css             *//* empty css              */const w=`<ul role="tree" aria-label="Root Tree" id="TREE1RTLND1" class="fd-tree fd-tree--no-data">
...
`,k=`<h3>Left multi-selection(Dependent Selections)</h3>
    ...
    <li role="treeitem" aria-level="1" aria-expanded="true" class="fd-tree__item">
        <div class="fd-tree__item-container is-selected" tabindex="0">
            ...
            <div class="fd-form-item">
                ...
                <label tabindex="-1" aria-label="checkbox" class="fd-checkbox__label" for="Ai4ezA"></label>
            </div>
        </div>
            ...
            <li role="treeitem" aria-level="2" class="fd-tree__item">
                <div class="fd-tree__item-container" tabindex="0">
                    ...
                    <div class="fd-form-item">
                        ...
                        <label tabindex="-1" aria-label="checkbox" class="fd-checkbox__label" for="Ai4ezB"></label>
                    </div>
                </div>
            </li>
            <li role="treeitem" aria-level="2" class="fd-tree__item">
                <div class="fd-tree__item-container" tabindex="0">
                    ...
                    <div class="fd-form-item">
                        ...
                        <label tabindex="-1" aria-label="checkbox" class="fd-checkbox__label" for="Ai4ezC"></label>
                    </div>
                </div>
            </li>
            <li role="treeitem" aria-level="2" class="fd-tree__item">
                <div class="fd-tree__item-container" tabindex="0">
                    ...
                    <div class="fd-form-item">
                        ...
                        <label tabindex="-1" aria-label="checkbox" class="fd-checkbox__label" for="Ai4ezD"></label>
                    </div>
                </div>
            </li>
        </ul>
    ...
    <li role="treeitem" aria-level="1" class="fd-tree__item">
        <div class="fd-tree__item-container is-selected" tabindex="0">
            ...
            <div class="fd-form-item">
                ...
                <label tabindex="-1" aria-label="checkbox" class="fd-checkbox__label" for="Ai4ezEE"></label>
            </div>
        </div>
    </li>
    <li role="treeitem" aria-level="1" class="fd-tree__item">
        <div class="fd-tree__item-container" tabindex="0">
            ...
            <div class="fd-form-item">
                ...
                <label tabindex="-1" aria-label="checkbox" class="fd-checkbox__label" for="Ai4ezF"></label>
            </div>
        </div>
    </li>
</ul>
...
`,T=`<ul role="tree" aria-label="Root Tree" id="TREE6CL1" class="fd-tree expanded-level-6">
    <li role="treeitem" aria-level="1" aria-expanded="true" class="fd-tree__item">
...
`,R=`<ul role="tree" aria-label="Root Tree" id="TREE3L1" class="fd-tree expanded-level-3">
    <li role="treeitem" aria-level="1" aria-expanded="true" class="fd-tree__item">
        <div class="fd-tree__item-container has-highlight-indicator" tabindex="0">
...
`,A=`<ul role="tree" aria-label="Root Tree" id="TREE2L1" class="fd-tree fd-tree--no-border expanded-level-2">
    <li role="treeitem" aria-level="1" aria-expanded="true" class="fd-tree__item">
        <div class="fd-tree__item-container" tabindex="0">
...
`,z=`<ul role="tree" aria-label="Root Tree" id="TREE1L1" class="fd-tree expanded-level-1">
    <li role="treeitem" aria-level="1" aria-expanded="true" class="fd-tree__item">
        <div class="fd-tree__item-container" tabindex="0">
...
<br>
`,docs:{story:{iframeHeight:400}},tags:["f3","a11y","theme","development"]}},t=()=>z;t.parameters={docs:{story:{iframeHeight:950},description:{story:"\nThe primary tree component displays level 1 expanded to show level 2, which is indented by 1.5rem. Only the root tree (ul element) needs to have the `expanded-level-*` modifier class to indicate which level is currently expanded."}}};const n=()=>A;n.parameters={docs:{story:{iframeHeight:400},description:{story:"\nTree can be displayed without borders. To remove the borders from the first level items, add the `fd-tree--no-border` modifier class to the root tree. Additionally, tree list items can display actions, which are added as children of the `fd-tree__item-container` class.\n\n####Icons\nIcons can be added before and/or after the text as children of the `fd-tree__content` class.\n        "}}};const e=()=>R;e.storyName="Highlight indicators";e.parameters={docs:{story:{iframeHeight:500},description:{story:`
