/* empty css             *//* empty css             *//* empty css                 *//* empty css             *//* empty css               */import"./iframe-B0Ohe5Cn.js";import"./preload-helper-CR6acF8F.js";const m=`<h4 id="O09lk8">Standard</h4>
...
`,v=`<ul class="fd-list fd-list--selection fd-list--byline fd-list--navigation fd-list--navigation-indication" role="listbox"
...
`,u=`<ul class="fd-list fd-list--selection fd-list--byline" role="listbox" aria-labelledby="O09lk9">
...
</ul>`,y=`<ul class="fd-list fd-list--no-border fd-list--byline" role="list">
<li role="listitem" tabindex="0" class="fd-list__item">
    <span class="fd-list__thumbnail"><i role="presentation" class="sap-icon--activate"></i></span>
    <div class="fd-list__content">
      <div class="fd-list__title">Title</div>
...
`,h=`<ul class="fd-list fd-list--byline fd-list--navigation fd-list--navigation-indication" role="list">
<li role="listitem" tabindex="-1" class="fd-list__item fd-list__item--link">
  <a tabindex="0" class="fd-list__link fd-list__link--navigation-indicator" href="#">
    <span class="fd-list__thumbnail"><i role="presentation" class="sap-icon--activate"></i></span>
    <div class="fd-list__content">
...
`,x=`<ul class="fd-list fd-list--byline" role="list">
...
`,k=`<ul class="fd-list fd-list--byline fd-list--navigation" role="list">
<li role="listitem" tabindex="-1" class="fd-list__item fd-list__item--link">
  <a tabindex="0" class="fd-list__link" href="#">
    <span class="fd-list__thumbnail"><i role="presentation" class="sap-icon--activate"></i></span>
    <div class="fd-list__content">
...
`,N={title:"Components/List/Byline",parameters:{description:`
...
`,tags:["f3","a11y","theme","development"]}},i=()=>L;i.storyName="Default";i.parameters={docs:{description:{story:"The default byline list dislays list items in the standard size, which is ideal for mobile. To display the byline list in compact mode (for desktop), add the `is-compact` modifier class to the main element.\n    "}}};const l=()=>w;l.parameters={docs:{description:{story:`The Attachment List shares the same specification as the Standard List with Byline. The only difference is that if two text items are set within the Byline row, the text aligned to the right is always standard text (i.e. not semantic text)
    `}}};const n=()=>k;n.parameters={docs:{description:{story:"\nByline list items can contain navigation links. To add navigation, add the `fd-list--navigation` modifier class to the list and the `fd-list__item--link` modifier class to the list elements that contain links. All items should be navigable.\n"}}};const a=()=>g;a.parameters={docs:{description:{story:`
`}}};const d=()=>x;d.parameters={docs:{description:{story:"The `fd-list__item--interractive` will force list item to handle hover and active states.\n            Usage of this modifier is not needed on `Selection`, `Navigation` and `Action` modes."}}};const s=()=>h;s.storyName="Navigation indicators";s.parameters={docs:{description:{story:"\nIf only some of the list items are navigable, you should indicate them with an arrow icon. To display navigation indicators, add the `fd-list--navigation-indication` modifier class to the unordered list element. Do not show indicators if all items are navigable. In this case, use a byline list with navigation (in the example above).\n"}}};const o=()=>y;o.parameters={docs:{description:{story:"To display a borderless byline list, add the `fd-list--no-border` modifier class to the main element.\n    "}}};const c=()=>u;c.parameters={docs:{description:{story:"\nByline list items can display checkboxes that users can select from. To display byline list items with selection, add the `fd-list--selection` modifier class to the main element. To create checkbox form items, add the `fd-list__form-item` class within each list element.\n    "}}};const t=()=>v;t.storyName="Selection with navigation";t.parameters={docs:{description:{story:"To display byline list items with selection and navigation, add these following modifier classes to the main element:\n\n- `fd-list--byline`\n- `fd-list--selection`\n- `fd-list--navigation`\n- `fd-list--navigation-indicator`\n    "}}};const r=()=>p;r.storyName="Byline List with Counter";i.parameters={docs:{}};const e=()=>b;e.storyName="List with long Title and Byline";e.parameters={docs:{description:{story:`By default, To allow the title and byline text to wrap, add these following modifier classes to the the title and byline respectively:

- \`fd-list__title--wrap\`
- \`fd-list__byline--wrap\`

When more than 100 characters for small screens or 300 characters for medium to large screens are used, a clickable "MORE" link should be displayed to reveal the entire contents of the text.`}}};const _=()=>S;_.storyName="With Group Header";const f=()=>m;f.parameters={docs:{description:{story:`<span class="fd-info-label fd-info-label--accent-color-1"><span class="fd-info-label__text">non-fiori 3</span></span><br>
    `}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => standardExampleHtml",...i.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"() => attachmentExampleHtml",...l.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => navigationExampleHtml",...n.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => buttonsExampleHtml",...a.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => interractiveExampleHtml",...d.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => navigationIndicatorExampleHtml",...s.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => borderlessExampleHtml",...o.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:"() => selectionExampleHtml",...c.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => selectionAndNavigationExampleHtml",...t.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => counterExampleHtml",...r.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => longTextExampleHtml",...e.parameters?.docs?.source}}};_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:"() => groupHeaderExampleHtml",..._.parameters?.docs?.source}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:"() => unreadNotificationExampleHtml",...f.parameters?.docs?.source}}};const q=["Standard","Attachment","Navigation","Buttons","Interractive","NavigationIndicator","Borderless","Selection","SelectionAndNavigation","Counter","LongText","GroupHeader","UnreadNotification"];export{l as Attachment,o as Borderless,a as Buttons,r as Counter,_ as GroupHeader,d as Interractive,e as LongText,n as Navigation,s as NavigationIndicator,c as Selection,t as SelectionAndNavigation,i as Standard,f as UnreadNotification,q as __namedExportsOrder,N as default};
