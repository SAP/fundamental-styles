...
</div>`;const N={title:"AI/Patterns/Writing Assistant",parameters:{description:`The AI Writing Assistant simplifies interactions with generative AI, improving task efficiency and creating an intuitive, valuable user experience.
...
<br><b>Note: The component is in an experimental state.</b>`,tags:["ai","experimental"]}},a=()=>g;var o,d,u;a.parameters=s(e({},a.parameters),{docs:s(e({},(o=a.parameters)==null?void 0:o.docs),{source:e({originalSource:"() => aiWritingAssistantInputsExampleHtml"},(u=(d=a.parameters)==null?void 0:d.docs)==null?void 0:u.source)})});const T=["AIWritingAssistantForInputFileds"];export{a as AIWritingAssistantForInputFileds,T as __namedExportsOrder,N as default};
