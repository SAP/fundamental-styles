/* empty css            *//* empty css             *//* empty css                   *//* empty css             */const o=`
<br>
...
`,p={title:"Layouts/Page Footer",parameters:{description:`The Page Footer displays at the bottom of the page, and includes the links, icons and copy Right string.
...
Note: You may want to display components from right to left on the screen for international purposes. To display them as such, add the \`rtl\` directive to the main element.`,tags:["non-f3","a11y","theme"]}},t=()=>l;t.parameters={docs:{description:{story:"The Page Footer contains Image/logo, And list of links in the footer. It is responsive to tablet and mobile screen sizes."}}};const e=()=>s;e.parameters={docs:{description:{story:"The Page Footer contains Image/logo, And list of links in the footer. To apply multiline link, add the `fd-page-footer__row` modifier class to the container element."}}};const a=()=>i;a.parameters={docs:{description:{story:"Example of The Page Footer representing multiline link,and adding images in the code to represent the clickable images and multiline is achived by adding the `fd-page-footer__row` modifier class to the container element."}}};const n=()=>o;n.parameters={docs:{description:{story:"Example of The Page Footer representing multiline lin, add the `--xl` `--lg` `--md` `--sm` size modifier class to the container element."}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => singleLineLinkExampleHtml",...t.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => multiLineLinkExampleHtml",...e.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => imageAndIconLinkExampleHtml",...a.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => footerWithDiffrentSizeExampleHtml",...n.parameters?.docs?.source}}};const g=["SingleLineLink","MultiLineLink","ImageAndIconLink","FooterWithDiffrentSize"];export{n as FooterWithDiffrentSize,a as ImageAndIconLink,e as MultiLineLink,t as SingleLineLink,g as __namedExportsOrder,p as default};
