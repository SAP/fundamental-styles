/* empty css               *//* empty css             *//* empty css                *//* empty css              *//* empty css                    *//* empty css                  */const u=`<div class="fdx-side-nav" style="max-height: 500px;">
...
`,h=`<div class="fdx-side-nav fdx-side-nav--compact fdx-side-nav--narrow">
...
`,L=`<div class="fdx-side-nav fdx-side-nav--compact fdx-side-nav--narrow">
    <nav class="fdx-side-nav__main-navigation">
        <ul class="fdx-nested-list fdx-nested-list--compact level-1">
            <li class="fdx-nested-list__item">
                <a class="fdx-nested-list__link" href="#" aria-label="Level 1 Item">
...
`,I=`<div class="fdx-side-nav fdx-side-nav--narrow">
    <nav class="fdx-side-nav__main-navigation">
...
`,w=`<div class="fdx-side-nav fdx-side-nav--compact">
    <nav class="fdx-side-nav__main-navigation" aria-label="Main Menu">
...
`,N=`<div class="fdx-side-nav fdx-side-nav--compact">
    <nav class="fdx-side-nav__main-navigation" aria-label="Main Menu">
        <ul class="fdx-nested-list fdx-nested-list--compact level-1" aria-labelledby="EX500H1">
            <li class="fdx-nested-list__item">
                <a class="fdx-nested-list__link" href="#">
...
`,M=`<div class="fdx-side-nav fdx-side-nav--dynamic-width" style="max-height: 500px;">
...
`,S=`<div class="fdx-side-nav" style="max-height: 500px;">
    <nav class="fdx-side-nav__main-navigation" aria-label="Main Menu">
        <ul class="fdx-nested-list level-1">
            <li class="fdx-nested-list__item">
                <a class="fdx-nested-list__link" href="#">
...
`,q=`<div style="display: flex; gap: 2rem;">
...
</div>`;const B={title:"Components/Cx Side Navigation",parameters:{description:`The Side Navigation can display structures of up to three levels.
...
- Second level items do not display an icon and are not indented
- If second-level items have children, they show the expand/collapse arrows
- Third level items do not display an icon and are indented by 2 rem (32px)`,tags:["cx","theme"]}},a=()=>S;a.storyName="Cosy Wide With Icon, 1 Level";const s=()=>H;s.storyName="Cosy Wide Text Only, 1 Level";s.parameters={docs:{description:{story:"<b>Important: </b>This type of Side Navigation does not have <code>Narrow</code> variant."}}};const d=()=>M;d.parameters={docs:{description:{story:`Side Navigation can react dynamically to long label texts in navigational items. In such case the width of the Side Navigation is adapted by the longest label. The label does not wrap or truncate. Use the modifier class <code>.fdx-side-nav--dynamic-width</code> for Side Navigation with dynamic width.
        `}}};const n=()=>C;n.storyName="Cosy Wide Text Only, 3 Levels";n.parameters={docs:{description:{story:`<b>Important: </b>This type of Side Navigation does not have <code>Narrow</code> variant.
        `}}};const c=()=>W;c.storyName="Cosy Wide With Icons, 3 Levels, Collapse Only";const _=()=>E;_.storyName="Cosy Wide With Icons, 3 Levels, Navigation and Collapse";const e=()=>N;e.storyName="Compact Wide With Icons, Level 2 Collapsed";e.parameters={docs:{description:{story:`For compact Side Navigation apply the <code>.fdx-side-nav--compact</code> modifier class with <code>.fdx-side-nav</code> base class, and <code>.fdx-nested-list--compact</code> modifier class with <code>.fdx-nested-list</code> base class.
        ...
        `}}};const t=()=>g;t.storyName="Cosy Narrow, Levels 2 and 3 in Popover Hidden";t.parameters={docs:{description:{story:`For <code>Narrow</code> variant of Side Navigation apply <code>.fdx-side-nav--narrow</code> modifier class to <code>.fdx-side-nav</code> base class.
        `}}};const o=()=>I;o.storyName="Cosy Narrow with Vertical Overflow Behaviour, Levels 2 and 3 in Popover Hidden";const v=()=>y,l=()=>b;l.storyName="Cosy Narrow Popover with Dynamic Width";l.parameters={docs:{description:{story:`Side Navigation Popover can react dynamically to long label texts in navigational items. In such case the width of the Side Navigation Popover is adapted by the longest label. The label does not wrap or truncate. Use the modifier class <code>.fdx-side-nav__popover-body--dynamic-width</code> modifier class with <code>.fdx-side-nav__popover-body</code> base class for Side Navigation Popover with dynamic width.
        `}}};const r=()=>L;r.parameters={docs:{description:{story:`For <code>Narrow</code> variant of Side Navigation in compact mode apply <code>.fdx-side-nav--narrow</code> and <code>.fdx-side-nav--compact</code> modifier classed to <code>.fdx-side-nav</code> base class.
`}}};const f=()=>h;f.storyName="Compact Narrow with Vertical Overflow Behaviour, Levels 2 and 3 in Popover Hidden";const m=()=>k,x=()=>u;x.storyName="Cosy Wide With Icon and Filter Integration, 1 Level";const p=()=>q;p.parameters={docs:{description:{story:`By default, side navigation will wrap long text into multiple lines if the width of the nav is not enough. Developers can modify this behaviour by adding <code>.fdx-side-nav--single-line</code> class modifier.
        `}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => cozyWideIconsExampleHtml",...a.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => cozyWideTextOnlyExampleHtml",...s.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => dynamicWidthExampleHtml",...d.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => cosyWideTextOnlyLevelsExampleHtml",...n.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:"() => cosyWideIconsLevelsExampleHtml",...c.parameters?.docs?.source}}};_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:"() => cosyWideIconsLevelsMultiClickExampleHtml",..._.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => compactWideIconsExampleHtml",...e.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => compactWideIconsNavCollapseExampleHtml",...i.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => cosyNarrowExampleHtml",...t.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => cosyNarrowOverflowExampleHtml",...o.parameters?.docs?.source}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:"() => cosyNarrowPopoverExampleHtml",...v.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"() => cosyNarrowPopoverDynamicWidthExampleHtml",...l.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => compactNarrowExampleHtml",...r.parameters?.docs?.source}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:"() => compactNarrowOverflowExampleHtml",...f.parameters?.docs?.source}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:"() => compactNarrowPopoverExampleHtml",...m.parameters?.docs?.source}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:"() => cozyWideIconsSearchExampleHtml",...x.parameters?.docs?.source}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:"() => wrappingLongTextExampleHtml",...p.parameters?.docs?.source}}};const F=["CozyWideIcons","CozyWideTextOnly","DynamicWidth","CosyWideTextOnlyLevels","CosyWideIconsLevels","CosyWideIconsLevelsMultiClick","CompactWideIcons","CompactWideIconsNavCollapse","CosyNarrow","CosyNarrowOverflow","CosyNarrowPopover","CosyNarrowPopoverDynamicWidth","CompactNarrow","CompactNarrowOverflow","CompactNarrowPopover","CozyWideIconsSearch","WrappingLongText"];export{r as CompactNarrow,f as CompactNarrowOverflow,m as CompactNarrowPopover,e as CompactWideIcons,i as CompactWideIconsNavCollapse,t as CosyNarrow,o as CosyNarrowOverflow,v as CosyNarrowPopover,l as CosyNarrowPopoverDynamicWidth,c as CosyWideIconsLevels,_ as CosyWideIconsLevelsMultiClick,n as CosyWideTextOnlyLevels,a as CozyWideIcons,x as CozyWideIconsSearch,s as CozyWideTextOnly,d as DynamicWidth,p as WrappingLongText,F as __namedExportsOrder,B as default};
