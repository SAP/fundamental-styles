/* empty css               *//* empty css               *//* empty css              *//* empty css             *//* empty css                      *//* empty css                        *//* empty css              *//* empty css                 *//* empty css             *//* empty css             *//* empty css             */const x=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
...
`,y=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
...
`,C=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
...
`,T=`<div style="display:flex; justify-content:space-around; flex-wrap: wrap">
    <div style="width: 300px; height: 400px; margin: 1rem;">
...
`,tags:["f3","a11y","theme","development"]}},a=()=>T;a.storyName="Standard card";a.parameters={docs:{story:{iframeHeight:900},description:{story:`The standard card displays a header area with a title and a content area, as well as any other components mentioned in the card anatomy section.
`}}};const e=()=>w;e.storyName="Analytical card";e.parameters={docs:{story:{iframeHeight:450},description:{story:`The analytical card is used for data visualization. It can display a KPI header and various chart types in the content. The only difference between a KPI header and a standard header is that the former requires a subtitle, a KPI area and can display an optional second subtitle. To display an analytical card, add the \`fd-card--analytical\` modifier class to the main element.
...
`}}};const t=()=>C;t.storyName="List card";t.parameters={docs:{story:{iframeHeight:400},description:{story:`A card can display various types of lists. All components placed inside should behave natively.
        ...
        `}}};const n=()=>y;n.storyName="Table card";n.parameters={docs:{story:{iframeHeight:400},description:{story:"Cards can display tables within the content area. To display a table card, add the `fd-card--table` modifier class to the main element."}}};const d=()=>x;d.storyName="Object card";d.parameters={docs:{story:{iframeHeight:600},description:{story:"The object card can display a single object or a group of objects. Contrary to other cards, object card has 1rem padding on all sides of the content area. To display an object card, add the `fd-card--object` modifier class to the main element.\n\n**Within the content area, there are several components:**\n\nComponent (class) |	Description\n:---------------- | :-----------\n`fd-card__content-container` | a wrapper for the content sections. By default, the content is displayed in one column. To display the content in two columns, add the `fd-card__content-container--horizontal` modifier class.\n`fd-card__content-section` | a content section. A section contains a group title and one or multiple groups. The min-width of the section is 12rem and it can reach a maximum of 24rem.\n`fd-card__content-title-container` | a container for the title.\n`fd-card__content-group` | a container for the content group. It can also contain an avatar with size XS, a group label and a group value.\n`fd-card__content-label-container` | a container for the label of the group.\n`fd-card__content-group-container` | a container for the value of the group.\n"}}};var i,s,r;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:"() => cardAnatomyExampleHtml",...(r=(s=a.parameters)==null?void 0:s.docs)==null?void 0:r.source}}};var l,c,o;e.parameters={...e.parameters,docs:{...(l=e.parameters)==null?void 0:l.docs,source:{originalSource:"() => analyticalCardExampleHtml",...(o=(c=e.parameters)==null?void 0:c.docs)==null?void 0:o.source}}};var _,v,f;t.parameters={...t.parameters,docs:{...(_=t.parameters)==null?void 0:_.docs,source:{originalSource:"() => listCardExampleHtml",...(f=(v=t.parameters)==null?void 0:v.docs)==null?void 0:f.source}}};var p,u,m;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:"() => tableCardExampleHtml",...(m=(u=n.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};var b,h,g;d.parameters={...d.parameters,docs:{...(b=d.parameters)==null?void 0:b.docs,source:{originalSource:"() => objectCardExampleHtml",...(g=(h=d.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};const z=["CardAnatomy","AnalyticalCard","ListCard","TableCard","ObjectCard"];export{e as AnalyticalCard,a as CardAnatomy,t as ListCard,d as ObjectCard,n as TableCard,z as __namedExportsOrder,U as default};
//# sourceMappingURL=card.stories-244cbe23.js.map
