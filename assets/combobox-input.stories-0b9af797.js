var P=Object.defineProperty,K=Object.defineProperties;var C=Object.getOwnPropertyDescriptors;var c=Object.getOwnPropertySymbols;var L=Object.prototype.hasOwnProperty,O=Object.prototype.propertyIsEnumerable;var f=(a,e,s)=>e in a?P(a,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):a[e]=s,n=(a,e)=>{for(var s in e||(e={}))L.call(e,s)&&f(a,s,e[s]);if(c)for(var s of c(e))O.call(e,s)&&f(a,s,e[s]);return a},t=(a,e)=>K(a,C(e));/* empty css              *//* empty css              *//* empty css                   *//* empty css                *//* empty css             *//* empty css                    *//* empty css              *//* empty css             *//* empty css               *//* empty css               *//* empty css            *//* empty css                  */const B=`<div class="fd-dialog fd-dialog-docs-static fd-select-docs-max-height fd-dialog--active"
...
`,k=`<div style="display:flex;height:250px">
    <div style="display:flex;flex-direction:column">
...
`,D=`<div style="display:flex;justify-content:space-around;height:500px">
    <div style="display:flex;flex-direction:column">
...
`,tn={title:"Patterns/Combobox Input",parameters:{description:`
...
`,tags:["f3","a11y","theme"]}},i=()=>M;i.parameters={docs:{description:{story:`
...
`}}};const o=()=>D;o.parameters={docs:{description:{story:`
The \`ComboBox\` component can be customized by adding additional information in additional columns as seen below.

In cases where the list items need to be categorized into groups, it is possible to add headers for each category.`}}};const l=()=>k;l.parameters={docs:{description:{story:"\nThe default length size of the popover body is often different from the text length.\nThe body length can be adjusted to match the text length by adding the `fd-popover__body--dropdown-fill` class to the `fd-popover__body`.\nThis class has been added to all the `Combobox` examples above.\nIn the example you can see how the `Combobox` component looks without the `fd-popover__body--dropdown-fill` modifier.\n"}}};const d=()=>R;d.parameters={docs:{description:{story:'\nTo disable a `Combobox` component, the disabled attribute needs to be added to the `fd-popover__control` and the `fd-input__control` elements.\nThe disabled state can also be achieved by adding the `.is-disable` class or the `aria-disabled="true"` attribute.\n\nTo make the `Combobox` component read-only, the readonly attribute needs to be added to the `fd-nput-group` element.\nThis can also be done by using the `.is-readonly` class or `aria-readonly="true"` attribute.'}}};const r=()=>z;r.parameters={docs:{description:{story:"\nFor a complete list of states supported by the `combobox` component, please see the documentation for the form or select components.\n\nThe semantic mode can be used to modify the combobox component by adding one of\n`is-error` | `is-success` | `is-warning` | `is-information` classes into fd-input-group element.\nTo add text in the `body` of the component, simply include your text in the `fd-list__message` under the `ul` element.\n"}}};const p=()=>B;p.parameters={docs:{description:{story:"\nFor mobile devices, or tablets, combobox component should be displayed in fullscreen mode.\nSo instead of using popover and dropdown, it should be wrapped in `dialog` and `bar` components.\n"}}};var _,u,b;i.parameters=t(n({},i.parameters),{docs:t(n({},(_=i.parameters)==null?void 0:_.docs),{source:n({originalSource:"() => asFormItemExampleHtml"},(b=(u=i.parameters)==null?void 0:u.docs)==null?void 0:b.source)})});var m,v,g;o.parameters=t(n({},o.parameters),{docs:t(n({},(m=o.parameters)==null?void 0:m.docs),{source:n({originalSource:"() => twoItemsAndItemsGroupingExampleHtml"},(g=(v=o.parameters)==null?void 0:v.docs)==null?void 0:g.source)})});var h,x,y;l.parameters=t(n({},l.parameters),{docs:t(n({},(h=l.parameters)==null?void 0:h.docs),{source:n({originalSource:"() => matchPopoverBodySizeExampleHtml"},(y=(x=l.parameters)==null?void 0:x.docs)==null?void 0:y.source)})});var w,F,E;d.parameters=t(n({},d.parameters),{docs:t(n({},(w=d.parameters)==null?void 0:w.docs),{source:n({originalSource:"() => disabledAndReadOnlyExampleHtml"},(E=(F=d.parameters)==null?void 0:F.docs)==null?void 0:E.source)})});var A,I,H;r.parameters=t(n({},r.parameters),{docs:t(n({},(A=r.parameters)==null?void 0:A.docs),{source:n({originalSource:"() => semanticExampleHtml"},(H=(I=r.parameters)==null?void 0:I.docs)==null?void 0:H.source)})});var S,T,G;p.parameters=t(n({},p.parameters),{docs:t(n({},(S=p.parameters)==null?void 0:S.docs),{source:n({originalSource:"() => mobileExampleHtml"},(G=(T=p.parameters)==null?void 0:T.docs)==null?void 0:G.source)})});const en=["AsFormItem","TwoItemsAndItemsGrouping","MatchPopoverBodySize","DisabledAndReadOnly","Semantic","Mobile"];export{i as AsFormItem,d as DisabledAndReadOnly,l as MatchPopoverBodySize,p as Mobile,r as Semantic,o as TwoItemsAndItemsGrouping,en as __namedExportsOrder,tn as default};
