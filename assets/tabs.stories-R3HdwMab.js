...
`,w={title:"Deprecated/Components/Tabs",parameters:{tags:["deprecated"],description:`Tabs are based on the folder metaphor and used to separate content into different sections. Tabs should be ordered based on priority to create visual hierarchy.
...
<br>
        `}},a=()=>h;a.storyName="Default";a.parameters={docs:{description:{story:`By default, tabs are displayed in a bar and are either inactive or active (highlighted in blue). The bar can also contain actions that apply to the whole page. The example below illustrates the tabs component in cozy mode with no horizontal padding.
        `}}};const s=()=>u;s.storyName="Counters";s.parameters={docs:{description:{story:"Tabs can be displayed with counters to indicate that there are a number of resources the user can or should access. To display counters, wrap the `fd-tabs__count` class in paragraph tags below the `fd-tabs__link` element.\n\nIn the example below, the tabs component is optimized for an extra-large screen with the `fd-tabs--xl` modifier class, which adds 3rem horizontal paddings.\n        "}}};const n=()=>m;n.storyName="Navigable";n.parameters={docs:{description:{story:"Tabs can be navigable by applying the `role=”navigation”` attribute to the main element.\n    "}}};const e=()=>f;e.storyName="Icon";e.parameters={docs:{description:{story:"Tabs can display icons instead of text with the ` fd-tabs__icon` class (see **Icon** for a list of available icons). To display icon tabs without text, you will also need to add the `fd-tabs--icon-only` modifier class to the main element.\n    "}}};const t=()=>_;t.storyName="Process mode";t.parameters={docs:{description:{story:"Tabs can be displayed in subsequent steps, indicating to the user that there is a process to follow. To display tabs in process mode, add the `fd-tabs--process` modifier class to the main element.\n    "}}};const l=()=>b;l.storyName="Filter mode";l.parameters={docs:{description:{story:"Tabs can be displayed in filter mode, indicating to the user that a value has been filtered into separate tabs. To display tabs in filter mode, add the `fd-tabs--filter` modifier class to the main element.\n    "}}};const i=()=>p;i.storyName="Semantic mode";i.parameters={docs:{description:{story:"Tabs can be displayed with semantic colors to indicate a status. To display semantic tabs, add the following modifier classes to the `fd-tabs__item` elements:\n\n| State | Modifier class |\n| :------- | :--------------- |\n| Success | `fd-tabs__item--success` |\n| Warning | `fd-tabs__item--warning` |\n| Information | `fd-tabs__item--information` |\n| Error | `fd-tabs__item--error` |\n| Neutral | `fd-tabs__item--neutral` |\n        "}}};const r=()=>c;r.storyName="Semantic filter mode";r.parameters={docs:{description:{story:"Tabs can be displayed in filter mode with semantic colors. As detailed in the previous examples, add the `fd-tabs--filter` modifier class to the main element and add the semantic modifier classes to the `fd-tabs__item` elements (see **semantic mode** example for modifier class names).\n        "}}};const o=()=>d;o.storyName="Semantic inline";o.parameters={docs:{description:{story:"Tabs can be displayed with inline text in semantic colors. To display inline text tabs, add the `fd-tabs__tag` class below the `fd-tabs__link` element.\n        "}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => primaryExampleHtml",...a.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => tabWithCountersExampleHtml",...s.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => navTabExampleHtml",...n.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => iconOnlyExampleHtml",...e.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => processModeExampleHtml",...t.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"() => filterModeExampleHtml",...l.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => semanticModeExampleHtml",...i.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => semanticFilterModeExampleHtml",...r.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => semanticInlineExampleHtml",...o.parameters?.docs?.source}}};const g=["Primary","TabWithCounters","NavTab","IconOnly","ProcessMode","FilterMode","SemanticMode","SemanticFilterMode","SemanticInline"];export{l as FilterMode,e as IconOnly,n as NavTab,a as Primary,t as ProcessMode,r as SemanticFilterMode,o as SemanticInline,i as SemanticMode,s as TabWithCounters,g as __namedExportsOrder,w as default};
