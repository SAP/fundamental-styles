/* empty css                  *//* empty css                   *//* empty css              *//* empty css                *//* empty css                     */const d=`
...
`,b={title:"Components/Forms/Input",parameters:{description:`Inputs are used to collect data from the user and should always be paired with a label. When a field is required, the label should include an asterisk (*).
...
- The user needs to carry out a search. In this case, use the search field.
        `,tags:["f3","a11y","theme"]}},e=()=>o;e.storyName="Default";e.parameters={docs:{story:{iframeHeight:500},description:{story:"The standard input component can be displayed by using `fd-input` class"}}};const l=()=>d;l.parameters={docs:{storyDescription:`
...
//# sourceMappingURL=input.stories-05825f20.js.map
