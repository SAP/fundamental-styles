/* empty css            *//* empty css               *//* empty css              *//* empty css                    *//* empty css                *//* empty css                         */const d=`<div style="min-height: 250px;">
...
`},tags:["f3","theme"]},e=()=>_;e.storyName="Time Picker with 24-hour Clock Face";e.parameters={docs:{description:{story:`The 24-hour clock face shows an additional inner circle for the times from 13:00 to 24:00 hours.
`}}};const i=()=>p;i.storyName="Time Picker with 12-hour Clock Face";i.parameters={docs:{description:{story:`The 12-hour clock face shows only one circle and an AM/PM switch is displayed.
`}}};const s=()=>a;s.storyName="Minutes Face";s.parameters={docs:{description:{story:"When the minutes value is selected in the time display, the minutes clock face is shown."}}};const n=()=>c;n.storyName="Seconds Face";n.parameters={docs:{description:{story:"When the seconds value is selected in the time display, the seconds clock face is shown."}}};const t=()=>d;t.parameters={docs:{description:{story:`On phones, focusing on the time input field opens a time input popover. The user can then use the mobile keyboard to enter the time. For the 12-hour time format, the popover also offers an AM/PM switch.
`}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => hours24CozyExampleHtml",...e.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => hours12CozyExampleHtml",...i.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => minutesCozyExampleHtml",...s.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => secondsCozyExampleHtml",...n.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => mobileExampleHtml",...t.parameters?.docs?.source}}};const g=["Hours24Cozy","Hours12Cozy","MinutesCozy","SecondsCozy","Mobile"];export{i as Hours12Cozy,e as Hours24Cozy,s as MinutesCozy,t as Mobile,n as SecondsCozy,g as __namedExportsOrder,v as default};
