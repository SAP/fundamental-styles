...
Component not working in the IE, default scrollbar is shown instead.
            `,tags:[]}},e=()=>r;e.storyName="Default";e.parameters={docs:{description:{story:"To use themeable scrollbar use `fd-scrollbar` class on scrollable element.\n"}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => defaultExampleExampleHtml",...e.parameters?.docs?.source}}};const o=["DefaultExample"];export{e as DefaultExample,o as __namedExportsOrder,a as default};
