...
`,d={title:"Border Radius",parameters:{description:`Provides CSS classes and SCSS mixins for controlling the corner rounding of elements. Classes apply predefined theme-based border-radius values, while the sap-border-radius mixin lets you define custom values for one or multiple corners.
...
<code>@include sap-border-radius(1rem 0.5rem 0.25rem 0.25rem)</code><br>
      `}},r=()=>e;r.storyName="Border Radius Types";r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => borderRadiusExampleHtml",...r.parameters?.docs?.source}}};const t=["BorderRadius"];export{r as BorderRadius,t as __namedExportsOrder,d as default};
