/* empty css                *//* empty css             *//* empty css                   *//* empty css             *//* empty css             */const o=`
...
`,d=`<nav aria-label="products breadcrumbs">
    <ul class="fd-breadcrumb">
...
`,u={title:"Components/Breadcrumb",parameters:{description:`
...
`,tags:["f3","a11y","theme"]}},a=()=>d;a.parameters={docs:{description:{story:"The standard breadcrumb component displays several pages in text format separated by dividers, indicating a navigation path. Each page can be specifically selected to navigate to its corresponding page. It can be displayed by using the `fd-breadcrumb` class."}}};const e=()=>o;e.parameters={docs:{story:{iframeHeight:200},description:{story:"The overflow breadcrumb component displays a dropdown menu, followed by several pages in the navigation path. <br>Like the standard breadcrumb, each page can be selected to navigate to its corresponding page. This type is responsive and will collapse into a dropdown menu if there is insufficient horizontal space on the screen. <br>To display the overflow breadcrumb, include the `fd-popover` component in the first breadcrumb item within the element."}}};var n,s,i;a.parameters={...a.parameters,docs:{...(n=a.parameters)==null?void 0:n.docs,source:{originalSource:"() => standardExampleHtml",...(i=(s=a.parameters)==null?void 0:s.docs)==null?void 0:i.source}}};var t,r,l;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:"() => overflowExampleHtml",...(l=(r=e.parameters)==null?void 0:r.docs)==null?void 0:l.source}}};const _=["Standard","Overflow"];export{e as Overflow,a as Standard,_ as __namedExportsOrder,u as default};
//# sourceMappingURL=breadcrumb.stories-921fe07f.js.map
