/* empty css               *//* empty css                   *//* empty css                 *//* empty css             *//* empty css             *//* empty css                      *//* empty css              *//* empty css                *//* empty css                   *//* empty css                *//* empty css             *//* empty css            *//* empty css               *//* empty css              *//* empty css                    *//* empty css                 *//* empty css               *//* empty css             *//* empty css             *//* empty css                      *//* empty css                      *//* empty css              */const H=`<table class="fd-table fd-table--tree">
...
`,T=`<table class="fd-table fd-table--group">
        <thead class="fd-table__header">
            <tr class="fd-table__row">
                <th class="fd-table__cell" scope="col">
                    Type
...
`,F=`<table class="fd-table" aria-describedby="FU4EwF6st">
...
`,E=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
</table>`,A=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,W=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,j=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,I=`<div class="fd-dialog" id="filter-dialog-example">
...
`,M=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,z=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,P=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,U=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,O=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,B=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,D=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,G=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,V=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
</table>`,q=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,Y=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
`,K=`<div class="fd-toolbar fd-toolbar--title fd-toolbar-active">
...
</table>`,xe={title:"Components/Table",parameters:{description:`
...
In these cases, use the **Tree** instead.
        `,components:["button","form-label","fieldset","icon","link","object-status","table","toolbar","pagination","popover","list","toolbar","bar","dialog","input","input-group","checkbox","select","menu","text","object-number","object-marker"]}},u=()=>J;u.parameters={docs:{description:{story:`
...
To disable the hover and active states on header cells apply the <code>fd-table__header--non-interactive</code> modifier to <code>fd-table__header</code> base class.
    `}}};const x=()=>K;x.parameters={docs:{description:{story:`
...
The table component can display navigation indicators. When multi-selection is used in a master-detail scenario, it is not clear which item was last opened, you can mark it as a “navigated” indicator, as indicated in the second row, to mark an item that is currently open. To display a navigated indicator, add the \`fd-table__cell--navigated\` class to the desired table cell.
    `}}};const y=()=>E;y.parameters={docs:{description:{story:"\nThe desktop responsive table should contain `fd-table--responsive` modifier.\n    "}}};const f=()=>L;f.storyName="Responsive Table (pop-in mode)";f.parameters={docs:{description:{story:`
...
Information about the table such as a title, summary, and/or keyboard navigation instructions should be provided in captions for screen readers. To caption table information, use the \`fd-table__caption\` class.
    `}}};const p=()=>C;p.storyName="Table without data";p.parameters={docs:{description:{story:`
Table can indicate that there is no data to display.
    `}}};const m=()=>T;m.storyName="Table with group rows";m.parameters={docs:{description:{story:`
...
Please consider that you need to implement expanding/collapsing functionality by yourself.
    `}}};const h=()=>H;h.storyName="Tree Table";h.parameters={docs:{description:{story:`
...
Please consider that you need to implement expanding/collapsing functionality by yourself.
    `}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:"() => primaryExampleHtml",...u.parameters?.docs?.source}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:"() => borderlessExampleHtml",...x.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => borderlessbodyExampleHtml",...e.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"() => noOuterBorderExampleHtml",...l.parameters?.docs?.source}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:"() => footerExampleHtml",...v.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => condensedFooterExampleHtml",...a.parameters?.docs?.source}}};k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:"() => interactiveExampleHtml",...k.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => semanticRowsExampleHtml",...t.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => focusableRowsExampleHtml",...s.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => focusableCellsExampleHtml",...d.parameters?.docs?.source}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:"() => checkboxExampleHtml",...g.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => condensedCheckboxExampleHtml",...n.parameters?.docs?.source}}};w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:"() => paginationExampleHtml",...w.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:"() => advancedToolbarExampleHtml",...c.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => contextualMenuExampleHtml",...o.parameters?.docs?.source}}};_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:"() => menuHeaderExampleHtml",..._.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => fixColumnHeaderExampleHtml",...i.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => navIconExampleHtml",...r.parameters?.docs?.source}}};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:"() => navIndicatorsExampleHtml",...b.parameters?.docs?.source}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:"() => responsiveTableExampleHtml",...y.parameters?.docs?.source}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:"() => responsiveTablePopInModeExampleHtml",...f.parameters?.docs?.source}}};N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:"() => gridTableExampleHtml",...N.parameters?.docs?.source}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:"() => noDataTableExampleHtml",...p.parameters?.docs?.source}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:"() => groupRowsInTableExampleHtml",...m.parameters?.docs?.source}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:"() => treeRowsTableExampleHtml",...h.parameters?.docs?.source}}};const ve=["Primary","Borderless","Borderlessbody","NoOuterBorder","Footer","CondensedFooter","Interactive","SemanticRows","FocusableRows","FocusableCells","Checkbox","CondensedCheckbox","Pagination","AdvancedToolbar","ContextualMenu","MenuHeader","FixColumnHeader","NavIcon","NavIndicators","ResponsiveTable","ResponsiveTablePopInMode","GridTable","NoDataTable","GroupRowsInTable","TreeRowsTable"];export{c as AdvancedToolbar,x as Borderless,e as Borderlessbody,g as Checkbox,n as CondensedCheckbox,a as CondensedFooter,o as ContextualMenu,i as FixColumnHeader,d as FocusableCells,s as FocusableRows,v as Footer,N as GridTable,m as GroupRowsInTable,k as Interactive,_ as MenuHeader,r as NavIcon,b as NavIndicators,p as NoDataTable,l as NoOuterBorder,w as Pagination,u as Primary,y as ResponsiveTable,f as ResponsiveTablePopInMode,t as SemanticRows,h as TreeRowsTable,ve as __namedExportsOrder,xe as default};
