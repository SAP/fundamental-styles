...
Negative | \`fd-progress-indicator--negative\`
        `,components:["progress-indicator","menu","popover","icon"],tags:["f3","a11y","theme","development"]}},s=()=>f;s.parameters={docs:{description:{story:`
