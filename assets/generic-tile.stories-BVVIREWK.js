/* empty css             *//* empty css              *//* empty css               *//* empty css                        *//* empty css             */const v=`<div class="fddocs-container">
...
</div>`,_=`<h4>Link tile: Floating behaviour</h4>
...
</div>`,f=`<div class="fddocs-container">
...
</div>`,p=`<div class="fddocs-container">
    <div role="button" tabindex="0" class="fd-tile fd-tile--double fd-tile--feed">
        <div class="fd-tile__header">
            <div class="fd-tile__title">Title: Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</div>
            <div class="fd-tile__subtitle">Subtitle</div>
...
</div>`,m=`<h4>KPI tile with numeric content (size L)</h4>
...
`,b=`<h4>Launch tile with numeric content and launch icon</h4>
<br>
<div class="fddocs-container">
    <div role="button" tabindex="0" class="fd-tile fd-tile--launch">
        <div class="fd-tile__header">
...
</div>`,h=`<div class="fddocs-container">
...
</div>`,q={title:"Components/Generic Tiles",decorators:[r=>`<style>.fddocs-container { gap: 2rem; }</style>${r()}`],parameters:{description:`
...
<br>
      `,tags:[]}},e=()=>x;e.storyName="Sizes";e.parameters={docs:{description:{story:`
...
- Small tile (2 x 1) - 19 x 9.25rem
        `}}};const i=()=>g;i.storyName="Layout";i.parameters={docs:{description:{story:`
...
| L | 4 characters can be displayed within numeric content.
        `}}};const d=()=>m;d.storyName="KPI tile";d.parameters={docs:{description:{story:`
...
**Note:** The KPI tile supports a limited number of characters, which varies depending on the tile size (see launch tile above for more details).
        `}}};const l=()=>p;l.storyName="Feed tile";l.parameters={docs:{description:{story:"The feed tile displays a news feed with a news headline, the source, and a time stamp. It shows new notifications in 10-second intervals, and tile content is updated every five minutes. If there are no new notifications, the most recent notifications are displayed. The feed tile’s headline uses the full width of the container and does not contain an icon. To display a feed tile, add the `fd-tile--feed` modifier class to the main element.\n        "}}};const s=()=>u;s.storyName="Badge tile";s.parameters={docs:{description:{story:`The badge tile displays very short and important information at the top right corner of the tile. It's recommended to add a badge to a tile when it has been newly added. Badges are not displayed when in action/edit mode.
        `}}};const a=()=>f;a.storyName="Slide tile";a.parameters={docs:{description:{story:`
...
When in action mode, default (floating) link tiles display the actions and close button immediately after the text. However, when they are in list format, link tiles display the actions and close button along the right side of the container. To display link tile in action mode, add \`fd-tile__action-container\` after the header element. Gradient masking is also supported in edit mode.
        ...
        `}}};const c=()=>v;c.storyName="Action mode";c.parameters={docs:{description:{story:"\nWhile a tile is in action mode, a close button is displayed on the top right-hand corner of the tile. The action icon is displayed on the bottom right-hand corner, and is only an indicator. The click/touch area fills the entire tile, excluding the area reserved for the close button. To display generic tile in action mode, add the `fd-tile--action` modifier class to the main element.\n        "}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => genericTileSizesExampleHtml",...e.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => genericTileLayoutExampleHtml",...i.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => genericTileContentColumnsExampleHtml",...t.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => launchTileExampleHtml",...n.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => kpiTileExampleHtml",...d.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"() => feedTileExampleHtml",...l.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => badgeTileExampleHtml",...s.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => slideTileExampleHtml",...a.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"() => linkTileExampleHtml",...o.parameters?.docs?.source}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:"() => tileInActionModeExampleHtml",...c.parameters?.docs?.source}}};const L=["GenericTileSizes","GenericTileLayout","GenericTileContentColumns","LaunchTile","KpiTile","FeedTile","BadgeTile","SlideTile","LinkTile","TileInActionMode"];export{s as BadgeTile,l as FeedTile,t as GenericTileContentColumns,i as GenericTileLayout,e as GenericTileSizes,d as KpiTile,n as LaunchTile,o as LinkTile,a as SlideTile,c as TileInActionMode,L as __namedExportsOrder,q as default};
