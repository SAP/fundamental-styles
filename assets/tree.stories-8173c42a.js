var D=Object.defineProperty,I=Object.defineProperties;var q=Object.getOwnPropertyDescriptors;var _=Object.getOwnPropertySymbols;var C=Object.prototype.hasOwnProperty,N=Object.prototype.propertyIsEnumerable;var p=(i,t,n)=>t in i?D(i,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):i[t]=n,e=(i,t)=>{for(var n in t||(t={}))C.call(t,n)&&p(i,n,t[n]);if(_)for(var n of _(t))N.call(t,n)&&p(i,n,t[n]);return i},a=(i,t)=>I(i,q(t));/* empty css               *//* empty css                 *//* empty css             *//* empty css              */const H=`<ul role="tree" aria-label="Root Tree" id="TREE1RTLND1" class="fd-tree fd-tree--no-data">
...
`,F=`<h3>Left multi-selection(Dependent Selections)</h3>
...
`,B=`<ul role="tree" aria-label="Root Tree" id="TREE6CL1" class="fd-tree expanded-level-6">
    <li role="treeitem" aria-level="1" aria-expanded="true" class="fd-tree__item">
...
`,W=`<ul role="tree" aria-label="Root Tree" id="TREE3L1" class="fd-tree expanded-level-3">
    <li role="treeitem" aria-level="1" aria-expanded="true" class="fd-tree__item">
        <div class="fd-tree__item-container has-highlight-indicator" tabindex="0">
...
`,P=`<ul role="tree" aria-label="Root Tree" id="TREE2L1" class="fd-tree fd-tree--no-border expanded-level-2">
    <li role="treeitem" aria-level="1" aria-expanded="true" class="fd-tree__item">
        <div class="fd-tree__item-container" tabindex="0">
...
`,U=`<ul role="tree" aria-label="Root Tree" id="TREE1L1" class="fd-tree expanded-level-1">
    <li role="treeitem" aria-level="1" aria-expanded="true" class="fd-tree__item">
        <div class="fd-tree__item-container" tabindex="0">
...
<br>
`,tags:["f3","a11y","theme","development"]}},l=()=>U;l.parameters={docs:{description:{story:"\nThe primary tree component displays level 1 expanded to show level 2, which is indented by 1.5rem. Only the root tree (ul element) needs to have the `expanded-level-*` modifier class to indicate which level is currently expanded."}}};const d=()=>P;d.parameters={docs:{description:{story:"\nTree can be displayed without borders. To remove the borders from the first level items, add the `fd-tree--no-border` modifier class to the root tree. Additionally, tree list items can display actions, which are added as children of the `fd-tree__item-container` class.\n\n####Icons\nIcons can be added before and/or after the text as children of the `fd-tree__content` class.\n        "}}};const s=()=>W;s.storyName="Highlight indicators";s.parameters={docs:{description:{story:`
...
`}}};const o=()=>B;o.parameters={docs:{description:{story:"\nTree can be displayed with navigation links by anchoring the `href` attribute with the `fd-tree__content` class. If only a subset of the tree items is navigable, you should indicate them with navigation arrows.\n\n####Navigation arrows\nTo display navigation arrows in tree items, create an element with `fd-tree__icon` and `fd-tree__icon--navigation` classes inside `fd-tree__item-container` with the `fd-tree__item-container--active` modifier class applied.\n\n**If all items are navigable:** Do not display arrows at all. In this case, add the `fd-tree--active` modifier class to the root tree. This will add states (hover, selected, active) to all tree items.\n\n**If an item has been navigated:** When a user has navigated to an item but has since moved onto another item, you can indicate that it has been navigated to by adding the `is-navigated` class to the `fd-tree__item-container` element.\n\n**Note:** In this example, each level indents by 0.25rem more than the previous level (up to level 12).\n\n"}}};const c=()=>F;c.parameters={docs:{description:{story:"\nTree can be displayed with checkboxes, allowing the user to select multiple items. To display selected tree items, add the `is-selected` class to the `fd-tree__item-container` element.\n\n####Form items\nForm items can be added before or after the `fd-tree__content` element. The `fd-tree__form-item ` class must be added together with the `fd-form-item` element.\n\n- Multi-selection: use **Checkboxes**\n- Single selection: use **Radio buttons**\n\n"}}};const r=()=>H;r.storyName="No data";r.parameters={docs:{description:{story:"\nIf there is no data to display, add the `fd-tree--no-data` modifier class to the root tree.\n"}}};var f,v,h;l.parameters=a(e({},l.parameters),{docs:a(e({},(f=l.parameters)==null?void 0:f.docs),{source:e({originalSource:"() => primaryExampleHtml"},(h=(v=l.parameters)==null?void 0:v.docs)==null?void 0:h.source)})});var m,b,u;d.parameters=a(e({},d.parameters),{docs:a(e({},(m=d.parameters)==null?void 0:m.docs),{source:e({originalSource:"() => borderlessExampleHtml"},(u=(b=d.parameters)==null?void 0:b.docs)==null?void 0:u.source)})});var x,g,k;s.parameters=a(e({},s.parameters),{docs:a(e({},(x=s.parameters)==null?void 0:x.docs),{source:e({originalSource:"() => highlightIndicatorsExampleHtml"},(k=(g=s.parameters)==null?void 0:g.docs)==null?void 0:k.source)})});var E,L,y;o.parameters=a(e({},o.parameters),{docs:a(e({},(E=o.parameters)==null?void 0:E.docs),{source:e({originalSource:"() => navigableExampleHtml"},(y=(L=o.parameters)==null?void 0:L.docs)==null?void 0:y.source)})});var w,T,R;c.parameters=a(e({},c.parameters),{docs:a(e({},(w=c.parameters)==null?void 0:w.docs),{source:e({originalSource:"() => selectionExampleHtml"},(R=(T=c.parameters)==null?void 0:T.docs)==null?void 0:R.source)})});var A,z,S;r.parameters=a(e({},r.parameters),{docs:a(e({},(A=r.parameters)==null?void 0:A.docs),{source:e({originalSource:"() => treeWithNoDataExampleHtml"},(S=(z=r.parameters)==null?void 0:z.docs)==null?void 0:S.source)})});const K=["Primary","Borderless","HighlightIndicators","Navigable","Selection","TreeWithNoData"];export{d as Borderless,s as HighlightIndicators,o as Navigable,l as Primary,c as Selection,r as TreeWithNoData,K as __namedExportsOrder,J as default};
