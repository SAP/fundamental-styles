...
- **With independent steps**:  the steps are not connected and can be processed in any order. This type can be used when the user doesn’t need to perform the steps in a linear sequence.
        ...
        `,tags:["f3","a11y","theme"]}},o=()=>V;o.storyName="Micro process flow with dependent steps (Default)";o.parameters={docs:{description:{story:`
        `}}};const s=()=>L;s.storyName="Micro process flow with independent steps";s.parameters={docs:{description:{story:"Add the `.fd-micro-process-flow--independent-steps` modifier class to `.fd-micro-process-flow` class to remove the connector line.\n        "}}};const i=()=>A;i.storyName="Micro process flow with custom steps";i.parameters={docs:{description:{story:`
