...
`,x=`<label class="fd-form-label" for="step-13">Disabled Step Input</label><br />
...
`,h=`<label class="fd-form-label" for="step-20">Focused Step Input</label><br />
...
`}},n=()=>k;n.storyName="Default";n.parameters={docs:{description:{story:`The default step input displays an input field with a plus and minus icon on opposing sides to either increase or decrease the value. It is displayed in cozy mode, which is ideal for mobile and tablet screens.
        `}}};const e=()=>w;e.parameters={docs:{description:{story:`Step input can be displayed in various states such as Success, Information, Error and Warning.
