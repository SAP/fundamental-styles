/* empty css             *//* empty css                     *//* empty css                *//* empty css             *//* empty css               *//* empty css             */const fa=`<div class="fddocs-icon-tab-container" style="min-height: 600px;">
...
`,ma=`<div class="fddocs-icon-tab-container" style="min-height: 100px;">
...
`,va=`<div class="fddocs-icon-tab-container" style="min-height: 600px;">
<h4>With Overflow</h4>
...
`,ha=`<div class="fd-icon-tab-bar fd-icon-tab-bar--responsive-paddings">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item">
...
`,ya=`<div class="fddocs-icon-tab-container" style="min-height: 400px;">
    <div class="fd-icon-tab-bar fd-icon-tab-bar--md">
        <ul role="tablist" class="fd-icon-tab-bar__header">
            <li role="presentation" class="fd-icon-tab-bar__item">
...
`,Sa=`<div class='fddocs-icon-tab-container' style="min-height: 800px;">
    <div class="fd-icon-tab-bar fd-icon-tab-bar--xl">
        <ul role="tablist" class="fd-icon-tab-bar__header">
            <li role="presentation" class="fd-icon-tab-bar__item">
...
`,xa=`<div class="fd-icon-tab-bar fd-icon-tab-bar--process">
...
</div>`,ka=`<div class="fd-icon-tab-bar fd-icon-tab-bar--filter">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item">
...
</div>`,wa=`<div class="fd-icon-tab-bar fd-icon-tab-bar--icon fd-icon-tab-bar--process">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item">
            <a role="tab" class="fd-icon-tab-bar__tab" href="#" aria-selected="true" id="tab1">
                <div class="fd-icon-tab-bar__container">
...
`,Ta=`<div class="fd-icon-tab-bar fd-icon-tab-bar--icon">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item">
...
`,Ia=`<div class="fd-icon-tab-bar fd-icon-tab-bar--icon-only">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item fd-icon-tab-bar__item--positive">
            <a role="tab" class="fd-icon-tab-bar__tab" href="#" id="tab1">
                <div class="fd-icon-tab-bar__container">
...
</div>`,Aa=`<div class="fd-icon-tab-bar fd-icon-tab-bar--icon-only">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item">
...
`,Ha=`<div class="fd-icon-tab-bar fd-icon-tab-bar--counters">
    <ul role="tablist" class="fd-icon-tab-bar__header">
        <li role="presentation" class="fd-icon-tab-bar__item">
            <a role="tab" class="fd-icon-tab-bar__tab" href="#section1" id="tab1">
...
`,za={title:"Components/Icon Tab Bar",parameters:{description:`
...
<br><br><br>
      `,tags:["f3","theme","development"]}},a=()=>Ca;a.storyName="Text Only (Inline mode)";a.parameters={docs:{description:{story:"The text-only variant is one of the most common types. It allows longer labels, and can also display counters next to the text to indicate the number of items on the tab page. The labels of the tabs do not get truncated. The full text is always shown. As a result, you need to ensure that your labels do not become too long. They should still be easy to read on smaller screens. The control has the same look and feel in Cozy and Compact mode."}}};const b=()=>Oa;b.storyName="Text Only (Inline mode) Semantic Colors";const n=()=>Ha;n.storyName="Counters and Text";n.parameters={docs:{description:{story:"Counters can be shown on top of labels. In this case you need to apply the `fd-icon-tab-bar--counters` modifier class. <br> The control has the same look and feel in Cozy and Compact mode."}}};const d=()=>Aa;d.parameters={docs:{description:{story:"The Icon tabs are rounded tabs that can be populated with any icon. The labels in this case are omitted and counters are optional. You need to apply the `fd-icon-tab-bar--icon-only` modifier class for this type of tabs."}}};const _=()=>Ia;_.storyName="Icon Only Semantic Colors";const p=()=>Ta;p.parameters={docs:{description:{story:"To display Icon Tabs with labels and counters you need to apply the `fd-icon-tab-bar--icon` modifier class. The counters are optional and can be ommited. The label is always positioned at the bottom. If you decide to use labels, use them for all tabs. The badge is rendered at the top right hand corner of the icon container. Consider using shorter labels or text tabs (without icons), since text tabs cannot get truncated."}}};const f=()=>wa;f.parameters={docs:{description:{story:"You can also use the tab bar to depict a process. In this case, each tab stands for one step. You need to add the `fd-icon-tab-bar--process` modifier class and a sibling html element with `fd-icon-tab-bar__separator` class to the tab."}}};const m=()=>ka;m.parameters={docs:{description:{story:`The tab bar as a filter has two parts: <br>
        ...
        <br>
        You need to add the \`fd-icon-tab-bar--filter\` modifier class for this type of tabs.`}}};const v=()=>xa;v.parameters={docs:{description:{story:`Tabs can have an overflow to either sides of the control. Depending on if the order is fixed (process steps) or can be rearranged (tabs).
        For processes with a fixed order, an overflow to both sides is used. For tabs that can be rearranged, only one overflow will be displayed on the right side.`}}};const t=()=>Sa;t.storyName="Universal Icon Tab Bar Single Click Area";t.parameters={docs:{description:{story:"When there is only one click area per tab (also including tabs with sub-items), regular tabs get selected immediately after the click is released. Tabs with sub-items trigger the expansion of a menu (Popover) showing its sub-items. The parent tab title remains displayed when its child is select.\n        <br>\n        You need to apply the `fd-icon-tab-bar__item--single-click` modifier class to `fd-icon-tab-bar__item` element. The List component inside the Popover has an additional modifier class `fd-icon-tab-bar__list` to achieve the nesting (indentation) of the elements. The list menu can be borderless, with line separators (`fd-icon-tab-bar__line-separator`) or icon separators (`fd-icon-tab-bar__icon-separator`) "}}};const i=()=>ya;i.storyName="Universal Icon Tab Bar Multi Click Area";i.parameters={docs:{description:{story:"In case of two click areas for tabs with sub-tabs, the behaviour for regular tabs (without sub-items) remains unchanged, like described above the tabs get selected immediately. Tabs with two click areas behave differently: when the main part of the tab is clicked, it is highlighted and then selected immediately. Clicking the second area opens a menu (Popover) containing the sub-items. Once a sub-item is clicked, the main tab is highlighted as selected. "}}};const s=()=>ga;s.storyName="Badges";s.parameters={docs:{description:{story:"The Tab attention badge is applied as a visual eye-catcher to indicate a change within a Tab. <br>\n        The badge is a span element with `fd-icon-tab-bar__badge` class. It can be animated by adding an additional ` fd-icon-tab-bar__badge--animated` modifier class. In this case the badge appears for a few milliseconds and then disappears."}}};const e=()=>ha;e.storyName="Responsive Paddings";e.parameters={docs:{description:{story:"For an Icon Tab Bar with responsive paddings that adjust based on the screen size add the `fd-icon-tab-bar--responsive-paddings` modifier class."}}};const o=()=>ua;o.storyName="Sizes and Horizontal Paddings";o.parameters={docs:{description:{story:'You can set horizontal paddings by adding a modifier class and specifying the size of the paddings. Please refer to the "Paddings" section at the top of the page for the available sizes.'}}};const r=()=>va;r.storyName="Navigation Icon Tab Bar (Shell Navigation)";r.parameters={docs:{description:{story:`The Navigation Tab Bar is the main/default navigation displayed on the SAP Fiori launchpad home page. It offers the user an easy access to multiple pages per space. The background color of the Shell Navigation is connected the Home/Shell Header to properly differentiate the global shell navigation versus any application specific navigation. The Navigation Bar snaps to top and remains visible while scrolling. It is not visible in App view. <br>
        ...
        `}}};var u,h,g;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:"() => textOnlyExampleHtml",...(g=(h=a.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};var y,S,x;b.parameters={...b.parameters,docs:{...(y=b.parameters)==null?void 0:y.docs,source:{originalSource:"() => textOnlySemanticExampleHtml",...(x=(S=b.parameters)==null?void 0:S.docs)==null?void 0:x.source}}};var k,w,T;n.parameters={...n.parameters,docs:{...(k=n.parameters)==null?void 0:k.docs,source:{originalSource:"() => counterExampleHtml",...(T=(w=n.parameters)==null?void 0:w.docs)==null?void 0:T.source}}};var I,A,H;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:"() => iconOnlyExampleHtml",...(H=(A=d.parameters)==null?void 0:A.docs)==null?void 0:H.source}}};var O,C,E;_.parameters={..._.parameters,docs:{...(O=_.parameters)==null?void 0:O.docs,source:{originalSource:"() => iconOnlySemanticExampleHtml",...(E=(C=_.parameters)==null?void 0:C.docs)==null?void 0:E.source}}};var N,P,B;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:"() => iconExampleHtml",...(B=(P=p.parameters)==null?void 0:P.docs)==null?void 0:B.source}}};var D,F,z;f.parameters={...f.parameters,docs:{...(D=f.parameters)==null?void 0:D.docs,source:{originalSource:"() => processExampleHtml",...(z=(F=f.parameters)==null?void 0:F.docs)==null?void 0:z.source}}};var Y,M,j;m.parameters={...m.parameters,docs:{...(Y=m.parameters)==null?void 0:Y.docs,source:{originalSource:"() => filterExampleHtml",...(j=(M=m.parameters)==null?void 0:M.docs)==null?void 0:j.source}}};var L,U,W;v.parameters={...v.parameters,docs:{...(L=v.parameters)==null?void 0:L.docs,source:{originalSource:"() => overflowExampleHtml",...(W=(U=v.parameters)==null?void 0:U.docs)==null?void 0:W.source}}};var R,X,G;t.parameters={...t.parameters,docs:{...(R=t.parameters)==null?void 0:R.docs,source:{originalSource:"() => singleClickExampleHtml",...(G=(X=t.parameters)==null?void 0:X.docs)==null?void 0:G.source}}};var q,J,K;i.parameters={...i.parameters,docs:{...(q=i.parameters)==null?void 0:q.docs,source:{originalSource:"() => multiClickExampleHtml",...(K=(J=i.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};var Q,V,Z;s.parameters={...s.parameters,docs:{...(Q=s.parameters)==null?void 0:Q.docs,source:{originalSource:"() => badgeExampleHtml",...(Z=(V=s.parameters)==null?void 0:V.docs)==null?void 0:Z.source}}};var $,aa,na;e.parameters={...e.parameters,docs:{...($=e.parameters)==null?void 0:$.docs,source:{originalSource:"() => respPaddingsExampleHtml",...(na=(aa=e.parameters)==null?void 0:aa.docs)==null?void 0:na.source}}};var ta,ia,sa;o.parameters={...o.parameters,docs:{...(ta=o.parameters)==null?void 0:ta.docs,source:{originalSource:"() => paddingsExampleHtml",...(sa=(ia=o.parameters)==null?void 0:ia.docs)==null?void 0:sa.source}}};var ea,oa,ra;r.parameters={...r.parameters,docs:{...(ea=r.parameters)==null?void 0:ea.docs,source:{originalSource:"() => navigationExampleHtml",...(ra=(oa=r.parameters)==null?void 0:oa.docs)==null?void 0:ra.source}}};var la,ca,ba;l.parameters={...l.parameters,docs:{...(la=l.parameters)==null?void 0:la.docs,source:{originalSource:"() => navigationFlatExampleHtml",...(ba=(ca=l.parameters)==null?void 0:ca.docs)==null?void 0:ba.source}}};var da,_a,pa;c.parameters={...c.parameters,docs:{...(da=c.parameters)==null?void 0:da.docs,source:{originalSource:"() => dragAndDropExampleHtml",...(pa=(_a=c.parameters)==null?void 0:_a.docs)==null?void 0:pa.source}}};const Ya=["TextOnly","TextOnlySemantic","Counter","IconOnly","IconOnlySemantic","Icon","Process","Filter","Overflow","SingleClick","MultiClick","Badge","RespPaddings","Paddings","Navigation","NavigationFlat","DragAndDrop"];export{s as Badge,n as Counter,c as DragAndDrop,m as Filter,p as Icon,d as IconOnly,_ as IconOnlySemantic,i as MultiClick,r as Navigation,l as NavigationFlat,v as Overflow,o as Paddings,f as Process,e as RespPaddings,t as SingleClick,a as TextOnly,b as TextOnlySemantic,Ya as __namedExportsOrder,za as default};
//# sourceMappingURL=icon-tab-bar.stories-09680208.js.map
