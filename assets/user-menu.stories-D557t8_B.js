/* empty css                  *//* empty css                 *//* empty css                *//* empty css                     *//* empty css             *//* empty css               *//* empty css             *//* empty css              *//* empty css            *//* empty css              *//* empty css               *//* empty css             *//* empty css              *//* empty css                        *//* empty css                    *//* empty css              *//* empty css                *//* empty css             *//* empty css                      */const a=`<div class="fddocs-container" style="margin-bottom: 500px; flex-wrap: wrap; gap: 5rem">
    ...
    <div style="height: 700px;">
        <div class="fd-user-menu fd-user-menu--mobile">
            ...
            <div class="fd-user-menu__body">
                ...
                <div class="fd-user-menu__content-container">
                    <div class="fd-panel fd-user-menu__panel" aria-labelledby="__panel-title-10" role="form">
                        <div class="fd-panel__header">
                            <div class="fd-panel__expand">
                                <button class="fd-button fd-button--transparent fd-panel__button" aria-expanded="false" onclick="toggleExpandedButton(event)"
                                    aria-haspopup="true" aria-label="expand/collapse panel" aria-controls="__panel-10">
                                    <i class="sap-icon--slim-arrow-right"></i>
                                </button>
                            </div>
                            <h4 class="fd-panel__title" id="__panel-title-10">Accounts (2)</h4>
                            <div class="fd-toolbar fd-toolbar--clear fd-toolbar--transparent">
                                <span class="fd-toolbar__spacer fd-toolbar__spacer--auto"> </span>
                        ...
                        <div role="region" aria-labelledby="__panel-title-10" class="fd-panel__content fd-panel__content--no-padding" aria-hidden="true" id="__panel-10">
        ...
        <div class="fd-user-menu fd-user-menu--mobile">
            <div class="fd-bar fd-bar--header">
                <div class="fd-bar__left">
                    ...
                    <div class="fd-bar__element">
                        <h5 class="fd-title fd-title--h5" aria-label="text">Menu Item</h5>
                    </div>
                </div>
                <div class="fd-bar__right">
                    <div class="fd-bar__element">
...
`,M={title:"Components/User Menu",parameters:{description:`The User Menu is an integral part of the Shell Bar, accessible by clicking the avatar located at its far-right end. It provides user-specific options and remains available across all screens. In addition to standard options, the User Menu can include product-specific functionality.
    <br>
...
<ul>
  ...
  <li>
    ...
    `,tags:["uxc"]}},n=()=>a;n.parameters={docs:{description:{story:""}}};const e=()=>s;e.parameters={docs:{description:{story:""}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => defaultExampleHtml",...n.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => mobileExampleHtml",...e.parameters?.docs?.source}}};const L=["Default","Mobile"];export{n as Default,e as Mobile,L as __namedExportsOrder,M as default};
