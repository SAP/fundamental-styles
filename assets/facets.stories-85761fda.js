var I=Object.defineProperty,z=Object.defineProperties;var O=Object.getOwnPropertyDescriptors;var u=Object.getOwnPropertySymbols;var K=Object.prototype.hasOwnProperty,N=Object.prototype.propertyIsEnumerable;var b=(i,t,n)=>t in i?I(i,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):i[t]=n,a=(i,t)=>{for(var n in t||(t={}))K.call(t,n)&&b(i,n,t[n]);if(u)for(var n of u(t))N.call(t,n)&&b(i,n,t[n]);return i},e=(i,t)=>z(i,O(t));/* empty css                     *//* empty css                   *//* empty css                      *//* empty css              *//* empty css             *//* empty css                      *//* empty css             *//* empty css               *//* empty css                         *//* empty css               *//* empty css             *//* empty css            *//* empty css                   *//* empty css             *//* empty css                *//* empty css                *//* empty css                *//* empty css                 */const V=`<div class="mobile-container">
...
`,W=`<section class="fd-dynamic-page fd-dynamic-page--xl" aria-label="Dynamic Page Desktop Example">
        <header class="fd-dynamic-page__header">
...
`,U=`<div class="fd-facet fd-facet--image fd-margin-end--md">
        <span class="fd-avatar fd-avatar--l" aria-label="Avatar">
            <i class="fd-avatar__icon sap-icon--money-bills" role="presentation"></i>
        </span>
    </div>
`,J=`<div class="fd-facet fd-facet--rating-indicator fd-margin-end--md fd-margin-bottom--sm" role="group" aria-labelledby="ratingFacetTitle2">
...
`,G=`<div class="fd-facet fd-facet--form fd-margin-end--md fd-margin-bottom--sm" role="group" aria-labelledby="formFacetTitle3">
...
`,Q=`<div class="fd-facet fd-facet--form fd-margin-end--md fd-margin-bottom--sm" role="group" aria-labelledby="formFacetTitle2">
        <div role="heading" aria-level="3" class="fd-title fd-margin-bottom--sm" id="formFacetTitle2"> Technical Data </div>
        <div class="fd-facet__container fd-margin-bottom--tiny">
...
`,X=`<div class="fd-facet fd-facet--key-value fd-margin-end--md fd-margin-bottom--sm" role="group" aria-labelledby="kvFacetTitle5">
        <div role="heading" aria-level="3" class="fd-title fd-margin-bottom--sm" id="kvFacetTitle5"> Status </div>
        <span class="fd-object-status fd-object-status--positive fd-object-status--large fd-facet__object-status">
            <span class="fd-object-status__text fd-facet__object-status-text">Delivery</span>
        </span>
    </div>
    <div class="fd-facet fd-facet--key-value fd-margin-end--md fd-margin-bottom--sm" role="group" aria-labelledby="kvFacetTitle6">
        <div role="heading" aria-level="3" class="fd-title fd-margin-bottom--sm" id="kvFacetTitle6"> Delivery Time </div>
        <span class="fd-object-status fd-object-status--negative fd-object-status--large fd-facet__object-status">
            <span class="fd-object-status__text fd-facet__object-status-text">12 days</span>
        </span>
    </div>
...
`,Y=`<div class="fd-facet-group" role="group">
        <div class="fd-facet fd-facet--image fd-margin-end--md">
            <span class="fd-avatar fd-avatar--l" aria-label="Avatar">
                <i class="fd-avatar__icon sap-icon--money-bills" role="presentation"></i>
            </span>
        ...
        <div class="fd-facet fd-facet--key-value fd-margin-end--md fd-margin-bottom--sm" role="group" aria-labelledby="kvFacetTitle2">
            <div role="heading" aria-level="3" class="fd-title fd-margin-bottom--sm" id="kvFacetTitle2">Delivery Time</div>
            <span class="fd-object-status fd-object-status--large fd-object-status--critical fd-facet__object-status">
                <i class="fd-object-status__icon sap-icon--shipping-status fd-padding--none fd-margin-end--tiny" role="presentation"></i>
                <span class="fd-object-status__text fd-facet__object-status-text">12 days</span>
            </span>
        ...
        <div class="fd-facet fd-facet--key-value fd-margin-end--md fd-margin-bottom--sm" role="group" aria-labelledby="kvFacetTitle3">
            <div role="heading" aria-level="3" class="fd-title fd-margin-bottom--sm" id="kvFacetTitle3">Assembly Option </div>
            <span class="fd-object-status fd-object-status--negative fd-object-status--large fd-facet__object-status">
                <span class="fd-object-status__text fd-facet__object-status-text">To be selected</span>
            </span>
        </div>
...
`,va={title:"Dev/Facets",parameters:{description:`Facets can be used as a standalone component or linked to another component. Facets are usually a part of the *Object Page* header content.
        Each facet adapts its size to the content and makes optimal use of the space without truncating the texts. If the facets do not all fit on one line, those on the right wrap to the line below. `}},s=()=>Y;s.storyName="Combination of facets";s.parameters={docs:{description:{story:"Facet types(image, form, and key-value) used together."}}};const d=()=>X;d.storyName="Key-Value Facet";d.parameters={docs:{description:{story:`Key-Value facet is used to highlight important data or KPIs. It consists of a mandatory title
        and a text or number in a larger font size(**Object Status** or **Object Number**). The value can also have an icon to its left.
        `}}};const f=()=>Q;f.parameters={docs:{description:{story:`Form facet is used to display datasets. It consists of an optional title and label-value pair.
        Note that the labels can be icons, but need to have a text for accessibility purposes.
        `}}};const l=()=>G;l.storyName="Form Facet with Link";l.parameters={docs:{description:{story:"Text in a form facet can also hold a link by using the Link component."}}};const r=()=>J;r.storyName="Rating Indicator Facet";r.parameters={docs:{description:{story:`The Rating Indicator Facet displays a **Rating Indicator**. It consists of a mandatory title, optional supplementary texts
        like a subtitle or a dynamic text, and the rating indicator.`}}};const o=()=>U;o.storyName="Image/Avatar Facet";o.parameters={docs:{description:{story:"Counter added to a tab"}}};const c=()=>W;c.storyName="Facets in Object Page";c.parameters={docs:{description:{story:"All facet types used together in the context of a dynamic page. To have the image from the image facet appear next to the title, add the class\n        `fd-facet` and apply the modifiers `fd-facet--image` and `fd-facet--image-header-title` to the\n        `fd-dynamic-page__title-container` class. Note that the dynamic page title and subtitle should be placed in the `fd-dynamic-page__title-subtitle-container` class\n        for proper alignment with the image.\n\nThe final structure of a collapsed header with image next to the title is shown below with changes marked in bold:\n\n- `fd-dynamic-page__title-area` The area holding title, KPI content, subtitle, and actions\n  - `fd-dynamic-page__main-container` Main container that holds Breadcrumb, image, title, title content and actions\n    - `fd-dynamic-page__breadcrumb-title-container` Container that holds breadcrumb, title, and title content\n        - `fd-dynamic-page__breadcrumb-container` Breadcrumbs Container, can contain toolbar container\n            - `fd-dynamic-page__breadcrumb` Breadcrumbs\n        - **`fd-dynamic-page__title-container` The container for image, title, subtitle and toolbar**\n            - **`fd-facet fd-facet--image fd-facet--image-header-title` The image facet**\n            - **`fd-facet__title-subtitle-container` The container for title and subtitle**\n                - `fd-dynamic-page__title` Dynamic page title\n                - **`fd-dynamic-page__subtitle` Dynamic page subtitle**\n            - `fd-dynamic-page__title-content` The KPI content\n            - `fd-dynamic-page__toolbar-container` Container that holds toolbar-related actions\n                - `fd-dynamic-page__toolbar` Toolbar container for actions\n                - `fd-dynamic-page__toolbar--actions` Navigation actions\n"}}};const m=()=>V;m.storyName="Facets in Object Page Mobile";var p,g,v;s.parameters=e(a({},s.parameters),{docs:e(a({},(p=s.parameters)==null?void 0:p.docs),{source:a({originalSource:"() => combinedExampleHtml"},(v=(g=s.parameters)==null?void 0:g.docs)==null?void 0:v.source)})});var _,h,y;d.parameters=e(a({},d.parameters),{docs:e(a({},(_=d.parameters)==null?void 0:_.docs),{source:a({originalSource:"() => keyValueExampleHtml"},(y=(h=d.parameters)==null?void 0:h.docs)==null?void 0:y.source)})});var x,k,j;f.parameters=e(a({},f.parameters),{docs:e(a({},(x=f.parameters)==null?void 0:x.docs),{source:a({originalSource:"() => formFacetExampleHtml"},(j=(k=f.parameters)==null?void 0:k.docs)==null?void 0:j.source)})});var T,E,F;l.parameters=e(a({},l.parameters),{docs:e(a({},(T=l.parameters)==null?void 0:T.docs),{source:a({originalSource:"() => formFacetLinkExampleHtml"},(F=(E=l.parameters)==null?void 0:E.docs)==null?void 0:F.source)})});var q,A,C;r.parameters=e(a({},r.parameters),{docs:e(a({},(q=r.parameters)==null?void 0:q.docs),{source:a({originalSource:"() => ratingIndicatorExampleHtml"},(C=(A=r.parameters)==null?void 0:A.docs)==null?void 0:C.source)})});var w,B,S;o.parameters=e(a({},o.parameters),{docs:e(a({},(w=o.parameters)==null?void 0:w.docs),{source:a({originalSource:"() => imageFacetExampleHtml"},(S=(B=o.parameters)==null?void 0:B.docs)==null?void 0:S.source)})});var D,M,R;c.parameters=e(a({},c.parameters),{docs:e(a({},(D=c.parameters)==null?void 0:D.docs),{source:a({originalSource:"() => objectPageExampleHtml"},(R=(M=c.parameters)==null?void 0:M.docs)==null?void 0:R.source)})});var L,P,H;m.parameters=e(a({},m.parameters),{docs:e(a({},(L=m.parameters)==null?void 0:L.docs),{source:a({originalSource:"() => objectPageMobileExampleHtml"},(H=(P=m.parameters)==null?void 0:P.docs)==null?void 0:H.source)})});const _a=["Combined","KeyValue","FormFacet","FormFacetLink","RatingIndicator","ImageFacet","ObjectPage","ObjectPageMobile"];export{s as Combined,f as FormFacet,l as FormFacetLink,o as ImageFacet,d as KeyValue,c as ObjectPage,m as ObjectPageMobile,r as RatingIndicator,_a as __namedExportsOrder,va as default};
