...
`,C={title:"Components/Avatar Group",parameters:{description:`The avatar group displays a number of avatars, which act as a digital representation of a user. This control is useful for visualizing a team, project team members, or a group of employees, for example. <br />
...
`,docs:{story:{}},tags:[]}},a=()=>c;a.parameters={docs:{story:{},description:{story:"The Avatar Individual Type component features avatars and an overflow shape, each with its own click area, catering to scenarios where users prioritize detailed information about specific group members. Avatars are displayed adjacent to each other without overlap, making it ideal for smaller groups like project teams.<br>\n      For Individual type add the `fd-avatar-group--individual-type` modifier class to the `fd-avatar-group` base class."}}};const r=()=>v;r.parameters={docs:{story:{},description:{story:"For vertical orientation of the Avatar Group add the `fd-avatar-group--vertical` modifier class to the `fd-avatar-group` base class."}}};const n=()=>o;n.parameters={docs:{story:{},description:{story:"The avatar group type is one single click/tap area. This means that the entire control is the click/tap area. <br>For Group type add the `fd-avatar-group--group-type` modifier class to the `fd-avatar-group` base class."}}};const d=()=>i;d.parameters={docs:{story:{},description:{story:"For vertical orientation of the Avatar Group add the `fd-avatar-group--vertical` modifier class to the `fd-avatar-group` base class."}}};const e=()=>s;e.parameters={docs:{story:{},description:{story:""}}};const t=()=>l;t.parameters={docs:{description:{story:'The overflow Avatar inherits the styling of the secondary regular Button control. Applications can also choose to set the background color to a random or specific color from the Avatar. The span element has a `role="button"` and `fd-avatar--overflow` modifier class. '}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => individualTypeExampleHtml",...a.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"() => individualTypeVerticalExampleHtml",...r.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => groupTypeExampleHtml",...n.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"() => groupTypeVerticalExampleHtml",...d.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => groupTypeInteractionStatesExampleHtml",...e.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => overflowExampleHtml",...t.parameters?.docs?.source}}};const M=["IndividualType","IndividualTypeVertical","GroupType","GroupTypeVertical","GroupTypeInteractionStates","Overflow"];export{n as GroupType,e as GroupTypeInteractionStates,d as GroupTypeVertical,a as IndividualType,r as IndividualTypeVertical,t as Overflow,M as __namedExportsOrder,C as default};
