...
In these cases, use the **Tree** instead.
        `,components:["button","form-label","fieldset","icon","link","object-status","table","toolbar","pagination","popover","list","toolbar","bar","dialog","input","input-group","checkbox","select","menu","text","object-number","object-marker"]}},u=()=>he;u.parameters={docs:{description:{story:"\nThe primary table contains columns with headers, and rows with links. In the first column, links are displayed. To display links within a table, add the `fd-link` class within the table data.\n    "}}};const x=()=>me;x.parameters={docs:{description:{story:`
...
//# sourceMappingURL=table.stories-692df67b.js.map
