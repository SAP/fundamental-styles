/* empty css             *//* empty css             *//* empty css               *//* empty css                *//* empty css                   *//* empty css                         */const o=`<div class="fd-toolbar fd-toolbar--clear fd-toolbar--title-bar" role="toolbar" aria-label="Left, center, and right-aligned toolbar">
...
</div>`,s=`<div style="max-width: 860px;">
    <div class="fd-toolbar fd-toolbar--clear fd-toolbar--title-bar" role="toolbar" aria-label="Left, center, and right-aligned toolbar">
        <div class="fd-title-bar">
            <div class="fd-title-bar__button-container">
...
</div>`,e=`<div style="max-width: 600px;">
    <div class="fd-toolbar fd-toolbar--clear fd-toolbar--title-bar" role="toolbar" aria-label="Left, center, and right-aligned toolbar">
        <div class="fd-title-bar">
            <div class="fd-title-bar__button-container">
                <button class="fd-button fd-button--nested" aria-label="Back">
...
</div>`,u={title:"BTP/Title Bar",parameters:{description:`Title Bar is a composite control that uses a toolbar as a container and a title for labeling. It varies from the standard title control in its bold visual state and text size. In addition, the title bar comes in three variants:
...
`,tags:["btp","development","horizon-only"]}},t=()=>o;t.parameters={docs:{description:{story:""}}};const n=()=>s;n.parameters={docs:{description:{story:""}}};const a=()=>e;a.parameters={docs:{description:{story:""}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => desktopExampleHtml",...t.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => tabletExampleHtml",...n.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => mobileExampleHtml",...a.parameters?.docs?.source}}};const p=["Desktop","Tablet","Mobile"];export{t as Desktop,a as Mobile,n as Tablet,p as __namedExportsOrder,u as default};
