var k=Object.defineProperty,S=Object.defineProperties;var T=Object.getOwnPropertyDescriptors;var _=Object.getOwnPropertySymbols;var D=Object.prototype.hasOwnProperty,C=Object.prototype.propertyIsEnumerable;var i=(t,n,e)=>n in t?k(t,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[n]=e,a=(t,n)=>{for(var e in n||(n={}))D.call(n,e)&&i(t,e,n[e]);if(_)for(var e of _(n))C.call(n,e)&&i(t,e,n[e]);return t},d=(t,n)=>S(t,T(n));/* empty css            *//* empty css               *//* empty css             *//* empty css                 *//* empty css               *//* empty css                         *//* empty css             */const U=`<style>
.docs-calendar {
    width: 100%;
}
...
`,B=`<div style="display: flex; justify-content: space-around; margin-bottom: 1rem; flex-wrap: wrap;">
...
`,M=`<div style="display: flex; justify-content: space-around;">
...
`,N=`<div style="display: flex; justify-content: space-around;">
    <section class="fd-calendar">
        <header class="fd-calendar__navigation">
            <div class="fd-calendar__action fd-calendar__action--arrow-left">
                <button type="button" class="fd-button fd-button--transparent" aria-label="Previous">
...
`,I={title:"Components/Calendar",parameters:{description:`
...
`,tags:["f3","a11y","theme"]}},s=()=>U;s.parameters={docs:{description:"Day Types"}};const l=()=>N;l.parameters={docs:{description:{story:"The calendar component can display days of the month by adding the `fd-calendar__content--dates` class to the container element."}}};const r=()=>M;r.parameters={docs:{description:{story:"The calendar component can display months in a year by adding the `fd-calendar__content--months` class to the container element."}}};const c=()=>B;c.parameters={docs:{description:{story:"The calendar component can display a range of years in various ways: short-term, long-term, year ranges etc. Add the `fd-calendar__content--years` class to the container element, and adjust the number of columns, rows, and content to fit your use case."}}};var o,p,f;s.parameters=d(a({},s.parameters),{docs:d(a({},(o=s.parameters)==null?void 0:o.docs),{source:a({originalSource:"() => calExampleHtml"},(f=(p=s.parameters)==null?void 0:p.docs)==null?void 0:f.source)})});var m,v,u;l.parameters=d(a({},l.parameters),{docs:d(a({},(m=l.parameters)==null?void 0:m.docs),{source:a({originalSource:"() => daysExampleHtml"},(u=(v=l.parameters)==null?void 0:v.docs)==null?void 0:u.source)})});var b,x,w;r.parameters=d(a({},r.parameters),{docs:d(a({},(b=r.parameters)==null?void 0:b.docs),{source:a({originalSource:"() => monthsExampleHtml"},(w=(x=r.parameters)==null?void 0:x.docs)==null?void 0:w.source)})});var y,g,h;c.parameters=d(a({},c.parameters),{docs:d(a({},(y=c.parameters)==null?void 0:y.docs),{source:a({originalSource:"() => yearsExampleHtml"},(h=(g=c.parameters)==null?void 0:g.docs)==null?void 0:h.source)})});const R=["CalendarDays","Days","Months","Years"];export{s as CalendarDays,l as Days,r as Months,c as Years,R as __namedExportsOrder,I as default};
