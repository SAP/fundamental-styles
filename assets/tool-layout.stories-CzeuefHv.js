const o=`<div style="height: 30rem; position: relative;">
...
`,r={title:"Layouts/Tool Layout",parameters:{description:`
## Anatomy
...
`,tags:[]}},e=()=>u;e.parameters={docs:{description:{story:""}}};const i=()=>o;i.parameters={docs:{description:{story:"The <code>fd-tool-layout--sticky</code> modifier class will position the whole layout absolutely with the header container always on top. The navigation and content containers receive the scroll overflow."}}};const t=()=>s;t.parameters={docs:{description:{story:"Apply the <code>fd-tool-layout--tablet</code> modifier class for tablet devices."}}};const a=()=>n;a.parameters={docs:{description:{story:"Apply the <code>fd-tool-layout--phone</code> modifier class for mobile devices."}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => desktopExampleHtml",...e.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => stickyExampleHtml",...i.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => tabletExampleHtml",...t.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => mobileExampleHtml",...a.parameters?.docs?.source}}};const l=["Desktop","Sticky","Tablet","Mobile"];export{e as Desktop,a as Mobile,i as Sticky,t as Tablet,l as __namedExportsOrder,r as default};
