/* empty css               *//* empty css             *//* empty css             */const Q=`
...
`,X={title:"Deprecated/Components/Tabs",parameters:{tags:["f3","a11y","theme"],description:`Tabs are based on the folder metaphor and used to separate content into different sections. Tabs should be ordered based on priority to create visual hierarchy.
## DEPRECATED
...
<br>
        `,docs:{iframeHeight:150}}},a=()=>P;a.storyName="Default";a.parameters={docs:{story:{iframeHeight:300},description:{story:`By default, tabs are displayed in a bar and are either inactive or active (highlighted in blue). The bar can also contain actions that apply to the whole page. The example below illustrates the tabs component in cozy mode with no horizontal padding.
        `}}};const s=()=>F;s.storyName="Counters";s.parameters={docs:{story:{iframeHeight:300},description:{story:"Tabs can be displayed with counters to indicate that there are a number of resources the user can or should access. To display counters, wrap the `fd-tabs__count` class in paragraph tags below the `fd-tabs__link` element.\n\nIn the example below, the tabs component is optimized for an extra-large screen with the `fd-tabs--xl` modifier class, which adds 3rem horizontal paddings.\n        "}}};const n=()=>Y;n.storyName="Navigable";n.parameters={docs:{story:{iframeHeight:300},description:{story:"Tabs can be navigable by applying the `role=”navigation”` attribute to the main element.\n    "}}};const e=()=>Z;e.storyName="Icon";e.parameters={docs:{story:{iframeHeight:300},description:{story:"Tabs can display icons instead of text with the ` fd-tabs__icon` class (see **Icon** for a list of available icons). To display icon tabs without text, you will also need to add the `fd-tabs--icon-only` modifier class to the main element.\n    "}}};const t=()=>V;t.storyName="Process mode";t.parameters={docs:{story:{iframeHeight:300},description:{story:"Tabs can be displayed in subsequent steps, indicating to the user that there is a process to follow. To display tabs in process mode, add the `fd-tabs--process` modifier class to the main element.\n    "}}};const l=()=>O;l.storyName="Filter mode";l.parameters={docs:{story:{iframeHeight:300},description:{story:"Tabs can be displayed in filter mode, indicating to the user that a value has been filtered into separate tabs. To display tabs in filter mode, add the `fd-tabs--filter` modifier class to the main element.\n    "}}};const i=()=>W;i.storyName="Semantic mode";i.parameters={docs:{story:{iframeHeight:300},description:{story:"Tabs can be displayed with semantic colors to indicate a status. To display semantic tabs, add the following modifier classes to the `fd-tabs__item` elements:\n\nState | Modifier class\n:------- | :---------------\nSuccess | `fd-tabs__item--success`\nWarning | `fd-tabs__item--warning`\nInformation | `fd-tabs__item--information`\nError | `fd-tabs__item--error`\nNeutral | `fd-tabs__item--neutral`\n        "}}};const r=()=>R;r.storyName="Semantic filter mode";r.parameters={docs:{story:{iframeHeight:300},description:{story:"Tabs can be displayed in filter mode with semantic colors. As detailed in the previous examples, add the `fd-tabs--filter` modifier class to the main element and add the semantic modifier classes to the `fd-tabs__item` elements (see **semantic mode** example for modifier class names).\n        "}}};const o=()=>Q;o.storyName="Semantic inline";o.parameters={docs:{story:{iframeHeight:300},description:{story:"Tabs can be displayed with inline text in semantic colors. To display inline text tabs, add the `fd-tabs__tag` class below the `fd-tabs__link` element.\n        "}}};var d,c,p;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:"() => primaryExampleHtml",...(p=(c=a.parameters)==null?void 0:c.docs)==null?void 0:p.source}}};var b,_,f;s.parameters={...s.parameters,docs:{...(b=s.parameters)==null?void 0:b.docs,source:{originalSource:"() => tabWithCountersExampleHtml",...(f=(_=s.parameters)==null?void 0:_.docs)==null?void 0:f.source}}};var m,u,h;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:"() => navTabExampleHtml",...(h=(u=n.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};var v,y,x;e.parameters={...e.parameters,docs:{...(v=e.parameters)==null?void 0:v.docs,source:{originalSource:"() => iconOnlyExampleHtml",...(x=(y=e.parameters)==null?void 0:y.docs)==null?void 0:x.source}}};var g,w,k;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:"() => processModeExampleHtml",...(k=(w=t.parameters)==null?void 0:w.docs)==null?void 0:k.source}}};var S,D,H;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:"() => filterModeExampleHtml",...(H=(D=l.parameters)==null?void 0:D.docs)==null?void 0:H.source}}};var T,M,E;i.parameters={...i.parameters,docs:{...(T=i.parameters)==null?void 0:T.docs,source:{originalSource:"() => semanticModeExampleHtml",...(E=(M=i.parameters)==null?void 0:M.docs)==null?void 0:E.source}}};var N,L,I;r.parameters={...r.parameters,docs:{...(N=r.parameters)==null?void 0:N.docs,source:{originalSource:"() => semanticFilterModeExampleHtml",...(I=(L=r.parameters)==null?void 0:L.docs)==null?void 0:I.source}}};var z,A,C;o.parameters={...o.parameters,docs:{...(z=o.parameters)==null?void 0:z.docs,source:{originalSource:"() => semanticInlineExampleHtml",...(C=(A=o.parameters)==null?void 0:A.docs)==null?void 0:C.source}}};const U=["Primary","TabWithCounters","NavTab","IconOnly","ProcessMode","FilterMode","SemanticMode","SemanticFilterMode","SemanticInline"];export{l as FilterMode,e as IconOnly,n as NavTab,a as Primary,t as ProcessMode,r as SemanticFilterMode,o as SemanticInline,i as SemanticMode,s as TabWithCounters,U as __namedExportsOrder,X as default};
//# sourceMappingURL=tabs.stories-a2991470.js.map
