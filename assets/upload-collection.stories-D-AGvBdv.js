/* empty css             *//* empty css             *//* empty css             *//* empty css               *//* empty css                      *//* empty css              *//* empty css                   *//* empty css                     *//* empty css                      */const l=`
...
`,b={title:"Components/Upload Collection",parameters:{description:`
...
`,tags:["f3","a11y","theme","development"]}},t=()=>o;t.storyName="Default";t.parameters={docs:{description:{story:"The default upload collection."}}};const n=()=>a;n.parameters={docs:{description:{story:"Users can activate edit mode where the file name can be changed."}}};const s=()=>l;s.parameters={docs:{description:{story:"Use a message page component when the user has yet to upload any files."}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => standardExampleHtml",...t.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => editExampleHtml",...n.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => noDataExampleHtml",...s.parameters?.docs?.source}}};const m=["Standard","Edit","NoData"];export{n as Edit,s as NoData,t as Standard,m as __namedExportsOrder,b as default};
