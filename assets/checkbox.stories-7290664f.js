/* empty css                   *//* empty css                 *//* empty css                 */const S=`<fieldset class="fd-fieldset">
...
`,C={title:"Components/Forms/Checkbox",parameters:{description:`A checkbox lets the user set a binary value such as “true/false”. When the user selects the checkbox, it toggles between:
...
`,e=()=>w;e.parameters={docs:{description:{story:"To show that a checkbox input is required, use the `fd-checkbox__label--required` class.\n        "}}};const c=()=>`
${i}
...
`;c.parameters={docs:{}};const a=()=>S;a.parameters={docs:{description:{story:"Checkboxes can display horizontally in a line. To display them this way, add the `fd-checkbox__label--inline` modifier class to the element."}}};const s=()=>`
${i}
...
`;d.parameters={docs:{description:{story:`In the Display Only Mode, the checkbox is replaced by two icons to represent the checked and unchecked states. The control becomes a simple icon. <br>Add the <code>.is-display</code> modifier class to <code>.fd-checkbox</code> for Display Only Mode.
        `}}};var n,o,t;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:"() => requiredExampleHtml",...(t=(o=e.parameters)==null?void 0:o.docs)==null?void 0:t.source}}};var r,b,f;c.parameters={...c.parameters,docs:{...(r=c.parameters)==null?void 0:r.docs,source:{originalSource:`() => \`
\${localStyles}
<fieldset class="fd-fieldset">
    <legend class="fd-fieldset__legend">Checkbox</legend>
    <div class="fd-form-group">
...
\``,...(f=(b=c.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};var h,k,_;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:"() => inlineExampleHtml",...(_=(k=a.parameters)==null?void 0:k.docs)==null?void 0:_.source}}};var p,x,m;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`() => \`
\${localStyles}
<div class="checkbox-example-container">
    <fieldset class="fd-fieldset">
        <legend class="fd-fieldset__legend">Error checkboxes</legend>
...
\``,...(m=(x=s.parameters)==null?void 0:x.docs)==null?void 0:m.source}}};var v,u,y;l.parameters={...l.parameters,docs:{...(v=l.parameters)==null?void 0:v.docs,source:{originalSource:`() => \`
\${localStyles}
<fieldset class="fd-fieldset">
    <legend class="fd-fieldset__legend">Truncation Options</legend>
    <div class="fd-form-group">
...
\``,...(y=(u=l.parameters)==null?void 0:u.docs)==null?void 0:y.source}}};var A,z,g;d.parameters={...d.parameters,docs:{...(A=d.parameters)==null?void 0:A.docs,source:{originalSource:`() => \`
\${localStyles}
<fieldset class="fd-fieldset">
    <legend class="fd-fieldset__legend">Display Only</legend>
    <div class="fd-form-group">
...
//# sourceMappingURL=checkbox.stories-7290664f.js.map
