/* empty css                   *//* empty css             *//* empty css                *//* empty css             *//* empty css               *//* empty css              *//* empty css                    *//* empty css                      */const r=`<div
...
`,N={title:"BTP/Navigation/Vertical Navigation",parameters:{description:`The navigation is one of the signature design elements of BTP Tools. 
...
`,tags:["btp","horizon-only"]}},n=()=>r;n.storyName="Vertical Navigation - Expanded";n.parameters={docs:{description:{story:`Vertical navigation is the most common and preferred way of navigating BTP tools. It comprises many elements that work together to provide a logical information hierarchy and inform users of their current position.
`}}};const a=()=>c;a.storyName="Vertical Navigation - Parent Navigation as Link";a.parameters={docs:{description:{story:`By default, the Parent Navigation Item functions as a Navigation Group. A small arrow icon shows the item's expanded/collapsed state in this scenario. In the snapped variant, clicking on such a navigation item will open a popover that displays the title and Child Items.<br>Although not recommended, the Navigation Item can function for navigation and expansion/collapse. In this case, clicking on the arrow will show/hide Child Items, and clicking on the item will perform the navigation.
`}}};const i=()=>d;i.storyName="Vertical Navigation - Snapped";i.parameters={docs:{description:{story:`The snapped vertical navigation variant reduces the navigation width to free horizontal space.
      `}}};const e=()=>o;e.storyName="Vertical Navigation - Popup";e.parameters={docs:{description:{story:`An alternative to the expanded/snapped variant, which places the navigation items in a popup.
`}}};const t=()=>_;t.storyName="Vertical Navigation - Indication Tags";t.parameters={docs:{description:{story:`Navigation items can display indication tags (e.g., "New", "Beta", "Deprecated") using the Object Status component.
...
`}}};const s=()=>p;s.storyName="Vertical Navigation - Sticky Area";s.parameters={docs:{description:{story:`Fixed header area that is separated by a separator similar to the footer area. Top-aligned and fixed/sticky (always visible). Contains the optional search field. Add <code>.fd-navigation__container--sticky</code> together with <code>.fd-navigation__container--top</code> modifier class to the <code>.fd-navigation__container</code> base class to make the top area sticky.<br>
Guideline: Recommended not to contain more than 4 items.`}}};const l=()=>v;l.storyName="Vertical Navigation - Search";l.parameters={docs:{description:{story:`Search Only: for a sticky search field, the sticky header area with separator is not needed. The search field can be sticky by applying <code>.fd-navigation__list-item--sticky</code> modifier class to the parent navigation list item.
<br><br><strong>Note:</strong> The <code>.fd-navigation__list-item--home</code> class is still supported for backward compatibility and functions identically to <code>.fd-navigation__list-item--sticky</code>. It was originally intended specifically for Home navigation link, but <code>.fd-navigation__list-item--sticky</code> is now the recommended approach as it can be applied to any list item that needs to be sticky at the top.`}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"() => navigationExampleHtml",...n.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"() => navigationLegacyExampleHtml",...a.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"() => navigationSnappedExampleHtml",...i.parameters?.docs?.source}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"() => navigationPopupExampleHtml",...e.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"() => navigationTagsHtml",...t.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"() => navigationStickyAreaHtml",...s.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"() => navigationSearchHtml",...l.parameters?.docs?.source}}};const I=["Navigation","NavigationLegacy","NavigationSnapped","NavigationPopup","NavigationTags","NavigationStickyArea","NavigationSearch"];export{n as Navigation,a as NavigationLegacy,e as NavigationPopup,l as NavigationSearch,i as NavigationSnapped,s as NavigationStickyArea,t as NavigationTags,I as __namedExportsOrder,N as default};
