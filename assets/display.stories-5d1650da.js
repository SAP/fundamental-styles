...
`,p={title:"Display",parameters:{description:o}},r=`
<style>
...
`;e.storyName="Display";e.parameters={docs:{description:{story:`
        `}}};const s=()=>`${r}
<a href="#">
    <span class="sap-icon sap-icon--account"></span>
    <span class="sap-sr-only">User Account</span>
</a>
`;s.storyName="Screen-reader-only elements";s.parameters={docs:{description:{story:`The <code>.sap-sr-only</code> class will hide the element visually without hiding it from screen readers. <br><br>
            <b>SCSS Mixin: </b>
...
\``,...(i=(d=e.parameters)==null?void 0:d.docs)==null?void 0:i.source}}};var t,a,l;s.parameters={...s.parameters,docs:{...(t=s.parameters)==null?void 0:t.docs,source:{originalSource:`() => \`\${localStyles}
<a href="#">
    <span class="sap-icon sap-icon--account"></span>
    <span class="sap-sr-only">User Account</span>
</a>
...
//# sourceMappingURL=display.stories-5d1650da.js.map
