/* empty css            *//* empty css               *//* empty css             *//* empty css                 *//* empty css               *//* empty css                         *//* empty css             */const u=`<style>
.docs-calendar {
    width: 100%;
}
...
</section>`,b=`<div style="display: flex; justify-content: space-around; margin-bottom: 1rem; flex-wrap: wrap;">
...
`,x=`<div style="display: flex; justify-content: space-around;">
...
`,w=`<div style="display: flex; justify-content: space-around;">
    <section class="fd-calendar">
        <header class="fd-calendar__navigation">
            <div class="fd-calendar__action fd-calendar__action--arrow-left">
                <button type="button" class="fd-button fd-button--transparent" aria-label="Previous">
...
`,C={title:"Components/Calendar",parameters:{description:`
...
`,tags:["f3","a11y","theme"]}},a=()=>u;a.parameters={docs:{description:"Day Types"}};const n=()=>w;n.parameters={docs:{description:{story:"The calendar component can display days of the month by adding the `fd-calendar__content--dates` class to the container element."}}};const e=()=>x;e.parameters={docs:{description:{story:"The calendar component can display months in a year by adding the `fd-calendar__content--months` class to the container element."}}};const t=()=>b;t.parameters={docs:{description:{story:"The calendar component can display a range of years in various ways: short-term, long-term, year ranges etc. Add the `fd-calendar__content--years` class to the container element, and adjust the number of columns, rows, and content to fit your use case."}}};var d,s,l;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:"() => calExampleHtml",...(l=(s=a.parameters)==null?void 0:s.docs)==null?void 0:l.source}}};var r,c,_;n.parameters={...n.parameters,docs:{...(r=n.parameters)==null?void 0:r.docs,source:{originalSource:"() => daysExampleHtml",...(_=(c=n.parameters)==null?void 0:c.docs)==null?void 0:_.source}}};var i,o,p;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:"() => monthsExampleHtml",...(p=(o=e.parameters)==null?void 0:o.docs)==null?void 0:p.source}}};var f,m,v;t.parameters={...t.parameters,docs:{...(f=t.parameters)==null?void 0:f.docs,source:{originalSource:"() => yearsExampleHtml",...(v=(m=t.parameters)==null?void 0:m.docs)==null?void 0:v.source}}};const U=["CalendarDays","Days","Months","Years"];export{a as CalendarDays,n as Days,e as Months,t as Years,U as __namedExportsOrder,C as default};
//# sourceMappingURL=calendar.stories-e5ca0125.js.map
