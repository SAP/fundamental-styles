/* empty css               *//* empty css            *//* empty css               *//* empty css             *//* empty css             *//* empty css                *//* empty css                         *//* empty css                    */const F=`<div style="display: flex; justify-content: center; padding: 100px 0 25px;">
...
`,O=`<div class="fd-popover" style="margin-bottom: 100px">
    <div class="fd-popover__control">
        <button
            class="fd-button"
...
</div>`,P=`<div style="display: flex; justify-content: center; padding: 100px 0 25px;">
    <div class="fd-popover">
        <div class="fd-popover__control">
            <button
                class="fd-button"
...
`,C=`<div class="fd-popover" style="margin-bottom: 300px">
    <div class="fd-popover__control">
        <button
            class="fd-button"
            aria-controls="popoverF1"
...
`,z=`<div class="fd-container" style="margin-bottom: 200px">
    <div class="fd-row">
...
`,H=`<div class="fddocs-container" style="margin-bottom: 275px">
    <div class="fd-popover">
        <div class="fd-popover__control">
            <button
...
`,docs:{story:{iframeHeight:350}},tags:["f3","a11y","theme"]}},n=()=>H;n.storyName="Body variants";n.parameters={docs:{story:{iframeHeight:200},description:{story:`There are several variants of the popover body that can be displayed depending on the use case.
...
You can also have subheader by using **Bar** component with subheader.
        `}}};const o=()=>z;o.storyName="Control variants";o.parameters={docs:{story:{iframeHeight:200},description:{story:`As popover's triggers buttons, images, icons, and more can be used. In the example below, the **Avatar** and **Icon** act as triggers.
        `}}};const e=()=>C;e.parameters={docs:{story:{iframeHeight:200},description:{story:"When the content overflows, the popover body can become scrollable. To achieve this, add element with class `fd-popover-body__wrapper` inside the popover body element.\n        "}}};const a=()=>P;a.parameters={docs:{description:{story:"It's possible to show popover on different sides of the trigger. To do that apply the following modifier classes to the popover body element.\n\n| Modifier | Description |\n| :---- | :---------- |\n| `fd-popover__body` | Positions the popover below the trigger. *(default)* |\n| `fd-popover__body--above` | Positions the popover above the trigger. |\n| `fd-popover__body--before` | Positions the popover before the trigger. |\n| `fd-popover__body--after` | Positions the popover next to the trigger. |\n\nTo align the popover arrow with the trigger apply the following modifier classes to the popover body element.\n\n| Arrow modifier class | Description |\n| :------------- | :---------- |\n| `fd-popover__body` | Positions the arrow on the top left side of the popover. *(default)* |\n| `fd-popover__body--arrow-bottom` | Positions the arrow on the bottom left right side of the popover. |\n| `fd-popover__body--arrow-left` | Positions the arrow on the left top side of the popover. |\n| `fd-popover__body--arrow-right` | Positions the arrow on the right top side of the popover. |\n| `fd-popover__body--arrow-x-center` | Positions the arrow horizontally centered on the popover. |\n| `fd-popover__body--arrow-x-end` | Positions the arrow to the end by horizontal line of the popover body. |\n| `fd-popover__body--arrow-y-center` | Positions the arrow vertically centered on the popover. |\n| `fd-popover__body--arrow-y-bottom` | Positions the arrow to the end by vertical line of the popover. |\n\n**note:** `fd-popover__body--arrow-y--end` class has been deprecated in favor of `fd-popover__body--arrow-y-bottom`!\n        "}}};const s=()=>O;s.parameters={docs:{description:{story:"It's possible to hide popover's arrow.\nTo achieve this apply the `fd-popover__body--no-arrow` modifier class to the popover body element and remove all the arrow modifier classes."}}};const i=()=>F;i.parameters={docs:{description:{story:""}}};var l,r,t;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:"() => variantsExampleHtml",...(t=(r=n.parameters)==null?void 0:r.docs)==null?void 0:t.source}}};var d,p,_;o.parameters={...o.parameters,docs:{...(d=o.parameters)==null?void 0:d.docs,source:{originalSource:"() => controlExamplesExampleHtml",...(_=(p=o.parameters)==null?void 0:p.docs)==null?void 0:_.source}}};var c,v,f;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:"() => scrollableExampleHtml",...(f=(v=e.parameters)==null?void 0:v.docs)==null?void 0:f.source}}};var u,m,b;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:"() => placementExampleHtml",...(b=(m=a.parameters)==null?void 0:m.docs)==null?void 0:b.source}}};var h,y,g;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:"() => noArrowExampleHtml",...(g=(y=s.parameters)==null?void 0:y.docs)==null?void 0:g.source}}};var w,x,k;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:"() => resizableExampleHtml",...(k=(x=i.parameters)==null?void 0:x.docs)==null?void 0:k.source}}};const N=["Variants","ControlExamples","Scrollable","Placement","NoArrow","Resizable"];export{o as ControlExamples,s as NoArrow,a as Placement,i as Resizable,e as Scrollable,n as Variants,N as __namedExportsOrder,Y as default};
//# sourceMappingURL=popover.stories-e9303e60.js.map
