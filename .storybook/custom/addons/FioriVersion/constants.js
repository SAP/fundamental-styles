...
export const fioriVersionCompliance = {
    fiori: (story) => story.id.match(/introduction/) || !story.id.match(/btp-experimental-design/),
    fioriNext: (story) => story.id.match(/introduction/) || story.id.match(/btp-experimental-design/),
    all: () => true
};
