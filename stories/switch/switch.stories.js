    ...
    <div class="fd-form-item">
        ...
        <label class="fd-switch__label">
            <span class="fd-switch fd-switch--semantic">
                ...
                <div class="fd-switch__wrapper">
                    <div class="fd-switch__track">
                        <i role="presentation" class="fd-switch__icon--on fd-switch__icon fd-icon--accept"></i>
                        <span class="fd-switch__handle" role="presentation"></span>
                        <i role="presentation" class="fd-switch__icon--off fd-switch__icon fd-icon--decline"></i>
                    </div>
                </div>
            </span>
        </label>
