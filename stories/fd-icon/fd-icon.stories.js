...
sizes.parameters = {
    docs: {
        iframeHeight: 250,
        storyDescription: 'Default size for icons is 1rem. They are vector graphics, meaning they can be easily resized without compromising their appearance. And because icons are essentially a font, there are unlimited sizes.'
    }
};
