...
import * as stories from './tool-header.stories.js';

export default {
    title: 'Visual/High Contrast Black/Tool Header',
    parameters: {
        components: ['avatar', 'button', 'form-label', 'icon', 'input-group', 'object-status', 'text', 'title', 'tool-header'],
