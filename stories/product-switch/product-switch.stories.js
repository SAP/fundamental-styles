                ...
                <div class="fd-product-switch__body">
                    <ul class="fd-product-switch__list">
                        <li class="fd-product-switch__item selected" tabindex="0">
                             <div class="fd-product-switch__icon">
                        ...
                        <li class="fd-product-switch__item" tabindex="0" selected>
                             <div class="fd-product-switch__icon">
                                <i class="sap-icon--business-objects-experience"></i>
                             </div>
                            <div class="fd-product-switch__text">
                        ...
                        <li class="fd-product-switch__item" tabindex="0">
                            <div class="fd-product-switch__icon">
                               <i class="sap-icon--credit-card"></i>
                            </div>
                            <div class="fd-product-switch__text">
                        ...
                        <li class="fd-product-switch__item" tabindex="0">
                            <div class="fd-product-switch__icon">
                               <i class="sap-icon--shipping-status"></i>
                            </div>
                            <div class="fd-product-switch__text">
                        ...
                        <li class="fd-product-switch__item" tabindex="0">
                            <div class="fd-product-switch__icon">
                               <i class="sap-icon--sales-notification"></i>
                            </div>
                            <div class="fd-product-switch__text">
                        ...
                        <li class="fd-product-switch__item" tabindex="0">
                            <div class="fd-product-switch__icon">
                               <i class="sap-icon--retail-store"></i>
                            </div>
                            <div class="fd-product-switch__text">
                        ...
                        <li class="fd-product-switch__item" tabindex="0">
                            <div class="fd-product-switch__icon">
                               <i class="sap-icon--marketing-campaign"></i>
                            </div>
                            <div class="fd-product-switch__text">
                        ...
                        <li class="fd-product-switch__item" tabindex="0">
                            <div class="fd-product-switch__icon">
                               <i class="sap-icon--customer-briefing"></i>
                            </div>
                            <div class="fd-product-switch__text">
                        ...
                        <li class="fd-product-switch__item" tabindex="0">
                            <div class="fd-product-switch__icon">
                               <i class="sap-icon--batch-payments"></i>
                            </div>
                            <div class="fd-product-switch__text">
