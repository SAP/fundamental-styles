export default {
    ...
    parameters: {
        description: `
The rich-text-editor component is an opinionated composition of the \`toolbar\`, \`toggle-button\`, \`menu-button\`, \`split-button\`, \`select\`,\`icon\`,\`popover\`,\`menu\`,\`list\` and \`text-area\` components.
...
export const cozyMode = () => `<div style="height:450px;overflow-y:hidden">
<div>
    ...
    <div class="fd-toolbar fd-toolbar--cozy">
        ...
        <button class="fd-button fd-button--transparent" aria-label="bold text">
        ...
        <div class="fd-popover">
                <div class="fd-popover__control">
                        <button aria-expanded="false" aria-haspopup="true" aria-label="cozy rte allignments"
                ...
                <div aria-hidden="true" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown" id="h0C6A324">
                    <ul aria-activedescendant="cozySelectRTE-currentlyFocusedItem" aria-labelledby="cozyRTELabel" class="fd-list fd-list--dropdown" role="listbox">
        ...
        <div class="fd-popover">
                <div class="fd-popover__control">
                    <div class="fd-select">
                        <button aria-expanded="false" aria-haspopup="listbox" aria-label="cozyselectlabel cozyselectvalue" class="fd-select__control" id="cozyRTEParagraph" onclick="
                                        toggleElAttrs('h0C6A325', ['aria-hidden']);
                                        toggleElAttrs('cozyRTEParagraph', ['aria-expanded']);
                                    " value="List Item 1" tabindex="0">
                            <span is="cozyselectvalue" class="fd-select__text-content">Paragraph</span>
        ...
        <div aria-hidden="true" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown" id="h0C6A325">
            <ul aria-activedescendant="cozyRTEParagraph-currentlyFocusedItem" aria-label="cozyselectlabel" class="fd-list fd-list--dropdown" role="listbox">
  ...
  <div class="fd-popover">
        <div class="fd-popover__control">
                <div class="fd-select">
                    <button aria-expanded="false" aria-haspopup="listbox" aria-label="cozySelectLabel cozySelectValue" class="fd-select__control" id="cozySelectCombobox" onclick="
                                    toggleElAttrs('h0C6A326', ['aria-hidden']);
                                    toggleElAttrs('cozySelectCombobox', ['aria-expanded']);
                                " value="Times New Roman" tabindex="0">
                    <span is="cozySelectValue" class="fd-select__text-content">Times New Roman</span>
                    <span class="fd-button fd-button--transparent fd-select__button">
                                    <i class="sap-icon--slim-arrow-down"></i> 
                    </span>
                    </button>
        ...
        <div aria-hidden="true" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown" id="h0C6A326">
            <ul aria-activedescendant="cozySelectCombobox-currentlyFocusedItem" aria-label="cozySelectLabel" class="fd-list fd-list--dropdown" role="listbox">
  ...
  <div class="fd-popover">
        <div class="fd-popover__control">
            <div class="fd-select">
                <button aria-expanded="false" aria-haspopup="listbox" aria-label="cozySelectLabel cozySelectValue" class="fd-select__control" id="cozyRTEFontSize" onclick="
                                toggleElAttrs('h0C6A327', ['aria-hidden']);
                                toggleElAttrs('cozyRTEFontSize', ['aria-expanded']);
                            " value="List Item 1" tabindex="0">
                    <span is="cozySelectValue" class="fd-select__text-content">10 pt</span>
                    <span class="fd-button fd-button--transparent fd-select__button">
                        <i class="sap-icon--slim-arrow-down"></i> 
                    </span>
                </button>
        ...
        <div aria-hidden="true" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown" id="h0C6A327">
            <ul aria-activedescendant="cozyRTEFontSize-currentlyFocusedItem" aria-label="cozySelectLabel" class="fd-list fd-list--dropdown" role="listbox">
  ...
  <div class="fd-button-split fd-button-split--transparent fd-has-margin-right-small" role="group" aria-label="button-split">
        <button class="fd-button fd-button--transparent" aria-haspopup="true" aria-expanded="false" aria-label="button" aria-controls="t4c0o273">
            ...
            <rect class="fill" x="1" y="12" width="14" height="3" rx="0.2" ry="0.2"/></svg>
        </button>
...
<textarea aria-label="rtecozytextarea" class="fd-textarea" cols="30" rows="15" id="textarea-2">Pellentesque metus lacus commodo eget justo ut rutrum varius nunc.</textarea>
</div>
</div>
...
export const compactMode = () => `<div style="height:450px;overflow-y:hidden">
    ...
    <div class="fd-toolbar">
        ...
        <div class="fd-popover">
            <div class="fd-popover__control">
                    <button aria-expanded="false" aria-haspopup="true" aria-label="compactSelectLabel compactSelectValue"
        ...
        <div aria-hidden="true" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown" id="h0C6A328">
            <ul aria-activedescendant="compactSelectRTE-currentlyFocusedItem" aria-label="compactSelectLabel" class="fd-list fd-list--compact fd-list--dropdown" role="listbox">
    ...
    <div class="fd-popover">
        <div class="fd-popover__control">
            <div class="fd-select fd-select--compact ">
                <button aria-expanded="false" aria-haspopup="listbox" aria-label="compactSelectLabel compactSelectValue" class="fd-select__control" id="compactRTEParagraph" onclick="
                                toggleElAttrs('h0C6A329', ['aria-hidden']);
                                toggleElAttrs('compactRTEParagraph', ['aria-expanded']);
                            " value="List Item 1" tabindex="0">
                    <span is="compactSelectValue" class="fd-select__text-content">Paragraph</span>
        ...
        <div aria-hidden="true" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown" id="h0C6A329">
            <ul aria-activedescendant="compactRTEParagraph-currentlyFocusedItem" aria-label="compactSelectLabel" class="fd-list fd-list--compact fd-list--dropdown" role="listbox">
  ...
  <div class="fd-popover">
        <div class="fd-popover__control">
                <div class="fd-select fd-select--compact">
                    <button aria-expanded="false" aria-haspopup="listbox" aria-label="compactSelectLabel compactSelectValue" class="fd-select__control" id="compactRTEFont" onclick="
                                    toggleElAttrs('h0C6A3211', ['aria-hidden']);
                                    toggleElAttrs('compactRTEFont', ['aria-expanded']);
                                " value="Times New Roman" tabindex="0">
                    <span is="compactSelectValue" class="fd-select__text-content">Times New Roman</span>
                    <span class="fd-button fd-button--compact fd-button--transparent fd-select__button">
                        <i class="sap-icon--slim-arrow-down"></i> 
                    </span>
                    </button>
        ...
        <div aria-hidden="true" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown" id="h0C6A3211">
            <ul aria-activedescendant="cozySelectCombobox-currentlyFocusedItem" aria-label="cozySelectLabel" class="fd-list fd-list--compact fd-list--dropdown" role="listbox">
                <li id="cozySelectCombobox-currentlyFocusedItem" class="fd-list__item" role="option" tabindex="0">
                    <span class="fd-list__title">Select</span>
                </li>
                <li aria-selected="true" class="fd-list__item is-selected" role="option" tabindex="0">
  ...
  <div class="fd-popover">
        <div class="fd-popover__control">
            <div class="fd-select fd-select--compact">
                <button aria-expanded="false" aria-haspopup="listbox" aria-label="compactSelectLabel compactSelectValue" class="fd-select__control" id="compactRTEFontSize" onclick="
                                toggleElAttrs('h0C6A3212', ['aria-hidden']);
                                toggleElAttrs('compactRTEFontSize', ['aria-expanded']);
                            " value="List Item 1" tabindex="0">
                    <span is="compactSelectValue" class="fd-select__text-content">10 pt</span>
                    <span class="fd-button fd-button--compact fd-button--transparent fd-select__button">
                        <i class="sap-icon--slim-arrow-down"></i> 
                    </span>
                </button>
        ...
        <div aria-hidden="true" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown" id="h0C6A3212">
            <ul aria-activedescendant="compactRTEFontSize-currentlyFocusedItem" aria-label="compactSelectLabel" class="fd-list fd-list--compact fd-list--dropdown" role="listbox">
...
<textarea  aria-label="compactRTEtextarea" class="fd-textarea" cols="30" rows="15" id="textarea-2">Pellentesque metus lacus commodo eget justo ut rutrum varius nunc.</textarea>
</div>

`;

export const overFlowRTE = () => `<div style="height:450px;overflow-y:hidden">
    <div class="fd-docs-rich-text-editor">
        <div class="fd-toolbar fd-toolbar--title fd-toolbar-active ">
            <h4>RTE Title</h4>
        </div>
    <div class="fd-toolbar">
        ...
        <div class="fd-popover">
            <div class="fd-popover__control">
                    <button aria-expanded="false" aria-haspopup="true" aria-label="overflowSelectLabel overflowSelectValue"
                    class="fd-button fd-button--compact fd-button--menu fd-button--transparent" 
        ...
        <div aria-hidden="true" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown" id="h0C6A3213">
            <ul aria-activedescendant="compactSelectRTE-currentlyFocusedItem" aria-label="overflowSelectLabel" class="fd-list fd-list--compact fd-list--dropdown" role="listbox">
                <li id="compactSelectRTE-currentlyFocusedItem" class="fd-list__item is-selected" role="option" aria-selected="true" tabindex="0">
                    <span class="fd-list__thumbnail">
                    <i class="sap-icon--text-align-left"></i>
                    <span class="fd-list__title"> Left Align</span>
    ...
    <div class="fd-popover">
        <div class="fd-popover__control">
            <div class="fd-select fd-select--compact ">
                <button aria-expanded="false" aria-haspopup="listbox" aria-label="overflowSelectLabel overflowSelectValue" class="fd-select__control" id="overflowRTEParagraph" onclick="
                                toggleElAttrs('h0C6A3214', ['aria-hidden']);
                                toggleElAttrs('overflowRTEParagraph', ['aria-expanded']);
                            " value="List Item 1" tabindex="0">
                    <span is="overflowSelectValue" class="fd-select__text-content">Paragraph</span>
                    <span class="fd-button fd-button--compact fd-button--transparent fd-select__button">
                        <i class="sap-icon--slim-arrow-down"></i> 
                    </span>
                </button>
        ...
        <div aria-hidden="true" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown" id="h0C6A3214">
            <ul aria-activedescendant="overflowRTEParagraph-currentlyFocusedItem" aria-label="overflowSelectLabel" class="fd-list fd-list--compact fd-list--dropdown" role="listbox">
  ...
  <div class="fd-popover">
        <div class="fd-popover__control">
                <div class="fd-select fd-select--compact">
                    <button aria-expanded="false" aria-haspopup="listbox" aria-label="overflowSelectLabel overflowSelectValue" class="fd-select__control" id="overflowRTEFont" onclick="
                                    toggleElAttrs('h0C6A3215', ['aria-hidden']);
                                    toggleElAttrs('overflowRTEFont', ['aria-expanded']);
                                " value="Times New Roman" tabindex="0">
                    <span is="overflowSelectValue" class="fd-select__text-content">Times New Roman</span>
                    <span class="fd-button fd-button--compact fd-button--transparent fd-select__button">
                        <i class="sap-icon--slim-arrow-down"></i> 
                    </span>
                    </button>
        ...
        <div aria-hidden="true" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown" id="h0C6A3215">
            <ul aria-activedescendant="overflowRTEFont-currentlyFocusedItem" aria-label="overflowSelectLabel" class="fd-list fd-list--compact fd-list--dropdown" role="listbox">
  ...
  <div class="fd-popover">
        <div class="fd-popover__control">
            <div class="fd-select fd-select--compact">
                <button aria-expanded="false" aria-haspopup="listbox" aria-label="overflowSelectLabel overflowSelectValue" class="fd-select__control" id="overflowRTEFontSize" onclick="
                                toggleElAttrs('h0C6A3216', ['aria-hidden']);
                                toggleElAttrs('overflowRTEFontSize', ['aria-expanded']);
                            " value="List Item 1" tabindex="0">
                    <span is="overflowSelectValue" class="fd-select__text-content">10 pt</span>
                    <span class="fd-button fd-button--compact fd-button--transparent fd-select__button">
                        <i class="sap-icon--slim-arrow-down"></i> 
                    </span>
                </button>
        ...
        <div aria-hidden="true" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--dropdown" id="h0C6A3216">
            <ul aria-activedescendant="overflowRTEFontSize-currentlyFocusedItem" aria-label="overflowSelectLabel" class="fd-list fd-list--compact fd-list--dropdown" role="listbox">
  ...
  <div class="fd-button-split fd-button-split--compact fd-button-split--transparent fd-has-margin-right-small" role="group" aria-label="button-split">
   ...
   <div class="fd-popover">
   <div class="fd-popover__control">
    <button class="fd-button fd-button--compact fd-button--transparent" aria-controls="t4c0o2738" aria-haspopup="true" aria-expanded="false" aria-label="More"><i class="sap-icon--overflow"></i></button>
    ...
    <textarea  aria-label="rteoverflowtextarea" class="fd-textarea" cols="30" rows="15" id="textarea-2">Pellentesque metus lacus commodo eget justo ut rutrum varius nunc.</textarea>
</div>
</div>
`;
