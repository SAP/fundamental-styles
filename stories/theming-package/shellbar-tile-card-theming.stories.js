export default {
    title: 'Theming/Shellbar, Tiles, and Cards',
    parameters: {
        components: [
            'button', 'input-group', 'icon', 'menu', 'avatar', 'input-group', 'popover', 'product-switch', 'shellbar', 'counter',
            'tile', 'badge', 'generic-tile', 'numeric-content', 'icon',
            'card', 'object-status', 'table', 'checkbox', 'list', 'link'
        ]
    }
};
...
export const primary = () => `
    ...
    <div style="height:150px; max-width: 1024px;">
    ...
    <div style="height:150px; max-width: 600px;">
