...
import * as stories from './fn-shell.stories.js';

export default {
    title: 'Visual/High Contrast Black/Fn Shell',
    parameters: {
        components: ['fn-shell', 'fn-button', 'fn-search', 'fn-avatar', 'fn-button', 'icon', 'toolbar'],
