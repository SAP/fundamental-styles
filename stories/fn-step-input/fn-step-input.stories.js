export default {
    ...
    parameters: {
        ...
        `,
        components: ['fn-input', 'fn-nested-button', 'fn-step-input', 'icon']
    }
};
...
<div class="docs-fn-container">
    ...
    <div class="fn-input fn-step-input" tabindex="0">
        <button class="fn-nested-button" aria-label="subtract button" tabindex="-1">
        ...
        <button class="fn-nested-button" aria-label="add button" tabindex="-1">
...
<div class="docs-fn-container">
    ...
    <div class="fn-input fn-step-input" tabindex="-1">
        <button class="fn-nested-button" disabled aria-label="subtract button" tabindex="-1">
            <span class="sap-icon sap-icon--less"></span>
        </button>
        <input class="fn-input__text-field fn-step-input__text-field" disabled type="number" id="field-5" value="42" tabindex="-1" />
        <div class="fn-input__border"></div>
        <button class="fn-nested-button" disabled aria-label="add button" tabindex="-1">
            <span class="sap-icon sap-icon--add"></span>
        </button>
    </div>
</div>
