...
import * as stories from './fn-object-status.stories.js';

export default {
    title: 'Visual/High Contrast Black/Fn Object Status',
    parameters: {
        components: ['fn-object-status', 'icon'],
