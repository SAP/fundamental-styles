...
<div class="fd-form-item">
    ...
    <div class="fd-input-group">
        ...
        <span class="fd-input-group__addon fd-input-group__addon--button">
            <button class="fd-input-group__button fd-button" tabindex="-1">
                Button
            </button>
        </span>
    </div>
...
<div class="fd-form-item">
    ...
    <div class="fd-input-group">
        ...
        <span class="fd-input-group__addon fd-input-group__addon--button">
            <button class="fd-input-group__button fd-button fd-button--icon" aria-label="Navigation" tabindex="-1">
...
<div class="fd-form-item">
    ...
    <div class="fd-input-group">
        ...
        <span class="fd-input-group__addon fd-input-group__addon--button fd-input-group__addon--compact">
            <button class="fd-input-group__button fd-button fd-button--icon fd-button--compact" aria-label="Navigation" tabindex="-1">
                <i class="sap-icon--navigation-down-arrow"></i>
            </button>
        </span>
    </div>
...
<div class="fd-form-item">
    ...
    <div class="fd-input-group is-information">
        ...
        <span class="fd-input-group__addon fd-input-group__addon--button fd-input-group__addon--compact">
            <button class="fd-input-group__button fd-button fd-button--information fd-button--compact" tabindex="-1">
                Button
            </button>
        </span>
    </div>
