...
export const empty = () => `
    <div class="fd-feed-input" role="region" aria-label="Feed input empty">
        ...
        <button class="fd-button sap-icon--feeder-arrow fd-feed-input__submit-button" aria-label="Submit" title="Submit" aria-disabled="true" disabled></button>
    </div>
`;
...
export const notEmpty = () => `
    <div class="fd-feed-input" role="region" aria-label="Feed input with one row text">
        ...
        <button class="fd-button sap-icon--feeder-arrow fd-feed-input__submit-button" aria-label="Submit" title="Submit" aria-disabled="false"></button>
    </div>
`;
