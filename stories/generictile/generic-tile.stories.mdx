...
import InfoLabel from '../../.storybook/custom/components/InfoLabel';

import Community from '../../.storybook/custom/components/Community';
import Toc from '../../.storybook/custom/components/Toc.js';
import Footer from '../../.storybook/custom/components/Footer';

<Meta
    title="Components/GenericTile"
    parameters={{
        tags: ['f3', 'a11y', 'theme'],
...
<nav class=" toc">
    <ol class="toc-list ">
        <li class="toc-list-item is-active-li">
            <a href="#examples" class="toc-link node-name--H2  is-active-link" target="_self">
                Examples
            </a>
            <ol class="toc-list ">
                <li class="toc-list-item">
                    <a href="#generic-tile-sizes-responsiveness" class="toc-link node-name--H3 " target="_self">
                        Generic Tile Sizes (Responsiveness)
                    </a>
                </li>
                <li class="toc-list-item">
                    <a href="#generic-tile-layout" class="toc-link node-name--H3 " target="_self">
                        Generic Tile Layout
                    </a>
                </li>
                <li class="toc-list-item">
                    <a href="#generic-tile-content-columns" class="toc-link node-name--H3 " target="_self">
                        Generic Tile Content Columns
                    </a>
                </li>
                <li class="toc-list-item">
                    <a href="#launch-tile" class="toc-link node-name--H3 " target="_self">
                        Launch Tile
                    </a>
                </li>
                <li class="toc-list-item">
                    <a href="#kpi-tile-numeric-content" class="toc-link node-name--H3 " target="_self">
                        KPI Tile (Numeric Content)
                    </a>
                </li>
                <li class="toc-list-item">
                    <a href="#feed-tile" class="toc-link node-name--H3 " target="_self">
                        Feed Tile
                    </a>
                </li>
                <li class="toc-list-item">
                    <a href="#badge-tile" class="toc-link node-name--H3 " target="_self">
                        Badge Tile
                    </a>
                </li>
                <li class="toc-list-item">
                    <a href="#slide-tile" class="toc-link node-name--H3 " target="_self">
                        Slide Tile
                    </a>
                </li>
                <li class="toc-list-item">
                    <a href="#tile-in-action-mode" class="toc-link node-name--H3 " target="_self">
                        Tile In Action Mode
                    </a>
                </li>
                <li class="toc-list-item">
                    <a href="#line-tile" class="toc-link node-name--H3 " target="_self">
                        Line Tile
                    </a>
                </li>
            </ol>
...
<Preview>
    <Story name="Generic Tile Layout">
        {() => `
<div class="docs-section-container">
    <div role="button" aria-label="button" tabindex="0" class="fd-tile">
        <div class="fd-tile__header"></div>
...
<ul class="docs-ul">
    <li>
        Header <code>fd-tile__header fd-tile__header--2-col</code>
        <ul class="docs-ul">
            <li>
                Section <code>fd-tile__section</code>.
            </li>
            <li>
                Section <code>fd-tile__section</code>.
            </li>
    ...
    <li>
        Content <code>fd-tile__content fd-tile__content--2-col</code>
        <ul class="docs-ul">
            <li>
                Section <code>fd-tile__section</code>.
            </li>
    ...
    <li>
        Footer <code>fd-tile__footer fd-tile__footer--2-col</code>
        <ul class="docs-ul">
            <li>
                Section <code>fd-tile__section</code>.
            </li>
...
<Preview>
    <Story name="Generic Tile Content Columns">
        {() => `
<div class="docs-section-container">
    <div role="button" aria-label="button" tabindex="0" class="fd-tile">
...
<Preview>
    <Story name="Tile In Action Mode">
        {() => `
<div class="docs-section-container">
