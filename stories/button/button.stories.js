...
<span style=“color: darkred; font-weight: bold;“>Note: For the text to be read out loud by screen readers, a helper text has been added with <code>aria-describedby</code> matching the <code>id</code> of the paragraph element with the <code>_instructions</code> element. The element uses the <code>screen-reader-only</code> styling so that it is not visible.</span>
