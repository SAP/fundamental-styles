...
export const DisplayOnlyInfoLabel = () => `<div class="fddocs-container">
    <span class="fd-info-label fd-info-label--display">
        <span class="fd-info-label__text">system state</span>
    </span>
    <span class="fd-info-label fd-info-label--display fd-info-label--numeric">
        <span class="fd-info-label__numeric">42</span>
    </span>
