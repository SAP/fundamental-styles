...
import * as stories from './fn-message-toast.stories.js';

export default {
    title: 'Visual/High Contrast Black/Fn Message Toast',
    parameters: {
        components: ['fn-message-toast'],
