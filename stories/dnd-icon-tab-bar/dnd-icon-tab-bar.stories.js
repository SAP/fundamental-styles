...
<div class="fd-icon-tab-bar">
    <ul role="tablist" class="fd-icon-tab-bar__header">  
        <li role="presentation" class="fd-icon-tab-bar__item fd-icon-tab-bar-dnd-hovered">
        ...
        <li role="presentation" class="fd-icon-tab-bar__item fd-icon-tab-bar-dnd-preview" style="position: absolute; left: 20px; top: 10px;">
...
<div class="fd-icon-tab-bar">
    <ul role="tablist" class="fd-icon-tab-bar__header">  
        ...
        <li role="presentation" class="fd-icon-tab-bar__item fd-icon-tab-bar-dnd-separator">
            <a role="tab" class="fd-icon-tab-bar__tab" href="#section2" aria-selected="true" id="tab2">
                <span class="fd-icon-tab-bar__tag">Info</span>
            </a>
        </li>
        <li role="presentation" class="fd-icon-tab-bar__item fd-icon-tab-bar-dnd-preview" style="position: absolute; left: 128px; top: 10px">
            <a role="tab" class="fd-icon-tab-bar__tab" href="#section3" id="tab3">
                <span class="fd-icon-tab-bar__tag">Approvals (42)</span>
            </a>
    </ul> 
