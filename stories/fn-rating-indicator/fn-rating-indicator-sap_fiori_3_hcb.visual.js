...
import * as stories from './fn-rating-indicator.stories.js';

export default {
    title: 'Visual/High Contrast Black/Fn Rating Indicator',
    parameters: {
        components: ['fn-button', 'fn-rating-indicator', 'icon'],
...
export const FnRatingIndicator = () => {
