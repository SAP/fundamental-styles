...
import * as stories from './list-grid-select.stories.js';

export default {
    title: 'Visual/High Contrast Black/List Grid Select',
    parameters: {
        components: ['list-grid', 'layout-grid', 'toolbar', 'button', 'icon', 'title', 'radio', 'checkbox', 'avatar', 'link', 'object-status'],
